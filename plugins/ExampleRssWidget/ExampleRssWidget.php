...
class Piwik_ExampleRssWidget extends Piwik_Plugin
{
    ...
    {
        Piwik_WidgetsList::getInstance()->add('Example Widgets', 'Piwik.org Blog', 'ExampleRssWidget', 'rssPiwik');
        Piwik_WidgetsList::getInstance()->add('Example Widgets', 'Piwik Changelog', 'ExampleRssWidget', 'rssChangelog');
    }
}