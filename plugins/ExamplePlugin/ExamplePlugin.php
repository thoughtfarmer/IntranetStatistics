...
//			'Controller.renderView' => 'addUniqueVisitorsColumnToGivenReport',
    ...
    function addWidgets()
    {
        ...
        Piwik_WidgetsList::getInstance()->add('ExamplePlugin_exampleWidgets', 'ExamplePlugin_exampleWidget', 'ExamplePlugin', 'exampleWidget');
        Piwik_WidgetsList::getInstance()->add('ExamplePlugin_exampleWidgets', 'ExamplePlugin_photostreamMatt', 'ExamplePlugin', 'photostreamMatt');
        Piwik_WidgetsList::getInstance()->add('ExamplePlugin_exampleWidgets', 'ExamplePlugin_piwikForumVisits', 'ExamplePlugin', 'piwikDownloads');
    }
}
