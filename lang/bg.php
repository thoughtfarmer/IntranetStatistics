...
$translations = array(
	...
	'General_AllowPiwikArchivingToTriggerBrowser' => 'Разреши Intranet Statistics архивиране, веднага след като докладите бъдат гледани от браузър',
	'General_ArchivingInlineHelp' => 'За сайтовете със среден или висок трафик, препоръчваме да изключите Intranet Statistics архивиране след гледане от браузър. Съветваме ви в този случай да използвате cron job за Вашите доклади на всеки час.',
	'General_ArchivingTriggerDescription' => 'За по-големи Intranet Statistics инсталации, се препоръчва %scron job%s за автоматични доклади.',
	...
	'General_RequiresFlash' => 'За да виждате графиките в Intranet Statistics се нуждаете от Flash',
	'General_GraphHelp' => 'Повече информация за показаните графики в Intranet Statistics.',
	...
	'General_YouAreViewingDemoShortMessage' => 'В момента Вие разглеждате демо версия на Intranet Statistics',
	'General_YouAreCurrentlyUsing' => 'Вие използвате Intranet Statistics %s.',
	'General_DownloadFullVersion' => '%1$sИзтегли%2$s пълната версия! Провери %3$s',
	'General_NewUpdatePiwikX' => 'Нова версия: Intranet Statistics %s',
	'General_AboutPiwikX' => 'За Intranet Statistics %s',
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Intranet Statistics %1$s е наличен. %2$s Обновете сега. %3$s (вижте %4$s промените%5$s).',
	'General_PiwikXIsAvailablePleaseNotifyPiwikAdmin' => '%s е на разположение. Моля уведомете администратора на сайта.',
	'General_NewReportsWillBeProcessedByCron' => 'Когато Intranet Statistics архивирането не е предизвикано от браузърът, новите доклади ще бъдат обработени от crontab.',
	...
	'General_BackToPiwik' => 'Върни се в Intranet Statistics',
	...
	'General_ConfigFileIsNotWritable' => 'Конфигурационният файл %s на Intranet Statistics не е достъпен и Вашите настройки няма да бъдат запазени. %s Моля променете правата на файла, така, че да може да се пише в него.',
	'General_ExceptionDatabaseVersion' => 'Вашата %1$s версия е %2$s ,но Intranet Statistics изисква най-малко %3$s.',
	...
	'General_FileIntegrityWarningExplanation' => 'Проверката за целостта на файла се провали и се докладват някои грешки. Това най-вероятно се дължи на частичен файл или не е качен някой от файловете на Intranet Statistics. Трябва да качите отново всички файлове на Intranet Statistics в BINARY форма и да обновите тази страница, докато тя спре да показва грешки.',
	...
	'General_PleaseUpdatePiwik' => 'Моля, актуализирайте своя Intranet Statistics',
	...
	'Actions_DownloadsReportDocumentation' => 'В този отчет можете да видите файловете, които вашите посетители са изтеглили. %s Intranet Statistics отчита броя кликавания върху линка за сваляне. Дали изтеглянето е завършено не е ясно за Intranet Statistics.',
	...
	'API_PluginDescription' => 'Цялата информация от Intranet Statistics е достъпна чрез просто API. Тази добавка ви дава възможност да получите данни от Вашият Уеб Анализатор под формата на xml,json,php,cvs и др.',
	'API_QuickDocumentationTitle' => 'API бърза документация',
	'API_GenerateVisits' => 'Ако не разполагате с данни за днес можете да генерирате такива с помощта на плъгина %s. Вие можете да активирате плъгина %s, след което натиснете на \'Генератор на посещения\', намиращ се в менюто на администраторската среда на Intranet Statistics.',
	'API_MoreInformation' => 'За повече информация за Intranet Statistics API-тата, моля погледнете %s Въведение в Intranet Statistics API%s и %s Intranet Statistics API Референт%s.',
	...
	'CoreAdminHome_PluginDescription' => 'Администраторски панел на Intranet Statistics',
	...
	'CoreAdminHome_OptOutForYourVisitors' => 'Intranet Statistics отказ за вашите посетители',
	'CoreAdminHome_OptOutExplanation' => 'Intranet Statistics е ангажиран с осигуряването на поверителност в Интернет. За да позволите на потребителите си да се откажат от Intranet Statistics Web Analytics,  можете да добавите нужният HTML код в една от вашите уеб страници, например в раздела Поверителност.',
	'CoreAdminHome_OptOutExplanationBis' => 'Този код ще ви покаже рамка, съдържаща линк, на който вашите посетители могат да се откажат от Intranet Statistics, като поставят бисквитка в техните браузъри. %s Натиснете тук%s за да видите съдържанието, което ще бъде показано в рамката.',
	...
	'CoreAdminHome_CustomLogoHelpText' => 'Можете да модифицирате логото на Intranet Statistics, което да се показва в интерфейса на потребителя и имейлите с отчети.',
	'CoreAdminHome_CustomLogoFeedbackInfo' => 'Ако модифицирате Intranet Statistics логото, може също да пожелаете да скриете %s линка в главното меню. За да направите това, можете да изключите плъгина за обратна връзка в страницата %sУправление на добавки%s.',
	...
	'CoreAdminHome_LogoNotWriteable' => 'За да използвате изработеното лого Intranet Statistics изисква писмен достъп до файловете на логото в тематичната директория: %s',
	'CoreAdminHome_PiwikIsInstalledAt' => 'Intranet Statistics е инсталиран на',
	'PrivacyManager_TeaserHeadline' => 'Настройки на поверителността',
	'PrivacyManager_Teaser' => 'На тази страница можете да персонализирате Intranet Statistics, за да съгласувате поверителността със съществуващото законодателство, чрез: %s правейки посетителското IP анонимно %s, %s автоматично премахване на стари посетителски логове от базата данни %s, и %s даване на възможност за отказ от услуги за вашият уеб сайт%s.',
	'PrivacyManager_MenuPrivacySettings' => 'Поверителност',
	'PrivacyManager_PluginDescription' => 'Персонализирайте Intranet Statistics, за да го съгласувате със съществуващото законодателство.',
	'PrivacyManager_UseAnonymizeIp' => 'Правене на IP-тата на посетителите анонимни',
	'PrivacyManager_AnonymizeIpDescription' => 'Изберете "Да", ако желаете Intranet Statistics да не проследява напълно квалифицирани IP адреси.',
	...
	'PrivacyManager_DeleteDataDescription' => 'Можете да настроите Intranet Statistics периодично да изтрива старите потребителски логове и/или преработените отчети, за да пазите базата си данни малка.',
	...
	'PrivacyManager_DoNotTrack_EnabledMoreInfo' => 'Когато потребителите са настроили техният уеб браузър на "Аз не искам да бъда проследяван" (Не проследявай е включено), Intranet Statistics няма да отчита техните посещения.',
	'PrivacyManager_DoNotTrack_Disabled' => 'Intranet Statistics понястоящем проследява всички постетители, дори и те да са включили  "Не искам да бъда проследяван" в техният уеб браузър.',
	...
	'CoreHome_NoPrivilegesAskPiwikAdmin' => 'Вие се логнахте в като \'%s\' но изглежда че нямате разрешение от Intranet Statistics. %s Попитайте Вашият Intranet Statistics администратор (клик на email)%s да Ви даде "поглед" достъп до сайта.',
	'CoreHome_JavascriptDisabled' => 'JavaScript трябва да бъде разрешен за да използвате Intranet Statistics в стандартен изглед.<br />Същото е ако JavaScript не е разрешен или браузъра не го поддържа.<br />За да използвате стандартен изглед разрешете JavaScript от настройките на Вашия браузър и %1$sопитайте отново%2$s.<br />',
	...
	'CorePluginsAdmin_MainDescription' => 'Плъгините спомагат за по-обширното функциониране на Intranet Statistics. Веднъж инсталиран плъгин би могъл да бъде активиран (пускан) или деактивиран (спиран).',
	...
	'CoreUpdater_PluginDescription' => 'Механизъм за актуализиране на Intranet Statistics',
	'CoreUpdater_UpdateTitle' => 'Обновления',
	'CoreUpdater_DatabaseUpgradeRequired' => 'Необходимо е да се обнови базата от данни (БД)',
	'CoreUpdater_YourDatabaseIsOutOfDate' => 'Базата от данни (БД) на Intranet Statistics е остаряла. Трябва да обновите преди да продължите нататък.',
	'CoreUpdater_PiwikWillBeUpgradedFromVersionXToVersionY' => 'Intranet Statistics базата от данни (БД) ще бъде обновена от %1$s версия към %2$s.',
	'CoreUpdater_TheFollowingPluginsWillBeUpgradedX' => 'Следните плъгини ще бъдат обновени: %s.',
	'CoreUpdater_NoteForLargePiwikInstances' => 'Важна бележка за големи Intranet Statistics инсталации',
	'CoreUpdater_TheUpgradeProcessMayFailExecuteCommand' => 'Ако имате голяма Intranet Statistics база данни, актуализирането и може да отнеме прекалено много време, ако я стартирате през Вашият браузър. В този случай, можете да извършите актуализацията чрез команден ред: %s',
	'CoreUpdater_YouCouldManuallyExecuteSqlQueries' => 'Ако не сте в състояние да използвате актуализациите и ако не успеете да обновите Intranet Statistics (поради изчакване на база данни, изчакване на уеб браузъра или друго) можете ръчно да изпълните SQL заявките актуализиране на Intranet Statistics.',
	...
	'CoreUpdater_UpgradePiwik' => 'Обновете Intranet Statistics',
	...
	'CoreUpdater_ErrorDIYHelp_3' => 'опцията `ръчно обновяване` на таблиците в Intranet Statistics базата от данни (БД), определяне на стойността на version_core на версията на провалилота се актуализация',
	...
	'CoreUpdater_ErrorDIYHelp_5' => 'изпратете този проблем и/или решение на Intranet Statistics екипа - възможно е това да е важно!',
	...
	'CoreUpdater_HelpMessageIntroductionWhenError' => 'Открита е грешка в ядрото на Intranet Statistics. Ако имате нужда от допълнителна помощ моля обърнете се към нашия форум и/или прочетете документацията:',
	...
	'CoreUpdater_PiwikHasBeenSuccessfullyUpgraded' => 'Intranet Statistics успешно е обновен!',
	'CoreUpdater_ContinueToPiwik' => 'Продължете към Intranet Statistics',
	'CoreUpdater_UpdateAutomatically' => 'Обновете автоматично',
	'CoreUpdater_ThereIsNewVersionAvailableForUpdate' => 'Открита е нова версия на Intranet Statistics, можете да обновите!',
	...
	'CoreUpdater_YouMustDownloadPackageOrFixPermissions' => 'Intranet Statistics не е в състояние да презапишете текущата си инсталация. Можете да отстраните директорията/файла за достъп, или да изтеглите и инсталирате пакет версия %s и ръчно:',
	'CoreUpdater_DownloadX' => 'Изтегляне %s',
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'Автоматичното обновяване на Intranet Statistics е отказано. Опитайте отново! Ако не успеете автоматично да обновите Intranet Statistics, опитайте ръчно. %1$s Моля прочетете %2$s документацията %3$s и продължете!',
	...
	'CoreUpdater_PiwikUpdatedSuccessfully' => 'Обновлението на Intranet Statistics завърши успешно!',
	'CoreUpdater_EmptyDatabaseError' => 'Базата от данни (БД) %s е празна. Трябва да редактирате или изтриете конфигурационният файл на Intranet Statistics.',
	'CoreUpdater_ExceptionAlreadyLatestVersion' => 'Тази версия %s на Intranet Statistics е актуална.',
	...
	'CustomVariables_CustomVariablesReportDocumentation' => 'Този отчет съдържа информация за вашите Персонални променливи. Кликнете върху името на променлива, за да видите разпределението на стойностите. %s За повече информация отностно Персоналните Променливи в общ план, прочетете Документацията за %sПерсонални промеливи на Intranet Statistics.org%s',
	...
	'DBStats_PluginDescription' => 'Този плъгин докладва за използваното пространство на таблиците от Intranet Statistics в MySQL.',
	'DBStats_DatabaseUsage' => 'Натоварване на БД',
	'DBStats_MainDescription' => 'Intranet Statistics съхранява цялата информация в MySQL база от данни (БД). В момента Intranet Statistics таблиците използват %s.',
	'DBStats_LearnMore' => 'За да научите повече за това как Intranet Statistics обработва данни и колко добре работи за среден и висок трафик на уеб сайтове, проверете документацията %s.',
	...
	'ExampleUI_PluginDescription' => 'Примерен плъгин: Този плъгин показва как се работи с Intranet Statistics UI: създаване на таблици, графики, друго.',
	'Feedback_PluginDescription' => 'Изпратете обратна връзка към Intranet Statistics Team. Споделете Вашите идеи и предложения с нас!',
	...
	'Feedback_WhyWrongCountry' => 'Защо Intranet Statistics не отчита правилно държавата от която съм?',
	...
	'Feedback_SpecialRequest' => 'Имате ли специална молба към Intranet Statistics Team?',
	'Feedback_ContactThePiwikTeam' => 'Свържете се с Intranet Statistics Team!',
	'Feedback_IWantTo' => 'Желая да:',
	'Feedback_CategoryShareStory' => 'Споделете вашата успешна Intranet Statistics история',
	'Feedback_CategorySponsor' => 'Intranet Statistics Спонсор',
	'Feedback_CategoryHire' => 'Наемане на Intranet Statistics консултант',
	...
	'Feedback_MessageSent' => 'Вашето съобщение е изпратено до Intranet Statistics Team.',
	'Feedback_ThankYou' => 'Благодаря, че помогнахте да направим Intranet Statistics по-добър!',
	'Feedback_ThePiwikTeam' => 'Intranet Statistics Team',
	...
	'Goals_NoGoalsNeedAccess' => 'Само един администратор или Супер Потребителят може да добави цели за даден сайт. Моля, посъветвайте се с Вашия Intranet Statistics администратор да се създаде цел на вашия сайт. <br>Проследяването на целите е един чудесен начин да се спомогне за разбирането и максимизирането ефективността на уеб сайта Ви!',
	...
	'Goals_DefaultRevenueHelp' => 'Например, формуляр, предоставен от един посетител може да струва средно 10 долара. Intranet Statistics ще Ви помогне да разберете колко добре се представят Вашите посетители.',
	...
	'Goals_LearnMoreAboutGoalTrackingDocumentation' => 'Научете повече за %s Проследяване на целите в Intranet Statistics%s в ръководството.',
	...
	'Installation_PluginDescription' => 'Инсталационния процес на Intranet Statistics. Инсталацията обикновено се прави само веднъж. Ако конфигурационния файл config/ config.inc.php е изтрит, инсталацията ще започне отново.',
	...
	'Installation_NoConfigFound' => 'Intranet Statistics конфигурационният файл не е открит.<br /><b>  » Можете да <a href=\'index.php\'>инсталирате Intranet Statistics сега</a></b><br /><small>Ако преди това сте инсталирали Intranet Statistics и имате в базата от данни (БД) таблици - можете да запазите Вашите данни!</small>',
	...
	'Installation_LargePiwikInstances' => 'Помощ за големи Intranet Statistics случаи',
	'Installation_JsTag' => 'JavaScript код',
	'Installation_Congratulations' => 'Поздравления',
	'Installation_CongratulationsHelp' => '<p>Поздравления! Инсталацията на вашия Intranet Statistics завърши.</p><p>Убедете се, че сте добавили вашия JavaScript код в сайта!</p>',
	'Installation_ContinueToPiwik' => 'Продължете към Intranet Statistics',
	...
	'Installation_Requirements' => 'Intranet Statistics Изисквания',
	...
	'Installation_SystemCheckDatabaseHelp' => 'Необходимо е за да инстаалирате Intranet Statistics базата от данни(БД) да поддържа mysqli или PDO и pdo_mysql разширенията.',
	...
	'Installation_SystemCheckParseIniFileHelp' => 'Вградената функция е изключена от Вашият хостинг. Intranet Statistics ще се опитва да подражава на тази функция, но може да се сблъска с допълнителни ограничения за сигурност. Следването на изпълнението също ще бъде засегнато.',
	'Installation_SystemCheckGlobHelp' => 'Вградената функция е изключена от Вашият хостинг. Intranet Statistics ще се опитва да подражава на тази функция, но може да се сблъска с допълнителни ограничения за сигурност. Функционалността може да бъде засегната.',
	'Installation_SystemCheckDebugBacktraceHelp' => 'View::factory няма да бъде в състояние да създаде мнение за извикване на модул.',
	'Installation_SystemCheckCreateFunctionHelp' => 'Intranet Statistics използва анонимни функции за извиквания.',
	...
	'Installation_SystemCheckPackHelp' => 'Функцията "pack()" е нужна, за да следите посетителите в Intranet Statistics.',
	...
	'Installation_SystemCheckAutoUpdateHelp' => 'Забележка: Intranet Statistics One Click обновяване изисква разрешение за папката Intranet Statistics и нейното съдържание.',
	'Installation_SystemCheckError' => 'Открита е грешка - трябва да бъде поправена преди да преминете нататък',
	'Installation_SystemCheckWarning' => 'Intranet Statistics ще работи нормално, но някои услуги ще липсват',
	...
	'Installation_TablesWithSameNamesFound' => 'Някои %1$s таблици в базата от данни (БД) %2$s имат същите имена, както тези, които Intranet Statistics се опитва да създаде',
	'Installation_TablesFound' => 'Следните таблици бяха открити в базата от данни (БД)',
	'Installation_TablesWarningHelp' => 'Изберете дали да обновите данните в съществуващите таблици или да инсталирате Intranet Statistics на чисто.',
	'Installation_TablesReuse' => 'Използвай съществуващите таблици',
	'Installation_TablesDelete' => 'Изтрий съществуващите таблици',
	'Installation_TablesDeletedSuccess' => 'Съществуващите Intranet Statistics таблици бяха изтрити усшешно',
	...
	'Installation_GoBackAndDefinePrefix' => 'Върнете се за да зададете Prefix за Intranet Statistics таблиците в базата от данни (БД)',
	...
	'Installation_WelcomeHelp' => '<p>Intranet Statistics е анализатор (уеб брояч) с отворен код, който гъвкаво и лесно предоставя информация за посетителите на сайта ви.</p><p>Този процес е съкратен в %s лесни стъпки и не отнема повече от 5 минути.</p>',
	'Installation_ConfigurationHelp' => 'Вашият Intranet Statistics конфигурационен файл изглежда не добре конфигуриран. Можете да премахнете config/config.ini.php и да започнете инсталирането, или да поправите настройките за връзка към БД-то.',
	'Installation_ErrorInvalidState' => 'Грешка: възможно е да сте опитали да прескочите стъпка от инсталацията или е забранена поддръжката на бисквитките (cookies) или конфигурационният файл на Intranet Statistics вече съществува. %1$sПроверете дали са разрешени бисквитките (cookies)%2$s и се върнете %3$s на първата страница на инсталацията%4$s.',
	...
	'LanguagesManager_PluginDescription' => 'Този плъгин ще покаже списък с наличните езици за интерфейса на Intranet Statistics. Избраният език ще бъде записан в предпочитанията за всеки потребител.',
	'LanguagesManager_AboutPiwikTranslations' => 'За Intranet Statistics преводите',
	...
	'Login_InvalidNonceOrHeadersOrReferer' => 'Сигурността на формата е нарушена. Моля презаредете формата и проверете отново дали бисквитките са включени. Ако използвате прокси сървър, трябва да %s конфигурирате Intranet Statistics да приема хеадъра%s на проксито, който препраща хост хеадъра. Също така проверете, дали вашият хеадър за прапращане(Referer header) е изпратен правилно.',
	...
	'Login_ContactAdmin' => 'Възможни причини: функцията mail() е липсваща или забранена на сървъра. <br />Свържете се с вашия Intranet Statistics администратор.',
	...
	'Mobile_AddPiwikDemo' => 'Добавяне на Intranet Statistics демонстрация',
	...
	'Mobile_AccessUrlLabel' => 'Intranet Statistics URL достъп',
	...
	'Mobile_NoPiwikAccount' => 'Нямате Intranet Statistics акаунт?',
	...
	'MultiSites_PluginDescription' => 'Показват много места резюме/статистика. В момента поддържа като основен плъгин на Intranet Statistics.',
	...
	'Provider_ProviderReportDocumentation' => 'Отчетът показва кои доставчици на интернет услуги използват вашите потребители за достъп до уеб сайта. Можете да кликнете върху името на доставчика за повече детайли. %s Ако Intranet Statistics не може да определи доставчика на потребителя, той е показан само като IP.',
	...
	'SitesManager_PluginDescription' => 'Уеб сайтове за управление в Intranet Statistics: Добавяне на нов сайт, редактиране на вече съществуващ такъв, показване на JavaScript код за добавяне на страниците си. Всички действия са достъпни чрез API.',
	...
	'SitesManager_AliasUrlHelp' => 'Препоръчително е, но не е задължително, да се уточнят различните URL адреси, по един на ред, че Вашите посетители имат достъп до този сайт. Наричани още URL адреси за сайта няма да се появяват в Референции > Сайтове. Имайте в предвид, че не е необходимо да се уточнят URL адреси със и без "WWW" като Intranet Statistics автоматично смята така.',
	...
	'SitesManager_PiwikWillAutomaticallyExcludeCommonSessionParameters' => 'Intranet Statistics автоматично ще изключи общите параметри на сесията (%s).',
	'SitesManager_HelpExcludedIps' => 'Въведете списък с IP адреси, по един на ред, които искате да бъдат изключени от проследяването на Intranet Statistics. Можете да използвате заместващи символи, например. %1$s или %2$s',
	...
	'SitesManager_PiwikOffersEcommerceAnalytics' => 'Intranet Statistics позволява задълбочено проследяване и анализ на Електронна търговия. Научете повече относно %s Електронна търговия анализ %s.',
	'TranslationsAdmin_PluginDescription' => 'Помощ за Intranet Statistics превода на Вашият език.',
	...
	'UsersManager_PluginDescription' => 'Управлението на потребители в Intranet Statistics: добавяне на нов потребител, редактиране на съществуващ, актуализиране на разрешения. Всички действия са достъпни чрез API.',
	...
	'UsersManager_MainDescription' => 'Можете да управлявате правата на потребителите в Intranet Statistics, които да имат достъп до статистиките на вашия сайт. Също така можете да зададете права над всички сайтове.',
	...
	'UsersManager_YourVisitsAreIgnoredOnDomain' => '%sВашите посещения са игнорирани от Intranet Statistics в %s %s (Intranet Statistics игнорира бисквитката, намерена във Вашият браузър).',
	'UsersManager_YourVisitsAreNotIgnored' => '%sВашите посещения не се игнорират от Intranet Statistics %s(Бисквитката за игнориране на Вашите посещения, не е открита във Вашият браузър).',
	'UsersManager_ClickHereToDeleteTheCookie' => 'Натиснете тук, за да изтриете бисквитката и Intranet Statistics да отчита Вашите посещения',
	'UsersManager_ClickHereToSetTheCookieOnDomain' => 'Натиснете тук, за да зададете бисквитка, която ще Ви гарантира, че Вашите посещения няма да се отчитат от Intranet Statistics в %s',
	...
	'UsersManager_WhenUsersAreNotLoggedInAndVisitPiwikTheyShouldAccess' => 'Когато потребителите не са влезли и посетят Intranet Statistics, те се нуждаят от достъп',
	...
	'UsersManager_ExceptionEditAnonymous' => 'Анонимният потребител не може да бъде редактиран или изтрит. Intranet Statistics по този начин дефинира в система потребители, които не са влезли. Например можете да направите данните на брояча ви публични, като зададете \'преглед\' права на \'анонимен\' потребител.',
	'UsersManager_ExceptionSuperUser' => 'Този потребител е СУПЕР ПОТРЕБИТЕЛ - не може да бъде редактиран и изтрит през API. Можете ръчно да редактирате СУПЕР ПОТРЕБИТЕЛ от конфигурационния файл на Intranet Statistics.',
	...
	'VisitorGenerator_PluginDescription' => 'Плъгин за създаване на фалшиви посетители. Това може да се използва от потребителите на Intranet Statistics или разработчиците като лесен начин за производство на фалшиви данни, за да пренесат Intranet Statistics доклади.',
	'VisitorGenerator_VisitorGenerator' => 'Генератор на посещения',
	'VisitorGenerator_Warning' => 'На път сте да генерирате фалшиви посещения, които ще бъдат записани в базата данни на Intranet Statistics.',
	'VisitorGenerator_NotReversible' => '%sНяма%s да е възможно лесното изтриване на тези посещения от логовете на Intranet Statistics.',
	...
	'Widgetize_PluginDescription' => 'Този плъгин прави много лесен за износ на всяка Intranet Statistics джаджа във вашия блог, уебсайт или по Igoogle и Netvibes!',
	...
	'PDFReports_PiwikReports' => 'Intranet Statistics доклади',
	...
	'ImageGraph_PluginDescription' => 'Генерирайте красиви статични PNG графични изображения за всеки Intranet Statistics доклад.',
