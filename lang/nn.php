...
$translations = array(
	...
	'General_BackToHomepage' => 'Attende til hovudsida i Intranet Statistics',
	'General_Yes' => 'Ja',
	'General_No' => 'Nei',
	...
	'General_ArchivingInlineHelp' => 'For nettstader med middels til høg trafikk, er det tilrådd å slå av arkivering via nettlesaren. Me oppmodar deg heller til å setja opp ein cron-jobb for å handsama rapportane til Intranet Statistics kvar time.',
	'General_ArchivingTriggerDescription' => 'For større installasjonar av Intranet Statistics er det tilrådd at du %ssett opp ein cron-jobb%s for å handsama rapportane automatisk.',
	...
	'General_RequiresFlash' => 'Grafar i Intranet Statistics krev Flash',
	'General_GraphHelp' => 'Meir informasjon om visning av grafar i Intranet Statistics.',
	...
	'General_YouAreViewingDemoShortMessage' => 'Dette er ein demo av Intranet Statistics',
	'General_YouAreCurrentlyUsing' => 'Du bruker no Intranet Statistics %s.',
	'General_DownloadFullVersion' => '%1$sLast ned%2$s fullversjonen! Sjekk ut %3$s',
	'General_NewUpdatePiwikX' => 'Ny oppdatering: Intranet Statistics %s',
	'General_AboutPiwikX' => 'Om Intranet Statistics %s',
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Intranet Statistics %1$s er komen. %2$s Oppdater no!%3$s (sjå %4$s endringar%5$s).',
	...
	'General_BackToPiwik' => 'Attende til Intranet Statistics',
	...
	'General_ConfigFileIsNotWritable' => 'Konfigurasjonsfila til Intranet Statistics, %s, er ikkje skrivbar. Somme av endringane dine vil kanskje ikkje koma med. %s Endre tilgangsløyver for fila for å gjera den skrivbar.',
	'General_ExceptionDatabaseVersion' => 'Din %1$s versjon er %2$s, men Intranet Statistics krev minst %3$s.',
	...
	'General_FileIntegrityWarningExplanation' => 'Sjekking av filintegritet feila og gav feilmeldingar. Dette skuldast truleg at nokre av filane til Intranet Statistics berre vart delvis eller feilaktig lasta opp. Du bør lasta opp Intranet Statistics på nytt i BINÆR-modus og oppfriska denne sida til feilmeldingane forsvinn.',
	...
	'General_PleaseUpdatePiwik' => 'Oppdater Intranet Statistics',
	...
	'Actions_DownloadsReportDocumentation' => 'I denne rapporten kan du sjå kva filer som vitjarane har lasta ned. %s Intranet Statistics tel berre klikk på peikarar til filer. Det er ikkje kjent for Intranet Statistics om nedlastinga vart fullførd eller ikkje.',
	...
	'CoreAdminHome_PluginDescription' => 'Administrering av Intranet Statistics',
	...
	'CoreAdminHome_OptOutForYourVisitors' => 'Avmelding av Intranet Statistics for vitjarar',
	'CoreAdminHome_OptOutExplanation' => 'Intranet Statistics er oppteken av personvern på Internett.For å gje vitjarane dine valet om å slå av Intranet Statistics Nettstatistikk, kan du leggja til følgjande HTML-kode på ei av sidene dine, til dømes ei side med retningsliner for personvern.',
	...
	'CoreAdminHome_CustomLogoHelpText' => 'Du kan tilpassa Intranet Statistics-logoen som visast i brukargrensesnittet og e-postrapportar.',
	...
	'CoreAdminHome_LogoNotWriteable' => 'For å bruka ein tilpassa logo, krev Intranet Statistics skrivetilgang til logofilene i bunad-katalogen: %s',
	...
	'CoreHome_NoPrivilegesAskPiwikAdmin' => 'Du er innlogga som \'%s\' men det ser ikkje ut til at du har vidare tilgang til Intranet Statistics. %s Spør Intranet Statistics-administratoren (klikk for å senda e-post)%s om å gje deg \'vis\'-tilgang til ei nettside.',
	'CoreHome_JavascriptDisabled' => 'JavaScript må vera slegen på for å kunne bruka Intranet Statistics i standardvisning.<br />Det ser ut til at JavaScript er slegen av eller ikkje støtta i nettlesaren din.<br />For å bruka standardvisninga, slå på JavaScript i nettlesaren din, og %1$sprøv igjen%2$s.<br />',
	...
	'CorePluginsAdmin_MainDescription' => 'Innstikk utvidar funksjonane til Intranet Statistics. Når eit innstikk er lagt til, kan du slå det av og på her.',
	...
	'CoreUpdater_PluginDescription' => 'Oppdateraren til Intranet Statistics',
	'CoreUpdater_UpdateTitle' => 'Oppdater',
	'CoreUpdater_DatabaseUpgradeRequired' => 'Databaseoppdatering krevst',
	'CoreUpdater_YourDatabaseIsOutOfDate' => 'Intranet Statistics-databasa di er gamal, og må bli oppgradert før du kan halda fram.',
	'CoreUpdater_PiwikWillBeUpgradedFromVersionXToVersionY' => 'Intranet Statistics-databasa vil bli oppgradert frå versjon %1$s til den nye versjonen %2$s.',
	'CoreUpdater_TheFollowingPluginsWillBeUpgradedX' => 'Dei følgjande innstikka vil bli oppdaterte: %s.',
	'CoreUpdater_NoteForLargePiwikInstances' => 'Viktig melding for store Intranet Statistics-installasjonar',
	'CoreUpdater_TheUpgradeProcessMayFailExecuteCommand' => 'Om du har ein stor Intranet Statistics-database, kan det hende at oppdateringa tek for lang tid i nettlesaren. Då kan du køyre oppdateringane frå kommandolinja: %s',
	'CoreUpdater_YouCouldManuallyExecuteSqlQueries' => 'Om du ikkje kan nytta kommandolinja og oppdateringa feiler (pga tidsavbrot mot databasen, tidsavbrot i nettlesaren, eller andre problem), kan du manuelt køyre SQL-spurnadane for å oppdatera Intranet Statistics.',
	...
	'CoreUpdater_UpgradePiwik' => 'Oppdater Intranet Statistics',
	...
	'CoreUpdater_ErrorDIYHelp_3' => 'manuelt oppdater `option`-tabellen i Intranet Statistics-databasen din, set verdien av version_core til versjonen av den feila oppdateringa',
	...
	'CoreUpdater_ErrorDIYHelp_5' => 'Rapporter problemet (og løysinga) slik at Intranet Statistics kan bli forbetra',
	'CoreUpdater_HelpMessageContent' => 'Les %1$s Intranet Statistics OSS %2$s som forklarar dei vanlegaste feila under oppdatering. %3$s Spør dine systemadministratorar, dei kan kanskje hjelpa deg me feilen, som sannsynlegvis hev noko med tenar- eller MySQL-innstillingane dine å gjera.',
	...
	'CoreUpdater_ContinueToPiwik' => 'Hald fram til Intranet Statistics',
	'CoreUpdater_UpdateAutomatically' => 'Oppdater automatisk',
	'CoreUpdater_ThereIsNewVersionAvailableForUpdate' => 'Ein ny versjon av Intranet Statistics er tilgjengeleg for oppdatering',
	...
	'CoreUpdater_YouMustDownloadPackageOrFixPermissions' => 'Intranet Statistics kan ikkje overskriva den gjeldande installasjonen. Du kan anten fikse katalog/filtilgangen, eller lasta ned pakken og installera versjon %s manuelt:',
	...
	'CoreUpdater_PiwikUpdatedSuccessfully' => 'Oppdatering av Intranet Statistics var vellukka!',
	'CoreUpdater_EmptyDatabaseError' => 'Databasen %s er tom. Du må endra eller fjerna konfigurasjonsfila til Intranet Statistics.',
	'CoreUpdater_ExceptionAlreadyLatestVersion' => 'Din versjon av Intranet Statistics %s er oppdatert.',
	...
	'DBStats_PluginDescription' => 'Dette innstikket rapporterer bruken til Intranet Statistics av MySQL-databasen.',
	'DBStats_DatabaseUsage' => 'Databasebruk',
	'DBStats_MainDescription' => 'Intranet Statistics lagrar alle dine nettstatistikkdata i MySQL-databasen. Nett no nyttar tabellane til Intranet Statistics %s.',
	'DBStats_LearnMore' => 'For å læra meir om korleis Intranet Statistics prosesserer data, og korleis gjera at Intranet Statistics fungerer bra for nettstader med middels og høg trafikk, sjå dokumentasjonen %s.',
	...
	'ExampleUI_PluginDescription' => 'Innstikkdøme: Dette innstikket viser fram arbeid med Intranet Statistics UI: opprett tabellar, grafer, osb.',
	'Feedback_PluginDescription' => 'Send dine attendemeldingar til Intranet Statistics. Del dine idear og framlegg med oss!',
	...
	'Feedback_WhyWrongCountry' => 'Kvifor viser Intranet Statistics vitjinga mi frå feil land?',
	...
	'Feedback_SpecialRequest' => 'Har du ein førespurnad til Intranet Statistics?',
	'Feedback_ContactThePiwikTeam' => 'Kontakt Intranet Statistics-teamet!',
	'Feedback_IWantTo' => 'Eg ønskjer:',
	'Feedback_CategoryShareStory' => 'Del ein suksesshistorie om Intranet Statistics',
	'Feedback_CategorySponsor' => 'Støtt Intranet Statistics',
	'Feedback_CategoryHire' => 'Hyr ein Intranet Statistics-konsulent',
	...
	'Feedback_MessageSent' => 'Meldinga din vart sendt til Intranet Statistics-teamet.',
	'Feedback_ThankYou' => 'Takk for at hjelper oss med å forbetra Intranet Statistics!',
	'Feedback_ThePiwikTeam' => 'Intranet Statistics-teamet',
	...
	'Installation_PluginDescription' => 'Installasjonsprosessen til Intranet Statistics. Installasjonen er vanlegvis utførd berre ein gong. Viss konfigurasjonsfila config/config.inc.php er sletta, vil installasjonen starta på nytt.',
	...
	'Installation_NoConfigFound' => 'Du prøvar å nå ein Intranet Statisticsside, men konfigurasjonen vart ikkje funnen.<br /><b>  » Du kan <a href=\'index.php\'>installera Intranet Statistics no</a></b><br /><small>Om du allereie har hatt Intranet Statistics installert og har nokre tabellar i databasen, treng du ikkje bekymra deg. Du kan nytta dei same tabellane og data!</small>',
	...
	'Installation_LargePiwikInstances' => 'Hjelp for større Intranet Statistics-installasjonar',
	'Installation_JsTag' => 'JavaScript-sporingskode',
	'Installation_Congratulations' => 'Gratulerer',
	'Installation_CongratulationsHelp' => '<p>Gratulerer! Intranet Statistics-installasjon er ferdig.</p><p>Sjå til at JavaScript-koden er lagt til på sidene dine, og vent på dine fyrste vitjarar!</p>',
	'Installation_ContinueToPiwik' => 'Hald fram til Intranet Statistics',
	...
	'Installation_SystemCheckDatabaseHelp' => 'Intranet Statistics krev anten mysqli-utvidinga eller båe utvidingane PDO og pdo_mysql.',
	...
	'Installation_SystemCheckGDHelp' => 'Gnistlinjene (små bilete) og biletgrafane (i e-postrapportar og i mobilappen til Intranet Statistics) vil ikkje fungera.',
	...
	'Installation_SystemCheckAutoUpdateHelp' => 'Merk: Eittklikksoppdateringa til Intranet Statistics krev skrivetilgang til Intranet Statistics-katalogen og innhaldet der.',
	'Installation_SystemCheckError' => 'Det skjedde ein feil - du må retta på den før du kan halda fram',
	'Installation_SystemCheckWarning' => 'Intranet Statistics vil fungera som normalt, men det kan hende at somme funksjonar manglar',
	'Installation_Tables' => 'Opprettar tabellane',
	'Installation_TablesWithSameNamesFound' => 'Nokre %1$s tabellar i databasen din %2$s hev dei same namna som dei tabellane Intranet Statistics prøvar å lage',
	...
	'Installation_GoBackAndDefinePrefix' => 'Gå attende og vel ein prefiks for Intranet Statistics-tabellane',
	...
	'Installation_WelcomeHelp' => '<p>Intranet Statistics er ein nettstatistikkprogramvare med open kjeldekode, som gjer det enkelt å henta ut informasjonen du ønskjer om dine vitjarar.</p><p>Denne prosessen er delt opp i %s enkle steg, og tek omkring 5 minuttar.</p>',
	'LanguagesManager_PluginDescription' => 'Dette innstikket vil visa ei liste over tilgjengelege språk for Intranet Statistics-brukargrensesnittet. Det valde språket vil lagrast i innstillingane til kvar enkelt brukar.',
	'LanguagesManager_AboutPiwikTranslations' => 'Om Intranet Statistics-omsetjingane',
	...
	'Login_ContactAdmin' => 'Mulig grunn: tenaren din hev slått av mail() funksjonen. <br />Kontakt din Intranet Statistics administrator.',
	...
	'TranslationsAdmin_PluginDescription' => 'Hjelp med å omsetja Intranet Statistics til ditt språk.',
	...
	'UsersManager_PluginDescription' => 'Intranet Statisticss brukarhehandling: Opprett ein ny brukar, endre ein eksisterande brukar eller oppdater tilgangar. Desse handlingane kan også nyttast gjennom APIet.',
	...
	'UsersManager_ExcludeVisitsViaCookie' => 'Utelukk dine vitjingar frå Intranet Statistics med ein informasjonskapsel.',
	'UsersManager_YourVisitsAreIgnoredOnDomain' => '%sDine vitjingar blir ignorert av Intranet Statistics på %s %s (Informasjonskapselen frå Intranet Statistics vart funnen i din nettlesar).',
	'UsersManager_YourVisitsAreNotIgnored' => '%sDine vitjingar blir ikkje ignorert av Intranet Statistics%s (Informasjonskapselen frå Intranet Statistics vart ikkje funnen i din nettlesar).',
	'UsersManager_ClickHereToDeleteTheCookie' => 'Klikk her for å sletta informasjonskapselen slik at Intranet Statistics loggar dine vitjingar',
	...
	'UsersManager_WhenUsersAreNotLoggedInAndVisitPiwikTheyShouldAccess' => 'Når brukarar vitjar Intranet Statistics uten å vera innlogga, skal dei ha tilgang til',
	...
	'UsersManager_ExceptionEditAnonymous' => 'Den anonyme brukaren kan ikkje bli endra eller sletta. Den er brukt av Intranet Statistics for å definera ein brukar som ikkje hev logga inn. Til døme kan du gjera statistikken offentleg tilgjengeleg ved å gjeva lesetilgang til den anonyme brukaren.',
	'UsersManager_ExceptionSuperUser' => 'Den valde brukaren er superbrukaren, og kan ikkje bli henta, endra eller redigert via APIet. Du kan endre han manuelt i Intranet Statistics sin konfigurasjonsfil.',
	...
	'VisitTime_NHour' => '%st',
	'ImageGraph_PluginDescription' => 'Opprett vakre statiske grafar som PNG-bilete for ein Intranet Statistics-rapport.',
