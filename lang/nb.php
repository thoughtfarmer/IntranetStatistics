...
$translations = array(
	...
	'General_BackToHomepage' => 'Tilbake til Intranet Statistics startside',
	'General_Yes' => 'Ja',
	'General_No' => 'Nei',
	...
	'General_AllowPiwikArchivingToTriggerBrowser' => 'Tillatt at Intranet Statistics-arkivering utløses når rapporter vises i nettleseren',
	'General_ArchivingTriggerDescription' => 'For større Intranet Statistics-installasjoner anbefales det at du setter opp en %scron-jobb%s for å behandle rapporter automatisk.',
	...
	'General_RequiresFlash' => 'Visning av grafikk i Intranet Statistics krever Flash',
	'General_GraphHelp' => 'Mer informasjon om visning av grafikk i Intranet Statistics',
	...
	'General_YouAreViewingDemoShortMessage' => 'Du ser for øyeblikket på Intranet Statistics-demoen',
	'General_DownloadFullVersion' => '%1$sLast ned%2$s den fullstendige utgaven! Prøv %3$s',
	'General_NewUpdatePiwikX' => 'Ny utgave: Intranet Statistics %s',
	'General_AboutPiwikX' => 'Om Intranet Statistics %s',
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Intranet Statistics %1$s er tilgjengelig. %2$s Oppdater nå!%3$s (se %4$s endringer%5$s).',
	'General_PiwikXIsAvailablePleaseNotifyPiwikAdmin' => '%s er tilgjengelig. Gjør nettstedets administrator oppmerksom på dette.',
	'General_BackToPiwik' => 'Tilbake til Intranet Statistics',
	...
	'General_ConfigFileIsNotWritable' => 'Konfigurasjonsfilen for Intranet Statistics %s er ikke skrivbar. Noen av endringene dine blir kanskje ikke lagret. %s Endre rettighetene for filen slik at den er skrivbar.',
	'General_ExceptionDatabaseVersion' => 'Din %1$s versjon er %2$s, men Intranet Statistics krever minst %3$s.',
	...
	'General_FileIntegrityWarningExplanation' => 'Integritetskontrollen av filer oppdaget noen feil. Dette skyldes mest sannsynlig feil under opplasting av Intranet Statistics sine filer. Du bør laste opp alle Intranet Statistics sine filer på nytt i BINARY-modus og oppfriske siden inntil ingen feil vises.',
	...
	'General_PleaseUpdatePiwik' => 'Oppdatering din Intranet Statistics',
	...
	'CoreAdminHome_PluginDescription' => 'Administrasjonsområdet for Intranet Statistics.',
	...
	'CoreAdminHome_OptOutForYourVisitors' => 'Intranet Statistics «opt-out» for dine besøkende',
	...
	'CoreHome_JavascriptDisabled' => 'JavaScript må være aktivert for at du skal kunne bruke Intranet Statistics i standardvisning.<br />Det ser ut til at JavaScript enten er deaktivert eller ikke støttet av din nettleser.<br />For å bruke standardvisning, må du aktivere JavaScript i nettleserinnstillingene og deretter %1$sprøve igjen%2$s.<br />',
	...
	'CorePluginsAdmin_MainDescription' => 'Tillegg kan utvide eller begrense funksjonaliteten i Intranet Statistics. Når et tillegg har blitt installert, kan du slå det av eller på her.',
	...
	'CoreUpdater_PluginDescription' => 'Intranet Statistics-oppdateringsmekanisme',
	'CoreUpdater_UpdateTitle' => 'Oppdater',
	'CoreUpdater_DatabaseUpgradeRequired' => 'Databaseoppgradering er nødvendig',
	'CoreUpdater_YourDatabaseIsOutOfDate' => 'Intranet Statistics-databasen din er utdatert og må oppgraderes før du kan fortsette.',
	'CoreUpdater_PiwikWillBeUpgradedFromVersionXToVersionY' => 'Intranet Statistics-databasen blir oppgradert fra versjon %1$s til versjon %2$s .',
	'CoreUpdater_TheFollowingPluginsWillBeUpgradedX' => 'Følgende tillegg vil nå bli oppdatert: %s.',
	'CoreUpdater_NoteForLargePiwikInstances' => 'Viktig merknad for store Intranet Statistics-installasjoner',
	'CoreUpdater_TheUpgradeProcessMayFailExecuteCommand' => 'Hvis du har en stor Intranet Statistics-database, kan oppdateringer ta for lang tid til at de kan kjøres i nettleseren. I slike situasjoner kan du utføre oppdateringene fra kommandolinja: %s',
	'CoreUpdater_YouCouldManuallyExecuteSqlQueries' => 'Hvis du ikke kan oppdatere fra kommandolinja og hvis Intranet Statistics ikke klarer å oppdatere (på grunn av tidsavbrudd i databasen eller nettleseren, eller en annen grunn), så kan du utføre SQL-spørringene manuelt.',
	...
	'CoreUpdater_UpgradePiwik' => 'Oppgrader Intranet Statistics',
	...
	'CoreUpdater_ErrorDIYHelp_3' => 'manuelt oppdater "option"-tabellen i din Intranet Statistics-database; sett verdien av version_core til versjonen for den oppdateringen som feilet',
	...
	'CoreUpdater_ErrorDIYHelp_5' => 'rapporter problemet (og løsningen) slik at Intranet Statistics kan bli forbedret',
	'CoreUpdater_HelpMessageContent' => 'Sjekk %s Intranet Statistics FAQ-en %s som prøver å forklare de mest vanlige feil under oppdatering. %s Spør din systemadministrator - vedkommende kan kanskje hjelpe deg med feilen som antakelig har sammenheng med din tjener eller MySQL-installasjon.',
	...
	'CoreUpdater_PiwikHasBeenSuccessfullyUpgraded' => 'Intranet Statistics ble korrekt oppdatert!',
	'CoreUpdater_ContinueToPiwik' => 'Fortsett til Intranet Statistics',
	'CoreUpdater_UpdateAutomatically' => 'Oppdater automatisk',
	'CoreUpdater_ThereIsNewVersionAvailableForUpdate' => 'Du kan oppdatere til en ny versjon av Intranet Statistics.',
	...
	'CoreUpdater_YouMustDownloadPackageOrFixPermissions' => 'Intranet Statistics klarte ikke skrive over din nåværende installasjon. Du kan enten fikse mappe/filrettighetene eller laste ned pakken og installere versjon %s manuelt:',
	'CoreUpdater_DownloadX' => 'Last ned %s',
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'Den automatiske oppdateringen av Intranet Statistics har blitt avbrutt. Hvis du ikke kan fikse feilen over, anbefales det at du oppdaterer Intranet Statistics manuelt. %s Les  %soppdateringsdokumentasjonen%s for å komme i gang!',
	...
	'CoreUpdater_PiwikUpdatedSuccessfully' => 'Intranet Statistics ble vellykket oppdatert!',
	'CoreUpdater_EmptyDatabaseError' => 'Databasen %s er tom. Du må enten redigere eller fjerne din Intranet Statistics konfigurasjonsfil.',
	'CoreUpdater_ExceptionAlreadyLatestVersion' => 'Din Intranet Statistics versjon %s er siste utgave.',
	...
	'CustomVariables_PluginDescription' => 'Egendefinerte variabler er navn og verdier som du kan sette for en besøkende via funksjonen setVisitCustomVariables() i Javascript API-et. Intranet Statistics vil da kunne rapportere hvor mange besøkende, sider, konverteringer som benytter disse egendefinerte variablene og verdiene.',
	'CustomVariables_CustomVariables' => 'Egendefinerte variabler',
	'CustomVariables_TrackingHelp' => 'Hjelp: %1$sSporing av egendefinerte variabler i Intranet Statistics%2$s',
	...
	'DBStats_PluginDescription' => 'Dette tillegget rapporterer MySQL-databasebruk for Intranet Statistics-tabeller.',
	'DBStats_DatabaseUsage' => 'Databasebruk',
	'DBStats_MainDescription' => 'Intranet Statistics lagrer all din statistikk i MySQL-databasen. Akkurat nå bruker Intranet Statistics-tabellene %s.',
	'DBStats_LearnMore' => 'For å lære mer om hvordan Intranet Statistics behandler data og hvordan få Intranet Statistics til å virke bra for nettsteder med medium og høy trafikk, les dokumentasjonen %s.',
	...
	'Feedback_PluginDescription' => 'Send din tilbakemelding til Intranet Statistics-laget. Del din ideer og forslag med oss!',
	...
	'Feedback_WhyWrongCountry' => 'Hvorfor viser Intranet Statistics mine besøk fra feil land?',
	...
	'Feedback_SpecialRequest' => 'Har du en spesiell forespørsel til Intranet Statistics-laget?',
	'Feedback_ContactThePiwikTeam' => 'Kontakt Intranet Statistics-laget!',
	'Feedback_IWantTo' => 'Jeg vil:',
	'Feedback_CategoryShareStory' => 'Dele en Intranet Statistics-suksesshistorie',
	'Feedback_CategorySponsor' => 'Sponse Intranet Statistics',
	'Feedback_CategoryHire' => 'Leie inn en Intranet Statistics-konsulent',
	...
	'Feedback_MessageSent' => 'Din melding ble sendt til Intranet Statistics-laget',
	'Feedback_ThankYou' => 'Takk for at du hjelper oss å lage Intranet Statistics bedre!',
	'Feedback_ThePiwikTeam' => 'Intranet Statistics-laget',
	...
	'Installation_NoConfigFound' => 'Klarte ikke finne konfigurasjonsfilen for Intranet Statistics, og du prøver å få tilgang til en Intranet Statistics-side. <br /><b>  »Du kan <a href=\'index.php\'>installere Intranet Statistics nå</a></b><br /><small>Hvis du prøvde å installere Intranet Statistics tidligere og har noen tabeller i databasen, kan du ta det med ro. Du kan bruke de gamle tabellene og beholde dine eksisterende data!</small>',
	...
	'Installation_LargePiwikInstances' => 'Hjelp for store Intranet Statistics-instanser',
	'Installation_JsTag' => 'JavaScript-kode',
	'Installation_Congratulations' => 'Gratulerer',
	'Installation_CongratulationsHelp' => '<p>Gratulerer! Din Intranet Statistics installasjon er fullført.</p><p>Sørg for at JavaScript-koden er lagt inn på dine sider, og vent på dine første besøkende!</p>',
	'Installation_ContinueToPiwik' => 'Fortsett til Intranet Statistics',
	...
	'Installation_SecurityNewsletter' => 'send meg e-post om viktige Intranet Statistics-oppgraderinger og sikkerhetsvarsler',
	'Installation_CommunityNewsletter' => 'send meg e-post med oppdatering fra Intranet Statistics-samfunnet (nye tillegg, nye egenskaper, osv)',
	'Installation_PasswordDoNotMatch' => 'passordene stemmer ikke overens',
	'Installation_Requirements' => 'Krav for å kjøre Intranet Statistics',
	...
	'Installation_SystemCheckDatabaseHelp' => 'Intranet Statistics krever enten mysqli utvidelsen eller både PDO og pdo_mysql utvidelsene.',
	...
	'Installation_SystemCheckWarning' => 'Intranet Statistics vil virke normalt, men noen tjenester vil kanskje mangle',
	'Installation_Tables' => 'Oppretter tabellene',
	'Installation_TablesWithSameNamesFound' => 'Noen %s tabeller i databasen din %s har samme navn som de tabellene Intranet Statistics prøver å opprette',
	...
	'Installation_TablesDeletedSuccess' => 'Eksisterende Intranet Statistics-tabeller ble vellykket slettet',
	...
	'Installation_GoBackAndDefinePrefix' => 'Gå tilbake og definer et prefiks for Intranet Statistics-tabellene',
	...
	'Installation_WelcomeHelp' => '<p>Intranet Statistics er åpen kildekode nettstatistikk-programvare som gjør det enkelt å finne informasjonen du ønsker om dine besøkende.</p><p>Denne prossessen er delt opp i %s lette steg og vil ta ca 5 minutter.</p>',
	'Installation_ErrorInvalidState' => 'Feil: Det ser ut som om du prøver å hoppe over et steg i installasjonsprosessen eller informasjonskapsler (cookies) er deaktivert eller Intranet Statistics sin konfigurasjon er allerede opprettet. %1$sForsikre deg om at du har aktivert informasjonskapsler%2$s og gå tilbake %3$s til første side av installasjonen %4$s.',
	'LanguagesManager_PluginDescription' => 'Dette tillegg viser en liste med tilgjengelige språk for Intranet Statistics-grensesnittet. Språket som velges lagres i innstillingene for hver bruker.',
	'LanguagesManager_AboutPiwikTranslations' => 'Om Intranet Statistics-oversettelser',
	...
	'Login_ContactAdmin' => 'Mulig grunn: Din tjener har kanskje deaktivert mail()-funksjonen. <br />Kontakt din Intranet Statistics administrator.',
	...
	'TranslationsAdmin_PluginDescription' => 'Hjelp til å oversette Intranet Statistics til ditt språk.',
	...
	'UsersManager_PluginDescription' => 'Brukeradministrasjon i Intranet Statistics: Legg til en ny bruker, endre en eksisterende bruker, oppdatere rettighetene. Alle handlingene er også tilgjengelig gjennom API-et.',
	...
	'UsersManager_MainDescription' => 'Bestem hvilke brukere som har tilgang til Intranet Statistics på dine nettsteder. Du kan også sette rettighetene på alle dine nettsteder på en gang.',
	...
	'UsersManager_YourVisitsAreIgnoredOnDomain' => '%sDine besøk blir ignorert av Intranet Statistics på %s %s (informasjonskapselen for ekskludering fra Intranet Statistics ble funnet i din nettleser).',
	'UsersManager_YourVisitsAreNotIgnored' => '%sDine besøk blir ikke ignorert av Intranet Statistics%s (informasjonskapselen for ekskludering fra Intranet Statistics ble ikke funnet i din nettleser).',
	'UsersManager_ClickHereToDeleteTheCookie' => 'Klikk her for å slette informasjonskapselen og la Intranet Statistics spore dine besøk.',
	'UsersManager_ClickHereToSetTheCookieOnDomain' => 'Klikk her for å sette en informasjonskapsel som vil ekskludere dine besøk på nettsteder som spores av Intranet Statistics på %s',
	...
	'UsersManager_WhenUsersAreNotLoggedInAndVisitPiwikTheyShouldAccess' => 'Brukere som ikke er logget og besøker Intranet Statistics, skal sendes til',
	...
	'UsersManager_ExceptionEditAnonymous' => 'Den anonyme brukeren kan ikke bli redigert eller slettet. Den blir brukt av Intranet Statistics for å definere en bruker som ikke har blitt logget inn ennå. Du kan for eksempel gjøre statistikken din offentlig ved å gi \'view\'-tilgang til \'anonymous\'-brukeren.',
	'UsersManager_ExceptionSuperUser' => 'Den forespurte brukeren er Super User og kan ikke bli undersøkt, redigert eller slettet via API-et. Du kan redigere informasjonen for Super User manuelt i Intranet Statistics sin konfigurasjonsfil.',
