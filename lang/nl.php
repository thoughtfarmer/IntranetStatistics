...
$translations = array(
	...
	'General_BackToHomepage' => 'Terug naar de Intranet Statistics homepage',
	'General_Yes' => 'Ja',
	'General_No' => 'Nee',
	...
	'General_AllowPiwikArchivingToTriggerBrowser' => 'Sta toe Intranet Statistics archivering te starten wanneer rapporten worden bekeken vanuit de browser.',
	'General_ArchivingInlineHelp' => 'Voor middelgrote tot grote websites, is het aan te raden Intranet Statistics archivering voor de browser uit te schakelen. Als alternatief raden we aan om een cronjob te maken om piwik om het uur rapporten te laten genereren.',
	'General_ArchivingTriggerDescription' => 'Aangeraden voor grote Intranet Statistics installaties, gebruik een %scronjob%s om automatisch rapporten te genereren.',
	...
	'General_RequiresFlash' => 'Flash is vereist om grafieken weer te geven in Intranet Statistics',
	'General_GraphHelp' => 'Meer informatie over grafieken weergeven in Intranet Statistics.',
	...
	'General_YouAreViewingDemoShortMessage' => 'U bekijkt momenteel de demo versie van Intranet Statistics.',
	'General_YouAreCurrentlyUsing' => 'U gebruikt momenteel Intranet Statistics %s.',
	'General_DownloadFullVersion' => '%1$sDownload%2$s de volledige versie! Bezoek %3$s',
	'General_NewUpdatePiwikX' => 'Nieuwe Update: Intranet Statistics %s',
	'General_AboutPiwikX' => 'Over Intranet Statistics %s',
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Intranet Statistics %1$s is beschikbaar. %2$s Gelieve nu te updaten! %3$s \'zie %4$s wijzigingen%5$s)',
	'General_PiwikXIsAvailablePleaseNotifyPiwikAdmin' => '%s is beschikbaar. Gelieve de site admin te verwittigen.',
	'General_NewReportsWillBeProcessedByCron' => 'Wanneer Intranet Statistics archivering niet wordt ingeschakeld door de browser, zullen nieuwe rapporten verwerkt worden door de crontab.',
	...
	'General_BackToPiwik' => 'Terug naar Intranet Statistics',
	...
	'General_ExceptionDatabaseVersion' => 'Uw %1$s versie is %2$s maar Intranet Statistics vereist ten minste %3$s.',
	...
	'General_FileIntegrityWarningExplanation' => 'Bestand integriteit controle mislukt en er zijn fouten ontdekt. Dit komt waarschijnlijk door een gedeeltelijke of mislukte upload van enkele Intranet Statistics bestanden. We raden u aan alle Intranet Statistics bestanden opnieuw te uploaden en deze pagina te vernieuwen tot er geen fouten meer weergegeven worden.',
	...
	'General_PleaseUpdatePiwik' => 'Update uw Intranet Statisticsinstallatie',
	...
	'Actions_DownloadsReportDocumentation' => 'Dit rapport laat zien welke bestanden door de bezoekers zijn gedownload. %s Intranet Statistics telt een klik op een downloadlink als een download. Intranet Statistics kan niet zien of de download succesvol is uitgevoerd en afgerond.',
	...
	'API_PluginDescription' => 'Alle data in Intranet Statistics is beschikbaar via simpele API\'s. Deze plugin is het webservice startpunt dat u kunt aanroepen om uw Web Analytics data te ontvangen in xml, json, php, csv, enz.',
	'API_QuickDocumentationTitle' => 'Korte API handleiding',
	'API_GenerateVisits' => 'Als u geen data hebt voor vandaag, kunt u eerst wat data genereren met de %s plugin. U kunt de %s plugin inschakelen, en dan klikken op het Bezoekers generator menu in het Intranet Statistics beheer gedeelte.',
	'API_MoreInformation' => 'Voor meer informatie over de Intranet Statistics API\'s, lees even de %s introductie van de Intranet Statistics API %s en de %s Intranet Statistics API referenties %s.',
	...
	'CoreAdminHome_PluginDescription' => 'Beheeromgeving van Intranet Statistics',
	...
	'CoreAdminHome_OptOutForYourVisitors' => 'Intranet Statistics opt-out voor uw bezoekers',
	'CoreAdminHome_OptOutExplanation' => 'Intranet Statistics is ingericht om de privacy op internet te respecteren. U kunt uw bezoekers de keuze opting-out van Intranet Statistics Web Analytics aanbieden. Daartoe kunt u de volgende HTML-code toevoegen aan één van uw webpagina\'s, bijvoorbeeld op een pagina met de Privacy Policy.',
	'CoreAdminHome_OptOutExplanationBis' => 'Deze code zal een I-frame tonen met daarin een link naar de opt-out van Intranet Statistics door een opt-out cookie te plaatsen in hun browser. %s Klik hier%s om de tekst te bekijken die in het I-frame getoond zal worden.',
	...
	'CoreAdminHome_CustomLogoHelpText' => 'U kunt het Intranet Statistics logo aanpassen dat wordt weergegeven in de gebruikersinterface en in de e-mail rapportages.',
	'CoreAdminHome_CustomLogoFeedbackInfo' => 'Als u het Intranet Statistics logo bijwerkt, heeft u wellicht ook interesse om de %s link te verbergen in het menu bovenaan. Om dit te doen, kunt u de feedback plugin uitschakelen in de pagina van de %sManage Plugins%s.',
	...
	'CoreAdminHome_LogoNotWriteable' => 'Voor het gebruik van een aangepast logo heeft Intranet Statistics schrijfrechten nodig in de map met de logo-bestanden in de themes map: %s',
	'CoreAdminHome_TrustedHostSettings' => 'Toegestane Intranet Statistics hostnaam',
	'CoreAdminHome_PiwikIsInstalledAt' => 'Intranet Statistics is geïnstalleerd in',
	'CoreHome_InjectedHostSuperUserWarning' => 'Intranet Statistics is waarschijnlijk verkeerd geconfigureerd (bijv. Intranet Statistics werd verplaatst naar een nieuwe server of URL). %1$sKlik hier en voeg %2$s toe als een toegestane Intranet Statistics hostnaam indien je die vertrouwd%3$s, of %4$sklik hier en ga naar %5$s om Intranet Statistics veilig te banaderen%6$s.',
	'CoreHome_InjectedHostEmailSubject' => 'Intranet Statistics werd bezocht via een onbekende hostnaam: %s',
	'CoreHome_CheckForUpdates' => 'Controleer op updates',
	'PrivacyManager_TeaserHeadline' => 'Privacy instellingen',
	'PrivacyManager_Teaser' => 'Op deze pagina kunt u Intranet Statistics zodanig instellen dat het voldoet aan de bestaande privacy wetgeving in uw regio. Door: %s anonimiseren van uw bezoekers IP %s,%s automatisch verwijderen oude bezoekerlogs uit de database %s en %s door een opt-out ondersteuning aan te bieden voor uw website%s.',
	'PrivacyManager_MenuPrivacySettings' => 'Privacy',
	'PrivacyManager_PluginDescription' => 'Stel Intranet Statistics in zodat het voldoet aan de lokale wetgeving.',
	'PrivacyManager_UseAnonymizeIp' => 'Anonimiseer bezoekers IP-adressen',
	'PrivacyManager_AnonymizeIpDescription' => 'Selecteer "Ja" als u wilt dat Intranet Statistics niet de volledige IP-adressen registreert.',
	...
	'PrivacyManager_DeleteDataDescription' => 'U kunt Intranet Statistics instellen om regelmatig oude bezoekerslogs en/of gemaakte rapporten te verwijderen en zo de database klein te houden.',
	...
	'PrivacyManager_DoNotTrack_EnabledMoreInfo' => 'Als bezoekers hun browser hebben ingesteld op "volg-me-niet" (DoNotTrack is enabled), dan zal Intranet Statistics deze bezoek niet registreren.',
	'PrivacyManager_DoNotTrack_Disabled' => 'Intranet Statistics registreert momenteel alle bezoekers, zelfs als ze hun browser hebben ingesteld op "volg-me-niet".',
	'PrivacyManager_DoNotTrack_DisabledMoreInfo' => 'We adviseren om de privacy van bezoekers te respecteren en de "volg-me-niet" ondersteuning in Intranet Statistics te activeren.',
	...
	'CoreHome_NoPrivilegesAskPiwikAdmin' => 'U bent aangemeld as \'%s\'. Maar het lijkt er op dat u geen rechten hebt op Intranet Statistics te bezoeken. %sVraag aan uw webmaster (klik hier voor e-mail)%s of hij u de juiste rechten wilt geven om de statistieken te bekijken.',
	'CoreHome_JavascriptDisabled' => 'JavaScript moet ingeschakeld zijn om Intranet Statistics in standaard weergave te bekijken. <br/> Het lijkt erop dat JavaScript is uitgeschakeld of niet ondersteund wordt door uw browser.<br/> Om de standaard weergave te gebruiken, schakel JavaScript in door uw browser instellingen te wijzigen, probeer het daarna %1$s opnieuw %2$s.<br/>',
	...
	'CoreUpdater_PluginDescription' => 'Intranet Statistics updating mechanisme',
	'CoreUpdater_UpdateTitle' => 'Intranet Statistics › Update',
	'CoreUpdater_DatabaseUpgradeRequired' => 'Database upgrade vereist',
	'CoreUpdater_YourDatabaseIsOutOfDate' => 'Uw Intranet Statistics database is niet up to date en zal ge-upgrade moeten worden om verder te kunnen gaan.',
	'CoreUpdater_PiwikWillBeUpgradedFromVersionXToVersionY' => 'Intranet Statistics Database zal ge-upgrade worden van versie %1$s naar de nieuwe versie %2$s',
	'CoreUpdater_TheFollowingPluginsWillBeUpgradedX' => 'De volgende plugins zullen ge-upgrade worden: %s.',
	'CoreUpdater_NoteForLargePiwikInstances' => 'Belangrijke mededeling voor grote Intranet Statistics installaties',
	'CoreUpdater_TheUpgradeProcessMayFailExecuteCommand' => 'Als u een grote Intranet Statistics database heeft, dan kunnen de updates te lang duren om in de browser te worden uitgevoerd. In dat geval, kunt u de updates uitvoeren vanaf de opdrachtprompt: %s',
	'CoreUpdater_YouCouldManuallyExecuteSqlQueries' => 'Als u de opdrachtprompt updater niet kunt gebruiken en piwik kan niet upgraden (vanwege een timeout van de database, een browser timeout of een ander probleem), dan kunt u de SQL queries handmatig uitvoeren om Intranet Statistics te updaten.',
	...
	'CoreUpdater_ErrorDIYHelp_3' => 'Update handmatig de \'option\' tabel in uw Intranet Statistics database, en zet de waarde version_core naar de versie van de mislukte update',
	...
	'CoreUpdater_ErrorDIYHelp_5' => 'Meld het probleem (en oplossing) zo dat Intranet Statistics kan worden verbeterd.',
	'CoreUpdater_HelpMessageContent' => 'Controleer de %1$s Intranet Statistics FAQ %2$s waarin de meest voorkomende upgrade foutmeldingen worden uitgelegd. %3$s Vraag uw systeem beheerder - deze kan u wellicht helpen met deze fout die waarschijnlijk gerelateerd is aan de configuratie van uw webserver of MySQL-database.',
	...
	'CoreUpdater_PiwikHasBeenSuccessfullyUpgraded' => 'Intranet Statistics upgrade was succesvol!',
	'CoreUpdater_ContinueToPiwik' => 'Ga verder naar Intranet Statistics',
	'CoreUpdater_UpdateAutomatically' => 'Update automatisch.',
	'CoreUpdater_ThereIsNewVersionAvailableForUpdate' => 'Er is een nieuwe versie van Intranet Statistics beschikbaar als update',
	...
	'CoreUpdater_YouMustDownloadPackageOrFixPermissions' => 'Intranet Statistics kan de huidige installatie niet overschrijven. U kunt de huidige map/bestands rechten wijzigen, of de nieuwe versie downloaden en versie %s handmatig installeren:',
	'CoreUpdater_DownloadX' => 'Download %s',
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'Intranet Statistics één klik update is geannuleerd. Als u de bovenstaande foutmelding niet kan oplossen, raden we u aan Intranet Statistics handmatig te updaten. %1$s Lees de %2$s Update documentatie %3$s om te beginnen.',
	...
	'CoreUpdater_PiwikUpdatedSuccessfully' => 'Intranet Statistics is succesvol geüpdatet!',
	'CoreUpdater_EmptyDatabaseError' => 'Database %s is leeg. U moet uw Intranet Statistics configuratiebestand bewerken of verwijderen.',
	'CoreUpdater_ExceptionAlreadyLatestVersion' => 'Uw Intranet Statistics versie %s is up to date',
	...
	'DBStats_PluginDescription' => 'Deze plugin toont het MySQL database verbruik door de Intranet Statistics tabellen.',
	'DBStats_DatabaseUsage' => 'Database gebruik',
	'DBStats_MainDescription' => 'Intranet Statistics slaat alle analysedata op in een MySQL database. Momenteel is de omvang van deze database %s.',
	'DBStats_LearnMore' => 'Voor meer informatie over de manier waarop Intranet Statistics de data verwerkt en over de werking van Intranet Statistics in combinatie met middelgrote en grote website\'s, zie de documentatie %s.',
	'DBStats_Table' => 'Tabel',
	...
	'ExampleUI_PluginDescription' => 'Voorbeeld plugin: Deze plugin toont hoe u kunt werken met de Intranet Statistics UI: tabellen aanmaken, grafieken, enz…',
	'Feedback_PluginDescription' => 'Stuur uw feedback naar het Intranet Statistics team. Deel uw ideeën en suggesties met ons!',
	...
	'Feedback_WhyWrongCountry' => 'Waarom toont Intranet Statistics mijn bezoek uit een ander land?',
	...
	'Feedback_SpecialRequest' => 'Heeft u een speciaal verzoek aan het Intranet Statistics team?',
	'Feedback_ContactThePiwikTeam' => 'Neem contact op met het Intranet Statistics team!',
	'Feedback_IWantTo' => 'Ik wil:',
	'Feedback_CategoryShareStory' => 'Deel een Intranet Statistics succes verhaal:',
	'Feedback_CategorySponsor' => 'Sponsor Intranet Statistics:',
	'Feedback_CategoryHire' => 'Huur een Intranet Statistics consultant',
	...
	'Feedback_MessageSent' => 'Uw bericht is verzonden naar het Intranet Statistics team.',
	'Feedback_ThankYou' => 'Bedankt voor uw bijdrage om Intranet Statistics beter te maken!',
	'Feedback_ThePiwikTeam' => 'Het Intranet Statistics Team.',
	...
	'Goals_NoGoalsNeedAccess' => 'Alleen een beheerder of Superuser kan doelstellingen toevoegen voor een website. Vraag uw Intranet Statisticsbeheerder om doelstellingen op te zetten voor uw website. <br> Doelstellingen bijhouden is een goede manier om de prestaties van uw website te begrijpen en maximaliseren!',
	...
	'Goals_DefaultRevenueHelp' => 'Bijvoorbeeld, een contactformulier dat is verzonden door een bezoeker kan gemiddeld €10,- waard zijn. Met de doelconversies zal Intranet Statistics u helpen begrijpen hoe goed de onderdelen van uw website presteren.',
	...
	'Goals_LearnMoreAboutGoalTrackingDocumentation' => 'Leer meer over %s doelen bijhouden in Intranet Statistics%s in de gebruikersdocumentatie of stel nu een doel in!',
	...
	'Installation_PluginDescription' => 'Installatieproces van Intranet Statistics. De installatie wordt meestal maar éénmaal uitgevoerd. Als het configuratie bestand config/config.inc.php is verwijderd, zal de installatie opnieuw beginnen.',
	'Installation_Installation' => 'Installatie',
	'Installation_InstallationStatus' => 'Installatie status',
	'Installation_PercentDone' => '%s %% Gereed',
	'Installation_NoConfigFound' => 'Het Intranet Statistics configuratiebestand werd niet gevonden.<br /><b>  » U kunt <a href=\'index.php\'>Intranet Statistics nu installeren</a></b><br /><small>Wanneer u Intranet Statistics al eerder geïnstalleerd heeft en de Intranet Statistics tabellen reeds data bevatten: maakt u zich geen zorgen, u kunt dezelfde tabellen blijven gebruiken en uw bestaande data behouden!</small>\',',
	...
	'Installation_LargePiwikInstances' => 'Hulp voor grote Intranet Statistics installaties',
	'Installation_JsTag' => 'Javascript trackingcode',
	'Installation_Congratulations' => 'Gefeliciteerd',
	'Installation_CongratulationsHelp' => '<p>Gefeliciteerd! Uw Intranet Statistics installatie is voltooid.</p><p>Controleer of de javascript code geplaatst is op uw pagina\'s, en wacht op de eerste bezoekers!</p>',
	'Installation_ContinueToPiwik' => 'Ga verder naar Intranet Statistics',
	...
	'Installation_SecurityNewsletter' => 'stuur mij e-mails over grote Intranet Statistics upgrades en beveiligingswaarschuwingen',
	...
	'Installation_Requirements' => 'Intranet Statistics vereisten',
	...
	'Installation_SystemCheckDatabaseHelp' => 'Intranet Statistics vereist ofwel de mysqli extensie of de PDO en pdo_mysql extensies.',
	...
	'Installation_SystemCheckParseIniFileHelp' => 'Deze ingebouwde functie is uitgeschakeld op uw host. Intranet Statistics zal proberen deze functie te emuleren maar dit kan andere veiligheidsbeperkingen oplopen. De Tracker prestaties zullen ook veranderen.',
	'Installation_SystemCheckGlobHelp' => 'Deze ingebouwde functie is uitgeschakeld door uw webhoster. Intranet Statistics zal proberen deze functie te emuleren, maar kan tegen andere veiligheids restricties oplopen. Functionaliteit kan worden ingeperkt.',
	...
	'Installation_SystemCheckCreateFunctionHelp' => 'Intranet Statistics gebruikt anonieme functies voor aanroepen.',
	...
	'Installation_SystemCheckPackHelp' => 'De pack() functie is nodig om bezoekers in Intranet Statistics te registreren.',
	...
	'Installation_SystemCheckAutoUpdateHelp' => 'Opmerking: Intranet Statistics One Click update vereist schrijfrechten naar de Intranet Statistics map en alle onderliggende bestanden en mappen.',
	'Installation_SystemCheckError' => 'Er is een fout opgetreden - deze dient verholpen te zijn alvorens u verder gaat',
	'Installation_SystemCheckWarning' => 'Intranet Statistics zal normaal functioneren, maar er zullen een aantal mogelijkheden ontbreken',
	...
	'Installation_TablesWithSameNamesFound' => 'Enkele %1$s tabellen in uw database %2$s hebben dezelfde naam als de tabellen die Intranet Statistics probeert aan te maken.',
	...
	'Installation_TablesDeletedSuccess' => 'Bestaande Intranet Statistics tabellen met succes verwijderd',
	...
	'Installation_GoBackAndDefinePrefix' => 'Ga terug en definieer een voorvoegsel voor de Intranet Statistics tabellen',
	...
	'Installation_WelcomeHelp' => '<p>Intranet Statistics is een open source web analytics software pakket die u op simpele wijze de gegevens van uw bezoekers presenteert.</p><p>Dit proces is opgedeeld in %s simpele stappen welke ongeveer 5 minuten in beslag nemen.</p>',
	'Installation_ConfigurationHelp' => 'Uw Intranet Statistics configuratie bestand is waarschijnlijk niet correct geconfigureerd. U kunt ofwel config/config.ini.php verwijderen en de installatie vervolgen of de toegangsgegevens voor de database corrigeren.',
	'Installation_ErrorInvalidState' => 'Fout: Het lijkt erop dat u probeerde een stap van het installatieproces over te slaan, of dat cookies uitgeschakeld zijn, of dat uw Intranet Statistics configuratie bestand reeds was aangemaakt. %1$s Zorg ervoor dat uw cookies zijn ingeschakeld%2$s en ga terug %3$s naar de eerste pagina van de installatie %4$s.',
	...
	'LanguagesManager_PluginDescription' => 'Deze plugin zal een lijst weergeven van de beschikbare talen voor de Intranet Statistics interface. De geselecteerde taal zal opgeslagen worden in de voorkeuren voor elke gebruiker.',
	'LanguagesManager_AboutPiwikTranslations' => 'Over de Intranet Statistics vertalingen',
	...
	'Login_InvalidNonceOrHeadersOrReferer' => 'Securityformulier gefaald. Herlaad het formulier en controleer dat cookies worden toegestaan. Als u een proxyserver gebruikt, %s configureer Intranet Statistics dan zodanig dat deze proxy headers%s accepteert, die de Hostheaders doorstuurt. Controleer tevens dat de refererheader correct wordt verzonden.',
	'Login_InvalidOrExpiredToken' => 'Token is ongeldig of is verlopen',
	'Login_MailTopicPasswordChange' => 'Bevestig wachtwoord wijziging',
	'Login_ContactAdmin' => 'Mogelijke reden: uw host heeft mogelijk de mail() functie geblokkeerd. <br />Neem contact op met uw Intranet Statistics beheerder.',
	...
	'Mobile_HelpUsToImprovePiwikMobile' => 'Wilt u anonieme registratie van gebruiksgegevens inschakelen in Intranet Statistics Mobile?',
	'Mobile_HttpIsNotSecureWarning' => 'Uw Intranet Statistics autorisatie token (token_auth) wordt verzonden in gewone tekst als u \'HTTP\'. Om deze reden adviseren wij HTTPS voor een veilig transport van gegevens via het internet. Wilt u doorgaan?',
	...
	'Mobile_RatingPleaseRateUs' => 'Intranet Statistics Mobile is vrije software. We zouden het erg op prijs stellen als u 1 minuut tijd nam om de app te waarderen op %s. Als u suggesties voor nieuwe functies heeft of foutmeldingen, neem dan a.u.b. contact op met %s',
	...
	'Mobile_AccessUrlLabel' => 'Intranet Statistics toegang Url',
	...
	'Mobile_NoPiwikAccount' => 'Geen Intranet Statistics account?',
	...
	'MultiSites_PluginDescription' => 'Toont de multi-site uitvoering van de samenvatting/statistieken. Momenteel onderhouden als een core plugin van Intranet Statistics.',
	...
	'Provider_ProviderReportDocumentation' => 'Dit rapport toont de Internet Service Providers die uw bezoekers gebruiken om de website te bezoeken. Klik op een  provider naam voor meer informatie. %s Als Intranet Statistics de naam van de provider niet kan achterhalen, dan wordt deze vermeld als IP.',
	...
	'SitesManager_PluginDescription' => 'Websitebeheer in Intranet Statistics: Voeg een nieuwe website toe, pas een bestaande aan, toon de javascript code om te integreren in uw pagina\'s. Alle acties zijn ook beschikbaar via de API.',
	...
	'SitesManager_PiwikWillAutomaticallyExcludeCommonSessionParameters' => 'Intranet Statistics sluit automatisch veelvoorkomende sessie parameters uit (%s).',
	'SitesManager_HelpExcludedIps' => 'Voer de IP adressen in (één per lijn) die u niet wilt volgen via Intranet Statistics. U kunt wildcards gebruiken, bijv. %1$s of %2$s',
	...
	'SitesManager_PiwikOffersEcommerceAnalytics' => 'In Intranet Statistics is een geavanceerde Ecommerce Analytics tracking & rapportage mogelijk. Leer meer over %s Ecommerce Analytics%s.',
	'TranslationsAdmin_PluginDescription' => 'Help Intranet Statistics te vertalen in uw taal.',
	...
	'UsersManager_PluginDescription' => 'Gebruikers beheer in Intranet Statistics: voeg een nieuwe gebruiker toe, pas een bestaande aan, pas de permissies aan. Alle acties zijn ook beschikbaar via de API',
	...
	'UsersManager_MainDescription' => 'Stel in welke gebruikers toegang hebben tot de Intranet Statistics rapporten van deze website. U kan de toegangsrechten voor alle websites tegelijk bepalen door deze optie te kiezen in de dropdown.',
	...
	'UsersManager_YourVisitsAreIgnoredOnDomain' => '%s Uw Intranet Statistics bezoeken worden genegeerd door Intranet Statistics op %s %s (Intranet Statistics negeer cookie is gevonden in uw browser).',
	'UsersManager_YourVisitsAreNotIgnored' => '%sUw bezoeken worden niet genegeerd door Intranet Statistics%s (de Intranet Statistics negeer cookie is niet gevonden in uw browser).',
	'UsersManager_ClickHereToDeleteTheCookie' => 'Klik hier om de cookie te verwijderen en laat Intranet Statistics uw bezoeken volgen.',
	'UsersManager_ClickHereToSetTheCookieOnDomain' => 'Klik hier om een cookie te plaatsen dat uw bezoeken uitsluit van Intranet Statistics op %s',
	...
	'UsersManager_WhenUsersAreNotLoggedInAndVisitPiwikTheyShouldAccess' => 'Wanneer gebruikers niet ingelogd zijn en Intranet Statistics bezoeken, moeten ze toegang krijgen',
	...
	'UsersManager_ExceptionEditAnonymous' => 'De anonieme gebruiker kan niet gewijzigd of verwijderd worden. Deze wordt door Intranet Statistics gebruikt voor gebruikers die nog niet zijn ingelogd. U kunt bijvoorbeeld uw statistieken publiekelijk maken door de \'anonieme\' gebruiker \'kijkers rechten\' te geven.',
	'UsersManager_ExceptionSuperUser' => 'De betreffende gebruiker is de Superuser en kan niet worden opgevraagd, bewerkt of worden verwijderd via de API. U kunt de Superuser handmatig aanpassen in uw Intranet Statistics configuratie bestand.',
	...
	'VisitorGenerator_PluginDescription' => 'Plugin om bezoekersdata creëren. Dit kan worden gebruikt door Intranet Statisticsgebruikers of ontwikkelaars als een makkelijke manier om Intranet Statistics te vullen met testgegevens.',
	'VisitorGenerator_VisitorGenerator' => 'Bezoekers Generator',
	'VisitorGenerator_Warning' => 'U staat op het punt om testbezoeken te genereren die opgeslagen zullen worden in uw Intranet Statistics database.',
	'VisitorGenerator_NotReversible' => 'Het is %s niet%s mogelijk om deze testgegevens weer makkelijk te verwijderen uit de Intranet Statistics logs.',
	...
	'Widgetize_PluginDescription' => 'Deze plugin maakt het zeer gemakkelijk om Intranet Statistics widgets te exporteren naar uw blog, website of op iGoogle en Netvibes.',
	...
	'PDFReports_PiwikReports' => 'Intranet Statistics rapporten',
	...
	'ImageGraph_PluginDescription' => 'Genereer mooie PNG Grafieken voor elk Intranet Statistics rapport.',
