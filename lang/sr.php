...
$translations = array(
	...
	'General_AllowPiwikArchivingToTriggerBrowser' => 'Dozvoli da Intranet Statistics arhivira izveštaje svaki put kada se pregledaju iz brauzera',
	'General_ArchivingInlineHelp' => 'Za srednje i velike sajtove preporuka je da isključite ovu opciju i da podesite cron koji će procesirati Intranet Statistics izveštaje svaki sat',
	'General_ArchivingTriggerDescription' => 'Preporučljivo za velike Intranet Statistics instalacije; potrebno je da %spodesite cron%s da procesira izveštaje automatski',
	...
	'General_GraphHelp' => 'Više informacija o prikazivanju grafikona u Intranet Statistics',
	...
	'General_PiwikIsACollaborativeProjectYouCanContributeAndDonate' => '%1$s Intranet Statistics %2$s je zajednički projekat. %3$s Ako vam se sviđa Intranet Statistics, možete pomoći. Proverite %4$s kako možete doprineti razvoju Intranet Statistics-a%5$s ili%6$s %7$sizvršite donaciju%8$s kako biste pomogli finansiranju Intranet Statistics 2.0!',
	'General_YouAreViewingDemoShortMessage' => 'Trenutno koristite demo verziju programa Intranet Statistics',
	'General_YouAreCurrentlyUsing' => 'Trenutno koristite Intranet Statistics %s.',
	'General_DownloadFullVersion' => '%1$sPreuzmite%2$s punu verziju! Posetite %3$s',
	'General_NewUpdatePiwikX' => 'Izašla je nova verzija: %s',
	'General_AboutPiwikX' => 'O programu Intranet Statistics %s',
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Objavljen je Intranet Statistics %1$s. %2$s Molimo Vas da izvršite nadogradnju!%3$s (pogledajte %4$spromene%5$s).',
	'General_PiwikXIsAvailablePleaseNotifyPiwikAdmin' => '%s je na raspolaganju. Molimo vas da obavestite administratora sajta',
	'General_NewReportsWillBeProcessedByCron' => 'Ako Intranet Statistics arhiviranje nije pokrenuto od strane brauzera, onda će nove izveštaje procesirati crontab',
	...
	'General_BackToPiwik' => 'Nazad na Intranet Statistics',
	...
	'General_ConfigFileIsNotWritable' => 'U Intranet Statistics datoteku sa podešavanjima %s nije moguće pisati tako da neke od vaših izmena nije moguće sačuvati. %s Molimo vas da promenite dozvole nad ovom datotekom kako bi se u nju moglo pisati.',
	'General_StatisticsAreNotRecorded' => 'Intranet Statistics praćenje posetilaca je trenutno isključeno. Uključite ga tako što ćete upisati record_statistics = 1 u config/config.ini.php datoteku.',
	'General_ExceptionDatabaseVersion' => 'Vaša %1$s verzija je %2$s ali Intranet Statistics zahteva barem %3$s.',
	...
	'General_PleaseUpdatePiwik' => 'Molimo vas da nadogradite Intranet Statistics',
	...
	'Actions_DownloadsReportDocumentation' => 'U ovom izveštaju možete videti koje su fajlove posetioci kliknuli. %s Ono što Intranet Statistics računa kao download jeste klik na link za skidanje fajla. Bilo da je fajl skinut ili ne, to nije poznato Intranet Statistics-u.',
	...
	'API_PluginDescription' => 'Svi podaci u Intranet Statistics-u su dostupni preko jednostavnog API-ja. Ovaj dodatak je ulazna tačka koju pozivate kako biste dobili podatke u xml, json, php, csv itd.',
	'API_QuickDocumentationTitle' => 'API kratka dokumentacija',
	'API_GenerateVisits' => 'Ukoliko nema podataka za danas, onda ih prvo generišite pomoću dodatka %s. Aktivirajte dodatak %s a onda kliknite na \'Generator posetilaca\' na stranici za Intranet Statistics administraciju.',
	'API_MoreInformation' => 'Za više informacija o Intranet Statistics API-ju molimo vas da pogledate %s uvod u Intranet Statistics API %s i %s Intranet Statistics API referenc listu %s.',
	...
	'CoreAdminHome_PluginDescription' => 'Intranet Statistics administracija',
	...
	'CoreAdminHome_OptOutForYourVisitors' => 'Intranet Statistics opt-out za vaše posetioce',
	'CoreAdminHome_OptOutExplanation' => 'Intranet Statistics poštuje privatnost na Internetu. Kako biste omogućili vašim posetiocima da budu izuzeti iz Intranet Statistics analize, dodajte sledeći HTML kod na neku od stranica vaše sajta, na primer u polisu privatnosti',
	'CoreAdminHome_OptOutExplanationBis' => 'Ovaj tag će prikazati iframe element koji sadrži link za vaše posetioce koji žele da budu izuzeti iz Intranet Statistics analize tako što će imati specijalan opt-out kolačić u svom brauzeru. %s Kliknite ovde%s kako biste videli sadržaj iframe elementa.',
	...
	'CoreAdminHome_CustomLogoHelpText' => 'Možete podesiti Intranet Statistics logo koji će biti prikazan u korisničkom interfejsu i E-Mail izveštajima.',
	'CoreAdminHome_CustomLogoFeedbackInfo' => 'Ako podesite Intranet Statistics logo, možda biste bili zainteresovani da sakrijete %s link iz glavnog menija. Da to uradite, možete isključiti Feedback plugin iz %sOrganizuj Plugin-ove%s.',
	...
	'CoreAdminHome_LogoNotWriteable' => 'Da biste koristili svoj logo za Intranet Statistics, potrebno je da omogućite prava za pisanje logo fajlovima u okviru foldera za teme: %s',
	'CoreAdminHome_TrustedHostSettings' => 'Naziv Intranet Statistics hosta',
	'CoreAdminHome_TrustedHostConfirm' => 'Da li ste sigurni da želite da promenite naziv Intranet Statistics hosta?',
	'CoreAdminHome_PiwikIsInstalledAt' => 'Intranet Statistics je instaliran',
	'CoreAdminHome_ValidPiwikHostname' => 'Validni naziv Intranet Statistics hosta',
	...
	'CoreHome_InjectedHostWarningIntro' => 'Sada pristupate Intranet Statistics-u sa %1$s, ali je Intranet Statistics podešen da radi sa ove adrese: %2$s.',
	'CoreHome_InjectedHostNonSuperUserWarning' => '%1$sKliknite ovde kako biste pristupili Intranet Statistics-u bezbedno%2$s i uklonili ovo upozorenje. Takođe možete kontaktirati administratora i obavestiti ga o ovom upozorenju (%3$skliknite ovde kako biste poslali poruku%4$s).',
	'CoreHome_InjectedHostEmailSubject' => 'Intranet Statistics-u je pristupljeno sa nepoznatim nazivom hosta: %s',
	'CoreHome_InjectedHostEmailBody' => 'Pozdrav. Pokušao/la sam da pristupim Intranet Statistics-u danas i dobio/la upozorenje o nepoznatom nazivu hosta.',
	'CoreHome_CheckForUpdates' => 'Proveri da li se pojavila nova verzija',
	'CoreHome_YouAreUsingTheLatestVersion_js' => 'Koristite poslednju verziju Intranet Statistics-a',
	'CoreHome_MakeADifference' => 'Budi drugačiji: %1$sDoniraj%2$s za Intranet Statistics 2.0!',
	'CoreHome_DonateCall1' => 'Intranet Statistics vas nikada neće ništa koštati ali to ne znači da nas Intranet Statistics ništa ne košta dok ga pravimo.',
	'CoreHome_DonateCall2' => 'Intranet Statisticsu je potrebna vaša stalna podrška kako bi rastao i napredovao.',
	'CoreHome_DonateCall3' => 'Ukoliko imate osećaj da je Intranet Statistics u znatnoj meri dodao vrednost vašem biznisu, %1$smolimo vas da razmislite o donaciji%2$s.',
	'CoreHome_HowMuchIsPiwikWorth' => 'Koliko Intranet Statistics po vama vredi?',
	'CoreHome_SupportPiwik' => 'Podržite Intranet Statistics!',
	...
	'CoreHome_SubscribeAndBecomePiwikSupporter' => 'Nastavite ka stranici za sigurno plaćanje (Paypal) kako biste postali Intranet Statistics suporter!',
	...
	'CoreHome_ViewAllPiwikVideoTutorials' => 'Prikaži sve Intranet Statistics video tutorijale',
	'CoreHome_SharePiwikShort' => 'Intranet Statistics! Besplatna web analitika otvorenog koda. Budite vlasnici svojih podataka.',
	'CoreHome_SharePiwikLong' => 'Ćaos! Upravo sam naleteo na strava program: Intranet Statistics!    Intranet Statistics je besplatan program otvorenog koda za praćenje posetilaca na tvom sajtu. Definitvno moraš da ga isprobaš!',
	'PrivacyManager_TeaserHeadline' => 'Podešavanja privatnosti',
	'PrivacyManager_Teaser' => 'Na ovoj stranici možete izvršiti Intranet Statistics podešavanja u pogledu privatnosti tako što ćete: %s anonimizirati IP adrese posetilaca%s, %s automatski ukloniti stare zapise iz baze%s, obezbediti mehanizam da %s podaci ne budu zabeleženi ako posetioc to ne želi%s',
	'PrivacyManager_MenuPrivacySettings' => 'Privatnost',
	'PrivacyManager_PluginDescription' => 'Intranet Statistics podešavanja u pogledu privatnosti',
	'PrivacyManager_UseAnonymizeIp' => 'Anonimizacija IP adrese posetilaca',
	'PrivacyManager_AnonymizeIpDescription' => 'Kliknite na "Da" ako želite da Intranet Statistics ne beleži pune IP adrese',
	...
	'PrivacyManager_DeleteDataDescription' => 'Možete podesiti Intranet Statistics tako da periodično briše stare zapise o posetama i/ili obrađene izveštaje te da tako održite veličinu baze malom.',
	...
	'PrivacyManager_DoNotTrack_EnabledMoreInfo' => 'Kada korisnik u svom brauzeru uključi opciju "I do not want to be tracked" (Do Not Track je uključen), onda Intranet Statistics ne prati njihove posete.',
	'PrivacyManager_DoNotTrack_Disabled' => 'Intranet Statistics trenutno prati sve posetioce, čak iako su oni u svom brauzeru uključi opciju "I do not want to be tracked"',
	...
	'CoreHome_NoPrivilegesAskPiwikAdmin' => 'Prijavljeni ste kao \'%s\' ali izgleda da nemate postavljena nikakva ovlašćenja. %s Tražite od Intranet Statistics administratora (kliknite za poruku)%s da vam dozvoli \'prikaz\' na sajtu.',
	'CoreHome_JavascriptDisabled' => 'JavaScript mora bidi uključen kako biste standardno koristili Intranet Statistics.<br />Izgleda da je JavaScript ili isključen ili nije podržan od strane vašeg brauzera.<br />Kako biste omogućili standardni prikaz, uključite JavaScript kroz podešavanja vašeg brauzera a onda %1$spokušajte ponovo%2$s.<br />',
	...
	'CorePluginsAdmin_MainDescription' => 'Dodaci proširuju funkcionalnost Intranet Statistics-a. Jednom instaliran dodatak se ovde može aktivirati ili deaktivirati.',
	...
	'CoreUpdater_YourDatabaseIsOutOfDate' => 'Intranet Statistics baza podataka je zastarela i mora biti nadograđena pre nego što nastavite.',
	'CoreUpdater_PiwikWillBeUpgradedFromVersionXToVersionY' => 'Intranet Statistics baza će biti nadograđena sa verzije %1$s na %2$s.',
	'CoreUpdater_TheFollowingPluginsWillBeUpgradedX' => 'Sledeći dodaci će biti nadograđeni: %s.',
	'CoreUpdater_NoteForLargePiwikInstances' => 'Važna napomena za velike Intranet Statistics instalacije',
	'CoreUpdater_TheUpgradeProcessMayFailExecuteCommand' => 'Ukoliko imate veliku Intranet Statistics bazu onda nadogradnja može trajati predugo da bi se izvršila iz brauzera. U tom slučaju nadogradnju možete izvršiti iz komandne linije: %s',
	'CoreUpdater_YouCouldManuallyExecuteSqlQueries' => 'Ukoliko niste u mogućnosti da izvršite nadogradnju iz komandne linije i ako Intranet Statistics ne uspe da se nadogradi (zbog isteka vremena na bazi, brauzeru ili bilo čega drugog), možete ručno izvršiti SQL upite.',
	...
	'CoreUpdater_UpgradePiwik' => 'Nadogradnja Intranet Statistics-a',
	...
	'CoreUpdater_ErrorDIYHelp_3' => 'ručno izmenite tabelu `option` u Intranet Statistics bazi tako što ćete za version_core postaviti vrednost verzije poslednje nadogradnje',
	...
	'CoreUpdater_ErrorDIYHelp_5' => 'prijavite problem (i rešenje) kako bi Intranet Statistics bio poboljšan',
	'CoreUpdater_HelpMessageContent' => 'Pogledajte %1$s Intranet Statistics pitanja i odgovore %2$s koja objašnjavaju najčešće greške prilikom nadogradnje. %3$s Kontaktirajte vašeg sistemskog administratora - možda je u mogućnosti da vam pomogne oko grešaka koje su najverovatnije u domenu podešavanja servera ili MySQL-a.',
	...
	'CoreUpdater_PiwikHasBeenSuccessfullyUpgraded' => 'Intranet Statistics je uspešno nadograđen!',
	'CoreUpdater_ContinueToPiwik' => 'Nastavite rad sa Intranet Statistics-om.',
	'CoreUpdater_UpdateAutomatically' => 'Automatska nadogradnja',
	'CoreUpdater_ThereIsNewVersionAvailableForUpdate' => 'Izašla je nova verzija Intranet Statistics-a',
	'CoreUpdater_YouCanUpgradeAutomaticallyOrDownloadPackage' => 'Možete izvršiti automatsku nadogradnju na verziju %s ili preuzeti poslednju verziju Intranet Statistics-a i izvršiti ručnu nadogradnju',
	'CoreUpdater_YouMustDownloadPackageOrFixPermissions' => 'Intranet Statistics nije u stanju da prebriše trenutnu instalaciju. Možete ili da popravite dozvole nad datotekama i direktorijumima ili da preuzmete paket sa Interneta i instalirate verziju %s ručno:',
	'CoreUpdater_DownloadX' => 'Preuzmite %s',
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'Automatska nadogradnja Intranet Statistics-a je prekinuta. Ako ne možete popraviti grešku iznad, preporučljivo je da ručno izvršite nadogradnju. %1$s Molimo Vas da proverite %2$sdokumentaciju za nadogradnju%3$s!',
	...
	'CoreUpdater_PiwikUpdatedSuccessfully' => 'Intranet Statistics je uspešno nadograđen!',
	...
	'CustomVariables_PluginDescription' => 'Dodatni parametri predstavljaju uređene parove ime, vrednost koje možete sami postaviti pomoću JavaScript API funkcije setVisitCustomVariables(). U tom slučaju Intranet Statistics će prikazati koliko je bilo poseta, otvaranja stranica i ciljeva za svaki od zadatih parova.',
	...
	'CustomVariables_TrackingHelp' => 'Pomoć: %1$sPraćenje korisničkih promenljivih u Intranet Statistics-u%2$s',
	...
	'DBStats_PluginDescription' => 'Ovaj dodatak prikazuje iskorišćenost MySQL baze od strane Intranet Statistics tabela.',
	'DBStats_DatabaseUsage' => 'Iskorišćenost baze',
	'DBStats_MainDescription' => 'Intranet Statistics smešta sve vaše analitičke podatke u MySQL bazu. Trenutno Intranet Statistics tabele zauzimaju %s.',
	'DBStats_LearnMore' => 'Ukoliko želite da naučite više o tome kako Intranet Statistics procesira podatke i kako da ga naterate da dobro radi sa srednjim i velikim sajtovima, proučite dokumentaciju %s.',
	...
	'ExampleUI_PluginDescription' => 'Primer dodatka: ovaj dodatak pokazuje kako se radi sa Intranet Statistics UI (pravljenje tabela, grafikona itd.)',
	'Feedback_PluginDescription' => 'Pošaljite vaša opažanja Intranet Statistics timu. Podelite sa nama vaše ideje i sugestije!',
	...
	'Feedback_WhyWrongCountry' => 'Zašto Intranet Statistics prikazuje moje posete pod pogrešnom zemljom?',
	...
	'Feedback_SpecialRequest' => 'Da li imate neki specijalan zahtev za Intranet Statistics tim?',
	'Feedback_ContactThePiwikTeam' => 'Kontaktirajte Intranet Statistics tim!',
	'Feedback_IWantTo' => 'Želim da:',
	'Feedback_CategoryShareStory' => 'Podelite sa drugima uspešnu Intranet Statistics priču',
	'Feedback_CategorySponsor' => 'Sponzorišite Intranet Statistics',
	'Feedback_CategoryHire' => 'Unajmite konsultanta za Intranet Statistics',
	...
	'Feedback_MessageSent' => 'Vaša poruka je poslata Intranet Statistics timu',
	'Feedback_ThankYou' => 'Hvala vam što nam pomažete da učinimo Intranet Statistics boljim!',
	'Feedback_ThePiwikTeam' => 'Intranet Statistics tim',
	...
	'Feedback_WantToThankConsiderDonating' => 'Da li smatrate da je Intranet Statistics izuzetan i želite da nam zahvalite? Razmislite o donaciji',
	'Goals_Goals' => 'Ciljevi',
	...
	'Goals_NoGoalsNeedAccess' => 'Samo adminitartor i superkorisnik mogu dodavati ciljeve za dati sajt. Molimo vas da zatražite od vašeg Intranet Statistics administratora da postavi cilj za vaš sajt. <br>Praćenje ciljeva je odličan način za razumevanje i maksimiziranje učinka vašeg sajta!',
	...
	'Goals_DefaultRevenueHelp' => 'Na primer, kontakt forma koju je popunio posetioc može u proseku biti vredna 10$. Intranet Statistics vam može pomoći da razumete koliko su dobre vaše grupe posetilaca.',
	...
	'Goals_LearnMoreAboutGoalTrackingDocumentation' => 'Saznajte više o %s praćenju ciljeva u Intranet Statistics-u%s u korisničkoj dokumentaciji.',
	...
	'Installation_PluginDescription' => 'Proces instalacije Intranet Statistics-a. Instalacija se obično vrši samo jednom. Ukoliko datoteku sa podešavanjima config/config.inc.php obrišete, instalacija će početi ispočetka.',
	...
	'Installation_NoConfigFound' => 'Intranet Statistics datoteka sa podešavanjima nije nađena u momentu dok vi pokušavate da pristupite Intranet Statistics stranici.<br /><b>  » Kliknite ovde kako biste <a href=\'index.php\'>instalirali Intranet Statistics</a></b><br /><small>Ukoliko ste već ranije instalirali Intranet Statistics i imate neke tabele u bazi podataka, bez brige: možete nastaviti da ih koristite i zadržite postojeće podatke!</small>',
	...
	'Installation_LargePiwikInstances' => 'Pomoć u vezi velikih Intranet Statistics instalacija',
	'Installation_JsTag' => 'JavaScript kod',
	'Installation_Congratulations' => 'Čestitamo',
	'Installation_CongratulationsHelp' => '<p>Čestitamo! Intranet Statistics instalacija je završena.</p><p>Proverite da li je JavaScript kod ubačen na sve stranice sajta i sačekajte vaše prve posetioce!</p>',
	'Installation_ContinueToPiwik' => 'Nastavite sa upotrebom Intranet Statistics-a',
	'Installation_SiteSetup' => 'Molimo vas da podesite prvi sajt koji želite da pratite i analizirate pomoću Intranet Statistics-a:',
	...
	'Installation_SecurityNewsletter' => 'pošaljite mi elektronsko pismo sa važnim Intranet Statistics nadogradnjama i sigurnosim upozorenjima',
	'Installation_CommunityNewsletter' => 'pošaljite mi elektronsko pismo sa nadogradnjama od strane Intranet Statistics zajednice (novi dodaci, nove opcije, itd.)',
	'Installation_PasswordDoNotMatch' => 'lozinke se ne podudaraju',
	'Installation_Requirements' => 'Intranet Statistics zahtevi',
	...
	'Installation_SystemCheckDatabaseHelp' => 'Intranet Statistics zahteva ili mysqli proširenje ili PDO i pdo_mysql proširenja.',
	...
	'Installation_SystemCheckParseIniFileHelp' => 'Ova funkcija je isključena na vašem serveru. Intranet Statistics će pokušati da je emulira ali može da naleti na neke dalja sigurnosna ograničenja. Takođe će biti i uticaja na treker.',
	'Installation_SystemCheckGlobHelp' => 'Ova funkcija je isključena na vašem serveru. Intranet Statistics će pokušati da je emulira ali može da naleti na neke dalja sigurnosna ograničenja. Svakako će biti uticaja na funkcionalnost.',
	...
	'Installation_SystemCheckCreateFunctionHelp' => 'Intranet Statistics koristi anonimne funkcije',
	...
	'Installation_SystemCheckAutoUpdateHelp' => 'Pažnja: Intranet Statistics nadogradnja putem jednog klika zahteva da bude omogućeno pisanje u Intranet Statistics direktorijum i njegov sadržaj',
	'Installation_SystemCheckError' => 'Došlo je do greške koja mora biti ispravljena pre nego što nastavimo',
	'Installation_SystemCheckWarning' => 'Intranet Statistics će raditi normalno ali neke funkcije neće biti dostupne',
	...
	'Installation_TablesWithSameNamesFound' => 'Neke %1$s tabele u vašoj bazi %2$s imaju ista imena kao i tabele koje Intranet Statistics pokušava da kreira',
	...
	'Installation_TablesDeletedSuccess' => 'Postojeće Intranet Statistics tabele su uspešno obrisane',
	...
	'Installation_GoBackAndDefinePrefix' => 'Vratite se korak nazad i definišite prefiks za Intranet Statistics tabele',
	...
	'Installation_WelcomeHelp' => '<p>Intranet Statistics je alat otvorenog koda za analizu saobraćaja na sajtovima koji vam na lak način pruža željene informacije o vašim posetiocima.</p><p>Proces instalacije je podeljen na %s jednostavnih koraka i zahteva svega 5 minuta vašeg vremena.</p>',
	'Installation_ConfigurationHelp' => 'Vaša Intranet Statistics podešavanja kao da nisu dobra. Možete ili ukloniti config/config.ini.php datoteku i nastaviti sa instalacijom, ili ispraviti podešavanja u vezi sa povezivanjem na bazu podataka.',
	'Installation_ErrorInvalidState' => 'Greška: izgleda da ste pokušali da preskočite korak u instalalciji, ili vam je podrška za cookie onemogućena u vašem web čitaču, ili je Intranet Statistics datoteka sa podešavanjima već kreirana. %1$sPostarajte se da je podrška za cookie omogućena%2$s i vratite se nazad %3$s na prvu stranicu Intranet Statistics instalacije %4$s.',
	...
	'Installation_SystemCheckSummaryThereWereErrors' => 'Intranet Statistics je otkrio %1$skritične probleme%2$s sa vašom instalacijom. %3$sPotrebno je da ih odmah rešite.%4$s',
	'Installation_SystemCheckSummaryThereWereWarnings' => 'Postoje izvesni problemi sa vašim sistemom. Intranet Statistics će raditi ali možete iskusiti manje probleme.',
	'Installation_SystemCheckSummaryNoProblems' => 'Bravo! Nema problema sa vašom instalacijom Intranet Statistics-a. Možete biti zadovoljni.',
	...
	'Installation_LoadDataInfileRecommended' => 'Ukoliko vaš Intranet Statistics server prati sajtove sa velikim saobraćajem (na primer, više od 100.000 strana mesečno), predlažemo vam da pokušate da rešite ovaj problem.',
	'Installation_Filesystem' => 'Sistem datoteka',
	'Installation_NfsFilesystemWarning' => 'Vaš server koristi NFS sistem datoteka.',
	'Installation_NfsFilesystemWarningSuffixAdmin' => 'To znači da će Intranet Statistics biti jako spor ako koristite sesije bazirane na datotekama.',
	...
	'LanguagesManager_PluginDescription' => 'Ovaj dodatak prikazuje sve raspoložive jezike za Intranet Statistics interfejs. Izabrani jezik će biti sačuvan za svakog korisnika ponaosob.',
	'LanguagesManager_AboutPiwikTranslations' => 'O Intranet Statistics prevodima',
	...
	'Login_ContactAdmin' => 'Moguć razlog: vaš hosting provajder je možda onemogućio mail() funkciju. <br />Molimo vas da kontaktirate vašeg Intranet Statistics administratora.',
	...
	'Mobile_AddPiwikDemo' => 'Dodaj Intranet Statistics demo',
	'Mobile_AnonymousTracking' => 'Anonimno praćenje',
	'Mobile_AskForAnonymousTrackingPermission' => 'Ako je ova opcija uključena, Mobilni Intranet Statistics će slati anonimne podatke o upotrebi na piwik.org. Svrha ovoga je pomoć razvojnom timu koji radi na projektu kako bi bolje razumeo kako se koristi aplikacija. Informacije koje se šalju su: meniji i podešavanja na koja se klikće, naziv i verzija operativnog sistema, prikazane greške. Intranet Statistics tim NEĆE pratiti vaše analitičke podatke. Ovi anonimni podaci nikada neće postati javni. U bilo kom trenutku možete uključiti i isključiti ovu opciju preko podešavanja.',
	...
	'Mobile_HelpUsToImprovePiwikMobile' => 'Da li želite da omogućite anonimno praćenje u Mobilnom Intranet Statistics-u?',
	'Mobile_HttpIsNotSecureWarning' => 'Vaš Intranet Statistics autorizacioni token (token_auth) će biti poslat kao običan tekst ako koristite \'HTTP\'. Zbog toga vam savetujemo da koristite HTTPS za siguran prenos podataka preko Interneta. Da li želite da nastavite?',
	...
	'Mobile_RatingPleaseRateUs' => 'Mobilni Intranet Statistics je besplatna aplikacija. Zaista bismo cenili ako biste odvojili jedan minut i ocenili aplikaciju na %s. Ako imate predloge ili želite da prijavite problem, molimo vas da kontaktirate %s',
	...
	'Mobile_AccessUrlLabel' => 'URL za pristup Intranet Statistics-u',
	...
	'Mobile_NoPiwikAccount' => 'Nemate Intranet Statistics nalog?',
	'Mobile_NoVisitorFound' => 'Nije nađen nijedan posetioc',
	'Mobile_NoWebsiteFound' => 'Nije nađen nijedan sajt',
	'Mobile_SaveSuccessError' => 'Intranet Statistics URL ili kombinacija korisničko ime i lozinka je pogrešna.',
	...
	'MobileMessaging_VerificationText' => 'Kod je %s. Da biste izvršili validaciju broja vašeg telefona i počeli da primate SMS izveštaje, molimo vas da kopirate ovaj kod u Intranet Statistics > %s > %s.',
	...
	'MobileMessaging_Settings_PhoneNumbers_HelpAdd' => 'Kada budete kliknuli na "Dodaj", SMS sa kodom će biti poslat na mobilni. Korisnik koji bude primio kod bi onda trebalo da se prijavi na Intranet Statistics, klikne na Podešavanja pa na Mobilni. Nakon što unese kod korisnik će biti u mogućnosti da prima izveštaje na svoj mobilni telefon.',
	...
	'MobileMessaging_Settings_CredentialNotProvidedByAdmin' => 'Da biste bili u mogućnosti da kreirate i upravljate telefonskim brojevima, zamolite administratora da poveže Intranet Statistics sa SMS nalogom.',
	'MobileMessaging_Settings_CredentialNotProvided' => 'Pre nego što budete u mogućnosti da upravljate brojevima telefona, molimo vas da povežete Intranet Statistics sa vašim SMS nalogom.',
	...
	'MobileMessaging_MultiSites_Must_Be_Activated' => 'Da biste generisali SMS poruke za vaše statistike, molimo vas da u Intranet Statistics-u uključite MultiSites dodatak.',
	'MultiSites_PluginDescription' => 'Prikazuje statistiku za više sajtova. Ovaj dodatak je trenutno u samoj srži Intranet Statistics-a.',
	...
	'Provider_ProviderReportDocumentation' => 'Ovaj izveštaj prikazuje koje Internet provajdere koriste vaši posetioci kako bi pristupili sajtu. Možete kliknuti na naziv provajdera kako biste videli više detalja. %s Ako Intranet Statistics ne može da odredi koji provajder je u pitanju, onda prikazuje IP.',
	...
	'SitesManager_PiwikWillAutomaticallyExcludeCommonSessionParameters' => 'Intranet Statistics će automatski izuzeti uobičajene parametre sesije (%s)',
	'SitesManager_HelpExcludedIps' => 'Navedite listu IP adresa, jednu po liniji, koje želite da izuzmete iz Intranet Statistics analize. Možete koristiti i džokere poput %1$s i %2$s',
	...
	'SitesManager_PiwikOffersEcommerceAnalytics' => 'Intranet Statistics omogućuje napredno praćenje i izveštavanje u pogledu elektronskih porudžbina. Saznajte više na %s Ecommerce Analytics%s.',
	'SitesManager_TrackingSiteSearch' => 'Praćenje pretraživanja sajta',
	'SitesManager_SiteSearchUse' => 'Možete koristiti Intranet Statistics za praćenje i kreiranje izveštaja o tome šta posetioci traže na vašem sajtu koristeći polje za pretragu.',
	...
	'SitesManager_SearchCategoryDesc' => 'Intranet Statistics takođe može i da prati kategorije pretrage za svaku ključnu reč.',
	...
	'TranslationsAdmin_PluginDescription' => 'Pomozite u prevođenju Intranet Statistics-a na vaš jezik',
	...
	'UserCountryMap_LoginToViewRealTime' => 'Prijavite se kako biste videli Intranet Statistics mapu posetilaca u realnom vremenu!',
	...
	'UserCountry_PiwikNotManagingGeoIPDBs' => 'Intranet Statistics trenutno ne upravlja ni jednom GeoIP bazom.',
	...
	'UserCountry_GeolocationPageDesc' => 'Na ovoj stranici možete promeniti način na koji Intranet Statistics prepoznaje lokacije posetilaca.',
	...
	'UserCountry_TestIPLocatorFailed' => 'Intranet Statistics je pokušao da proveri lokaciju poznate IP adrese (%1$s) ali je vaš server vratio %2$s. Kada bi provajder bio podešen kako treba vratio bi %3$s.',
	...
	'UserCountry_HowToSetupGeoIP_Step2' => 'Raspakujte ovu datoteku i kopirajte rezultat, %1$s u %2$smisc%3$s Intranet Statistics direktorijum (to možete uraditi pomoću FTP-a ili SSH).',
	...
	'UserCountry_HowToSetupGeoIP_Step4' => 'I gotovo je! Upravo ste podesili Intranet Statistics da koristi GeoIP što znači da ćete moći da vidite regione i gradove vaših posetilaca sa veoma preciznom informacijom o zemljama.',
	...
	'UserCountry_OldGeoIPWarning' => 'Otrili smo stari GeoIP dodatak. GeoIP integracija je sada deo srži Intranet Statistics-a i ovaj dodatak se smatra zastarelim. Novi izveštaji o gradovima i regionima neće biti prikazani sve dok je ovaj dodatak učitan. %1$sMolimo vas da isključite dodatak%2$s i da %3$spodesite GeoIP%4$s. Ukoliko su vam potrebni podaci o lokacijama starih poseta, upotrebite skript %5$ssa ove adrese%6$s i %7$sponovo isprocesirajte podatke%8$s.',
	...
	'UserCountry_GeoIPServerVarsFound' => 'Intranet Statistics je pronašao sledeće GeoIP %s promenljive',
	...
	'UserCountry_FoundApacheModules' => 'Intranet Statistics je našao sledeće Apache module',
	'UserCountry_GeoIPNoServerVars' => 'Intranet Statistics ne može da nađe nijednu GeoIP %s promenljivu',
	'UserCountry_IPurchasedGeoIPDBs' => 'Naručio sam %1$sprecizniju bazu od MaxMind-a%2$s i želim da podesim automatska osvežavanja.',
	'UserCountry_GeoIPUpdaterIntro' => 'Intranet Statistics trenutno podržava sledeće GeoIP baze',
	...
	'UserCountry_CannotSetupGeoIPAutoUpdating' => 'Izgleda da ste GeoIP bazu smestili van Intranet Statistics-a (baza nije u misc direktorijumu ali GeoIP radi). Intranet Statistics ne može automatski da osvežava bazu ako je ona van misc direktorijuma.',
	...
	'UsersManager_PluginDescription' => 'Rad sa korisnicima Intranet Statistics-a: dodavanje novih korisnika, izmena postojećih, rad na privilegijama. Sve akcije su dostupne i preko API-ja.',
	...
	'UsersManager_YourVisitsAreIgnoredOnDomain' => '%s Intranet Statistics ignoriše vaše posete %s %s (pronađen je specijalni kolačić u vašem brauzeru).',
	'UsersManager_YourVisitsAreNotIgnored' => '%s Intranet Statistics ne ignoriše vaše posete%s (nije pronađen kolačić u vašem brauzeru).',
	'UsersManager_ClickHereToDeleteTheCookie' => 'Kliknite ovde kako biste obrisali kolačić i time omogućili Intranet Statistics da prati i vaše posete',
	'UsersManager_ClickHereToSetTheCookieOnDomain' => 'Kliknite ovde kako biste postavili kolačić i time onemogućili Intranet Statistics da prati i vaše posete %s',
	...
	'UsersManager_WhenUsersAreNotLoggedInAndVisitPiwikTheyShouldAccess' => 'Kada korisnik koji nije prijavljen pokuša da otvori Intranet Statistics, trebalo bi da se otvori:',
	...
	'UsersManager_ExceptionEditAnonymous' => 'Podaci o anonimnom korisniku ne mogu biti menjani ili obrisani. Anonimni korisnik služi da bi Intranet Statistics mogao da razlikuje korisnika koji se još nije prijavio na sistem. Primera radi, svoju statistiku možete učiniti javnom tako što ćete anonimnom korisniku dozvoliti \'prikaz\' pristup.',
	'UsersManager_ExceptionSuperUser' => 'Traženi korisnik je superkorisnik i kao takav ne može biti pozvan, izmenjen ili obrisan putem API-ja. Možete ručno izmeniti podatke superkorisnika u datoteci sa Intranet Statistics podešavanjima.',
	...
	'VisitorGenerator_PluginDescription' => 'Dodatak za generisanje lažnih poseta. Ovaj dodatak mogu koistiti Intranet Statistics korisnici ili ljudi koji rade na razvoju kako bi na lak način generisali lažne podatke i popunili izveštaje.',
	'VisitorGenerator_VisitorGenerator' => 'Generator posetilaca',
	'VisitorGenerator_Warning' => 'Upravo ćete generisati lažne posete koje će biti upisane u Intranet Statistics bazu.',
	'VisitorGenerator_NotReversible' => '%s Neće biti lako%s obrisati ove podatke iz Intranet Statistics zapisa.',
	...
	'Widgetize_PluginDescription' => 'Ovaj dodatak vam omogućuje da na veoma jednostavan način prikažete bilo koji od Intranet Statistics vidžeta na svom blogu, sajtu, Igoogle ili Netvibes!',
	'Widgetize_TopLinkTooltip' => 'Prikaži Intranet Statistics izveštaje kao vidžete i ugradi konzolu u svoju aplikaciju kao iframe.',
	...
	'PDFReports_PiwikReports' => 'Intranet Statistics izveštaji',
	...
	'PDFReports_TopLinkTooltip' => 'Napravite izveštaje kako biste vi ili vaši klijenti automatski dobijali Intranet Statistics statistike putem elektronske pošte!',
	'ImageGraph_PluginDescription' => 'Kreirajte statične PNG slike grafika za bilo koji Intranet Statistics izveštaj.',
	...
	'Overlay_Link' => 'Link',
	'Overlay_RedirectUrlError' => 'Pokušali ste da otvorite stranicu za URL "%s". %s Nijedan od domena iz Intranet Statistics podešavanja ne odgovara ovom linku.',
	...
	'Overlay_ErrorNotLoadingDetails' => 'Možda stranica koja se učitala sa desne strane nema Intranet Statistics kod za praćenje. U tom slučaju, pokušajte da otvorite prikaz neke druge stranice sa izveštajem.',
	'Overlay_ErrorNotLoadingDetailsSSL' => 'S obzirom na to da koristite Intranet Statistics preko HTTPS-a, najverovatnije je da vaš sajt ne podržava SSL. Pokušajte da koristite Intranet Statistics preko HTTP-a.',
