...
$translations = array(
	...
	'General_BackToHomepage' => 'Takaisin Intranet Statisticsin etusivulle',
	'General_Yes' => 'Kyllä',
	'General_No' => 'Ei',
	...
	'General_ArchivingTriggerDescription' => 'Suositeltavaa suuremmissa Intranet Statistics-asennuksissa. Sinun täytyy %sasentaa cron-työ%s, jotta raportit käsitellään oikein.',
	...
	'General_RequiresFlash' => 'Intranet Statisticsin kuvaajien näyttämiseen tarvitaan Flash.',
	'General_GraphHelp' => 'Lisätietoa Intranet Statisticsin kuvaajista.',
	...
	'General_YouAreViewingDemoShortMessage' => 'Katselet demoversiota Intranet Statisticsistä',
	'General_YouAreCurrentlyUsing' => 'Käytät Intranet Statistics %s:ää',
	'General_DownloadFullVersion' => '%1$sLataa%2$s täysi versio! Katso %3$s',
	'General_NewUpdatePiwikX' => 'Uusi päivitys: Intranet Statistics %s',
	'General_AboutPiwikX' => 'Tietoja Intranet Statisticsistä %s',
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Intranet Statistics %1$s on saatavilla. %2$s Päivitä nyt!%3$s (katso %4$s muutokset%5$s).',
	'General_PiwikXIsAvailablePleaseNotifyPiwikAdmin' => '%s on saatavilla. Pyydä sivun ylläpitäjää päivittämään.',
	'General_NewReportsWillBeProcessedByCron' => 'Kun Intranet Statisticsin arkistointia ei käynnistetä selaimesta, uudet raportit luodaan cronilla.',
	...
	'General_BackToPiwik' => 'Takaisin Intranet Statisticsiin',
	...
	'General_ConfigFileIsNotWritable' => 'Intranet Statisticsin asetustiedostoon %s ei voi kirjoittaa. Kaikkia muutoksia ei voi tallentaa. %s Muuta tiedoston oikeuksia niin, että kirjoittaminen on sallittua.',
	'General_ExceptionDatabaseVersion' => 'Ohjelman %1$s versio on %2$s mutta Intranet Statistics tarvitsee vähintään %3$s',
	...
	'General_FileIntegrityWarningExplanation' => 'Tiedostojen eheystarkistus epäonnistui. Todennäköisesti osa Intranet Statisticsin tiedostojen tallentamisesta epäonnistui. Tallenna kaikki tiedostot binääritilassa (BINARY mode) ja lataa tämä sivu uudelleen.',
	...
	'General_PleaseUpdatePiwik' => 'Ole hyvä ja päivitä Intranet Statistics',
	...
	'Actions_DownloadsReportDocumentation' => 'Tässä raportissa näet, mitä tiedostoja kävijät ovat ladanneet. %s Intranet Statistics laskee lataukseksi latauslinkin klikkaamisen. Intranet Statistics ei tiedä, valmistuiko lataus.',
	...
	'API_PluginDescription' => 'Kaikki Intranet Statisticsin tiedot ovat saatavilla yksinkertaisella API:lla. Tämä lisäosa on API:n aloituspiste, josta voit hakea tietoja xml:ksi, json:ksi, php:ksi, csv:ksi jne.',
	'API_QuickDocumentationTitle' => 'API:n pikadokumentaatio',
	'API_GenerateVisits' => 'Jos sinulla ei ole yhtään tietoja tälle päivälle, voit generoida satunnaisia tietoja käyttämällä lisäosaa %s. Voit ottaa käyttöön %s-lisäosan ja painaa \'Vierailijoiden luominen\'-linkkiä Intranet Statisticsin ylläpitosivulla.',
	'API_MoreInformation' => 'Lisätietoa Intranet Statisticsin APIsta löytyy sivulta %sJohdatus Intranet Statisticsin APIin%s ja %sIntranet Statisticsin API%s.',
	...
	'CoreAdminHome_PluginDescription' => 'Intranet Statisticsin ylläpito.',
	...
	'CoreAdminHome_OptOutForYourVisitors' => 'Intranet Statisticsin poistaminen käytöstä kävijöillesi (opt-out)',
	'CoreAdminHome_OptOutExplanation' => 'Intranet Statistics on mukana mahdollistamassa yksityisyyttä internetissä. Jos haluat antaa kävijöillesi mahdollisuuden kieltää seuranta, lisää seuraava HTML-koodi verkkosivullesi, esimerkiksi "Yksityisyyskäytännöt"-sivulle.',
	'CoreAdminHome_OptOutExplanationBis' => 'Tämä koodi näyttää iframen, jossa on linkki Intranet Statisticsin poistamiseen käytöstä vierailijan selaimesta. Linkin klikkaaminen ei vaikuta muihin käyttäjiin mitenkään. %sKlikkaa tästä%s, jos haluat nähdä, mitä iframessa näytetään.',
	...
	'CoreAdminHome_CustomLogoHelpText' => 'Voit vaihtaa Intranet Statisticsin logoa, joka näytetään käyttöliittymässä ja sähköpostiraporteissa.',
	'CoreAdminHome_CustomLogoFeedbackInfo' => 'Jos haluat muokata Intranet Statisticsin logoa, voit myös piilottaa %s linkin ylävalikosta. Piilottaminen tapahtuu poistamalla Palaute-lisäosa %s Hallitse lisäosia %s -sivulta.',
	...
	'CoreAdminHome_LogoNotWriteable' => 'Intranet Statistics ei voi tallentaa uutta logoa. Intranet Statistics tarvitsee kirjoitusoikeuden kansioon %s',
	'CoreAdminHome_TrustedHostConfirm' => 'Haluatko varmasti vaihtaa luotettua Intranet Statisticsin konenimeä?',
	'CoreHome_InjectedHostEmailSubject' => 'Intranet Statisticsiin otettiin yhteyttä tuntemattomalla osoitteella: %s',
	'CoreHome_CheckForUpdates' => 'Tarkista päivitykset',
	'CoreHome_YouAreUsingTheLatestVersion_js' => 'Käytössäsi on uusin versio Intranet Statisticsistä!',
	'PrivacyManager_TeaserHeadline' => 'Yksityisyysasetukset',
	'PrivacyManager_Teaser' => 'Tällä sivulla voit kustomoida Intranet Statisticsiä, jotta se noudattaa voimassaolevia lakeja ja säännöksiä. Voit %s anonymisoida vierailijoiden IP-osoitteita%s, %s poistaa vanhat lokit automaattisesti%s ja %s tarjota mahdollisuuden poistaa seuranta käytöstä sivullasi%s.',
	'PrivacyManager_MenuPrivacySettings' => 'Yksityisyys',
	'PrivacyManager_PluginDescription' => 'Kustomoi Intranet Statisticsiä, jotta seurantasi noudattaa voimassaolevia lakeja ja säännöksiä.',
	'PrivacyManager_UseAnonymizeIp' => 'Anonymisoi vierailijoiden IP-osoitteet',
	'PrivacyManager_AnonymizeIpDescription' => 'Valitse "Kyllä", jos et halua, että Intranet Statistics seuraa kokonaisia IP-osoitteita.',
	...
	'PrivacyManager_DeleteDataDescription' => 'Voit säätää Intranet Statisticsin poistamaan vanhat kävijätiedot ja/tai luodut raportit, jotta tietokannan koko pysyy pienenä.',
	...
	'PrivacyManager_DoNotTrack_EnabledMoreInfo' => 'Kun käyttäjät asettavat "älä seuraa minua" (DoNotTrack) -ominaisuuden käyttöön, Intranet Statistics ei seuraa käyntejä.',
	'PrivacyManager_DoNotTrack_Disabled' => 'Intranet Statistics seuraa kaikkia käyttäjiä, vaikka käyttäjä ilmoittaisi että ei halua tulla seuratuksi.',
	...
	'CoreHome_NoPrivilegesAskPiwikAdmin' => 'Olet kirjautuneena sisään käyttäjänä \'%s\', mutta sinulla ei ole mitään oikeuksia Intranet Statisticsissä. %sPyydä Intranet Statisticsin ylläpitäjää (klikkaa avataksesi sähköpostin)%s antamaan katseluoikeudet verkkosivuun.',
	...
	'CorePluginsAdmin_MainDescription' => 'Lisäosilla voi laajentaa ja parantaa Intranet Statisticsin toiminnallisuutta. Kun lisäosa on asennettu, voit aktivoida ja poistaa käytöstä sen täällä.',
	...
	'CoreUpdater_PluginDescription' => 'Intranet Statisticsin päivitysjärjestelmä',
	'CoreUpdater_UpdateTitle' => 'Intranet Statistics › Päivitys',
	'CoreUpdater_DatabaseUpgradeRequired' => 'Tietokannan päivitys tarvitaan',
	'CoreUpdater_YourDatabaseIsOutOfDate' => 'Intranet Statisticsin tietokanta on vanhentunut ja se tulee päivittää ennen jatkamista.',
	'CoreUpdater_PiwikWillBeUpgradedFromVersionXToVersionY' => 'Intranet Statisticsin tietokanta päivitetään versiosta %1$s versioon %2$s.',
	'CoreUpdater_TheFollowingPluginsWillBeUpgradedX' => 'Seuraavat lisäosat päivitetään: %s.',
	'CoreUpdater_NoteForLargePiwikInstances' => 'Tärkeä tiedotus suurille Intranet Statisticsin asennuksille',
	'CoreUpdater_TheUpgradeProcessMayFailExecuteCommand' => 'Jos Intranet Statisticsin tietokanta on suuri, päivittäminen saattaa kestää liian kauan. Voit ajaa komentoriviltä komennon %s',
	'CoreUpdater_YouCouldManuallyExecuteSqlQueries' => 'Jos et voi käyttää komentorivin päivitysohjelmaa ja Intranet Statisticsin päivitys epäonnistuu (aikakatkaisu tai jokin muu virhe), voit ajaa SQL-kyselyt itse.',
	...
	'CoreUpdater_UpgradePiwik' => 'Päivitä Intranet Statistics',
	...
	'CoreUpdater_ErrorDIYHelp_3' => 'päivitä manuaalisesti `option`-taulu Intranet Statisticsin tietokannasta. Aseta version_core epäonnistuneen päivityksen versioksi',
	...
	'CoreUpdater_HelpMessageContent' => 'Tarkista %1$s Intranet Statisticsin FAQ:sta%2$s yleisimmät virheet. %3$s Kysy järjestelmän ylläpitäjältä - he voivat auttaa virheissä, jotka johtuvat luultavasti palvelimesta tai tietokannasta.',
	...
	'CoreUpdater_PiwikHasBeenSuccessfullyUpgraded' => 'Intranet Statistics on päivitetty onnistuneesti!',
	'CoreUpdater_ContinueToPiwik' => 'Jatka Intranet Statisticsiin',
	'CoreUpdater_UpdateAutomatically' => 'Päivitä automaattisesti',
	'CoreUpdater_ThereIsNewVersionAvailableForUpdate' => 'Intranet Statisticsistä on uusi versio',
	...
	'CoreUpdater_YouMustDownloadPackageOrFixPermissions' => 'Intranet Statistics ei voi ylikirjoittaa nykyistä asennusta. Voit joko korjata hakemistojen/tiedostojen oikeudet tai ladata paketin ja asentaa version %s itse:',
	'CoreUpdater_DownloadX' => 'Lataa %s',
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'Intranet Statisticsin yhden klikkauksen päivitys on peruutettu. Jos et voi korjata alla oelvaa virhettä, on suositeltavaa päivittää Intranet Statistics manuaalisesti. %1$s Ole hyvä ja tarkista %2$sPäivitysdokumentaatio%3$s',
	...
	'CoreUpdater_PiwikUpdatedSuccessfully' => 'Intranet Statistics päivitettiin onnistuneesti!',
	'CoreUpdater_EmptyDatabaseError' => 'Tietokanta %s on tyhjä. Sinun täytyy muokata tai poistaa Intranet Statisticsin asetustiedosto.',
	'CoreUpdater_ExceptionAlreadyLatestVersion' => 'Intranet Statisticsin versiosi %s on ajantasalla.',
	...
	'CustomVariables_PluginDescription' => 'Kustomoidut muuttujat ovat nimi-arvo-pareja, joita voit asettaa käynnin aikana Javascript-API:n setVisitCustomVariables()-funktiolla. Intranet Statistics raportoi, kuinka monta käyntiä, sivua ja konversiota jokaisella kustomoidulla muuttujalla oli.',
	...
	'Dashboard_PluginDescription' => 'Intranet Statisticsin työpöytä. Voit muokata työpöytääsi: lisätä uusia raportteja, poistaa raportteja ja muuttaa raporttien järjestystä. Jokainen käyttäjä voi käyttää omaa työpöytäänsä.',
	...
	'DBStats_MainDescription' => 'Intranet Statistics tallentaa kaikki tiedot MySQL-tietokantaan. Intranet Statisticsin taulut käyttävät %s.',
	'DBStats_LearnMore' => 'Jos haluat tietää enemmän Piwin tietojen käsittelystä ja Intranet Statisticsin optimoinnista isoille verkkosivuille, voit katsoa dokumentaation %s.',
	'DBStats_Table' => 'Taulu',
	...
	'ExampleUI_PluginDescription' => 'Esimerkkilisäosa: tämä lisäosa näyttää miten työskennellä Intranet Statisticsin käyttöliittymän kanssa: taulujen luonti, kuvaajat jne.',
	'Feedback_PluginDescription' => 'Lähetä palautetta Intranet Statisticsin tiimille. Jaa ideoita kanssamme!',
	...
	'Feedback_WhyWrongCountry' => 'Miksi Intranet Statistics näyttää käyntini väärästä maasta?',
	...
	'Feedback_SpecialRequest' => 'Onko sinulla erikoispyyntö Intranet Statisticsin tiimille?',
	'Feedback_ContactThePiwikTeam' => 'Ota yhteyttä Intranet Statisticsin tiimiin!',
	'Feedback_IWantTo' => 'Haluan:',
	'Feedback_CategoryShareStory' => 'Jakaa onnistumistarinan',
	'Feedback_CategorySponsor' => 'Sponsoroida Intranet Statisticsiä',
	'Feedback_CategoryHire' => 'Palkata Intranet Statistics-konsultin',
	...
	'Feedback_MessageSent' => 'Viestisi on lähetetty Intranet Statisticsin tiimille.',
	'Feedback_ThankYou' => 'Kiitos että autat parantamaan Intranet Statisticsiä!',
	'Feedback_ThePiwikTeam' => 'Intranet Statistics-tiimi',
	...
	'Goals_NoGoalsNeedAccess' => 'Vain ylläpitäjä voi lisätä tavoitteita tälle sivulle. Pyydä Intranet Statistics-sivusi ylläpitäjää luomaan tavoite sivulle.<br/>                        Tavoitteet ovat hyvä tapa ymmärtää ja maksimoida verkkosivujesi tehokkuus!',
	...
	'Goals_DefaultRevenueHelp' => 'Esimerkiksi lähetetyn "Ota yhteyttä"-lomakkeen arvo voi olla keskimäärin 10€. Intranet Statistics auttaa ymmärtämään, miten eri segmentit tuovat rahaa.',
	...
	'Installation_PluginDescription' => 'Intranet Statisticsin asennusprosessi. Tämä asennusprosessi suoritetaan yleensä vain kerran. Jos asetustiedosto config/config.inc.php löytyy, asennus aloitetaan uudelleen.',
	'Installation_Installation' => 'Asennus',
	'Installation_InstallationStatus' => 'Asennuksen tila',
	'Installation_PercentDone' => '%s %% valmiina',
	'Installation_NoConfigFound' => 'Intranet Statisticsin asetustiedostoa ei löydy ja yrität siirtyä Intranet Statisticsin sivuille.<br /><b>  » Voit <a href=\'index.php\'>asentaa Intranet Statisticsin nyt</a></b><br /><small>Jos asensit Intranet Statisticsin aikaisemmin ja tietokannassa on jo tietoja, älä murehdi, tietoja ei hävitetä.</small>',
	...
	'Installation_CongratulationsHelp' => '<p>Onnittelut! Intranet Statisticsin asennus on valmis.</p><p>Varmista, että javascript-koodi on lisätty sivuille ja odota ensimmäisiä vierailijoita!</p>',
	'Installation_ContinueToPiwik' => 'Jatka Intranet Statisticsiin',
	...
	'Installation_SecurityNewsletter' => 'lähetä sähköpostia Intranet Statisticsin suurista päivityksistä ja turvallisuushälytyksistä',
	...
	'Installation_Requirements' => 'Intranet Statisticsin vaatimukset',
	...
	'Installation_SystemCheckDatabaseHelp' => 'Intranet Statistics vaatii joko mysqli-lisäosan tai sekä PDO- että pdo_mysql-lisäosat..',
	...
	'Installation_SystemCheckParseIniFileHelp' => 'Tämä sisäänrakennettu toiminnallisuus on poistettu käytöstä palvelimellasi. Intranet Statistics yrittää emuloida tätä toiminnallisuutta, mutta saattaa törmätä muihin turvallisuusrajoituksiin. Myös suorituskyky laskee.',
	'Installation_SystemCheckGlobHelp' => 'Tämä sisäänrakennettu toiminnallisuus on poistettu käytöstä palvelimellasi. Intranet Statistics yrittää emuloida toimintoa, mutta saattaa törmätä uusiin turvallisuusrajoituksiin. Suorituskyky heikkenee.',
	'Installation_SystemCheckDebugBacktraceHelp' => 'View::factory ei voi luoda näkymää kutsuvalle moduulille.',
	'Installation_SystemCheckCreateFunctionHelp' => 'Intranet Statistics käyttää anonyymejä funktioita takaisinkutsuihin.',
	...
	'Installation_SystemCheckPackHelp' => 'pack()-funktiota tarvitaan käyttäjien seuraamiseen Intranet Statisticsillä.',
	...
	'Installation_SystemCheckAutoUpdateHelp' => 'Huomioi: Intranet Statisticsin yhden klikkauksen päivitys vaatii kirjoitusoikeudet Intranet Statisticsin kansioon ja kansion kaikkeen sisältöön.',
	'Installation_SystemCheckError' => 'Tapahtui virhe - täytyy korjata ennen jatkamista',
	'Installation_SystemCheckWarning' => 'Intranet Statistics toimii normaalisti, mutta osa ominaisuuksista puuttuu',
	...
	'Installation_TablesWithSameNamesFound' => 'Osalla %1$s tauluista tietokannassa %2$s on sama nimi kuin tauluilla, joita Intranet Statistics yrittää luoda.',
	...
	'Installation_GoBackAndDefinePrefix' => 'Siirry takaisin ja määritä alkuliite (prefix) Intranet Statisticsin tauluille',
	...
	'Installation_WelcomeHelp' => '<p>Intranet Statistics on vapaan lähdekoodin verkkosivujen analysointityökalu, joka tekee kävijöiden tietojen keräämisen ja analysoinnin helpoksi.</p><p>Tämä prosessi on jaettu %s helppoon osaan ja vie aikaa noin viisi minuuttia.</p>',
	'Installation_ConfigurationHelp' => 'Intranet Statisticsin asetustiedosto on luotu väärin. Voit joko poistaa tiedoston config/config.ini.php ja käyttää asennusohjelmaa uudelleen tai korjata tietokannan asetukset.',
	...
	'LanguagesManager_PluginDescription' => 'Tämä lisäosa listaa saatavilla olevat kielet Intranet Statisticsin käyttöliittymässä. Valittu kieli tallennetaan käyttäjäkohtaisesti.',
	'LanguagesManager_AboutPiwikTranslations' => 'Tietoja Intranet Statisticsin käännöksistä',
...
Kiitos Intranet Statisticsin käyttämisestä!',
	...
	'Login_ContactAdmin' => 'Mahdollisia syitä: palvelin ei välttämättä salli sähköpostien lähetystä (mail()-funktiota).<br/>Ota yhteyttä Intranet Statisticsin ylläpitäjään.',
	...
	'Mobile_HelpUsToImprovePiwikMobile' => 'Haluatko ottaa käyttöön anonyymin käytön seurannan Intranet Statistics Mobileen?',
	'Mobile_HttpIsNotSecureWarning' => 'Intranet Statisticsin autentikointiavain ("token_auth") lähetetään salaamattomana jos käytät http:tä. Suosittelemmen salatun https:n käyttöä. Haluatko jatkaa?',
	...
	'Mobile_RatingPleaseRateUs' => 'Intranet Statisticsin mobiilisovellus on vapaa ohjelma. Arvostaisimme todella, jos voisit käyttää hetken ohjelman arvosteluun %s:ssä. Jos sinulla on parannusehdotuksia tai virheraportteja, ota yhteyttä %s',
	...
	'Mobile_AccessUrlLabel' => 'Intranet Statisticsin osoite',
	...
	'Mobile_NoPiwikAccount' => 'Ei Intranet Statistics-tiliä?',
	...
	'MultiSites_PluginDescription' => 'Näytä monen sivun yleiskatsaus/tilastot. Tällä hetkellä ylläpidetään Intranet Statisticsin ydinmoduulina.',
	...
	'Provider_ProviderReportDocumentation' => 'Tämä raportti näyttää, mitä internetin toimittajia kävijäsi käyttivät sivuillasi. Saat lisätietoja klikkaamalla toimittajan nimeä. %s Jos Intranet Statistics ei tunnista toimittajan nimeä, kävijästä näytetään IP.',
	...
	'SitesManager_PluginDescription' => 'Verkkosivujen hallinta Intranet Statisticsissä: lisää uusi sivu, muokkaa sivua, näytä sivuille lisättävä Javascript. Kaikkia toimintoja voi käyttää myös API:lla.',
	...
	'SitesManager_PiwikWillAutomaticallyExcludeCommonSessionParameters' => 'Intranet Statistics jättää automaattisesti huomiotta yleiset istuntoparametrit (%s).',
	...
	'SitesManager_PiwikOffersEcommerceAnalytics' => 'Intranet Statisticsillä voi seurata verkkokauppaa tarkasti. Lue lisää %s verkkokauppa-analytiikasta%s.',
	'TranslationsAdmin_PluginDescription' => 'Auttaa kääntämään Intranet Statisticsin kielellesi.',
	...
	'UserCountry_GeolocationPageDesc' => 'Tällä sivulla voit säätää, miten Intranet Statistics päättelee kävijöiden sijainnin, ja tarkastella eri toteutusten asetuksia.',
	...
	'UsersManager_PluginDescription' => 'Käyttäjien hallinta Intranet Statisticsissä: lisää uusi käyttäjä, muokkaa käyttäjiä, päivitä oikeuksia. Kaikkia toimintoja voi käyttää myös API:sta.',
	...
	'UsersManager_ThereAreCurrentlyNRegisteredUsers' => 'Intranet Statisticsissä on nyt %s rekisteröitynyttä käyttäjää.',
	...
	'UsersManager_YourVisitsAreIgnoredOnDomain' => '%sIntranet Statistics ei seuraa käyntejäsi sivulla %s %s (Intranet Statisticsin cookie löytyi selaimestasi).',
	'UsersManager_YourVisitsAreNotIgnored' => '%sIntranet Statistics seuraa käyntejäsi%s (Intranet Statisticsin cookieta ei löytynyt selaimestasi).',
	...
	'UsersManager_WhenUsersAreNotLoggedInAndVisitPiwikTheyShouldAccess' => 'Kun käyttäjä ei ole kirjautunut sisään ja käy Intranet Statisticsissä, heillä on pääsy',
	...
	'UsersManager_ExceptionEditAnonymous' => 'Anonyymikäyttäjää ei voi muokata tai poistaa. Se on Intranet Statisticsin sisäinen tunnus käyttäjälle, joka ei ole kirjautunut sisään. Voit esimerkiksi julkaista tilastoja kaikille sallimalla anonyymikäyttäjälle katsomisoikeuden.',
	'UsersManager_ExceptionSuperUser' => 'Pyydetty käyttäjä on pääkäyttäjä. Pääkäyttäjää ei voi muokata tai poistaa API:n kautta. Voit manuaalisesti muokata pääkäyttäjää Intranet Statisticsin asetustiedostosta.',
	...
	'VisitorGenerator_PluginDescription' => 'Lisäosa valheellisten käyntien luomiseen. Tätä voi käyttää helppona tapana luoda Intranet Statisticsiin valheellisia tietoja testaamista varten.',
	'VisitorGenerator_VisitorGenerator' => 'Kävijöiden luonti',
	'VisitorGenerator_Warning' => 'Olet luomassa valheellisia',
	'VisitorGenerator_NotReversible' => 'Näitä käyntejä %sei voi%s helposti poistaa Intranet Statisticsin logeista.',
	...
	'Widgetize_PluginDescription' => 'Tällä lisäosalla voit helposti näyttää minkä tahansa Intranet Statisticsin raportin blogissa, verkkosivulla, iGooglessa tai Netvibesissä!',
	'Widgetize_TopLinkTooltip' => 'Vie Intranet Statisticsin raportteja vimpaimiksi ja lisää työpöytä ohjelmaan iframena.',
	...
	'PDFReports_PiwikReports' => 'Intranet Statisticsin raportit',
	...
	'PDFReports_TopLinkTooltip' => 'Voit luoda sähköpostiraportin, jotta saat Intranet Statisticsin tilastot suoraan sähköpostiin automaattisesti.',
	'ImageGraph_PluginDescription' => 'Luo upeita staattisia PNG-kuvaajia mistä tahansa Intranet Statisticsin raportista.',
