...
$translations = array(
	...
	'General_BackToHomepage' => 'Zurück zur Intranet Statistics Homepage',
	'General_Yes' => 'Ja',
	'General_No' => 'Nein',
	...
	'General_AllowPiwikArchivingToTriggerBrowser' => 'Intranet Statistics erlauben, die Archivierung zu starten, wenn Berichte im Browser angezeigt werden.',
	...
	'General_ArchivingTriggerDescription' => 'Für größere Intranet Statistics-Installationen sollten sie %seinen Cronjob erstellen%s, der die Berichte automatisch abarbeitet.',
	...
	'General_RequiresFlash' => 'Die Darstellung von Graphen in Intranet Statistics erfordert Flash.',
	'General_GraphHelp' => 'Mehr Informationen über die Darstellung von Graphen in Intranet Statistics.',
	...
	'General_PiwikIsACollaborativeProjectYouCanContributeAndDonate' => '%1$s Intranet Statistics %2$s ist ein kollaborirendes Projekt. %3$s Wenn Sie von Intranet Statistics begeistert sind können Sie helfen: Finden Sie heraus %4$s wie Sie Intranet Statistics%5$s unterstützen können, oder%6$s %7$sspenden Sie jetzt%8$s um Intranet Statistics 2.0 zu unterstützten!',
	'General_YouAreViewingDemoShortMessage' => 'Sie sehen gerade die Demo von Intranet Statistics',
	'General_YouAreCurrentlyUsing' => 'Sie nutzen Intranet Statistics %s.',
	'General_DownloadFullVersion' => '%1$sLaden%2$s Sie jetzt die Vollversion! Siehe %3$s',
	'General_NewUpdatePiwikX' => 'Neue Version: Intranet Statistics %s',
	'General_AboutPiwikX' => 'Über Intranet Statistics %s',
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Intranet Statistics %1$s ist verfügbar. %2$s Bitte aktualisieren Sie jetzt!%3$s (siehe %4$s Änderungen%5$s).',
	...
	'General_BackToPiwik' => 'Zurück zu Intranet Statistics',
	...
	'General_ConfigFileIsNotWritable' => 'Die Intranet Statistics-Konfigurationsdatei %s ist nicht schreibbar, Ihre Änderungen werden nicht gespeichert. %s Bitte ändern Sie die Zugriffsrechte der Konfigurationsdatei, um diese schreibbar zu machen.',
	'General_StatisticsAreNotRecorded' => 'Das Besuchertracking von Intranet Statistics ist derzeit deaktiviert! Reaktivieren Sie das Tracking indem Sie in der Datei config/config.ini.php record_statistics = 1 setzen.',
	'General_ExceptionDatabaseVersion' => 'Ihre %1$s-Version ist %2$s, aber Intranet Statistics benötigt mindestens %3$s',
	...
	'General_PleaseUpdatePiwik' => 'Bitte Intranet Statistics aktualisieren',
	...
	'Actions_DownloadsReportDocumentation' => 'In diesem Report sehen Sie, welche Dateien Ihre Besucher heruntergeladen haben. %s Als Download wird in Intranet Statistics der Klick auf einen Downloadlink gewertet. Ob der Download abgeschlossen wurde oder nicht, ist Intranet Statistics nicht bekannt.',
	...
	'API_GenerateVisits' => 'Sollten für heute keine Daten verfügbar sein, so können Sie mit dem %s Plugin Testdaten erzeugen. Aktivieren Sie das %s Plugin und klicken dann auf das \'Besuchergenerator\' Menu in der Intranet Statistics-Administration.',
	'API_MoreInformation' => 'Für weitere Informationen über die Intranet Statistics-APIs lesen Sie bitte %s Einführung in die Intranet Statistics-API %s und die %s Intranet Statistics API Referenz %s.',
	...
	'CoreAdminHome_OptOutForYourVisitors' => 'Intranet Statistics-Deaktivierung für Ihre Besucher',
	'CoreAdminHome_OptOutExplanation' => 'Intranet Statistics ist es wichtig, die Privatsphäre Ihrer Besucher zu wahren. Fügen Sie den folgenden HTML-Code auf einer Seite Ihrer Seiten (z.B der Datenschutz-Seite) ein, um den Besuchern Ihrer Webseite die Möglichkeit zu geben, sich gegen eine Erfassung ihres Besuches durch Intranet Statistics zu entscheiden.',
	'CoreAdminHome_OptOutExplanationBis' => 'Dieser Code wird innerhalb eines Iframes angezeigt und enthält einen Link, über den ein Cookie im Browser Ihrer Besucher abgelegt wird, womit die Erfassung durch Intranet Statistics deaktiviert wird. %s Klicken Sie hier%s, um eine Vorschau auf den Text zu bekommen, der den Besuchern in dem Iframe angezeigt wird.',
	...
	'CoreAdminHome_OptOutCompleteBis' => 'Bitte beachten Sie, dass auch der Intranet Statistics-Deaktivierungs-Cookie dieser Webseite gelöscht wird, wenn Sie die in Ihrem Browser abgelegten Cookies entfernen. Außerdem müssen Sie, wenn Sie einen anderen Computer oder einen anderen Webbrowser verwenden, die Deaktivierungsprozedur nochmals absolvieren.',
	...
	'CoreAdminHome_YouMayOptOutBis' => 'Wenn Sie sich dagegen entscheiden möchten, klicken Sie den folgenden Link, um den Intranet Statistics-Deaktivierungs-Cookie in Ihrem Browser abzulegen.',
	'CoreAdminHome_YouAreOptedIn' => 'Ihr Besuch dieser Webseite wird aktuell von der Intranet Statistics Webanalyse erfasst.',
	'CoreAdminHome_YouAreOptedOut' => 'Ihr Besuch dieser Webseite wird aktuell von der Intranet Statistics Webanalyse nicht erfasst.',
	...
	'CoreAdminHome_CustomLogoHelpText' => 'Hier kann das Intranet Statistics-Logo angepasst werden, das in der Benutzetroberfläche sowie in E-Mail-Berichten verwendet wird.',
	'CoreAdminHome_CustomLogoFeedbackInfo' => 'Wenn Sie das Intranet Statistics-Logo anpassen, ist sicher auch das Verstecken des %s-Links in der Navigation von Interesse. Bitte dazu das Feedback Plugin auf der %sManage Plugins%s Seite deaktivieren.',
	...
	'CoreAdminHome_LogoNotWriteable' => 'Um ein eigenes Logo in Intranet Statistics verwenden zu können, wird Schreibzugriff auf die Logo Dateien im themes Ordner benötigt: %s',
	'CoreAdminHome_TrustedHostSettings' => 'Vertrauter Intranet Statistics Hostname',
	'CoreAdminHome_TrustedHostConfirm' => 'Wollen Sie wirklich den Vertrauten Intranet Statistics Hostnamen ändern?',
	'CoreAdminHome_PiwikIsInstalledAt' => 'Intranet Statistics ist installiert unter',
	'CoreAdminHome_ValidPiwikHostname' => 'Gültiger Intranet Statistics Hostname',
	...
	'CoreAdminHome_JSTrackingIntro2' => 'Sobald Sie den JavaScript Tracking Code für Ihre Website haben, fügen Sie ihn auf allen Seiten ein, die Sie mit Intranet Statistics überwachen möchten.',
	...
	'CoreAdminHome_JSTracking_CustomCampaignQueryParamDesc' => 'Hinweis: %1$sIntranet Statistics erkennt Parameter von Google Analytics automatisch.%2$s',
	...
	'CoreHome_InjectedHostWarningIntro' => 'Sie betreten Intranet Statistics aktuell von %1$s, allerdings wurde Intranet Statistics so konfiguriert, dass es unter dieser Adresse läuft: %2$s.',
	'CoreHome_InjectedHostSuperUserWarning' => 'Intranet Statistics könnte falsch konfiguriert sein (zum Beispiel wenn Sie Intranet Statistics vor kurzem auf einen neuen Server umgezogen haben). Sie können entweder %1$shier klicken und %2$s als gültigen Hostnamen (wenn Sei ihm vertrauen) hinzufügen%3$s, oder %4$shier klicken um Intranet Statistics unter %5$s sicher zu betreten%6$s',
	'CoreHome_InjectedHostNonSuperUserWarning' => '%1$sHier klicken um Intranet Statistics sicher zu betreten%2$s und die Warnung zu entfernen. Zusätzlich können Sie den Intranet Statistics Administrator kontaktieren und ihn auf dieses Problem hinzuweisen (%3$sHier klicken um eine E-Mail zu senden%4$s).',
	'CoreHome_InjectedHostEmailSubject' => 'Intranet Statistics wurde mit einem unbekannten Hostnamen aufgerufen: %s',
	'CoreHome_InjectedHostEmailBody' => 'Hallo, ich habe gerade versucht Intranet Statistics aufzurufen und erhielt eine Warnung, dass der Hostname unbekannt ist.',
	'CoreHome_CheckForUpdates' => 'Nach Aktualisierungen suchen',
	'CoreHome_YouAreUsingTheLatestVersion_js' => 'Sie verwenden die aktuellste Version  von Intranet Statistics!',
	'CoreHome_MakeADifference' => 'Machen Sie den Unterschied: %1$sSpenden Sie jetzt%2$s und Unterstützen Sie so Intranet Statistics 2.0!',
	'CoreHome_DonateCall1' => 'Die Nutzung von Intranet Statistics wird immer kostenlos bleiben, was aber nicht heißt, dass es uns nichts kostet es zu erstellen.',
	'CoreHome_DonateCall2' => 'Intranet Statistics braucht Ihre dauerhafte Unterstützung um zu wachsen und zu gedeihen.',
	'CoreHome_DonateCall3' => 'Finden Sie, dass Intranet Statistics einen deutlichen Mehrwert für Sie oder ihr Unternehmen hat? %1$sBitte spenden Sie!%2$s',
	'CoreHome_HowMuchIsPiwikWorth' => 'Wieviel ist Intranet Statistics Ihnen wert?',
	'CoreHome_SupportPiwik' => 'Unterstützen Sie Intranet Statistics!',
	...
	'CoreHome_SubscribeAndBecomePiwikSupporter' => 'Weiter zur sicheren Seite für Kreditkartenzahlung (Paypal) um ein Unterstützer von Intranet Statistics zu werden.',
	'CoreHome_CheckPiwikOut' => 'Sieh dir Intranet Statistics an!',
	...
	'CoreHome_ViewAllPiwikVideoTutorials' => 'Zeige alle Intranet Statistics Video Tutorials an',
	'CoreHome_SharePiwikShort' => 'Intranet Statistics! Kostenlose und Open Source Web Analyse. Behalten Sie Ihre Daten.',
	'CoreHome_SharePiwikLong' => 'Hi! Ich habe gerade diese großartige Open Soruce Software gefunden: Intranet Statistics! Intranet Statistics ermöglicht es Besucher einer Webseite zu tracken und ist kostenlos. Du solltest es dir unbedingt einmal ansehen!',
	'PrivacyManager_TeaserHeadline' => 'Privatsphäreeinstellungen',
	'PrivacyManager_Teaser' => 'Auf dieser Seite können Sie Intranet Statistics so anpassen, dass es die bei Ihnen herrschenden Datenschutzbestimmungen einhält. Sie können %sBenutzer-IPs anonymisieren%s, %sautomatisch alte Logs aus der Datenbank löschen%s und %seinen Opt-out Mechanismus auf Ihrer Webseite anbieten%s.',
	'PrivacyManager_MenuPrivacySettings' => 'Privatsphäre',
	'PrivacyManager_PluginDescription' => 'Erlaubt die Anpassung von Intranet Statistics, um es den jeweiligen Datenschutz-Bestimmungen des Landes anzupassen.',
	'PrivacyManager_UseAnonymizeIp' => 'Anonymisiere die IP-Adresse von Besuchern',
	'PrivacyManager_AnonymizeIpDescription' => 'Wählen Sie "Ja", wenn Intranet Statistics nicht die komplette IP-Adresse speichern soll.',
	...
	'PrivacyManager_DeleteDataDescription' => 'Sie können Intranet Statistics so konfigurieren, dass regelmäßig alte Besucher-Logs und/oder generierte Berichte gelöscht werden, um die Größe der Datenbank klein zu halten.',
	...
	'PrivacyManager_DoNotTrack_EnabledMoreInfo' => 'Wenn Benutzer in ihrem Browser "Ich möchte nicht getrackt werden" eingestellt haben (Do-not-Track aktiviert), dann wird Intranet Statistics diese Besuche nicht tracken.',
	'PrivacyManager_DoNotTrack_Disabled' => 'Intranet Statistics verfolgt derzeit das Verhalten aller Besucher, auch derjenigen, die explizit in ihrem Browser "Ich möchte nicht getrackt werden" eingestellt haben.',
	...
	'CoreHome_NoPrivilegesAskPiwikAdmin' => 'Sie sind eingeloggt als \'%s\', aber es wurden keine Berechtigungen für diesen Benutzer in Intranet Statistics gesetzt. %s Bitte fragen Sie Ihren Intranet Statistics Administrator (klicken für E-Mail)%s um Zugriff auf die Webseite zu erhalten.',
	'CoreHome_JavascriptDisabled' => 'JavaScript muss aktiviert sein, um die Standardansicht von Intranet Statistics zu benutzen.<br/>Es scheint jedoch so, als wäre JavaScript bei Ihnen deaktiviert bzw. würde nicht von Ihrem Browser unterstützt.<br />Um die Standardansicht zu benutzen, aktivieren Sie JavaScript in Ihren Browseroptionen und %1$sversuchen Sie es erneut%2$s.<br />',
	...
	'CorePluginsAdmin_MainDescription' => 'Plugins erweitern die Funktionalität von Intranet Statistics. Wenn ein Plugin installiert wurde, können Sie es hier aktivieren oder deaktivieren.',
	...
	'CoreUpdater_PluginDescription' => 'Intranet Statistics-Aktualisierung',
	'CoreUpdater_UpdateTitle' => 'Aktualisierung',
	'CoreUpdater_DatabaseUpgradeRequired' => 'Die Datenbank muss aktualisiert werden',
	'CoreUpdater_YourDatabaseIsOutOfDate' => 'Ihre Intranet Statistics-Datenbank ist nicht mehr aktuell und muss aktualisiert werden, bevor Sie weiter arbeiten können.',
	'CoreUpdater_PiwikWillBeUpgradedFromVersionXToVersionY' => 'Die Intranet Statistics-Datenbank wird von Version %1$s auf die neue Version %2$s aktualisiert.',
	'CoreUpdater_TheFollowingPluginsWillBeUpgradedX' => 'Die folgenden Plugins werden aktualisiert: %s',
	'CoreUpdater_NoteForLargePiwikInstances' => 'Wichtiger Hinweis für große Intranet Statistics-Installationen',
	'CoreUpdater_TheUpgradeProcessMayFailExecuteCommand' => 'Wenn Sie eine große Intranet Statistics-Datenbank haben, können Aktualisierungen zu lange dauern, um erfolgreich im Browser durchgeführt zu werden. In diesem Fall können Sie die Aktualisierung auch von der Kommandozeile aus starten: %s',
	'CoreUpdater_YouCouldManuallyExecuteSqlQueries' => 'Wenn Sie die Aktualisierung nicht von der Kommandozeile aus ausführen können und auch Intranet Statistics die Aktualisierung nicht durchführen kann (wegen Zeitüberschreitungen der Datenbank, des Browser oder sonstigen Fällen), können Sie auch die SQL-Befehle manuell ausführen, um Intranet Statistics zu aktualisieren.',
	...
	'CoreUpdater_UpgradePiwik' => 'Intranet Statistics aktualisieren',
	...
	'CoreUpdater_ErrorDIYHelp_5' => 'berichten Sie den Fehler (und die Lösung), um Intranet Statistics zu verbessern',
	'CoreUpdater_HelpMessageContent' => 'Lesen Sie die %1$sIntranet Statistics-FAQ%2$s. Dort werden die meisten Fehler, die während eines Updates auftreten können, erklärt. %3$sFragen Sie Ihren Systemadministrator - dieser kann Ihnen mit diesem Fehler helfen, da er am wahrscheinlichsten mit Ihrem Server oder dem MySQL-Server zusammenhängt.',
	...
	'CoreUpdater_PiwikHasBeenSuccessfullyUpgraded' => 'Intranet Statistics wurde erfolgreich aktualisiert!',
	'CoreUpdater_ContinueToPiwik' => 'Weiter zu Intranet Statistics',
	'CoreUpdater_UpdateAutomatically' => 'Aktualisierung automatisch ausführen',
	'CoreUpdater_ThereIsNewVersionAvailableForUpdate' => 'Eine neue Version von Intranet Statistics ist verfügbar',
	...
	'CoreUpdater_YouMustDownloadPackageOrFixPermissions' => 'Intranet Statistics kann Ihre aktuelle Installation nicht überschreiben. Sie müssen entweder die Ordner-/Dateiberechtigungen anpassen oder das Paket herunterladen und die Version %s manuell installieren.',
	'CoreUpdater_DownloadX' => '%s herunterladen',
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'Die Intranet Statistics Ein-Klick-Aktualisierung wurde abgebrochen. Wenn die oben stehende Fehlermeldung nicht behoben werden kann, sollten Sie Intranet Statistics manuell aktualisieren. %1$s Bitte lesen Sie die %2$sDokumentation zur Aktualisierung%3$s, um die Einzelheiten zu erfahren!',
	...
	'CoreUpdater_PiwikUpdatedSuccessfully' => 'Intranet Statistics wurde erfolgreich aktualisiert!',
	...
	'CustomVariables_PluginDescription' => 'Benutzerdefinierte Variablen sind Namen-Werte-Paare, die Sie über die setVisitCustomVariables() Funktion der Javascript-API setzen können. Intranet Statistics wird dann für jeden dieser Namen und Werte die Anzahl der Besuche, die Seiten sowie die Konversionen erfassen.',
	...
	'CustomVariables_TrackingHelp' => 'Hilfe:  %1$sBenutzerdefinierte Variablen in Intranet Statistics tracken%2$s',
	...
	'DBStats_PluginDescription' => 'Dieses Plugin berichtet über die Nutzung und Auslastung der Intranet Statistics-Tabellen in der MySQL Datenbank.',
	'DBStats_DatabaseUsage' => 'Datenbanknutzung',
	'DBStats_MainDescription' => 'Intranet Statistics speichert sämtliche Webanalyse-Daten in der MySQL-Datenbank. Aktuell belegter Speicherplatz %s.',
	'DBStats_LearnMore' => 'Um mehr darüber zu erfahren, wie Intranet Statistics Daten verarbeitet und wie Sie Intranet Statistics auf stark besuchten Webseiten einsetzen können, lesen Sie die Dokumentation unter %s.',
	...
	'ExampleUI_PluginDescription' => 'Beispielplugin: Dieses Plugin zeigt, wie man mit der Intranet Statistics-Oberfläche arbeitet: Erstellung von Tabellen, Graphen, etc.',
	'Feedback_PluginDescription' => 'Senden Sie Ihr Feedback an das Intranet Statistics-Team. Teilen Sie uns Ihre Ideen, Anforderungen und Wünsche mit!',
	...
	'Feedback_WhyWrongCountry' => 'Warum zeichnet Intranet Statistics meine Besuche als Zugriffe aus einem fremden Land auf?',
	...
	'Feedback_ContactThePiwikTeam' => 'Kontaktieren Sie das Intranet Statistics Team!',
	'Feedback_IWantTo' => 'Ich möchte:',
	'Feedback_CategoryShareStory' => 'Teilen Sie uns Ihre Erfolgsgeschichte mit',
	'Feedback_CategorySponsor' => 'Fördern Sie Intranet Statistics',
	'Feedback_CategoryHire' => 'Fragen Sie einen Intranet Statistics-Berater',
	...
	'Feedback_MessageSent' => 'Ihre Nachricht wurde an das Intranet Statistics-Team übermittelt.',
	'Feedback_ThankYou' => 'Danke für Ihre Unterstützung, um Intranet Statistics zu verbessern!',
	'Feedback_ThePiwikTeam' => 'Das Intranet Statistics-Team',
	...
	'Feedback_WantToThankConsiderDonating' => 'Finden Sie Intranet Statistics genial und möchten uns danken? Dann spenden Sie!',
	'Goals_Goals' => 'Ziele',
	...
	'Goals_DefaultRevenueHelp' => 'Das Absenden eines Kontaktformulars durch einen Besucher kann zum Beispiel durchschnittlich 10 € wert sein. Intranet Statistics hilft Ihnen, zu verstehen, wie sich Ihre Besucher-Segmente verhalten.',
	...
	'Goals_LearnMoreAboutGoalTrackingDocumentation' => 'Mehr zum Thema %s Erfassen von Zielen in Intranet Statistics%s erfahren Sie in der Dokumentation.',
	...
	'Installation_NoConfigFound' => 'Die Intranet Statistics-Konfigurationsdatei konnte nicht gefunden werden und es wird versucht, eine Intranet Statistics-Seite aufzurufen.<br /><b>  » Sie können <a href=\'index.php\'>Intranet Statistics jetzt installieren</a></b><br /><small>Wenn Sie Intranet Statistics zuvor schon installiert haben und noch Tabellen in der Datenbank vorhanden sind: Keine Angst, Sie können diese Tabellen und die enthaltenen Daten weiterhin verwenden!</small>',
	...
	'Installation_LargePiwikInstances' => 'Hilfe für große Intranet Statistics-Installationen',
	'Installation_JsTag' => 'Javascript-Tracking-Code',
	'Installation_Congratulations' => 'Glückwunsch',
	'Installation_CongratulationsHelp' => '<p>Glückwunsch! Intranet Statistics ist nun installiert.</p><p>Stellen Sie sicher, dass der Javascript-Code auf Ihrer Website eingefügt wurde und warten Sie auf die ersten Besucher.</p>',
	'Installation_ContinueToPiwik' => 'Weiter zu Intranet Statistics',
	'Installation_SiteSetup' => 'Konfiguriere deine erste Webseite, welche über Intranet Statistics getrackt und analyisert werden soll:',
	...
	'Installation_SiteSetupFootnote' => 'Hinweis: Nachdem die Installation von Intranet Statistics fertiggestellt wurde ist es möglich weitere Webseiten hinzuzufügen!',
	...
	'Installation_SecurityNewsletter' => 'Senden Sie mir per E-Mail Informationen zu wichtigen Intranet Statistics-Aktualisierungen sowie Sicherheitswarnungen',
	...
	'Installation_Requirements' => 'Anforderungen für die Intranet Statistics-Installation',
	...
	'Installation_SystemCheckDatabaseHelp' => 'Intranet Statistics erfordert entweder die mysqli Erweiterung oder die PDO und pdo_mysql Erweiterung.',
	...
	'Installation_SystemCheckParseIniFileHelp' => 'Diese Funktion wird von Ihrem System nicht unterstützt. Intranet Statistics wird versuchen, diese Funktion zu emulieren, aber es könnte sein, dass dadurch Sicherheitseinstellungen gelockert werden müssen. Die Geschwindigkeit des Tracker könnte auch beeinflußt werden.',
	'Installation_SystemCheckGlobHelp' => 'Diese eingebaute Funktion ist auf ihrem System deaktiviert. Intranet Statistics wird versuchen, diese Funktion zu emulieren, aber dabei möglicherweise auf weitere Sicherheitseinschränkungen stoßen. Die Funktionalität kann beeinträchtigt werden.',
	'Installation_SystemCheckDebugBacktraceHelp' => 'View::factory wird nicht in der Lage sein, die Module für die Anzeige zu laden.',
	'Installation_SystemCheckCreateFunctionHelp' => 'Intranet Statistics verwendet anonyme Funktionen für Rückfragen.',
	...
	'Installation_SystemCheckPackHelp' => 'Die Funktion pack() wird benötigt um Besucher in Intranet Statistics tracken zu können.',
	...
	'Installation_SystemCheckAutoUpdateHelp' => 'Hinweis: Intranet Statistics\'s Ein-Klick-Aktualisierung benötigt Schreibrechte für den Intranet Statistics-Ordner und dessen Inhalt.',
	'Installation_SystemCheckError' => 'Ein Fehler ist aufgetreten - dieser muss behoben werden, bevor Sie weiter machen können.',
	'Installation_SystemCheckWarning' => 'Intranet Statistics wird funktionieren, aber einige Funktionen werden fehlen',
	...
	'Installation_TablesWithSameNamesFound' => 'Einige %1$s Tabellen in Ihrer %2$s Datenbank haben dieselben Namen wie die Tabellen, die Intranet Statistics versucht zu erstellen',
	...
	'Installation_TablesDeletedSuccess' => 'Vorhandene Intranet Statisticstabellen wurden erfolgreich entfernt',
	...
	'Installation_GoBackAndDefinePrefix' => 'Zurückgehen und einen Präfix für die Intranet Statistics-Tabellen definieren',
	...
	'Installation_WelcomeHelp' => '<p>Intranet Statistics ist eine freiverfügbare Webanalyse-Software, um einfach Informationen über die Besucher Ihrer Webseite zu erhalten.</p><p>Der Prozess teilt sich in %s einfache Schritte und wird rund 5 Minuten dauern.</p>',
	...
	'Installation_SystemCheckSummaryThereWereWarnings' => 'Es gibt einige Ungereimtheiten mit Ihrem System. Intranet Statistics wird funktionieren, aber es könnten geringfügige Probleme auftauchen.',
	'Installation_SystemCheckSummaryNoProblems' => 'Gratulation! Es gibt keine Probleme mit Ihrer Intranet Statistics Installation. Sie können sich selbst auf die Schulter klopfen.',
	...
	'Installation_LoadDataInfileUnavailableHelp' => 'Die Benutzung von %1$s erhöht die Geschwindigkeit des Intranet Statistics Archivierungsprozesses erheblich. Um dies für Intranet Statistics verfügbar zu machen setzen Sie bitte eine neuere PHP & MySQL Software ein und stellen Sie sicher, dass der gewählte Datenbankbenutzer das %2$s Recht besitzt.',
	'Installation_LoadDataInfileRecommended' => 'Falls Ihr Intranet Statistics Server Webseiten mit erhöhtem Verkehrsaufkommen (z.B.: > 100.000 Seiten pro Monat) verarbeiten muss empfehlen wir dieses Problem zu beheben.',
	'Installation_Filesystem' => 'Dateisystem',
	'Installation_NfsFilesystemWarning' => 'Ihr Server nutzt ein NFS Dateisystem',
	'Installation_NfsFilesystemWarningSuffixAdmin' => 'Dies bedeutet, dass Intranet Statistics extrem langsam arbeitet wenn Dateibasierte Sessions genutzt werden.',
	...
	'LanguagesManager_PluginDescription' => 'Dieses Plugin zeigt eine Liste aller verfügbaren Sprachen für die Intranet Statistics-Oberfläche. Die ausgewählte Sprache wird in den Benutzereinstellungen jedes Benutzers gespeichert.',
	'LanguagesManager_AboutPiwikTranslations' => 'Über Intranet Statistics Übersetzungen',
	...
	'Login_InvalidNonceOrHeadersOrReferer' => 'Sicherheitschecks fehlgeschlagen. Bitte laden Sie das Formular erneut und prüfen Sie, ob Ihr Browser Cookies zulässt. Wenn Sie einen Proxy Server verwenden, müssen Sie %sIntranet Statistics so einrichten, dass es Proxy Header akzeptiert%s.',
	...
	'Login_MailPasswordChangeBody' => 'Hallo %1$s, eine Passwortänderung von %2$s wurde eingeleitet. Um das neue Passwort zu bestätigen besuche folgenden Link: %3$s Hinweis: Der Link ist nur 24 Stunden gültig. Vielen Dank, dass du Intranet Statistics verwendest!',
	...
	'Login_ContactAdmin' => 'Möglicher Grund: Der Server könnte die mail()-Funktion deaktiviert haben.<br/>Bitte sprechen Sie mit Ihrem Intranet Statistics-Administrator.',
	...
	'Mobile_AddPiwikDemo' => 'Intranet Statistics Demo hinzufügen',
	'Mobile_AnonymousTracking' => 'Anonymes aufzeichnen',
	'Mobile_AskForAnonymousTrackingPermission' => 'Falls aktiviert sendet Intranet Statistics Mobile anonyme Nutzungsdaten an piwik.org. Die Sammlung dieser Daten hilft den Intranet Statistics Mobile Entwicklern besser zu verstehen wie diese Applikation genutzt wird. Folgende Informationen werden gesendet: Menüs und Einstellungen, Betriebssystemname und Version und angezeigte Fehler in Intranet Statistics Mobile. Es werden KEINE Analytischen Daten aufgezeichnet. Die Anonymen Daten werden niemals der Öffentlichkeit zugänglich gemacht. Anonyme Nutzungsdatenerfassung kann jederzeit in den Einstellungen wieder aktiviert bzw. deaktiviert werden.',
	...
	'Mobile_HelpUsToImprovePiwikMobile' => 'Anonyme Nutzungsdaten in Intranet Statistics Mobile aktivieren?',
	'Mobile_HttpIsNotSecureWarning' => 'Bei der Verwendung von HTTP wird ihr Intranet Statistics Authorisierungstoken (token_auth) im Klartext übertragen. Aus diesem Grund empfehlen wir HTTPS für eine sichere Übertragung von Daten über das Internet. Möchten Sie forfahren?',
	...
	'Mobile_RatingPleaseRateUs' => 'Intranet Statistics Mobile App ist Freie Software, wir würden es sehr zu schätzen wissen, wenn Sie 1 Minute Ihrer wertvollen Zeit opfern würden um diese App im %s zu bewerten. Falls Sie Vorschläge für neue Features haben oder Fehler melden möchten, bitte kontaktieren Sie %s',
	...
	'Mobile_AccessUrlLabel' => 'URL zur Intranet Statistics-Installation',
	...
	'Mobile_NoPiwikAccount' => 'Kein Intranet Statistics Account?',
	'Mobile_NoVisitorFound' => 'Kein Besucher gefunden',
	'Mobile_NoWebsiteFound' => 'Webseite nicht gefunden',
	'Mobile_SaveSuccessError' => 'Intranet Statistics URL oder Benutzername-/Passwort-Kombination ist falsch.',
	...
	'MobileMessaging_VerificationText' => 'Der Code lautet %s. Um Ihre Telefonnummer zu validieren und Intranet Statistics SMS Berichte zu erhalten kopieren Sie bitte diesen Code in das Formular unter Intranet Statistics > %s > %s.',
	...
	'MobileMessaging_Settings_CredentialNotProvidedByAdmin' => 'Bevor Sie Telefonnummern anlegen und verwalten können, bitten Sie Ihren Administrator datum Intranet Statistics mit einem SMS-Account zu verknüpfen.',
	'MobileMessaging_Settings_CredentialNotProvided' => 'Bevor Sie Telefonnummern erstellen und verwalten können, verbinden Sie bitte Intranet Statistics mit Ihrem SMS Konto oberhalb.',
	...
	'MobileMessaging_MultiSites_Must_Be_Activated' => 'Um SMS-Berichte über ihre Website-Statistiken generieren zu können, aktivieren Sie das MultiSites-Plugin in Intranet Statistics.',
	'MultiSites_PluginDescription' => 'Zeigt eine Zusammenfassung über die Statistiken aller Webseiten. Wird derzeit als ein Intranet Statistics Core Plugin verwaltet',
	...
	'SitesManager_PluginDescription' => 'Webseitenverwaltung in Intranet Statistics: Eine neue Webseite hinzufügen, eine existierende Webseite editieren, den JavaScript-Code zum Einfügen in die Webseite anzeigen. Alle Aktionen sind auch über die API steuerbar.',
	...
	'SitesManager_GlobalListExcludedUserAgents_Desc' => 'Falls der übermittelte Browser Agent des Besuchers einen der angegebenen Zeichen enthält, wird der Besucher von Intranet Statistics ignoriert.',
	'SitesManager_GlobalExcludedUserAgentHelp1' => 'Geben Sie eine Liste aller Browser Agenten ein die von Intranet Statistics ignoriert werden sollen.',
	...
	'SitesManager_PiwikWillAutomaticallyExcludeCommonSessionParameters' => 'Intranet Statistics wird automatisch typische Session-Parameter ignorieren (%s).',
	'SitesManager_HelpExcludedIps' => 'Geben Sie eine Liste von IPs an (eine pro Zeile), die von Intranet Statistics beim Erfassen von Besuchen ignoriert werden sollen. Es können Wildcards wie z.B. %1$s oder %2$s genutzt werden.',
	...
	'SitesManager_PiwikOffersEcommerceAnalytics' => 'Mit Intranet Statistics können Sie Ihre Ecommerce Webseite tracken und erhalten spezielle Ecommerce Berichte. Weitere Informationen %sfinden Sie hier%s.',
	'SitesManager_TrackingSiteSearch' => 'Die interne Suche auswerten',
	'SitesManager_SiteSearchUse' => 'Intranet Statistics kann auswerten, wonach Besucher in der internen Suche der Websites suchen.',
	...
	'SitesManager_SearchCategoryDesc' => 'Intranet Statistics kann auch die Kategorie auswerten, die in der internen Suche gewählt wird.',
	...
	'TranslationsAdmin_PluginDescription' => 'Plugin, um Intranet Statistics in Ihrer Sprache zu übersetzen.',
	...
	'UserCountry_PiwikNotManagingGeoIPDBs' => 'Intranet Statistics verwaltet derzeit keine GeoIP Datenbanken.',
	...
	'UserCountry_GeolocationPageDesc' => 'Auf dieser Seite können Sie einstellen auf welche Weise Intranet Statistics die Herkunft eines Besuchers ermittelt.',
	...
	'UserCountry_TestIPLocatorFailed' => 'Intranet Statistics hat die Überprüfung einer bekannten IP-Adresse (%1$s) durchgeführt, aber Ihr Server hat %2$s zurückgegeben. Bei einer korrekten Konfiguration sollte allerdings %3$s zurückgegeben werden.',
	...
	'UserCountry_HowToSetupGeoIP_Step2' => 'Entpacken Sie die Datei und kopieren den Inhalt %1$s in das %2$smisc%3$s Intranet Statistics Unterverzeichnis (dies ist z.B.: mit FTP oder SSH möglich).',
	...
	'UserCountry_HowToSetupGeoIP_Step4' => 'Und fertig! Sie haben gerade Intranet Statistics konfiguriert GeoIP zu verwenden. Dies bedeutet, dass Sie nun in der Lage sind die Regionen und Städte zusammen mit einer sehr genauen Angabe der Länder ihrer Besucher zu sehen.',
	...
	'UserCountry_GeoIPServerVarsFound' => 'Intranet Statistics hat folgende GeoIP %s Variablen erkannt',
	...
	'UserCountry_FoundApacheModules' => 'Intranet Statistics hat folgende Apache-Module erkannt',
	'UserCountry_GeoIPNoServerVars' => 'Intranet Statistics konnte keine GeoIP %s Variablen finden.',
	...
	'UserCountry_GeoIPUpdaterIntro' => 'Intranet Statistics verwaltet derzeit die Updates für folgende GeoIP-Datenbanken',
	...
	'UserCountry_CannotSetupGeoIPAutoUpdating' => 'Ihre GeoIP Datenbanken scheinen außerhalb von Intranet Statistics gespeichert zu sein (es konnten keine Datenbanken innerhalb des \'misc\'-Unterordners gefunden werden, dennoch funktioniert die Standorterkennung). Intranet Statistics kann in diesem Fall keine automatischen Updates vornehmen.',
	...
	'UserCountry_FatalErrorDuringDownload_js' => 'Ein fataler Fehler trat während dem Herunterladen der Datei auf. Es könnte ein Fehler mit Ihrer Internet Verbindung, der GeoIP Datenbank die Sie herunterladen wollten oder Intranet Statistics vorliegen. Führen Sie den Download und die Installation der Datei manuell durch.',
	...
	'UsersManager_PluginDescription' => 'Benutzerverwaltung in Intranet Statistics: Einen neuen Benutzer hinzufügen, einen existierenden Benutzer bearbeiten, Berechtigungen ändern. Alle Aktionen sind auch über die API möglich.',
	...
	'UsersManager_MainDescription' => 'Hier kann Zugriff auf bestimmte Webseiten innerhalb von Intranet Statistics erteilt werden. Es ist auch möglich, Zugriff für alle Webseiten auf einmal zu erlauben.',
	...
	'UsersManager_YourVisitsAreIgnoredOnDomain' => '%sIhre Besuche auf %s werden von Intranet Statistics ignoriert %s (das Intranet Statistics-Cookie zum Ignorieren von Besuchen wurde in Ihrem Browser gefunden).',
	'UsersManager_YourVisitsAreNotIgnored' => '%sIhre Besuche werden von Intranet Statistics nicht ignoriert %s (das Intranet Statistics-Cookie zum Ignorieren von Besuchen wurde nicht in Ihrem Browser gefunden).',
	'UsersManager_ClickHereToDeleteTheCookie' => 'Klicken Sie hier, um das Cookie zu löschen und Ihre Besuche wieder zu zählen',
	'UsersManager_ClickHereToSetTheCookieOnDomain' => 'Klicken Sie hier, um ein Cookie zu setzen, damit Intranet Statistics Ihre Besuche auf %s ignoriert.',
	...
	'UsersManager_WhenUsersAreNotLoggedInAndVisitPiwikTheyShouldAccess' => 'Wenn Benutzer nicht eingeloggt sind und Intranet Statistics besuchen, sollten sie Zugriff haben auf',
	...
	'UsersManager_ExceptionEditAnonymous' => 'Der anonyme Benutzer kann nicht bearbeitet oder gelöscht werden. Er wird von Intranet Statistics benutzt, um einen Benutzer zu definieren, der sich noch nicht angemeldet hat. Zum Beispiel können Sie Ihre Statistiken öffentlich machen, indem Sie dem Benutzer \'anonymous\' das Recht \'view\' geben.',
	'UsersManager_ExceptionSuperUser' => 'Der angeforderte Benutzer ist der Hauptadministrator und kann über die API nicht abgefragt, beabeitet oder gelöscht werden. Die Angaben zum Hauptadministrator können in der Intranet Statistics-Konfigurationsdatei manuell editiert werden.',
	...
	'VisitorGenerator_PluginDescription' => 'Plugin, mit dem fingierte Besuche generiert werden können. Dies kann von Intranet Statistics-Benutzern oder -Entwicklern genutzt werden, um fingierte Daten zu erzeugen, um die Intranet Statistics-Berichte zu füllen.',
	'VisitorGenerator_VisitorGenerator' => 'Besuchergenerator',
	'VisitorGenerator_Warning' => 'Sie sind gerade dabei, fingierte Besuche zu generieren, die in der Intranet Statistics-Datenbank gespeichert werden.',
	'VisitorGenerator_NotReversible' => 'Es ist %s nicht%s einfach möglich, diese Besuche aus den Intranet Statistics-Logs zu löschen.',
	...
	'Widgetize_PluginDescription' => 'Dieses Plugin macht es sehr einfach, Intranet Statistics-Widgets für einen Blog, eine Webseite oder IGoogle und Netvibes zu exportieren.',
	'Widgetize_TopLinkTooltip' => 'Exportiere Intranet Statistics Berichte als Widgets und binde das Dashboard in deiner Applikation als iframe ein.',
	...
	'PDFReports_PiwikReports' => 'Intranet Statistics-Berichte',
	...
	'PDFReports_TopLinkTooltip' => 'Erstelle E-Mailberichte um Intranet Statistics Statistiken automatisch an deine E-Mailadresse oder die eines Kunden zu senden!',
	'ImageGraph_PluginDescription' => 'Plugin zum Generieren von statischen Graphen (PNG-Bilder) für jeden Intranet Statistics Bericht.',
	...
	'Overlay_Link' => 'Link',
	'Overlay_RedirectUrlError' => 'Sie versuchen eine Seitenüberlagerung für die URL "%s" zu starten. %s Keiner der in den Intranet Statistics Einstellungen hinterlegten Domänen passen zu diesem Link.',
	...
	'Overlay_ErrorNotLoadingDetails' => 'Möglicherweise hat die rechte Seite keinen Intranet Statistics Tracking Code. In diesem Fall bitte versuchen das Overlay für eine andere Seite aus dem Seitenbericht zu benutzen.',
	'Overlay_ErrorNotLoadingDetailsSSL' => 'Da Sie Intranet Statistics über https nutzen, ist es wahrscheinlich dass Ihre Webseite kein SSL unterstützt. Bitte benutzen Sie Intranet Statistics über http.',
