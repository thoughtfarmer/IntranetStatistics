...
$translations = array(
	...
	'General_BackToHomepage' => 'Kembali ke beranda Intranet Statistics',
	'General_Yes' => 'Ya',
	'General_No' => 'Tidak',
	...
	'General_AllowPiwikArchivingToTriggerBrowser' => 'Perbolehkan Intranet Statistics mengarsipkan laporan ketika laporan ditampilkan',
	'General_ArchivingInlineHelp' => 'Untuk kunjungan situs menengah hingga tinggi, disarankan untuk mematikan pengarsipan Intranet Statistics ketika laporan ditampilkan. Kami lebih menyarankan untuk mengatur tugas Cron untuk mengolah laporan pada tiap jam.',
	'General_ArchivingTriggerDescription' => 'Disarankan untuk instalasi Intranet Statistics besar untuk %smengatur tugas Cron%s untuk mengolah laporan otomatis.',
	...
	'General_RequiresFlash' => 'Menampilkan Grafik di Intranet Statistics memerlukan Flash',
	'General_GraphHelp' => 'Informasi lebih lanjut tentang menampilkan grafik di Intranet Statistics.',
	...
	'General_YouAreViewingDemoShortMessage' => 'Anda sedanng melihat demostrasi Intranet Statistics',
	'General_NewUpdatePiwikX' => 'Ada pembaruan: Intranet Statistics %s',
	'General_AboutPiwikX' => 'Tentang Intranet Statistics %s',
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Intranet Statistics %1$s tersedia. %2$sSilakan memperbarui sekarang!%3$s (lihat %4$sperubahan%5$s).',
	'General_PiwikXIsAvailablePleaseNotifyPiwikAdmin' => '%s tersedia. Harap memberitahu pengelola situs.',
	'General_NewReportsWillBeProcessedByCron' => 'Ketika pengarsipan Intranet Statistics tidak dipicu oleh browser, laporan baru akan diproses oleh Crontab.',
	...
	'General_BackToPiwik' => 'Kembali ke Intranet Statistics',
	...
	'General_ConfigFileIsNotWritable' => 'Berkas konfigurasi Intranet Statistics %s tak dapat ditulisi, beberapa perubahan Anda kemungkinan tidak tersimpan. %s Silakan mengubah perizinan berkas konfigurasi agar dapat ditulisi.',
	'General_ExceptionDatabaseVersion' => 'Versi %1$s Anda adalah %2$s, tetapi Intranet Statistics membtuhkan setidaknya versi %3$s.',
	...
	'General_FileIntegrityWarningExplanation' => 'Pemeriksaan integritas berkas gagal dan melaporkan beberapa galat. Kemungkinan ada berkas Intranet Statistics yang gagal terunggah. Anda harus mengunggah ulang berkas Intranet Statistics dalam modus BINARY dan memuat ulang halaman ini hingga tak menampilkan galat.',
	...
	'General_PleaseUpdatePiwik' => 'Silakan perbarui Intranet Statistics Anda',
	...
	'Actions_DownloadsReportDocumentation' => 'Dalam laporan ini, Anda dapat melihat berkas yang diunduh oleh pengunjung. %s Apa yang Intranet Statistics hitung adalah yang mengeklik tautan unduhan. Namun, bila unduhan sudah lengkap atau belum Intranet Statistics tidak mengetahuinya.',
	...
	'API_PluginDescription' => 'Seluruh data di Intranet Statistics tersedia dalam API sederhana. Pengaya ini adalah titik masuk layanan ramatraya, yang dapat Anda hubungi untuk mendapatkan data Analisis Ramatraya Anda dalam xml, json, php, csv, dll',
	'API_QuickDocumentationTitle' => 'Dokumentasi API ringkas',
	'API_GenerateVisits' => 'Bila Anda tidak memiliki data untuk hari ini, Anda dapat membuat beberapa menggunakan pengaya %s. Anda dapat mengaktifkan pengaya %s, lalu klik menu \'Pembangkit Kunjungan\' di halaman Pengurus Intranet Statistics.',
	'API_MoreInformation' => 'Untuk informasi selengkapnya tentang API Intranet Statistics, silakan melihat %s Pengenalan API Intranet Statistics%s dan %sReferensi API Intranet Statistics%s.',
	...
	'CoreAdminHome_PluginDescription' => 'Halaman Administrasi Intranet Statistics',
	...
	'CoreAdminHome_OptOutForYourVisitors' => 'Intranet Statistics Tak-Rekaman untuk Pengunjung',
	'CoreAdminHome_OptOutExplanation' => 'Intranet Statistics berdedikasi untuk menyediakan privasi Internet. Agar pengunjung Anda memiliki pilihan untuk tidak terekam oleh Analisis Ramatraya Intranet Statistics, Anda dapat menambahkan kode HTML di salah satu halaman situs Anda, misalnya di halaman Kebijakan Privasi.',
	'CoreAdminHome_OptOutExplanationBis' => 'Kode ini akan menampilkan bingkai pendam yang mengandung tautan untuk pengunjung agar Intranet Statistics tidak merekam dengan mengatur kuki Tak-rekam di peramban pengunjung. %sKlik di sini%s untuk melihat isi yang ditampilkan oleh bingkai pendam.',
	...
	'CoreAdminHome_CustomLogoHelpText' => 'Anda dapat Anda dapat menyesuaikan logo Intranet Statistics yang akan ditampilkan dalam antarmuka pengguna dan laporan surel.',
	'CoreAdminHome_CustomLogoFeedbackInfo' => 'Jika Anda menyesuaikan logo Intranet Statistics, Anda mungkin juga tertarik untuk menyembunyikan tautan %s di menu atas. Untuk melakukannya, Anda mematikan pengaya Umpan Balik di halaman %s Pengelolaan Pengaya%s.',
	...
	'CoreAdminHome_LogoNotWriteable' => 'Untuk menggunakan logo kustom, Intranet Statistics membutuhkan akses tulis ke file logo dalam direktori tema: %s',
	'PrivacyManager_TeaserHeadline' => 'Pengaturan Privasi',
	'PrivacyManager_Teaser' => 'Pada halaman ini, Anda dapat menyesuaikan Intranet Statistics untuk membuatnya sesuai dengan peraturan perundang-undangan privasi yang ada, dengan: %s anonimasi IP pengunjung%s, %s otomatis hapus catatan pengunjung lama dari basis data%s, dan %s menyediakan pilihan tak-rekam untuk situs Anda%s.',
	'PrivacyManager_MenuPrivacySettings' => 'Privasi',
	'PrivacyManager_PluginDescription' => 'Sesuaikan Intranet Statistics untuk membuatnya sesuai dengan peraturan perundang-undangan privasi yang ada.',
	'PrivacyManager_UseAnonymizeIp' => 'Anonimasi alamat IP Pengunjung',
	'PrivacyManager_AnonymizeIpDescription' => 'Pilih "Ya" jika Anda ingin Intranet Statistics tidak melacak Alamat IP sepenuhnya.',
	...
	'PrivacyManager_DeleteDataDescription' => 'Anda dapat mengatur Intranet Statistics agar menghapus catatan pengunjung dan/atau mengatur laporan agar basisdata Anda tetap berukuran kecil.',
	...
	'PrivacyManager_DoNotTrack_EnabledMoreInfo' => 'Bila pengguna mengatur peramban agar "Saya tidak ingin dilacak" (Tak-Rekam diaktifkan) lalu Intranet Statistics tidak melacak kunjungan mereka.',
	'PrivacyManager_DoNotTrack_Disabled' => 'Intranet Statistics saat ini melacak seluruh pengunjung, bahkan bila "Saya tidak ingin dilacak" diatur di peramban.',
	...
	'CoreHome_NoPrivilegesAskPiwikAdmin' => 'Anda masuk sebagai \'%s\' tetapi sepertinya Anda tidak memiliki izin apapun di Intranet Statistics. %s Tanyakan kepada pengelola Intranet Statistics Anda (klik untuk kirim surel)%s untuk memberikan akses \'Lihat\' ke situs.',
	'CoreHome_JavascriptDisabled' => 'JavaScript harus diaktifkan untuk melihat Intranet Statistics di tampilan standar. <br />Namun, tampaknya JavaScript dimatikan atau tidak didukung oleh peramban Anda. <br />Untuk menggunakan tampilan standar, aktifkan JavaScript dengan mengubah pengaturab peramban Anda, lalu %1$scoba lagi%2$s. <br />',
	...
	'CorePluginsAdmin_MainDescription' => 'Pengaya menambah dan memperluas kegunaan dari Intranet Statistics. Sekali pengaya terinstal, Anda dapat mengaktifkan dan mematikan di sini.',
	...
	'CoreUpdater_PluginDescription' => 'Cara pembaruan Intranet Statistics',
	'CoreUpdater_UpdateTitle' => 'Pembaruan',
	'CoreUpdater_DatabaseUpgradeRequired' => 'Membutuhkan Pembaruan Basisdata',
	'CoreUpdater_YourDatabaseIsOutOfDate' => 'Basis Data Intranet Statistics Anda kedaluwarsa, dan harus diperbarui sebelum Anda dapat melanjutkan.',
	'CoreUpdater_PiwikWillBeUpgradedFromVersionXToVersionY' => 'BasisData Intranet Statistics akan diperbarui dari versi %1$s ke versi %2$s.',
	'CoreUpdater_TheFollowingPluginsWillBeUpgradedX' => 'Pengaya berikut akan diperbarui: %s.',
	'CoreUpdater_NoteForLargePiwikInstances' => 'Catatan penting untuk instalasi besar Intranet Statistics',
	'CoreUpdater_TheUpgradeProcessMayFailExecuteCommand' => 'Bila Anda memiliki basisdata Intranet Statistics yang besar, pembaruan akan berjalan lama bila dilakukan di peramban. Dalam keadaan ini, Anda dapat mengeksekusi dari baris perintah: %s',
	'CoreUpdater_YouCouldManuallyExecuteSqlQueries' => 'Bila Anda tak dapat menggunakan pembaruan dari baris perintah dan bila Intranet Statistics gagal untuk melakukan pembaruan (disebabkan oleh basis data kehabisan waktu, a browser timeout, or any other issue), you could manually execute the SQL queries to update Intranet Statistics.',
	...
	'CoreUpdater_UpgradePiwik' => 'Pembaruan Intranet Statistics',
	...
	'CoreUpdater_ErrorDIYHelp_3' => 'perbarui secara manual tabel `option` di basisdata Intranet Statistics Anda, atur nilai version_core ke versi pembaruan yang gagal',
	...
	'CoreUpdater_ErrorDIYHelp_5' => 'laporkan permasalahan (serta pemecahannya) sehingga Intranet Statistics dapat menjadi lebih baik',
	'CoreUpdater_HelpMessageContent' => 'Perikasa %1$s Pertanyaan yang Sering Diajukan di Intranet Statistics %2$s yang menjelaskan galat selama pembaruan. %3$s Tanyakan pengelola sistem Anda - kemungkinan dapat membantu mengatasi masalah Anda yang berhubungan dengan pengaturan peladen dan MySQL.',
	...
	'CoreUpdater_PiwikHasBeenSuccessfullyUpgraded' => 'Intranet Statistics berhasil diperbarui!',
	'CoreUpdater_ContinueToPiwik' => 'Lanjut ke Intranet Statistics',
	'CoreUpdater_UpdateAutomatically' => 'Pembaruan Otomatis',
	'CoreUpdater_ThereIsNewVersionAvailableForUpdate' => 'Terdapat versi baru Intranet Statistics yang tersedia',
	...
	'CoreUpdater_YouMustDownloadPackageOrFixPermissions' => 'Intranet Statistics tak dapat menimpa intalasi Anda saat ini. Anda dapat mengubah perizinan berkas/direktori, atau mengunduh paket dan instalasi versi %s secara manual:',
	'CoreUpdater_DownloadX' => 'Mengunduh %s',
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'Pembaruan Sekali Klik Intranet Statistics telah dibatalkan. Jika Anda tak dapat memperbaiki kesalahan di atas, disarankan untuk memperbarui Intranet Statistics secara manual. %1$s Silakan periksa %2$s Dokumetasi pembaruan%3$s saat memulai!',
	...
	'CoreUpdater_PiwikUpdatedSuccessfully' => 'Pembaruan Intranet Statistics berhasil!',
	'CoreUpdater_EmptyDatabaseError' => 'Basisdata %s kosong. Anda harus menyunting atau menghapus berkas konfigurasi Intranet Statistics Anda.',
	'CoreUpdater_ExceptionAlreadyLatestVersion' => 'Versi %s Intranet Statistics Anda termutakhir.',
	...
	'CustomVariables_PluginDescription' => 'Variabel Kustom harus `nama,nilai` terkait yang dapat Anda atur ke `Visit` menggunakan fungsi API Javascript setVisitCustomVariables(). Intranet Statistics akan melaporkan jumlah kunjungan, halaman, dan konversi untuk tiap nama dan nilai kustom.',
	...
	'DBStats_PluginDescription' => 'Pengaya ini melaporkan pengunaan basisdata MySQL oleh tabel Intranet Statistics.',
	'DBStats_DatabaseUsage' => 'Penggunaan Basisdata Database',
	'DBStats_MainDescription' => 'Intranet Statistics menyimpan seluruh data analisis ramatraya Anda di basisdata MySQL. Sekarang, tabel Intranet Statistics menggunakan %s.',
	'DBStats_LearnMore' => 'Pelajari selengkapnya tentang bagaimana Intranet Statistics mengolah data dan bagaimana Intranet Statistics bekerja baik dalam kunjungan situs menengah dan tinggi, lihat dokumentasi %s.',
	'DBStats_Table' => 'Tabel',
	...
	'ExampleUI_PluginDescription' => 'Contoh Pengaya: Pengaya ini menampilkan bagaimana bekerja dengan antarmuka Intranet Statistics: mebuat tabel, grafik, dsb.',
	'Feedback_PluginDescription' => 'Kirim Umpanbalik Anda ke Tim Intranet Statistics. Bagikan gagasan dan saran Anda dengan kami!',
	...
	'Feedback_WhyWrongCountry' => 'Kenapa Intranet Statistics menampilkan kunjungan saya dari negara yang salah?',
	...
	'Feedback_SpecialRequest' => 'Apakah anda memiliki permintaan khusus untuk tim Intranet Statistics?',
	'Feedback_ContactThePiwikTeam' => 'Kontak tim Intranet Statistics!',
	'Feedback_IWantTo' => 'Saya ingin:',
	'Feedback_CategoryShareStory' => 'Berbagi kisah sukses Intranet Statistics',
	'Feedback_CategorySponsor' => 'Mensponsori Intranet Statistics',
	'Feedback_CategoryHire' => 'Menyewa konsultan Intranet Statistics',
	...
	'Feedback_MessageSent' => 'Pesan Anda telah terkirim ke tim Intranet Statistics.',
	'Feedback_ThankYou' => 'Terimaksih telah membantu kami menjadikan Intranet Statistics lebih baik!',
	'Feedback_ThePiwikTeam' => 'Tim Intranet Statistics',
	...
	'Goals_NoGoalsNeedAccess' => 'Hanya Pengelola atau Pengguna Super dapat menambah Tujuan untuk situs tertentu. Silakan tanyakan kepada Pengelola Intranet Statistics untuk mengatur Tujuan untuk situs Anda. <br />Pelacakan Tujuan merupakan cara terbaik untuk mengerti dan memaksimalkan kinerja situs Anda!',
	...
	'Goals_DefaultRevenueHelp' => 'Sebagai contoh, Borang Kontak yang dikirim oleh pengunjung mungkin benilai rerata $10. Intranet Statistics akan membantu Anda mengerti bagaimana seberapa baik ruas pengunjung Anda berkinerja.',
	...
	'Goals_LearnMoreAboutGoalTrackingDocumentation' => 'Pelajari selengkapnya tentang %s Pelacakan Tujuan di Intranet Statistics%s dalam dokumentasi pengguna.',
	'Goals_ProductSKU' => 'Produk SKU',
	'Goals_ProductName' => 'Nama Produk',
	'Goals_ProductCategory' => 'Kategori Produk',
	'Goals_Products' => 'Produk',
	'Installation_PluginDescription' => 'Proses Instalasi Intranet Statistics. Instalasi ini biasanya dilakukan hanya sekali. Bila berkas konfigurasi di config/config.inc.php terhapus, instalasi akan diulangi.',
	'Installation_Installation' => 'Instalasi',
	'Installation_InstallationStatus' => 'Status Instalasi',
	'Installation_PercentDone' => '%s%% Selesai',
	'Installation_NoConfigFound' => 'Berkas konfigurasi tak dapat ditemukan dan Anda mencoba untuk mengakses halaman Intranet Statistics. <br /><strong>» Anda dapat <a href=\'index.php\'>menginstal Intranet Statistics sekarang</a></strong> <br /><small>Jika Anda mengistal Intranet Statistics sebelumnya dan memiliki beberapa tabel di basisdata Anda, jangan khawatir. Anda dapat menggunakan tabel lainnya dan menjaga data Anda saat ini!</small>',
	...
	'Installation_LargePiwikInstances' => 'Bantuan perihal Intranet Statistics besar',
	'Installation_JsTag' => 'Kode Pelacakan JavaScript',
	'Installation_Congratulations' => 'Selesai',
	'Installation_CongratulationsHelp' => '<p>Selamat! Instalasi Intranet Statistics selesai.</p><p>Pastikan kode JavaScript Anda telah dimasukkan pada halaman Anda, lalu tunggu pengunjung pertama Anda!</p>',
	'Installation_ContinueToPiwik' => 'Lanjut ke Intranet Statistics',
	...
	'Installation_SecurityNewsletter' => 'kirimi saya surel atas pembaruan besar Intranet Statistics dan peringatan keamanan',
	...
	'Installation_Requirements' => 'Persyaratan Intranet Statistics',
	...
	'Installation_SystemCheckDatabaseHelp' => 'Intranet Statistics membutuhkan ekstensi mysqli atau kedua ekstensi PDO dan pdo_mysql.',
	...
	'Installation_SystemCheckParseIniFileHelp' => 'Fungsi bawaan ini telah dimatikan dalam inang Anda. Intranet Statistics akan mencoba untuk meniru fungsi ini namun mungkin menghadapi pembatasan keamanan lebih lanjut. Kinerja pelacak juga akan terpengaruh.',
	'Installation_SystemCheckGlobHelp' => 'Fungsi bawaan ini telah dimatikan dalam inang Anda. Intranet Statistics akan mencoba untuk meniru fungsi ini namun mungkin menghadapi pembatasan keamanan lebih lanjut. Fungsionalitas mungkin terkena dampak.',
	'Installation_SystemCheckDebugBacktraceHelp' => 'View::factory tidak akan dapat membuat tampilan untuk modul panggilan.',
	'Installation_SystemCheckCreateFunctionHelp' => 'Intranet Statistics menggunakan fungsi anonim untuk panggil balik.',
	...
	'Installation_SystemCheckPackHelp' => 'Fungsi pack() dibutuhkan untuk melacak pengunjung di Intranet Statistics.',
	...
	'Installation_SystemCheckAutoUpdateHelp' => 'Catatan: Satu-Klik pembaruan Intranet Statistics membutuhkan izin-tulis ke map Intranet Statistics dan isinya.',
	'Installation_SystemCheckError' => 'Telah terjadi galat - harus diperbaiki sebelum Anda melanjutkannya',
	'Installation_SystemCheckWarning' => 'Intranet Statistics akan berjalan normal, tetapi beberapa fitur kemungkinan tak tersedia',
	...
	'Installation_TablesWithSameNamesFound' => 'Beberapa tabel %1$s dalam basisdata Anda %2$s memiliki beberapa nama dengan nama tabel yang akan dibuat oleh Intranet Statistics',
	...
	'Installation_TablesDeletedSuccess' => 'Tabel Intranet Statistics saat ini berhasil dihapus',
	'Installation_TablesCreatedSuccess' => 'Tabel berhasil dibuat!',
	'Installation_DatabaseCreatedSuccess' => 'Basisdata %s berhasil dibuat!',
	'Installation_GoBackAndDefinePrefix' => 'Kembali dan tetapkan kode awalan untuk tabel Intranet Statistics',
	...
	'Installation_WelcomeHelp' => '<p>Intranet Statistics merupakan piranti lunak analisa ramatraya yang memudahkan Anda mendapatkan informasi yang diinginkan dari pengunjung.</p><p>Proses ini dibagi menjadi %s langkah mudah dan membutuhkan sekitar 5 menit.</p>',
	'Installation_ConfigurationHelp' => 'Tampaknya berkas konfigurasi Intranet Statistics Anda terdapat kesalahan. Anda dapat menghapus config/config.ini.php dan melanjutkan instalasi, atau memperbaiki pengaturan sambungan basisdata.',
	'Installation_ErrorInvalidState' => 'Galat: tampaknya Anda mencoba melewati proses Instalasi, atau kuki Anda telah dimatikan, atau berkas konfigurasi Intranet Statistics telah tersedia. %1$sPeriksalah apakah kuki Anda telah aktif kemudian %2$s kembali %3$s ke halaman pertama instalasi %4$s.',
	...
	'LanguagesManager_PluginDescription' => 'Pengaya ini akan menampilkan daftar bahasa yang tersedia dalam antarmuka Intranet Statistics. Bahasa yang dipilih akan tersimpan dalam pengaturan setiap pengguna.',
	'LanguagesManager_AboutPiwikTranslations' => 'Tentang penerjemahan Intranet Statistics',
	...
	'Login_InvalidNonceOrHeadersOrReferer' => 'Borang keamanan gagal. Silkan muat ulang borang dan periksa apakah kuki Anda telah aktif. Bila Anda menggunakan peladen wali, Anda harus %s mengkonfigurasi Intranet Statistics untuk menerima `header` wali%s yang meneruskan `header` Inang. Serta, periksa apakah `header` Pengarah telah terkirim dengan benar.',
	'Login_InvalidOrExpiredToken' => 'Kepingan tak sahih atau telah kedaluwarsa.',
	'Login_ContactAdmin' => 'Kemungkinan: inang Anda kemungkinan mematikan fungsi mail(). <br />Silakan hubungi pengelola Intranet Statistics Anda.',
	...
	'Mobile_HttpIsNotSecureWarning' => 'Pecahan otorisasi Intranet Statistics Anda (token_auth) terkirim dalam teks polos bila Anda menggunakan \'HTTP\'. Untuk alasan tersebut, kami menyarankan menggunakan HTTPS untuk keamanan pengiriman data melalui internet. Anda yakin melanjutkannya?',
	...
	'Mobile_RatingPleaseRateUs' => 'App Bergerak Intranet Statistics merupakan Perangkat Lunak Gratis, kami sangat menghargai bila Anda meluangkan waktu sebentar untuk menilai aplikasi ini di %s. Bila Anda memiliki permintaan fitur baru atau laporan kutu, harap menghubungi %s',
	...
	'Mobile_AccessUrlLabel' => 'Url Akses Intranet Statistics',
	...
	'MultiSites_PluginDescription' => 'Menampilkan ringkasan eksekutif/statistik banyak-situs. Saat ini dikelola sebagai pengaya inti Intranet Statistics.',
	...
	'Provider_ProviderReportDocumentation' => 'Laporan ini menampilkan Penyedia Layanan Internet yang digunakan oleh pengunjung Anda untuk mengunjungi situs. Anda dapat mengeklik nama penyedia untuk melihat rinciannya. %s Bila Intranet Statistics tak dapat menentukan penyedia pengunjung, ini akan ditampikan sebagai IP.',
	...
	'SitesManager_PluginDescription' => 'Pengatur Situs di Intranet Statistics: Menambah Situs baru, Menyunting yang telah ada, Menampilakn kodeJavaScript untuk dimasukkan ke halaman Anda. Seluruh tindakan tersebut juga tersedia melalui API.',
	...
	'SitesManager_PiwikWillAutomaticallyExcludeCommonSessionParameters' => 'Intranet Statistics akan otomatis kecualikan parameter sesi umum (%s).',
	'SitesManager_HelpExcludedIps' => 'Masukkan daftar IP, satu tiap baris, yang ingin Anda kecualikan pelacakan Intranet Statistics. Anda dapat gunakan `wildcards`, seperti %1$s atau %2$s',
	...
	'SitesManager_PiwikOffersEcommerceAnalytics' => 'Intranet Statistics mungkinkan pelaporan dan pelacakan Analisis Niaga-E. Pelajari tentang %s Analisis Niaga-E%s.',
	'TranslationsAdmin_PluginDescription' => 'Bantu menerjemahkan Intranet Statistics ke bahasa Anda.',
	...
	'UsersManager_PluginDescription' => 'Pengatur Pengguna di Intranet Statistics: menmbah Pengguna, menyunting yang telah ada, memperbarui perizinan. Seluruh tindakan juga tersedia melalui API.',
	...
	'UsersManager_MainDescription' => 'Tentukan pengguna yang memilik akses Intranet Statistics ke situs Anda. Anda juga dapat mengatur perizinan seluruh Situs dalam satu kali.',
	...
	'UsersManager_YourVisitsAreIgnoredOnDomain' => '%sKunjungan Anda diabaikan oleh Intranet Statistics dalam %s %s (kuki pengecualian ditemukan dalam peramban Anda).',
	'UsersManager_YourVisitsAreNotIgnored' => '%sKunjungan Anda tidak diabaikan oleh Intranet Statistics%s (kuki pengecualian tidak ditemukan dalam peramban Anda).',
	'UsersManager_ClickHereToDeleteTheCookie' => 'Klik di sini untuk menghapus kuki dan mengizinkan Intranet Statistics melacak kunjungan Anda',
	'UsersManager_ClickHereToSetTheCookieOnDomain' => 'Klik di sini untuk mengatur kuki yang akan mengecualikan kunjungan Anda ke situs yang dilacak oleh Intranet Statistics %s',
	...
	'UsersManager_WhenUsersAreNotLoggedInAndVisitPiwikTheyShouldAccess' => 'Bila pengguna tidak masuk-log dan mengunjungi Intranet Statistics, mereka harus mengakses',
	...
	'UsersManager_ExceptionEditAnonymous' => 'Pengguna anonim tidak dapat dihapus atau disunting. Intranet Statistics menggunakan pengguna ini untuk menjelaskan pengguna yang belum masuk. Misalnya, Anda dapat membuat statistik publik Anda dengan memberi hak `Tampil` untuk pengguna \'anonim\'.',
	'UsersManager_ExceptionSuperUser' => 'Pengguna yang diminta adalah Pengguna Super dan tidak dapat diproses, disunting, atau dihapus melalui API. Anda dapat menyunting manual Pengguna Super selengkapnya dalam berkas konfigurasi Intranet Statistics Anda.',
	...
	'VisitorGenerator_PluginDescription' => 'Pengaya untuk membuat kunjungan palsu. Ini dapat digunakan oleh pengguna Intranet Statistics atau pengembang sebagai cara mudah untuk membuat data palsu untuk mengisi laporan Intranet Statistics.',
	'VisitorGenerator_VisitorGenerator' => 'Pembangkit Kunjungan',
	'VisitorGenerator_Warning' => 'Anda akan menghasilkan kunjungan palsu yang akan disimpan dalam basisdata Intranet Statistics Anda.',
	...
	'VisitTime_NHour' => '%sj',
	'Widgetize_PluginDescription' => 'Pengaya ini mempermudah mengekspor Widget Intranet Statistics dalam Blog, Situs, atau dalam Igoogle dan Netvibes Anda!',
	...
	'PDFReports_PiwikReports' => 'Laporan Intranet Statistics',
