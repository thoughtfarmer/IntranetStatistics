...
$translations = array(
	...
	'General_BackToHomepage' => 'Mbrapsht te faqja hyrëse e Intranet Statistics-it',
	'General_Yes' => 'Po',
	'General_No' => 'Jo',
	...
	'General_AllowPiwikArchivingToTriggerBrowser' => 'Lejoje vënien në punë të arkivimit nga Intranet Statistics-u kur raportet shihen nga një shfletues',
	'General_ArchivingInlineHelp' => 'Për site-e web me trafik mesatar ose të shumtë këshillohet të çaktivizohet vënia në punë e arkivimit nga Intranet Statistics-u prej shfletuesit. Në vend të kësaj këshillojmë të rregulloni një akt cron që të përpunoni raporte Intranet Statistics-u çdo orë.',
	'General_ArchivingTriggerDescription' => 'E këshilluar për instalime më të ngarkuara të Intranet Statistics-ut, lypset të %srregulloni një akt cron-i%s që të përpunohen raportet automatikisht.',
	...
	'General_RequiresFlash' => 'Shfaqja e Grafikëve në Intranet Statistics lyp Flash-in',
	'General_GraphHelp' => 'Më tepër të dhëna rreth shfaqjes së grafikëve në Intranet Statistics.',
	...
	'General_YouAreViewingDemoShortMessage' => 'Hëpërhë jeni duke parë një demonstrim të Intranet Statistics-ut',
	'General_YouAreCurrentlyUsing' => 'Jeni duke përdorur Intranet Statistics %s.',
	'General_DownloadFullVersion' => '%1$sShkarkoni%2$s versionin e plotë! Shihni %3$s',
	'General_NewUpdatePiwikX' => 'Përditësim i Ri: Intranet Statistics %s',
	'General_AboutPiwikX' => 'Rreth Intranet Statistics-ut %s',
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Mund të kihet Intranet Statistics %1$s. %2$s Ju lutem, përditësojeni tani!%3$s (shihni %4$s ndryshimet%5$s).',
	'General_PiwikXIsAvailablePleaseNotifyPiwikAdmin' => 'Mund të kihet %s. Ju lutem, njoftoni përgjegjësin e site-it.',
	'General_NewReportsWillBeProcessedByCron' => 'Kur arkivimi nga Intranet Statistics-u nuk vihet në punë nga shfletuesi, raportet e reja do të përpunohen nga crontab.',
	...
	'General_BackToPiwik' => 'Mbrapsht te Intranet Statistics-u',
	...
	'General_ConfigFileIsNotWritable' => 'Kartela për formësimin e Intranet Statistics-ut %s nuk është e shkruajtshme, disa nga ndryshimet tuaja mund të mos ruhen dot. %s Ju lutem, ndryshoni lejet mbi kartelën e formësimit për ta bërë të shkruajtshme.',
	'General_ExceptionDatabaseVersion' => 'Versioni juaj për %1$s është %2$s por Intranet Statistics-u lyp të paktën %3$s.',
	...
	'General_PleaseUpdatePiwik' => 'Ju lutem, përditësoni Intranet Statistics-un tuaj',
	...
	'Actions_DownloadsReportDocumentation' => 'Në këtë raport, mund të shihni cilat kartela kanë shkarkuar vizitorët tuaj. %s Ato që Intranet Statistics-u numëron si shkarkim është çdo klikim mbi një lidhje shkarkimi. Por Intranet Statistics-u nuk mund ta dijë a u plotësua a jo shkarkimi.',
	...
	'API_PluginDescription' => 'Në Intranet Statistics krejt të dhënat mund të kihen përmes API-sh të thjeshta. Kjo shtojcë është pikënisja e shërbimit web, ajo që mund të thërrisni për të patur të dhënat për Analizën tuaj Web në format xml, json, php, csv, etj.',
	'API_QuickDocumentationTitle' => 'Dokumentim i shpejtë për API',
	'API_GenerateVisits' => 'Nëse nuk keni të dhëna për ditën e sotme, mund të prodhonit ca të dhëna duke përdorur shtojcën %s. Shtojcën %s mund ta aktivizoni, mandej klikoni mbi menunë \'Gjenerator Vizitorësh\' te pjesa Përgjegjës Intranet Statistics-u.',
	'API_MoreInformation' => 'Për më tepër të dhëna rreth API-ve të Intranet Statistics-ut, ju lutem, hidhini një sy %s Hyrje në API-t e Intranet Statistics-ut %s dhe %s Referencë API-sh Intranet Statistics-u %s.',
	...
	'CoreAdminHome_PluginDescription' => 'Zona e administrimit të Intranet Statistics-ut.',
	...
	'CoreAdminHome_OptOutForYourVisitors' => '"Opt-out" i Intranet Statistics-ut për vizitorët tuaj',
	'CoreAdminHome_OptOutExplanation' => 'Intranet Statistics-u është i përkushtuar ndaj mundësimit të vetësisë në Internet. Për t\'u dhënë mundësinë e zgjedhjes së "opt-out" te Analizat Web Intranet Statistics, mund të shtoni kodin HTML vijues te një nga faqet e site-it tuaj web, për shembull te faqja e Rregullave të Vetësisë.',
	'CoreAdminHome_OptOutExplanationBis' => 'Ky kod do të shfaqë një Iframe që përmban një lidhje me të cilën vizitorët të mund të zgjedhin "opt-out" për Intranet Statistics-un, duke depozituar një "opt-out cookie" në shfletuesin e tyre. %s Klikoni këtu%s që të shihni lëndën që do të shfaqet nga iFrame-i.',
	...
	'CoreAdminHome_CustomLogoHelpText' => 'Logon e Intranet Statistics-ut, që do të shfaqet në ndërfaqen e përdoruesit dhe raportet email.',
	'CoreAdminHome_CustomLogoFeedbackInfo' => 'Nëse e përshtatni logon e Intranet Statistics-ut, mund t’ju interesonte edhe fshehja lidhjes %s te menuja në krye. Për ta bërë këtë, mund të çaktivizoni shtojcën e Përshtypjeve te faqja e %sAdministrimit të Shtojcëve%s.',
	...
	'CoreAdminHome_LogoNotWriteable' => 'Që të përdorni një logo Intranet Statistics të përshtatur ju nevojitet të keni leje shkrimi te kartelat e logos brenda drejtorisë së temës: %s',
	'CoreAdminHome_TrustedHostSettings' => 'Strehëemër e Besuar Intranet Statistics',
	'CoreAdminHome_TrustedHostConfirm' => 'Jeni i sigurt se doni të ndryshoni emërstrehën e besuar të Intranet Statistics-ut?',
	'CoreAdminHome_PiwikIsInstalledAt' => 'Intranet Statistics-u është instaluar te',
	'CoreAdminHome_ValidPiwikHostname' => 'Strehëemër e Vlefshme Intranet Statistics',
	...
	'PrivacyManager_Teaser' => 'Në këtë faqe, mund ta përshtatni Intranet Statistics-un që privatësi në të të jetë në pajtim me legjislacionin në fuqi, duke: %s anonimizuar IP-të e vizitorëve%s, %s hequr automatikisht nga baza e të dhënave regjistrime të vjetër vizitorësh%s, dhe %s duke ofruar një mekanizëm Opt-out për site-in tuaj web%s.',
	'PrivacyManager_MenuPrivacySettings' => 'Privatësi',
	'PrivacyManager_PluginDescription' => 'Përshtateni Intranet Statistics-un për ta bërë privatësinë të përputhshme me legjislacionin ekzistues.',
	'PrivacyManager_UseAnonymizeIp' => 'Anonimizoni adresat IP të Vizitorëve',
	'PrivacyManager_AnonymizeIpDescription' => 'Përzgjidhni "Po" nëse doni që Intranet Statistics-u të mos gjurmojë adresa IP të përcaktuara qartë.',
	...
	'CoreHome_NoPrivilegesAskPiwikAdmin' => 'Jeni i futur si \'%s\' por duket se nuk keni leje të rregulluara për ju në Intranet Statistics. %s Kërkojini administratorit tuaj te Intranet Statistics (klikoni që t’i dërgoni email)%s që t’ju japë të drejta \'parjesh\' te një site web.',
	'CoreHome_JavascriptDisabled' => 'Që të mund të përdorni Intranet Statistics-un në parjen standarde duhet të aktivizohet JavaScript-i.<br />Por ja që duket se ose JavaScript-i është i çaktivizuar, ose nuk mbulohet nga shfletuesi juaj.<br />Që të përdorni parjen standarde, aktivizoni JavaScript-in duke ndryshuar mundësitë përkatëse te shfletuesi juaj, mandej %1$sriprovoni%2$s.<br />',
	...
	'CorePluginsAdmin_MainDescription' => 'Shtojcat zgjerojnë dhe thellojnë funksionet e Intranet Statistics-ut. Pasi një shtojcë të jetë instaluar, mund ta aktivizoni ose çaktivizoni prej këtu.',
	...
	'CoreUpdater_PluginDescription' => 'Mekanizmi i përditësimit të Intranet Statistics-ut',
	'CoreUpdater_UpdateTitle' => 'Intranet Statistics › Përditësim',
	'CoreUpdater_DatabaseUpgradeRequired' => 'Lypset Përmirësim i Bazës së të Dhënave',
	'CoreUpdater_YourDatabaseIsOutOfDate' => 'Baza juaj e të dhënave për Intranet Statistics-un është e vjetruar, dhe duhet përmirësuar përpara se të mund të vazhdoni.',
	'CoreUpdater_PiwikWillBeUpgradedFromVersionXToVersionY' => 'Baza e të dhënave për Intranet Statistics-un do të përmirësohet prej versionit %1$s te versioni i ri %2$s.',
	'CoreUpdater_TheFollowingPluginsWillBeUpgradedX' => 'Shtojcat vijuese do të përditësohen: %s.',
	'CoreUpdater_NoteForLargePiwikInstances' => 'Shënime të rëndësishme për instalime Intranet Statistics me shumë ngarkesë',
	'CoreUpdater_TheUpgradeProcessMayFailExecuteCommand' => 'Nëse keni një bazë të dhënash Intranet Statistics të madhe, përditësimet mund të zgjasin shumë në shfletues. Në të tilla raste, mund t\'i bëni përditësimet që nga rresht urdhrash: %s',
	'CoreUpdater_YouCouldManuallyExecuteSqlQueries' => 'Nëse nuk jeni në gjendje të xhironi përditësuesin nga rresht urdhrash dhe Intranet Statistics-u nuk arrin të përmirësohet (për shkak mbarimi kohe për bazën e të dhënave, mbarimi kohe për shfletuesin, ose çfarëdo çështje tjetër), mundeni të ekzekutoni kërkesa SQL dorazi që të përditësoni Intranet Statistics-un.',
	...
	'CoreUpdater_UpgradePiwik' => 'Përmirësojeni Intranet Statistics-un',
	...
	'CoreUpdater_ErrorDIYHelp_3' => 'përditësojeni dorazi tabelën `option` te baza juaj e të dhënave për Intranet Statistics-un, duke caktuar si vlerë për version_core vlerën e përditësimit që dështoi',
	...
	'CoreUpdater_ErrorDIYHelp_5' => 'njoftoni për problemin (dhe zgjidhjen), që kështu Intranet Statistics-u të mund të përmirësohet',
	'CoreUpdater_HelpMessageContent' => 'Hidhini një sy %1$s Intranet Statistics FAQ %2$s që shpjegojnë gabimet më të rëndomta gjatë përditësimesh. %3$s Pyesni përgjegjësin e sistemit tuaj - ai mund të jetë në gjendje të t\'ju ndihmojë për gabimin, i cili ka shumë të ngjarë të ketë lidhje me rregullimet e shërbyesit tuaj ose ato të MySQL-së.',
	...
	'CoreUpdater_PiwikHasBeenSuccessfullyUpgraded' => 'Intranet Statistics-u u përmirësua me sukses!',
	'CoreUpdater_ContinueToPiwik' => 'Vazhdoni te Intranet Statistics-u',
	'CoreUpdater_UpdateAutomatically' => 'Përmirësoje Vetvetiu',
	'CoreUpdater_ThereIsNewVersionAvailableForUpdate' => 'Mund të kihet një version i ri, i përmirësuar, i Intranet Statistics-ut',
	...
	'CoreUpdater_YouMustDownloadPackageOrFixPermissions' => 'Intranet Statistics-u është i pazoti të mbishkruajë instalimin tuaj të tanishëm. Mundeni ose të ndreqni lejet mbi drejtorira/kartela, ose të shkarkoni paketën dhe instaloni versionin %s dorazi:',
	'CoreUpdater_DownloadX' => 'Shkarko %s',
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'Përditësimi Intranet Statistics Me Një Klik u anulua. Nëse nuk ndreqni dot gabimin me mesazhin e mësipërm, këshillohet ta përditësoni Intranet Statistics-un dorazi. %1$s Ju lutem, shihni %2$sdokumentimin e Përditësimeve%3$s për t\'ia filluar!',
	...
	'CoreUpdater_PiwikUpdatedSuccessfully' => 'Intranet Statistics-u u përditësua me sukses!',
	'CoreUpdater_EmptyDatabaseError' => 'Baza e të dhënave %s është bosh. Kartelën tuaj të formësimit të Intranet Statistics-ut duhet ta përpunoni ose ta hiqni.',
	'CoreUpdater_ExceptionAlreadyLatestVersion' => 'Versioni juaj %s i Intranet Statistics-ut është i fundit.',
	...
	'CustomVariables_PluginDescription' => 'Ndryshoret e personalizueshme janë të trajtës emër,çift vlerash që mund të rregullohen prej jush për një Vizitë duke përdorur funksionin Javascript API setVisitCustomVariables(). Intranet Statistics-u mandej do të njoftojë se sa vizita, faqe, shndërrime kanë ndodhur për këto emra dhe vlera të personalizuara.',
	...
	'DBStats_PluginDescription' => 'Kjo shtojcë raporton përdorimin e bazës së të dhënave MySQL nga tabelat e Intranet Statistics-ut.',
	'DBStats_DatabaseUsage' => 'Përdorim baze të dhënash',
	'DBStats_MainDescription' => 'Intranet Statistics-u po i depoziton krejt të dhënat tuaja për analizë web te baza e të dhënave MySQL. Tani për tani, tabelat e Intranet Statistics-ut po përdorin %s.',
	'DBStats_LearnMore' => 'Për të mësuar më tepër rreth se si i përpunon të dhënat Intranet Statistics-u dhe se si ta bëni Intranet Statistics-un të punojë mirë me site-e web me trafik mesatar ose të madh, kontrolloni dokumentimin %s.',
	...
	'ExampleUI_PluginDescription' => 'Shtojcë Shembull: Kjo shtojcë shfaq si të punohet me UI-në e Intranet Statistics-ut: krijoni tabela, grafikë, etj.',
	'Feedback_PluginDescription' => 'Dërgojini Përshtypjet tuaja Ekipit të Intranet Statistics-ut. Ndani me ne idetë dhe sugjerimet tuaja!',
	...
	'Feedback_WhyWrongCountry' => 'Pse e tregon gabimisht vendin e vizitës time Intranet Statistics-u?',
	...
	'Feedback_SpecialRequest' => 'Keni ndonjë kërkesë speciale për ekipin e Intranet Statistics-ut?',
	'Feedback_ContactThePiwikTeam' => 'Lidhuni me ekipin e Intranet Statistics-ut!',
	'Feedback_IWantTo' => 'Dua të:',
	'Feedback_CategoryShareStory' => 'Të ndaji me ju një shembull suksesi me Intranet Statistics-un',
	'Feedback_CategorySponsor' => 'Të sponsorizoj Intranet Statistics-un',
	'Feedback_CategoryHire' => 'Të punësoj një këshilltar për Intranet Statistics-un',
	...
	'Feedback_MessageSent' => 'Mesazhi u dërgua te ekipi i Intranet Statistics-ut.',
	'Feedback_ThankYou' => 'Faleminderit që na ndihmoni ta bëjmë më të mirë Intranet Statistics-un!',
	'Feedback_ThePiwikTeam' => 'Ekipi i Intranet Statistics-ut',
	...
	'Goals_NoGoalsNeedAccess' => 'Vetëm Përgjegjësi ose Super Përdoruesi mund të shtojnë Objektiva për një site web të dhënë. Ju lutem, kërkojini përgjegjësit tuaj për Intranet Statistics-un të rregullojë një Objektiv për site-in tuaj web. <br>Ndjekja e Objektivave është një rrugë e bukur në ndihmë të të kuptuarit dhe rritjes sa të jetë e mundur të funksionimit të site-it tuaj web!',
	...
	'Goals_DefaultRevenueHelp' => 'Për shembull, një Formular Kontakti parashtruar nga një vizitor mund të vlejë mesatarisht 10 euro. Intranet Statistics-u do t\'ju ndihmojë të kuptoni se si shtresëzohen segmentet e vizitorëve tuaj.',
	...
	'Goals_LearnMoreAboutGoalTrackingDocumentation' => 'Mësoni më tepër rreth %s Ndjekjes së Objektivave në Intranet Statistics%s, te dokumentimi i përdoruesit.',
	...
	'Installation_PluginDescription' => 'Procesi i instalimit të Intranet Statistics-ut. Instalimi zakonisht bëhet vetëm një herë. Po u fshi kartela e formësimit config/config.inc.php, instalimi duhet nisur nga e para.',
	'Installation_Installation' => 'Instalim',
	'Installation_InstallationStatus' => 'Gjendje instalimi',
	'Installation_PercentDone' => 'Plotësuar %s %%',
	'Installation_NoConfigFound' => 'S\'u gjet dot kartela e formësimit të Intranet Statistics-ut dhe po provoni të hyni te një faqe Intranet Statistics-u.<br /><b>  » Mund ta <a href=\'index.php\'>instaloni Intranet Statistics-un tani</a></b><br /><small>Nëse e kishit instaluar Intranet Statistics-un më parë dhe keni disa tabela te baza juaj e të dhënave, mos u shqetësoni, mund të ripërdorni po ato tabela dhe të mbani të dhënat tuaja ekzistuese!</small>',
	...
	'Installation_LargePiwikInstances' => 'Ndihmë për raste Intranet Statistics-u me ngarkesë',
	'Installation_JsTag' => 'Kod JavaScript Gjurmimi',
	'Installation_Congratulations' => 'Urime',
	'Installation_CongratulationsHelp' => '<p>Urime! Instalimi juaj i Intranet Statistics-ut u plotësua.</p><p>Sigurohuni që keni futur kodin JavaScript te faqet tuaja, dhe prisni për vizitorët e parë!</p>',
	'Installation_ContinueToPiwik' => 'Vazhdo te Intranet Statistics-u',
	...
	'Installation_SecurityNewsletter' => 'njoftomë me email për përditësime të rëndësishme të Intranet Statistics-ut dhe njoftime lidhur me sigurinë',
	...
	'Installation_Requirements' => 'Të domosdoshme për Intranet Statistics-un',
	...
	'Installation_SystemCheckDatabaseHelp' => 'Intranet Statistics-u lyp ose zgjerimin mysqli, ose që të dy zgjerimet PDO dhe pdo_mysql.',
	...
	'Installation_SystemCheckParseIniFileHelp' => 'Ky funksion i trupëzuar është i çaktivizuar te streha juaj. Intranet Statistics-u do të përpiqet ta emulojë këtë funksion por mund të hasë kufizime të mëtejshme sigurie. Edhe punimi i gjurmuesit do të preket nga kjo.',
	'Installation_SystemCheckGlobHelp' => 'Ky funksion i trupëzuar është i çaktivizuar te streha juaj. Intranet Statistics-u do të përpiqet ta emulojë këtë funksion por mund të hasë kufizime të mëtejshme sigurie. Kjo mund të ketë ndikim te funksionimi.',
	'Installation_SystemCheckDebugBacktraceHelp' => 'View::factory nuk do të jetë në gjendje të krijojë parje për modulin thirrës.',
	'Installation_SystemCheckCreateFunctionHelp' => 'Intranet Statistics-u përdor funksione anonime për "callbacks".',
	...
	'Installation_SystemCheckPackHelp' => 'Që të gjurmohen vizitorët me Intranet Statistics-un, funksioni pack() është i domosdoshëm.',
	...
	'Installation_SystemCheckAutoUpdateHelp' => 'Shënim: përditësimi me Një Klikim i Intranet Statistics-ut lyp leje për shkrim te dosja Intranet Statistics dhe lënda e saj.',
	'Installation_SystemCheckError' => 'Ndodhi një gabim - duhet të ndreqet përpara se të ecni më tej',
	'Installation_SystemCheckWarning' => 'Intranet Statistics-u do të punojë normalisht por mund t\'i mungojnë disa veçori',
	...
	'Installation_TablesWithSameNamesFound' => 'Disa tabela %1$s te baza juaj e të dhënave %2$s kanë të njëjtit emra si tabelat që Intranet Statistics-u po përpiqet të krijojë',
	...
	'Installation_TablesDeletedSuccess' => 'Tabelat ekzistuese të Intranet Statistics-ut u fshinë me sukses',
	...
	'Installation_GoBackAndDefinePrefix' => 'Kthehuni mbrapsht dhe përcaktoni një Prefiks për Tabelat e Intranet Statistics-ut',
	...
	'Installation_WelcomeHelp' => '<p>Intranet Statistics-u është një program analize web, me burim të hapët, që e bën të lehtë të kihen të dhëna që dëshironi rreth vizitorëve tuaj.</p><p>Ky proces është ndarë në %s hapa të kollajtë dhe do të zgjasë rreth 5 minuta.</p>',
	'Installation_ConfigurationHelp' => 'Kartela juaj për formësimin e Intranet Statistics-ut duket se është e keqformësuar.  Ose mund të hiqni config/config.ini.php dhe rinisni instalimin, ose ndreqni rregullimet për lidhjen me bazën e të dhënave.',
	'Installation_ErrorInvalidState' => 'Gabim: duket se po provoni të anashkaloni një hap të procesit të Instalimit, ose keni të çaktivizuara "cookies", ose kartela e formësimit të Intranet Statistics-ut është e krijuar tashmë. %1$sSigurohuni që "cookies" janë të aktivizuara%2$s dhe kthehuni mbrapsht %3$s te faqja e parë e instalimit %4$s.',
	'LanguagesManager_PluginDescription' => 'Kjo shtojcë  do të shfaqë një listë të gjuhëve të mundshme për ndërfaqen e Intranet Statistics-ut. Gjuha e përzgjedhur do të ruhet te parapëlqimet e çdo përdoruesi.',
	'LanguagesManager_AboutPiwikTranslations' => 'Mbi përkthimet e Intranet Statistics-ut',
	...
	'MultiSites_PluginDescription' => 'Shfaq përmbledhje/statistika ekzekutive multi-site-i. Hëpërhë trajtohet si shtojcë bazë e Intranet Statistics-ut.',
	...
	'Provider_ProviderReportDocumentation' => 'Ky raport ju tregon cilët Mundësuesa Shërbimi Internet kanë përdorur vizitorët tuaj për të hyrë te site-i web. Për më tepër hollësi mund të klikoni mbi emrin e një mundësuesi. %s Nëse Intranet Statistics nuk arrin ta përcaktojë mundësuesin për një vizitor, e tregon thjesht si IP.',
	...
	'SitesManager_PluginDescription' => 'Administrim site-esh web në Intranet Statistics: Shtoni një site web të ri, Përpunoni një ekzistues, Shfaqni kod JavaScript për t\'u përfshirë te faqet tuaja. Krejt veprimet mund të kryhen edhe përmes API-t.',
	...
	'SitesManager_AliasUrlHelp' => 'Këshillohet, por nuk është e domosdoshme, të jepen URL të ndryshme, një për rresht, që vizitorët tuaj përdorin për të hyrë në këtë site web. URL-të alias për site-in web nuk kanë për t\'u dukur te raporti Referuesa > Site-e Web. Mbani shënim që nuk është e domosdoshme të jepen URL me apo pa \'www\', ngaqë Intranet Statistics-u i ka që të dyja parasysh automatikisht.',
	...
	'SitesManager_PiwikWillAutomaticallyExcludeCommonSessionParameters' => 'Intranet Statistics-u do t\'i përjashtojë vetvetiu parametrat e zakonshëm të sesioneve (%s).',
	'SitesManager_HelpExcludedIps' => 'Jepni listën e IP-ve, një për rresht, që dëshironi të përjashtohen nga gjurmimi prej Intranet Statistics-ut. Mund të përdorni shenja të gjithëpushtetshme, p.sh. %1$s ose %2$s',
	...
	'SitesManager_PiwikOffersEcommerceAnalytics' => 'Intranet Statistics-u ju mundëson ndjekje & raportim të thelluar Analizash E-tregtie. Mësoni më tepër rreth %s Analizash E-tregtie%s.',
	'TranslationsAdmin_PluginDescription' => 'Ndihmoni të përkthehet Intranet Statistics-u në gjuhën tuaj.',
	...
	'UserCountry_country_bq' => 'Intranet Statistics',
	...
	'UsersManager_PluginDescription' => 'Administrimi i Përdoruesve në Intranet Statistics: shtoni një Përdorues të ri, përpunoni një ekzistues, përditësoni lejet për ta. Krejt veprimet mundet të kryhen edhe përmes API-t.',
	...
	'UsersManager_MainDescription' => 'Vendosni cilët përdoruesa kanë hyrje Intranet Statistics në "site"-et tuaj web. Mundet edhe të caktoni njëherazi lejet mbi tërë "site"-et web.',
	...
	'UsersManager_YourVisitsAreIgnoredOnDomain' => '%sVizitat tuaja te %s %s janë shpërfillur nga Intranet Statistics-u  (te shfletuesi juaj u gjet "cookie" për shpërfillje nga Intranet Statistics-u).',
	'UsersManager_YourVisitsAreNotIgnored' => '%sVizitat tuaja nuk janë shpërfillur nga Intranet Statistics-u%s (te shfletuesi juaj nuk u gjet "cookie" për shpërfillje nga Intranet Statistics-u).',
	'UsersManager_ClickHereToDeleteTheCookie' => 'Klikoni këtu që të fshihet "cookie" dhe që ta bëni Intranet Statistics-un të gjurmojë vizitat tuaja',
	'UsersManager_ClickHereToSetTheCookieOnDomain' => 'Klikoni këtu që të vendoset një "cookie" që do të përjashtojë vizitat tuaja në site-e web të gjurmuara nga Intranet Statistics-u %s',
	...
	'UsersManager_WhenUsersAreNotLoggedInAndVisitPiwikTheyShouldAccess' => 'Kur përdoruesit nuk janë të futur dhe vizitojnë Intranet Statistics-un, do të duhej të hynin',
	...
	'UsersManager_ExceptionEditAnonymous' => 'Përdoruesi anonim nuk mund të fshihet apo përpunohet të dhënat e tij. Përdoret nga Intranet Statistics-u për të përkufizuar një përdorues që nuk ka bërë ende hyrjen. Për shembull, mund t\'i bëni statistikat tuaja publike duke lejuar hyrje për \'parje\' për përdoruesin \'anonim\'.',
	'UsersManager_ExceptionSuperUser' => 'Përdoruesi i kërkuar është Super Përdoruesi dhe nuk i nënshtrohet kërkesave, as përpunohet apo fshihet përmes API-t. Hollësitë e Super Përdoruesit mund t\'i përpunoni dorazi te kartela juaj e formësimit të Intranet Statistics-ut.',
	...
	'VisitorGenerator_PluginDescription' => 'Shtojcë për krijim vizitash gjoja. Kjo mund të përdoret nga përdorues ose zhvillues të Intranet Statistics-ut si një rrugë e lehtë për të prodhuar të dhëna gjasme, për të mbushur raporte të Intranet Statistics-ut për prova.',
	'VisitorGenerator_VisitorGenerator' => 'Prodhues Vizitorësh',
	'VisitorGenerator_Warning' => 'Ju ndan një hap nga prodhimi i vizitave gjasme, që do të regjistrohen te baza juaj e të dhënave Intranet Statistics.',
	...
	'VisitTime_NHour' => '%sh',
	'Widgetize_PluginDescription' => 'Shtojca e bën shumë të lehtë të eksportohet çfarëdo Widget-i Intranet Statistics-u te Blogu juaj, site-i juaj web ose te Igoogle apo Netvibes!',
	...
	'PDFReports_PiwikReports' => 'Raporte Intranet Statistics',
	...
	'ImageGraph_PluginDescription' => 'Prodhoni për çfarëdo raporti Intranet Statistics figura të mrekullueshme PNG statike Grafikësh.',
