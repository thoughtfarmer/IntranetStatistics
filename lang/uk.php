...
$translations = array(
	...
	'General_BackToHomepage' => 'Назад до головної сторінки Intranet Statistics',
	'General_Yes' => 'Так',
	'General_No' => 'Ні',
	...
	'General_AllowPiwikArchivingToTriggerBrowser' => 'Дозволити Intranet Statistics можливість запуску коли звіти переглядаються барузером',
	'General_ArchivingInlineHelp' => 'Для веб-сайтів з середнім та високим трафіком рекомендується вимкнути можливість запуску Intranet Statistics при перегляді браузером. В такому випадку рекомендується налаштувати планувальних завдань (cron job) та генерувати звіти що години.',
	'General_ArchivingTriggerDescription' => 'Для великих інсталяцій Intranet Statistics рекомендується %sналаштувати планувальних завдань (cron job)%s щоб обробляти звіти автоматизовано.',
	...
	'General_RequiresFlash' => 'Для відображення графіків в Intranet Statistics необхідно Flash',
	'General_GraphHelp' => 'Дізнатися більше інформації про відображення графіків в Intranet Statistics',
	...
	'General_YouAreViewingDemoShortMessage' => 'Зараз переглядається демонстраційний варіант Intranet Statistics',
	'General_DownloadFullVersion' => '%1$sЗавантажити%2$s повну версію! Переглянути %3$s',
	'General_NewUpdatePiwikX' => 'останнє поновлення: Intranet Statistics %s',
	'General_AboutPiwikX' => 'Про Intranet Statistics %s',
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Intranet Statistics %1$s випущено. %2$s Будь-ласка поновіть негайно!%3$s (дивитися %4$s що змінилося%5$s).',
	'General_PiwikXIsAvailablePleaseNotifyPiwikAdmin' => 'Випущено %s . Будь-ласка повідомте адміністратора веб-сайту.',
	'General_NewReportsWillBeProcessedByCron' => 'Якщо обробка даних Intranet Statistics не запускається браузером то нові звіти будуть оброблені планувальником завдань (crontab)',
	...
	'General_BackToPiwik' => 'Повернутися до Intranet Statistics',
	...
	'General_ConfigFileIsNotWritable' => 'Файл конфігурації Intranet Statistics %s захищений від запису, деякі зміни можуть бути не збережені. %s Змініть права доступу до файла конфігурації щоб дозволити запис.',
	'General_ExceptionDatabaseVersion' => 'Ваша версія %1$s є %2$s але Intranet Statistics вимагає мінімум %3$s.',
	...
	'General_FileIntegrityWarningExplanation' => 'Перевірка цілісності файлу визначила пошкоджені файли. Можливо це відбулося через часткове завантаження або розриви зв’язку підчас завантаження файлів Intranet Statistics на сервер. Перезавантажте всі файли Intranet Statistics в двійковому режимі (BINARY mode) та обновіть цю сторінку щоб повторити перевірку.',
	...
	'General_PleaseUpdatePiwik' => 'Поновіть вашу інсталяцію Intranet Statistics',
	...
	'API_PluginDescription' => 'Всі дані в Intranet Statistics доступні через простий набір API для кожного набору даних.  Цей плагін є точною входу для веб-сервісу, через яку можливо звертатися щоб отримати дані веб-аналітики у форматі xml, json, php, csv, тощо.',
	'API_QuickDocumentationTitle' => 'Базова документація API',
	'API_GenerateVisits' => 'Якщо на сьогодні ще немає даних то можна власноручно згенерувати дані використовуючи плагін %s . Щоб увімкнути плагін %s , клацніть "Visitor Generator" меню в Панелі Адміністратора Intranet Statistics.',
	'API_MoreInformation' => 'Для отримання детальнішої інформації про API Intranet Statistics, перегляньте %s Вступ до Intranet Statistics API %s та %s Довідковий матеріал по Intranet Statistics API %s.',
	...
	'CoreAdminHome_PluginDescription' => 'Панель Адміністратора Intranet Statistics',
	...
	'CoreAdminHome_OptOutExplanation' => 'Intranet Statistics турбується про конфіденціальність в Інтернеті. Щоб надати вашим відвідувачам можливість відмовитися від включення інфомації про них до бази даних веб-аналітики Intranet Statistics, додайте наступний HTML код на одну з ваших сторінок - для прикладу на сторінку "Політика конфіденційності".',
	...
	'CoreHome_JavascriptDisabled' => 'JavaScript повинен бути увімкнений щоб користовуватися Intranet Statistics в стандартному режимі. <br /> Нажаль, JavaScript вимкнено або не підтримується вашим веб-оглядачем.<br /> Щоб використовувати стандартний режим, увімкніть JavaScript змінивши налаштування вашого веб-оглядача, а тоді %1$sспробуйте ще раз%2$s.<br />',
	...
	'CorePluginsAdmin_MainDescription' => 'Плагіни розширюють та примножують функціонал Intranet Statistics. Як тільки плагін встановлено його можна автивувати або деактивувати тут.',
	...
	'CoreUpdater_PluginDescription' => 'Механізм поновлення Intranet Statistics',
	'CoreUpdater_UpdateTitle' => 'Intranet Statistics › Поновлення',
	'CoreUpdater_DatabaseUpgradeRequired' => 'Необхідно поновити базу даних',
	'CoreUpdater_YourDatabaseIsOutOfDate' => 'База даних Intranet Statistics застаріла, і повинна бути поновлена перед наступним кроком.',
	'CoreUpdater_PiwikWillBeUpgradedFromVersionXToVersionY' => 'База даних Intranet Statistics буде поновлена з версії %1$s до нової версії %2$s.',
	'CoreUpdater_TheFollowingPluginsWillBeUpgradedX' => 'Наступні плагіни буде поновлено: %s.',
	'CoreUpdater_NoteForLargePiwikInstances' => 'Важливе зауваження для великих інсталяцій Intranet Statistics',
	'CoreUpdater_TheUpgradeProcessMayFailExecuteCommand' => 'Якщо у вас велика база даних Intranet Statistics, поновлення можуть забирати надто багато часу для запуску їх з браузера. В такому випадку, ви можете виконати поновлення з командного рядка: %s',
	'CoreUpdater_YouCouldManuallyExecuteSqlQueries' => 'Якщо немає можливості використовувати поновлювач з командного рядка або якщо не вдається здійснити поновлення Intranet Statistics (через розрив підєднання до бази даних, тайм-аут веб-оглядача чи з іншої причини) є можливість виконати SQL запити в ручну для поновлення бази даних до останньої версії.',
	...
	'CoreUpdater_UpgradePiwik' => 'Поновити Intranet Statistics',
	...
	'CoreUpdater_ErrorDIYHelp_3' => 'вручну обновіть таблицю "option" в базі даних Intranet Statistics, задавши значення "version_core" на версію обновитись до якої не вдалося',
	...
	'CoreUpdater_ErrorDIYHelp_5' => 'повідомте про проблему (або ваше рішення) що ми покращили роботу Intranet Statistics',
	'CoreUpdater_HelpMessageContent' => 'Гляньте на %1$s Intranet Statistics FAQ %2$s де є пояснення найтиповіших помилок що виникають протягом поновлення. %3$s Зверніться за допомогою до системного адміністратора, - що може допомогти вирішити помилки пов’язані з сервером або налаштуванням бази даних.',
	...
	'CoreUpdater_PiwikHasBeenSuccessfullyUpgraded' => 'Intranet Statistics успішно поновлено!',
	'CoreUpdater_ContinueToPiwik' => 'Перейти далі до Intranet Statistics',
	'CoreUpdater_UpdateAutomatically' => 'Поновити автоматично',
	'CoreUpdater_ThereIsNewVersionAvailableForUpdate' => 'Є нова версія Intranet Statistics доступна до поновлення',
	...
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'Поновлення Intranet Statistics Одним Клацанням було скасовано. Якщо неможливо виправити повідомлення про помилку вище, рекомендується поновити Intranet Statistics вручну. %1$s Гляньте %2$sДокументацію про поновлення%3$s щоб розпочати!',
	...
	'CoreUpdater_PiwikUpdatedSuccessfully' => 'Intranet Statistics успішно поновлено!',
	'CoreUpdater_EmptyDatabaseError' => 'База даних %s порожня. Відредагуйте або видаліть файл конфігурації Intranet Statistics.',
	'CoreUpdater_ExceptionAlreadyLatestVersion' => 'Версія Intranet Statistics %s обновлена до останньої.',
	...
	'DBStats_PluginDescription' => 'Цей плагін надає звіт про використання бази даних таблицями Intranet Statistics.',
	'DBStats_DatabaseUsage' => 'Використання бази даних',
	'DBStats_MainDescription' => 'Intranet Statistics зберігає всі дані для веб-аналітики в MySQL базі даних. На даний час, таблиці з даними Intranet Statistics займають %s',
	'DBStats_LearnMore' => 'Щоб зрозуміти більше як Intranet Statistics обробляє дані та як покращити роботу Intranet Statistics для сайтів з середнім та високим трафіком, перегляньте документацію %s.',
	...
	'ExampleUI_PluginDescription' => 'Зразок плагіну: Плагін який показує як працювати з Intranet Statistics UI: створювати таблиці, графіки, тощо...',
	'Feedback_PluginDescription' => 'Надішліть свій відгук кодманді Intranet Statistics. Поділіться з нами своїми ідеями та пропозиціями!',
	...
	'Feedback_WhyWrongCountry' => 'Чому Intranet Statistics показує мої візити з неправильної країни?',
	...
	'Feedback_SpecialRequest' => 'Чи є у вас спеціальне звернення до команди Intranet Statistics?',
	'Feedback_ContactThePiwikTeam' => 'Звязатися з командою Intranet Statistics!',
	'Feedback_IWantTo' => 'Я хочу:',
	'Feedback_CategoryShareStory' => 'Поділитися історією успіху використання Intranet Statistics',
	'Feedback_CategorySponsor' => 'Виступити спонсором Intranet Statistics',
	'Feedback_CategoryHire' => 'Найняти консультанта по Intranet Statistics',
	...
	'Feedback_MessageSent' => 'Повідомлення було надіслане команді Intranet Statistics.',
	'Feedback_ThankYou' => 'Дякуємо що допомагаєте робити Intranet Statistics кращим!',
	...
	'Goals_NoGoalsNeedAccess' => 'Тільки Адміністратор або Супер Користовувач можуть додавати Цілі для даного веб-сайту. Зверніться до Intranet Statistics адміністратора для налаштування Цілі для вашого сайту.<br>Відслідковування Цілей це хороший спосіб зрозуміти та максимізувати ефективність роботи сайту.',
	...
	'Goals_DefaultRevenueHelp' => 'Для прикладу, надіслана відвідувачем Форма Контактів може в середньому вартувати $10. Intranet Statistics дозволить вам зрозуміти наскільки добре поводять себе різні сегменти ваших користувачів.',
	...
	'Goals_LearnMoreAboutGoalTrackingDocumentation' => 'Дізнайтеся більше про %sВідслідковування Цілей в Intranet Statistics%s у документації користувача.',
	'Installation_PluginDescription' => 'Процес інсталяції Intranet Statistics. Інсталяція зазвичай виконується тільки один раз. Якщо файл конфігурації config/config.inc.php видалено, інсталяція розпочнеться знову.',
	...
	'Installation_NoConfigFound' => 'Файл конфігурації Intranet Statistics не знайдено в той час як Ви намагаєтесь користуватися Intranet Statistics.<br><b>  » Ви можете <a href=\'index.php\'>встановити Intranet Statistics зараз</a></b><br><small>Якщо ви встановили Intranet Statistics раніше і деякі таблиці залишились в базі даних, Ви зможете використати їх і тим самим зберегти вже існуючі дані!</small>',
	...
	'Installation_LargePiwikInstances' => 'Доомога для великих інсталяцій Intranet Statistics',
	'Installation_JsTag' => 'Тег JavaScript',
	'Installation_Congratulations' => 'Вітання!',
	'Installation_CongratulationsHelp' => '<p>Вітання! Встановлення Intranet Statistics завершено.</p><p>Переконайтеся що JavaScript код додано на кожну вашу сторінку, та очікуйте на перших відвідувачів!</p>',
	'Installation_ContinueToPiwik' => 'Перейти далі до Intranet Statistics',
	...
	'Installation_SecurityNewsletter' => 'Надішліть повідомлення при виході нових версій Intranet Statistics та поновленнях безпеки',
	...
	'Installation_Requirements' => 'Системні вимоги Intranet Statistics',
	...
	'Installation_SystemCheckDatabaseHelp' => 'Intranet Statistics вимагає або mysqli розширення або обидва розшинення PDO та pdo_mysql.',
	...
	'Installation_SystemCheckParseIniFileHelp' => 'Ця вбудована функція було заблокована на вашому хостингу. Intranet Statistics спробує емулювати цю функцію але може зістикнутися з подальшими обмеженнями по безпеці. Також це вплине на загальну швидкість роботи системи.',
	'Installation_SystemCheckGlobHelp' => 'Ця вбудована функція було заблокована на вашому хостингу. Intranet Statistics спробує емулювати цю функцію але може зістикнутися з подальшими обмеженнями по безпеці. Функціональність може бути обмежена.',
	'Installation_SystemCheckDebugBacktraceHelp' => 'View::factory неможе створити інтерфейс для модуля що робить виклик.',
	'Installation_SystemCheckCreateFunctionHelp' => 'Intranet Statistics використовує анонімні функції для зворотніх-викликів.',
	...
	'Installation_SystemCheckAutoUpdateHelp' => 'Примітка: Поновлення в-одне-клацання Intranet Statistics-а вимагає доступу на запис в папку Intranet Statistics та дочірні папки/файли.',
	'Installation_SystemCheckError' => 'Виникла помилка - треба виправити перед тим як рухатись далі',
	'Installation_SystemCheckWarning' => 'Intranet Statistics загалом буде працювати за вийнятком деяких можливостей',
	...
	'Installation_TablesWithSameNamesFound' => 'Деякі %1$s таблиці в базі даних %2$s мають імена тих таблиць що створюються Intranet Statistics-ом.',
	...
	'Installation_TablesDeletedSuccess' => 'Існуючі таблиці Intranet Statistics видалено успішно',
	...
	'Installation_GoBackAndDefinePrefix' => 'Повернутися і встановити префікс для таблиць Intranet Statistics',
	...
	'Installation_WelcomeHelp' => '<p>Intranet Statistics - це <a href="http://ru.wikipedia.org/wiki/Open_source">open source</a> програмне забезпечення для веб-аналітики, за допомогою якого ви можете з легкісню отримати аналітичну інформацию про ваших відвідувачів.</p><p>Цей процес складається з %s простих кроків і займе не більше 5 хвилин.</p>',
	'Installation_ConfigurationHelp' => 'Файл конфігурації Intranet Statistics не налаштований. Видаліть файл config/config.ini.php та перезапустіть інсталяцію, або виправте налаштування підєднання до бази даних.',
	'Installation_ErrorInvalidState' => 'Помилка: здається була спроба пропустити крок процесу встановлення, або браузер не приймає куки, або файл конфігурації Intranet Statistics вже створено. %1$sПереконайтеся що куки дозволено%2$s та поверніться %3$s до першого кроку процесу встановлення %4$s.',
	'LanguagesManager_PluginDescription' => 'Цей плагін показуватиме перелік наявних мов для інтерфейсу Intranet Statistics. Вибрана мова буде збережена в налаштуваннях для кожного користувача.',
	'LanguagesManager_AboutPiwikTranslations' => 'Про переклади Intranet Statistics',
	...
	'Login_ContactAdmin' => 'Можлива причина: функція mail() відключена в налаштуваннях вашого хостингу.<br/>Зверніться, будь ласка, до вашого Intranet Statistics-адміністратора.',
	...
	'MultiSites_PluginDescription' => 'Показує багато-сайтову всеохоплюючу статистику. На даний час підтримується як плагін ядра Intranet Statistics.',
	...
	'SitesManager_PluginDescription' => 'Керування Веб-сайтами в Intranet Statistics: Додати новий веб-сайт, редагувати існуючі, пеерглянути JavaScript код щоб включити на ваші сторінки. Всі операції також доступні через API.',
	...
	'SitesManager_PiwikWillAutomaticallyExcludeCommonSessionParameters' => 'Intranet Statistics автоматично виключатиме типові параметри сесій (%s).',
	'SitesManager_HelpExcludedIps' => 'Введіть перелік IP-адрес (кожну з нового рядка) що бажаєте виключити з відслідковування системою Intranet Statistics. Можете використовувати символи підстановок, наприклад %1$s or %2$s',
	...
	'TranslationsAdmin_PluginDescription' => 'Допоможіть перекласти Intranet Statistics вашою мовою.',
	...
	'UsersManager_PluginDescription' => 'Керування користувачами в Intranet Statistics: додати нового користувача, відредагувати існуючого, змінити налаштування прав доступу. Всі дії також доступні через API.',
	...
	'UsersManager_MainDescription' => 'Встановіть який рівень Intranet Statistics доступу має кожен користувач на ваших веб-сайтах.',
	...
	'UsersManager_YourVisitsAreIgnoredOnDomain' => '%sВаші відвідування ігноруються системою Intranet Statistics в %s %s (Intranet Statistics знашов cookie у вашому браузері з вказівкою ігнорувати).',
	'UsersManager_YourVisitsAreNotIgnored' => '%sВаші відвідування відслідковуються системою Intranet Statistics  %s (Intranet Statistics не знашов cookie у вашому браузері).',
	'UsersManager_ClickHereToDeleteTheCookie' => 'Клацніть щоб видалити cookie та дозволити Intranet Statistics відслідковувати ваші візити',
	...
	'UsersManager_WhenUsersAreNotLoggedInAndVisitPiwikTheyShouldAccess' => 'Якщо користувачі не увійшли в систему і відвідують Intranet Statistics, то овни повинні мати можливість отримати доступ',
	...
	'UsersManager_ExceptionEditAnonymous' => 'Анонімний користувач не може бути відредагований або видалений. Цей тип користувачів Intranet Statistics застосовує для користувачів, які не представились системі. Наприклад, Ви можете зробити Вашу статистику публічною надаючи права "перегляду" анонімномим користувачам.',
	'UsersManager_ExceptionSuperUser' => 'Запитуваний користувач є Супер-користувачем а тому не може бути запитаний, редогований або видалений через API. Можна тільки вручну редагувати деталі Супер-користувача в конфігураційному файлі Intranet Statistics.',
	...
	'VisitorGenerator_PluginDescription' => 'Плагін для створення не справжніх відвідувань. Може бути використаний Intranet Statistics користувачами чи розробниками як легкий інструмент для генерації не справжніх даних щоб заповнити звіти.',
	'VisitorGenerator_VisitorGenerator' => 'Генератор Відвідувачів',
	'VisitorGenerator_Warning' => 'Ви згенеруєте не справжні відвідучання які будуть записані в базу даних Intranet Statistics.',
	'VisitorGenerator_NotReversible' => 'Буде %s НЕ МОЖЛИВО%s легко видалити не справжні відвідування з протоколів Intranet Statistics.',
	...
	'Widgetize_PluginDescription' => 'Цей плагін дозволяє дуже легко експортувати будь-який віджет Intranet Statistics до свого блогу, веб-сайту або іGoogle чи Netvibes!',
	...
	'PDFReports_PiwikReports' => 'Звіти Intranet Statistics',
