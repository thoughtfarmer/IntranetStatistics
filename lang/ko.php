...
$translations = array(
	...
	'General_Error' => '에러',
	'General_Warning' => '경고',
	'General_BackToHomepage' => 'Intranet Statistics 홈페이지로 돌아가기',
	'General_Yes' => '예',
	'General_No' => '아니오',
	'General_Delete' => '삭제',
	'General_Report' => '보고서',
	...
	'General_AllowPiwikArchivingToTriggerBrowser' => '보고서가 브라우저에 표시될 때 트리거하는 Intranet Statistics 아카이브 허용',
	'General_ArchivingInlineHelp' => '비교적 트래픽이 높은 웹사이트는 브라우저 트리거를 Intranet Statistics에 보관하는 것을 비활성화하는 것이 좋습니다. 대신, 1 시간마다 Intranet Statistics 보고서를 처리하는 cron 작업을 설정하는 것이 좋습니다.',
	...
	'General_RequiresFlash' => 'Intranet Statistics에서 그래프 보기에는 Flash가 필요합니다',
	'General_GraphHelp' => 'Intranet Statistics 그래프 정보입니다.',
	...
	'General_PiwikIsACollaborativeProjectYouCanContributeAndDonate' => '%1$sIntranet Statistics%2$s은 공동 프로젝트입니다. %3$s 만약 Intranet Statistics의 팬이라면, %4$sIntranet Statistics에 참여하는 방법%5$s을 찾아보거나, Intranet Statistics 2.0을 위해 %6$s %7$s기부%8$s하여 도움을 주세요!',
	'General_YouAreViewingDemoShortMessage' => '현재 Intranet Statistics 데모를 표시',
	'General_YouAreCurrentlyUsing' => '현재 Intranet Statistics %s를 이용하고 있습니다.',
	'General_DownloadFullVersion' => '풀버전 %1$s다운로드%2$s! %3$s을 확인하세요.',
	'General_NewUpdatePiwikX' => '새로운 업데이트: Intranet Statistics %s',
	'General_AboutPiwikX' => 'Intranet Statistics %s은...',
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Intranet Statistics %1$s 이 사용 가능합니다. %2$s 지금 업데이트하세요!%3$s (보기: %4$s 변경%5$s).',
	'General_PiwikXIsAvailablePleaseNotifyPiwikAdmin' => '%s를 사용할 수 있습니다. 사이트 관리자에게 알려 주세요.',
	'General_NewReportsWillBeProcessedByCron' => 'Intranet Statistics 아카이브가 브라우저 표시를 트리거하지 않으면, 새로운 보고서는 crontab에 의해 처리됩니다.',
	...
	'General_BackToPiwik' => 'Intranet Statistics으로 돌아가기',
	...
	'General_ConfigFileIsNotWritable' => 'Intranet Statistics 설정 파일 %s를 쓸수 없기 때문에 일부 변경이 저장되지 않을 수 있습니다. %s 설정 파일의 권한을 쓸 수 있게 변경하세요.',
	'General_StatisticsAreNotRecorded' => 'Intranet Statistics의 방문자 추적이 현재 비활성화 되어 있습니다! 다시 추적을 활성화 하려면 config/config.ini.php 파일을 열고 record_statistics = 1로 설정하세요.',
	'General_ExceptionDatabaseVersion' => '현재 %1$s 버전 %2$s 이지만 Intranet Statistics에는 적어도 %3$s가 필요합니다.',
	...
	'General_FileIntegrityWarningExplanation' => '파일의 무결성 검사가 실패하고 몇 가지 오류가 보고되었습니다. 이것은 대부분의 경우, 파일이 불완전하거나 일부 Intranet Statistics 파일을 업로드에 실패했을 때 입니다. 모든 Intranet Statistics 파일을 바이너리 모드로 다시 업로드하여 오류가 나타나지 않을 때까지 페이지를 새로 고침할 필요가 있습니다.',
	...
	'General_Language' => '언어',
	'General_PleaseUpdatePiwik' => 'Intranet Statistics을 업데이트하세요',
	...
	'Actions_DownloadsReportDocumentation' => '이 보고서는 방문자가 어떤 파일을 다운로드했는지에 대한 정보입니다. %s Intranet Statistics는 다운로드 링크의 클릭 수를 계산합니다. 하지만 다운로드가 완료되었는지 여부는 확인할 수 없습니다.',
	...
	'API_PluginDescription' => 'Intranet Statistics의 모든 데이터는 간단한 API를 통해 사용할 수 있습니다. 이 플러그인은 xml, json, php, csv 등 웹 분석 데이터를 얻기 위해 호출 할 수있는 웹서비스의 진입점입니다.',
	...
	'API_MoreInformation' => 'Intranet Statistics API에 대한 자세한 내용은 %sIntroduction to Intranet Statistics API %s 문서와 %sIntranet Statistics API Reference%s 문서를 참조하세요.',
	...
	'CoreAdminHome_PluginDescription' => 'Intranet Statistics의 관리 영역입니다.',
	...
	'CoreAdminHome_OptOutForYourVisitors' => '방문자의 Intranet Statistics 차단',
	'CoreAdminHome_OptOutExplanation' => 'Intranet Statistics은 인터넷에서 개인 정보 제공에 최선을 다하고 있습니다. 방문자에 Intranet Statistics 웹 분석의 차단 옵션을 제공하기 위해 웹 사이트의 1페이지 (개인 정보 보호 정책 페이지 등)에 다음 HTML 코드를 추가 할 수 있습니다.',
	'CoreAdminHome_OptOutExplanationBis' => 'HTML 코드는 방문자의 브라우저에 차단 Cookie를 설정하는 Intranet Statistics 차단 링크를 ​​포함 iFrame을 표시합니다. iFrame에서 표시되는 내용을 표시하려면 %s여기를 클릭%s합니다.',
	...
	'CoreAdminHome_CustomLogoHelpText' => 'Intranet Statistics 로고를 사용자정의하여 사용자 인터페이스 화면과 이메일 보고서를 볼 수 있습니다.',
	'CoreAdminHome_CustomLogoFeedbackInfo' => 'Intranet Statistics 로고를 변경하거나 상단 메뉴의 %s 링크도 숨길 수 있습니다. %s 플러그인 관리 %s 페이지에서 피드백 플러그인을 비활성화세요.',
	...
	'CoreAdminHome_TrustedHostSettings' => '신뢰할 수 있는 Intranet Statistics 호스트네임',
	'CoreAdminHome_TrustedHostConfirm' => '신뢰할 수 있는 Intranet Statistics 호스트네임으로 변경하시겠습니까?',
	'CoreAdminHome_PiwikIsInstalledAt' => 'Intranet Statistics가 설치되어 있습니다',
	'CoreAdminHome_ValidPiwikHostname' => '유효한 Intranet Statistics 호스트네임',
	...
	'CoreHome_InjectedHostWarningIntro' => '당신은 지금 %1$s에서 Intranet Statistics에 접근하고 있지만 Intranet Statistics은 다음 주소로 실행되도록 구성되어 있습니다: %2$s',
	'CoreHome_InjectedHostSuperUserWarning' => 'Intranet Statistics이 잘못 구성된 것 같습니다 (예를 들어, Intranet Statistics이 최근에 새로운 서버 또는 URL로 이동됨). 유효한 Intranet Statistics 호스트네임을 (신뢰하는 경우) %1$s이곳을 클릭하여 추가%2$s할 수 있습니다 %3$s, 또는 %4$s이곳을 클릭하여 이동%5$s하는 것으로 Intranet Statistics의 안전한 %6$s로 접근할 수 있습니다.',
	'CoreHome_InjectedHostNonSuperUserWarning' => '%1$sIntranet Statistics에 안전하게 접근하려면 여기를 클릭%2$s하고 이 경고를 제거합니다. 또한 Intranet Statistics 관리자에게 문의하여이 이 문제를 알릴 수 있습니다 (%3$s클릭하여 이메일 발송%4$s).',
	'CoreHome_InjectedHostEmailSubject' => 'Intranet Statistics에서 알 수 없는 호스트네임을 사용하여 접근함: %s',
	'CoreHome_InjectedHostEmailBody' => '안녕하세요, 오늘 Intranet Statistics에 접근 시도했는데 알 수 없는 호스트 경고가 발생했습니다.',
	'CoreHome_CheckForUpdates' => '업데이트 확인',
	'CoreHome_YouAreUsingTheLatestVersion_js' => 'Intranet Statistics 최신 버전을 사용하고 있습니다!',
	'CoreHome_MakeADifference' => '개발 지원: Intranet Statistics 2.0에 %1$s기부해 주세요%2$s!',
	'CoreHome_DonateCall1' => 'Intranet Statistics을 사용하는데 당신의 비용이 들지는 않을 것입니다. 그렇다고  우리가 이것을 만드는데 비용이 들지 않다는 의미는 아닙니다.',
	'CoreHome_DonateCall2' => 'Intranet Statistics은 성장하고 번영하기 위해 당신의 지속적인 지원이 필요합니다.',
	'CoreHome_DonateCall3' => 'Intranet Statistics이 당신의 업무나 시도하는 일에 특별한 가치를 더해준다고 느끼신다면, %1$s기부해 주세요!%2$s',
	'CoreHome_HowMuchIsPiwikWorth' => '당신에게 Intranet Statistics의 가치는 얼마인가요?',
	'CoreHome_SupportPiwik' => 'Intranet Statistics 지원!',
	'CoreHome_OnlyForAdmin' => '이것은 슈퍼 유저인 당신에게만 표시됩니다.',
	'CoreHome_DonateFormInstructions' => '슬라이더를 클릭하여 금액을 선택하고, 기부에 기명을 클릭합니다.',
	'CoreHome_SubscribeAndBecomePiwikSupporter' => 'Intranet Statistics의 후원자가 되기 위해서 보안 신용카드 결제 페이지 (페이팔)로 이동합니다!',
	'CoreHome_CheckPiwikOut' => 'Intranet Statistics 출시 확인!',
	...
	'CoreHome_SharePiwikShort' => 'Intranet Statistics은 오픈소스기반 무료 웹 분석 도구입니다. 이제 소중한 정보를 소유하세요!',
	'CoreHome_SharePiwikLong' => 'Intranet Statistics! 이라는 멋진 오픈소스를 발견했습니다. Intranet Statistics은 웹사이트의 방문자를 추적할 수 있는 무료 분석 도구입니다. 꼭 확인해 보세요!',
	'PrivacyManager_TeaserHeadline' => '개인 정보 보호 설정',
	'PrivacyManager_Teaser' => '이 페이지에서는 기존의 법률에 따라, Intranet Statistics이 개인에 맞도록 정의할 수 있습니다: %s 익명 방문자의 IP 주소 %s, %s 자동으로 데이터베이스에서 오래된 방문자의 로그를 삭제 %s, %s 웹사이트를 탈퇴하는 방법을 제공 %s에 따름.',
	'PrivacyManager_MenuPrivacySettings' => '개인 정보 보호',
	'PrivacyManager_PluginDescription' => '기존의 법률에 따라, Intranet Statistics이 개인 정보 보호를 준수하도록 지정합니다.',
	...
	'PrivacyManager_DeleteDataDescription' => '데이터베이스 크기를 작게 유지하기 위해 기존 방문자의 로그와 생성된 보고서를 정기적으로 삭제하도록 Intranet Statistics을 설정할 수 있습니다.',
	...
	'PrivacyManager_DoNotTrack_EnabledMoreInfo' => '브라우저에서 사용자가 "추적당하고 싶지 않음"을 설정한 경우, ("추적하지 않음"기능이 활성화되어 있으면) Intranet Statistics 이러한 방문자를 추적하지 않습니다.',
	'PrivacyManager_DoNotTrack_Disabled' => 'Intranet Statistics은 현재 브라우저에서 "추적당하고 싶지 않음"이 지정된 경우에도 모든 방문자를 추적하고 있습니다.',
	...
	'CoreHome_NoPrivilegesAskPiwikAdmin' => '\'%s\'로 로그인되었지만 권한이 설정되어 있지 않습니다. %s Intranet Statistics 관리자(클릭 이메일) %s에 \'보기\'권한을 부여 받으세요.',
	'CoreHome_JavascriptDisabled' => 'Intranet Statistics의 표준보기를 이용하려면 JavaScript가가 활성화되어 있어야 합니다.<br />하지만, 당신의 브라우저는 활성화되어있지 않거나 지원되지 않는 것 같습니다.<br />표준보기를 이용하려면 브라우저 옵션을 변경하여 JavaScript를 활성화하고 <br /> %1$s다시 시도하세요%2$s.<br />',
	...
	'CorePluginsAdmin_MainDescription' => '플러그인 확장과 Intranet Statistics의 기능성 확장페이지입니다. 플러그인이 한번 설치되면 이곳에서 활성화하거나 비활성화할 수 있습니다.',
	...
	'CoreUpdater_PluginDescription' => 'Intranet Statistics 업데이트 메커니즘',
	'CoreUpdater_UpdateTitle' => 'Intranet Statistics › 업데이트',
	'CoreUpdater_DatabaseUpgradeRequired' => '데이터베이스 업그레이드 필요함',
	'CoreUpdater_YourDatabaseIsOutOfDate' => 'Intranet Statistics 데이터베이스가 오래되었으니 계속하기 이전에 먼저 업그레이드가 되어야 합니다.',
	'CoreUpdater_PiwikWillBeUpgradedFromVersionXToVersionY' => 'Intranet Statistics 데이터베이스가 %1$s 버전에서 %2$s 새 버전으로 업그레이드됩니다.',
	'CoreUpdater_TheFollowingPluginsWillBeUpgradedX' => '다음의 플러그인들이 업데이트됩니다: %s.',
	'CoreUpdater_NoteForLargePiwikInstances' => '용량이 큰 Intranet Statistics 설치시 주의해야 할 점',
	'CoreUpdater_TheUpgradeProcessMayFailExecuteCommand' => 'Intranet Statistics의 데이터베이스가 큰 경우, 브라우저에서 업데이트를 실행하는 데 시간이 오래 걸릴 수 있습니다. 이 경우 명령 줄에서 업데이트를 수행할 수 있습니다: %s',
	'CoreUpdater_YouCouldManuallyExecuteSqlQueries' => 'Intranet Statistics 업그레이드에 실패(데이터베이스의 시간 초과, 브라우저의 시간 제한 또는 기타 문제로 인해)하고 명령 줄 업데이트를 사용할 수 없는 경우, Intranet Statistics를 업데이트하기 위해 직접 SQL 쿼리를 실행할 수 있습니다.',
	...
	'CoreUpdater_UpgradePiwik' => 'Intranet Statistics 업그레이드',
	...
	'CoreUpdater_ErrorDIYHelp_3' => 'Intranet Statistics 데이터베이스 \'option\'테이블에있는 version_core 값을 실패한 업데이트 버전으로 설정하여 수동으로 테이블을 업데이트하세요',
	'CoreUpdater_ErrorDIYHelp_4' => '나머지 업데이트를 계속하기 위해 업데이트를 다시 실행하세요 (브라우저 또는 명령 줄에서)',
	'CoreUpdater_ErrorDIYHelp_5' => 'Intranet Statistics을 향상시킬 수 있도록 문제(또는 해결방법)를 알려주세요',
	'CoreUpdater_HelpMessageContent' => '업데이트 도중에 발생하는 공통적인 에러가 설명되어 있는 %1$s Intranet Statistics FAQ %2$s 를 확인하세요. %3$s 시스템 관리자에게 물어보세요 - 에러는 서버나 MySQL 설정과 관련되어 있는 경우가 많아 도움을 줄 수도 있습니다.',
	...
	'CoreUpdater_PiwikHasBeenSuccessfullyUpgraded' => 'Intranet Statistics 이 성공적으로 업데이트되었습니다!',
	'CoreUpdater_ContinueToPiwik' => 'Intranet Statistics 계속 하기',
	'CoreUpdater_UpdateAutomatically' => '자동 업데이트',
	'CoreUpdater_ThereIsNewVersionAvailableForUpdate' => 'Intranet Statistics의 새 버전으로 업데이트 할 수 있습니다.',
	'CoreUpdater_YouCanUpgradeAutomaticallyOrDownloadPackage' => '%s 버전으로 자동 업데이트하거나 수동적으로 패키지를 받아서 업데이트 할 수 있습니다:',
	'CoreUpdater_YouMustDownloadPackageOrFixPermissions' => 'Intranet Statistics 현재 설치에 덮어쓸 수 없습니다. 디렉토리/파일 권한을 수정하거나 패키지를 다운로드하여 수동으로 버전 %s를 설치할 수 있습니다:',
	'CoreUpdater_DownloadX' => '다운로드 %s',
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'Intranet Statistics 원클릭 업데이트가 취소되었습니다. 만약 위의 에러 메세지를 고칠 수 없다면, 수동으로 Intranet Statistics을 업데이트하는 것을 권장합니다. %1$s 시작하기 위해 %2$s업데이트 문서%3$s 를 확인하세요!',
	...
	'CoreUpdater_PiwikUpdatedSuccessfully' => 'Intranet Statistics 업데이트가 성공적으로 완료되었습니다!',
	'CoreUpdater_EmptyDatabaseError' => '데이터베이스 %s 는 비어있습니다. Intranet Statistics 설정 파일을 편집하거나 제거해야 합니다.',
	'CoreUpdater_ExceptionAlreadyLatestVersion' => 'Intranet Statistics %s 버전은 최신입니다.',
	...
	'CustomVariables_PluginDescription' => '맞춤 변수는 이름과 값으로 이루어집니다. Javascript API의 setVisitCustomVariables() 함수를 사용하여 방문 수를 설정할 수 있습니다. Intranet Statistics은 그 이름과 값에 대한 방문수와 페이지 전환수를 보고합니다.',
	...
	'CustomVariables_TrackingHelp' => '도움말: %1$sIntranet Statistics에서 사용자가 지정한 변수 추적%2$s',
	...
	'DBStats_PluginDescription' => 'Intranet Statistics 테이블의 MySQL 데이터베이스 사용량을 보고합니다.',
	'DBStats_DatabaseUsage' => '데이터베이스 사용량',
	'DBStats_MainDescription' => 'Intranet Statistics은 모든 웹 분석 데이터를 MySQL 데이터베이스에 저장하고 있습니다. 현재, Intranet Statistics 테이블은 %s 를 사용하고 있습니다.',
	'DBStats_LearnMore' => '트래픽이 비교적 높은 웹 사이트에서 Intranet Statistics 데이터를 처리 방법이나 Intranet Statistics을 작동시키는 방법에 대한 자세한 내용은 %s 문서를 참조하세요.',
	'DBStats_Table' => '테이블',
	...
	'ExampleUI_PluginDescription' => '예제 플러그인: 이 플러그인은 Intranet Statistics UI와의 연계 방법을 보여줍니다 (테이블, 그래프 등의 작성).',
	'Feedback_PluginDescription' => 'Intranet Statistics 팀에 의견을 제출합니다. 당신의 아이디어와 제안을 우리와 공유하해 주세요!',
	...
	'Feedback_SpecialRequest' => 'Intranet Statistics 팀에 특별한 요청이 있습니까?',
	'Feedback_ContactThePiwikTeam' => 'Intranet Statistics 팀에 연락하기!',
	'Feedback_IWantTo' => '내가 원하는 것은:',
	'Feedback_CategoryShareStory' => 'Intranet Statistics 성공 스토리 공유',
	'Feedback_CategorySponsor' => 'Intranet Statistics 후원',
	'Feedback_CategoryHire' => 'Intranet Statistics 컨설턴트',
	...
	'Feedback_MessageSent' => '당신의 메시지가 Intranet Statistics 팀에 제출되었습니다.',
	'Feedback_ThankYou' => '우리가 Intranet Statistics을 향상시키는 데 도움을 주셔서 감사합니다!',
	'Feedback_ThePiwikTeam' => 'Intranet Statistics 팀',
	...
	'Feedback_WantToThankConsiderDonating' => 'Intranet Statistics이 대단하다고 생각하며 감사를 표하고 싶으신가요? 기부를 고려하세요',
	'Goals_Goals' => '목표',
	...
	'Goals_NoGoalsNeedAccess' => '관리자 또는 슈퍼 사용자만이 특정 웹 사이트의 목표를 ​​추가할 수 있습니다. 웹사이트의 목표를 ​​설정하도록 Intranet Statistics 관리자에게 문의하세요. <br/> 목표 추적은 당신의 웹 사이트의 성능을 이해하고 극대화할 수 있도록 지원하는 좋은 방법입니다!',
	...
	'Goals_DefaultRevenueHelp' => '예를 들어 방문자가 전송된 연락처 양식이 평균적으로 10원의 가치가 있을지도 모릅니다. Intranet Statistics은 방문자 세그먼트가 얼마나 잘 수행하고 있는지를 이해하는 것을 돕고 있습니다.',
	...
	'Goals_LearnMoreAboutGoalTrackingDocumentation' => '%sIntranet Statistics에서 목표 추적%s에 대한 사용자 설명서에서 자세한 내용을 확인하세요!',
	...
	'Installation_PluginDescription' => 'Intranet Statistics 설치 작업을 수행합니다. 설치는 보통 한 번 하지만 설정 파일 (config/config.inc.php)이 삭제된 경우 설치가 다시 시작됩니다.',
	'Installation_Installation' => '설치',
	'Installation_InstallationStatus' => '설치 상태',
	'Installation_PercentDone' => '%s %% 완료',
	'Installation_NoConfigFound' => 'Intranet Statistics 설정 파일을 찾을 수 없으며 당신은 Intranet Statistics 페이지로 접근을 계속 시도하고 있습니다.<br /><b>  » <a href=\'index.php\'>지금 Intranet Statistics을 설치하세요.</a></b><br /><small>만약 Intranet Statistics을 이전에 설치한 적이 있고 DB에 테이블이 좀 있다면 걱정하지마세요, 같은 테이블을 재사용할 수 있고 현재 데이터를 보존할 수 있습니다!</small>',
	...
	'Installation_LargePiwikInstances' => '높은 트래픽 환경에서 Intranet Statistics를 사용하기 위한 팁',
	'Installation_JsTag' => '자바스크립트 태그',
	'Installation_Congratulations' => '축하합니다',
	'Installation_CongratulationsHelp' => '<p>축하합니다! Intranet Statistics 설치가 완료되었습니다.</p><p>페이지에 자바스크립트 코드가 입력되있는지 확인하시고 첫 방문객을 기다리세요!</p>',
	'Installation_ContinueToPiwik' => 'Intranet Statistics 계속 하기',
	'Installation_SiteSetup' => 'Intranet Statistics으로 추적 및 분석하려는 첫 번째 웹사이트를 설정하하세요:',
	...
	'Installation_SiteSetupFootnote' => '참고: Intranet Statistics 설치가 완료되면, 더 많은 웹사이트를 추적할 수 있습니다!',
	...
	'Installation_SecurityNewsletter' => 'Intranet Statistics의 주요 업그레이드 그리고 보안 경고를 이메일로 받기',
	'Installation_CommunityNewsletter' => '커뮤니티 업데이트를 이메일로 받기 (새로운 플러그인,새로운 기능 등등)',
	'Installation_PasswordDoNotMatch' => '비밀번호가 맞지 않습니다',
	'Installation_Requirements' => 'Intranet Statistics 요구 사항',
	...
	'Installation_SystemCheckDatabaseHelp' => 'Intranet Statistics은 mysqli 확장하거나 PDO와 pdo_mysql 확장의 둘 중 하나가 필요합니다.',
	...
	'Installation_SystemCheckParseIniFileHelp' => '이 내장 함수는 호스트에서 비활성화되어 있습니다. Intranet Statistics이 함수의 에뮬레이션을 시도하지만, 새로운 보안 제한으로 발생하는 경우가 있습니다. 또한 트래커 성능에도 영향을 미칩니다.',
	'Installation_SystemCheckGlobHelp' => '이 내장 함수는 호스트에서 비활성화되어 있습니다. Intranet Statistics이 함수의 에뮬레이션을 시도하지만, 새로운 보안 제한으로 발생하는 경우가 있습니다. 또한 기능에 영향을 미칠수 있습니다.',
	'Installation_SystemCheckDebugBacktraceHelp' => 'View::factory는 모듈을 호출하여 뷰를 만들 수 없습니다.',
	'Installation_SystemCheckCreateFunctionHelp' => 'Intranet Statistics은 콜백에 익명 함수를 사용합니다.',
	...
	'Installation_SystemCheckPackHelp' => 'pack() 함수는 Intranet Statistics에서 방문자를 추적하는 데 필요합니다.',
	...
	'Installation_SystemCheckAutoUpdateHelp' => '주의: Intranet Statistics의 원클릭 업데이트는 Intranet Statistics 폴더와 파일에 쓰기 권한이 필요합니다.',
	'Installation_SystemCheckError' => '에러 발생 - 진행 전에 수정이 필요함',
	'Installation_SystemCheckWarning' => 'Intranet Statistics 은 정상적으로 작동하지만 몇몇의 기능이 작동하지 않을 수 있습니다.',
	...
	'Installation_TablesWithSameNamesFound' => '몇몇의 테이블: %1$s / 데이터베이스: %2$s 가 Intranet Statistics이 생성하려고 하는 테이블 이름과 같습니다.',
	...
	'Installation_TablesDeletedSuccess' => '존재하는 Intranet Statistics 테이블을 성공적으로 삭제했습니다',
	'Installation_TablesCreatedSuccess' => '테이블 생성을 성공적으로 마쳤습니다!',
	'Installation_DatabaseCreatedSuccess' => '데이터베이스 %s 를 성공적으로 생성했습니다!',
	'Installation_GoBackAndDefinePrefix' => '돌아가서 Intranet Statistics 테이블을 위해 Prefix를 정의합니다',
	...
	'Installation_WelcomeHelp' => '<p>Intranet Statistics 은 오픈 소스 웹 분석 소프트웨어로써 쉽고 원하는 정보를 당신의 방문자들로부터 얻을 수 있게 해줍니다.</p><p>이 과정은 %s 의 쉬운 단계로 나뉘어 있고 5분 정도만 소요됩니다.</p>',
	'Installation_ConfigurationHelp' => 'Intranet Statistics 설정 파일이 잘못 설정되어있는 것 같습니다. config/config.ini.php를 제거하고 설치를 다시 시작하거나 데이터베이스의 연결 설정을 수정하세요.',
	'Installation_ErrorInvalidState' => '에러: 설치 과정의 단계를 뛰어넘으려고 하는 것 같습니다, 또는 쿠키가 비활성화거나, 또는 Intranet Statistics 설정 파일이 이미 생성되었습니다. %1$s쿠키가 활성화되어 있는지 확인하시고%2$s 설치 첫페이지로 %3$s 돌아가세요 %4$s.',
	...
	'Installation_SystemCheckSummaryThereWereErrors' => '헐! Intranet Statistics 설정에서 일부 %1$s심각한 오류%2$s를 감지했습니다. %3$s이 문제는 즉시 해결해야합니다.%4$s',
	'Installation_SystemCheckSummaryThereWereWarnings' => '시스템에 몇몇 문제가 있습니다. Intranet Statistics가 설치되었지만 몇가지 사소한 문제가 발생할 수 있습니다.',
	'Installation_SystemCheckSummaryNoProblems' => '만세! Intranet Statistics 설정에 아무런 문제가 없습니다. 스스로에게 칭찬하세요.',
	'Installation_SeeBelowForMoreInfo' => '자세한 내용은 아래를 참조하세요.',
	'Installation_DatabaseAbilities' => '데이터베이스 속성',
	'Installation_LoadDataInfileUnavailableHelp' => '%1$s을 사용하면 Intranet Statistics의 보관 과정의 속도를 크게 높일 수 있습니다. Intranet Statistics에서 사용할 수 있도록, PHP & MySQL의 소프트웨어를 업데이트하세요. 그리고 데이터베이스 사용자가 %2$s 권한을 가지고 있는지 확인하세요.',
	'Installation_LoadDataInfileRecommended' => '트래픽이 높은 웹사이트를 Intranet Statistics 서버에서 추적하려는 경우 (예: 한달 100,000 페이지뷰 이상), 이 문제를 해결하고 사용할 것을 권장합니다.',
	'Installation_Filesystem' => '파일시스템',
	'Installation_NfsFilesystemWarning' => '서버에서 NFS 파일시스템을 사용하고 있습니다.',
	'Installation_NfsFilesystemWarningSuffixAdmin' => '파일 기반 세션을 사용하는 경우 Intranet Statistics이 매우 느려짐을 의미합니다.',
	'Installation_NfsFilesystemWarningSuffixInstall' => 'NFS의 파일 기반 세션을 사용하면 매우 느립니다, 그래서 Intranet Statistics 데이터베이스 세션을 사용합니다. 대시보드 사용자가 많은 경우는, 데이터베이스 서버에 클라이언트 연결의 최대 수를 증가해야 할지도 모릅니다.',
	'LanguagesManager_PluginDescription' => 'Intranet Statistics 인터페이스에서 사용 가능한 언어 목록을 표시합니다. 선택된 언어는 각 사용자의 기본 설정에 저장됩니다.',
	'LanguagesManager_AboutPiwikTranslations' => 'Intranet Statistics 번역에 대해',
	...
	'Login_InvalidNonceOrHeadersOrReferer' => '양식 보안 실패, 양식을 새로고침하여 쿠키가 활성화되어 있는지 확인하세요. 프록시 서버를 사용하는 경우라면, 호스트 헤더에 %sIntranet Statistics configure에서 프록시 헤더를 수락%s하고 전달해야합니다. 또한 리퍼러 헤더가 올바르게 전송되는지 확인합니다.',
...
그리고 Intranet Statistics을 사용하여 주셔서 감사합니다!',
	...
	'Login_ContactAdmin' => '가능한 이유: 호스트가 메일 기능을 비활성화했을 수 있습니다. <br />당신의 Intranet Statistics 관리자에게 연락해보세요.',
	...
	'Mobile_AddPiwikDemo' => 'Intranet Statistics 데모 추가',
	'Mobile_AnonymousTracking' => '익명 추적',
	'Mobile_AskForAnonymousTrackingPermission' => '이것이 활성화되면, Intranet Statistics 모바일의 사용 데이터를 piwik.org에 익명으로 보냅니다. 이 데이터는 Intranet Statistics 모바일 개발자가 애플리케이션을 사용하는 방법을 이해하는 데 도움을 주려는 목적입니다. 전송되는 정보는 다음과 같습니다: 메뉴와 설정을 클릭, OS 이름과 버전, Intranet Statistics 모바일에 표시되는 오류 정보입니다. 어떠한 이유에서든 우리는 당신의 분석 데이터를 추적하지 않습니다. 또한 이 익명 데이터가 공개되지도 않습니다. 그리고 언제든지 설정에서 익명 추적을 활성 또는 비활성 할 수 있습니다.',
	'Mobile_Advanced' => '고급',
	'Mobile_ChooseHttpTimeout' => 'HTTP 시간 초과 값 선택',
	'Mobile_ChooseMetric' => '측정 항목 선택',
	'Mobile_ChooseReport' => '보고서 선택',
	'Mobile_HelpUsToImprovePiwikMobile' => 'Intranet Statistics 모바일에 익명의 사용 추적을 사용하시겠습니까?',
	'Mobile_HttpIsNotSecureWarning' => 'Intranet Statistics 승인을 위한 토큰 (token_auth) 발급시 \'HTTP\'를 사용하면 일반 텍스트로 전송됩니다. 그렇기 때문에 인터넷을 통한 데이터의 보안 전송을 위해 HTTPS를 사용하는 것을 추천합니다. 계속 진행 하시겠습니까?',
	...
	'Mobile_RatingPleaseRateUs' => 'Intranet Statistics 모바일 앱은 무료 소프트웨어입니다. 여러분의 소중한 1분으로 %s에서 우리의 애플리케이션을 평가해 주신다면 정말 감사하겠습니다. 새로운 기능 제안이나 버그를 발견하셨다면, %s로 연락 부탁드려요',
	'Mobile_Refresh' => '새로고침',
	...
	'Mobile_AccessUrlLabel' => 'Intranet Statistics 접근 URL',
	...
	'Mobile_NoPiwikAccount' => 'Intranet Statistics 계정이 없나요?',
	'Mobile_NoVisitorFound' => '방문자를 찾을 수 없음',
	'Mobile_NoWebsiteFound' => '웹사이트를 찾을 수 없음',
	'Mobile_SaveSuccessError' => 'Intranet Statistics URL 또는 사용자이름과 비밀번호 조합이 잘못되었습니다.',
	...
	'MobileMessaging_VerificationText' => '인증코드는 %s 입니다. Intranet Statistics SMS 보고서를 받기 위한 전화번호 확인을 위해 수신한 인증코드를 Intranet Statistics > %s > %s으로 이동하여 입력하세요.',
	...
	'MobileMessaging_Settings_PhoneNumbers_HelpAdd' => '"추가"를 클릭하면, 당신의 휴대 전화로 인증코드가 포함된 SMS를 전송합니다. 코드를 받는 사용자는 Intranet Statistics에 로그인하고 설정에 들어가서 모바일 메시징을 클릭합니다. 인증코드를 입력한 후, 사용자는 자신의 휴대 전화로 문자 보고서를 받을 수 있습니다.',
	...
	'MobileMessaging_Settings_CredentialNotProvidedByAdmin' => '그전에 전화번호를 생성하고 관리할 수 ​​있습니다. SMS 계정에 Intranet Statistics를 연결하려면 관리자에게 문의하시기 바랍니다.',
	'MobileMessaging_Settings_CredentialNotProvided' => '당신의 전화번호를 생성하고 관리할 수 ​​있습니다. 위 SMS 계정에 Intranet Statistics를 연결하세요.',
	...
	'MobileMessaging_MultiSites_Must_Be_Activated' => '웹사이트 통계를 SMS의 텍스트로 생성하려면, Intranet Statistics의 MultiSites 플러그인을 사용으로 설정하세요.',
	'MultiSites_PluginDescription' => '멀티 사이트 운영의 개요 및 통계를 표시합니다. 현재는 코어 Intranet Statistics 플러그인으로 관리되고 있습니다.',
	...
	'Provider_ProviderReportDocumentation' => '이 보고서는 웹사이트를 방문하는 방문자가 사용하고있는 인터넷 서비스 공급자를 보여줍니다. 자세한 내용은 공급자 이름을 클릭하세요. %s Intranet Statistics가 방문자의 공급자를 확인할 수없는 경우는 IP로 표시됩니다.',
	...
	'SitesManager_PluginDescription' => 'Intranet Statistics에서 웹사이트 관리는 새로운 웹사이트의 추가, 기존 웹사이트의 편집 페이지에 삽입하는 JavaScript 코드를 표시할 수 있습니다. 또한 모든 동작은 API를 통해 사용할 수 있습니다.',
	...
	'SitesManager_AliasUrlHelp' => '이것은 권장되지만 필수는 아닙니다. 사용자가이 웹사이트의 접근에 사용하는 다양한 URL을 지정하려면 한 줄에 하나의 URL을 입력합니다. 웹사이트의 URL 별칭은 \'소스\'> 웹 사이트의 보고서에 표시되지 않습니다. URL의 \'www\'의 유무는 Intranet Statistics가 자동으로 판단합니다.',
	...
	'SitesManager_GlobalListExcludedUserAgents_Desc' => '방문자의 사용자 에이전트 문자열에 지정한 문자열이 포함되어 있는 경우, Intranet Statistics의 방문기록에서 제외됩니다.',
	'SitesManager_GlobalExcludedUserAgentHelp1' => 'Intranet Statistics 추적에서 제외할 사용자 에이전트의 목록을 작성합니다.',
	...
	'SitesManager_PiwikWillAutomaticallyExcludeCommonSessionParameters' => '일반적인 세션 매개 변수 (%s)는 Intranet Statistics가 자동으로 제외합니다.',
	'SitesManager_HelpExcludedIps' => 'Intranet Statistics 추적에서 제외할 IP 목록을 한 줄에 하나씩 입력합니다. IP에는 와일드 카드 (예: %1$s와 %2$s)을 사용할 수 있습니다.',
	...
	'SitesManager_PiwikOffersEcommerceAnalytics' => 'Intranet Statistics은 고급 전자상거래 분석 및 추적 그리고 리포팅할 수 있습니다. %s전자상 상거래 분석%s에 대하여 더 알아보세요.',
	'SitesManager_TrackingSiteSearch' => '사이트 내부 검색 추적',
	'SitesManager_SiteSearchUse' => '당신은 Intranet Statistics를 사용하여 웹사이트의 내부검색 엔진에서 방문자가 어떤 검색을 했는지 추적하고 보고받을 수 있습니다.',
	'SitesManager_SearchKeywordParametersDesc' => '사이트 검색 키워드를 지정하는 모든 쿼리 매개변수 이름을 쉼표로 구분하여 모두 입력합니다.',
	'SitesManager_SearchCategoryDesc' => 'Intranet Statistics는 내부 사이트 검색어에 대한 검색 카테고리를 추적할 수 있습니다.',
	...
	'TranslationsAdmin_PluginDescription' => 'Intranet Statistics를 당신의 모국어로 번역하는 것을 지원합니다.',
	...
	'UserCountryMap_LoginToViewRealTime' => 'Intranet Statistics 실시간 방문자 지도를 보기려면 로그인하세요!',
	...
	'UserCountry_PiwikNotManagingGeoIPDBs' => 'Intranet Statistics은 현재 모든 GeoIP 데이터베이스를 관리하지 않습니다.',
	...
	'UserCountry_GeolocationPageDesc' => '이 페이지에서 Intranet Statistics 방문자 위치를 결정하는 방법을 변경할 수 있습니다.',
	...
	'UserCountry_TestIPLocatorFailed' => 'Intranet Statistics은 알려진 IP 주소 (%1$s)의 위치를 ​​확인하려고 시도했지만, 서버가 %2$s으로 응답했습니다. 이 공급자가 올바르게 구성된 경우, %3$s으로 반환되어야 합니다.',
	...
	'UserCountry_HowToSetupGeoIP_Step2' => '이 파일의 압축을 풀고 %1$s 파일을 Intranet Statistics 하위 디렉토리인 %2$smisc%3$s로 복사합니다 (FTP나 SSH를 이용하여).',
	'UserCountry_HowToSetupGeoIP_Step3' => '화면을 새로 고침합니다. %1$sGeoIP (PHP)%2$s 공급자가 %3$s설치됨%4$s으로 나타날 것입니다. 이것을 선택합니다.',
	'UserCountry_HowToSetupGeoIP_Step4' => '작업 완료! 이제 Intranet Statistics은 GeoIP를 사용하도록 설정되었으며, 이것은 방문자의 정확한 국가와 도시 지역 정보를 볼 수 있음을 의미합니다.',
	...
	'UserCountry_GeoIPServerVarsFound' => 'Intranet Statistics은 다음의 GeoIP %s 변수를 감지함',
	'UserCountry_AssumingNonApache' => '아파치 웹서버가 아니어서 apache_get_modules을 찾을 수 없습니다.',
	'UserCountry_FoundApacheModules' => 'Intranet Statistics은 다음의 아파치 모듈을 찾을 수 없음',
	'UserCountry_GeoIPNoServerVars' => 'Intranet Statistics은 GeoIP %s 변수를 찾을 수 없습니다.',
	...
	'UserCountry_GeoIPUpdaterIntro' => 'Intranet Statistics은 현재 다음 GeoIP 데이터베이스를 위한 업데이트를 관리함',
	...
	'UserCountry_CannotSetupGeoIPAutoUpdating' => 'Intranet Statistics의 외부에서 GeoIP 데이터베이스를 저장한 것 같군요 (하위 디렉토리인 misc에 데이터베이스가 없지만, 당신의 GeoIP가 잘 작동하고 있어요) 이 파일들이 misc 디렉토리의 밖에 있는 경우, Intranet Statistics는 자동으로 GeoIP 데이터베이스를 업데이트할 수 없습니다.',
	...
	'UserCountry_FatalErrorDuringDownload_js' => '파일을 다운로드하는 동안 치명적인 오류가 발생했습니다. Intranet Statistics에서 GeoIP 데이터베이스 다운로드하는데 인터넷 연결에 문제가 있을 수 있습니다, 직접 다운로드해서 수동으로 설치해 보세요.',
	...
	'UsersManager_PluginDescription' => 'Intranet Statistics에서 사용자 관리, 새 사용자 추가, 기존 사용자 편집 권한을 업데이트할 수 있습니다. 또한 모든 동작은 API를 통해 사용할 수 있습니다.',
	...
	'UsersManager_MainDescription' => '어떤 사용자가 어떤 Intranet Statistics 접근을 할 지 결정할 수 있습니다. 모든 웹사이트의 권한을 한번에 설정할 수 있습니다.',
	...
	'UsersManager_YourVisitsAreIgnoredOnDomain' => '%s당신의 방문은%s Intranet Statistics에 무시됩니다%s (브라우저에서 Intranet Statistics 무시 용 Cookie 발견).',
	'UsersManager_YourVisitsAreNotIgnored' => '%s당신의 방문은 Intranet Statistics에 무시하지 않습니다%s (브라우저에서 Intranet Statistics 무시의 Cookie를 찾을 수 없습니다).',
	'UsersManager_ClickHereToDeleteTheCookie' => 'Cookie를 삭제하고 Intranet Statistics이 당신의 방문도 추적하려면 여기를 클릭합니다.',
	'UsersManager_ClickHereToSetTheCookieOnDomain' => '%s의 Intranet Statistics에 추적하는 웹사이트에서 자신의 방문을 제외하는 Cookie를 설정하려면 여기를 클릭합니다.',
	...
	'UsersManager_WhenUsersAreNotLoggedInAndVisitPiwikTheyShouldAccess' => '로그인 않한 사용자가 Intranet Statistics에 접근할 때 표시하는 화면',
	...
	'UsersManager_ExceptionEditAnonymous' => '익명 사용자는 편집이나 삭제를 할 수 없습니다. Intranet Statistics에서 아직 로그인하지 않은 사용자를 골라낼 때 사용하기 때문입니다. 예를 들어, \'보기\' 접근을 \'익명\' 사용자에게 주어서 당신의 상태를 공개할 수 있습니다.',
	'UsersManager_ExceptionSuperUser' => '요청한 사용자는 슈퍼 사용자이며 API를 통해 쿼리,편집,삭제할 수 없습니다. Intranet Statistics 설정 파일에서 슈퍼 사용자를 수동으로 편집할 수 있습니다.',
	...
	'VisitorGenerator_PluginDescription' => '가짜 방문을 작성하는 플러그인입니다. Intranet Statistics 사용자와 개발자가 Intranet Statistics 보고서에 잘못된 데이터를 생성하는 간단한 방법으로 사용할 수 있습니다.',
	'VisitorGenerator_VisitorGenerator' => '방문자 생성기',
	'VisitorGenerator_Warning' => 'Intranet Statistics 데이터베이스에 기록되는 가짜 방문을 생성하려고합니다.',
	'VisitorGenerator_NotReversible' => 'Intranet Statistics 로그에서 이러한 방문을 %s 쉽게 제거할 수 없습니다 %s.',
	...
	'Widgetize_PluginDescription' => '당신의 블로그, 웹사이트, Igoogle, Netvibes 등 모든 Intranet Statistics 위젯을 매우 쉽게 내보낼 수 있습니다.',
	'Widgetize_TopLinkTooltip' => 'Intranet Statistics 보고서를 위젯으로 내보내고 당신의 애플리케이션 대시보드에 IFRAME으로 삽입할 수 있습니다.',
	...
	'PDFReports_PiwikReports' => 'Intranet Statistics 보고서',
	...
	'PDFReports_TopLinkTooltip' => '이메일 보고서를 만들어 Intranet Statistics 통계를 당신의 이메일로 전달하거나 고객의 주소에 자동으로 전달하세요!',
	'ImageGraph_PluginDescription' => 'Intranet Statistics 보고서의 아름다운 정적 PNG 그래프 이미지를 생성합니다.',
	...
	'Overlay_Link' => '링크',
	'Overlay_RedirectUrlError' => 'URL "%s"에 대한 페이지 오버레이를 열려고 시도합니다. %s은 Intranet Statistics 설정한 도메인과 어떤 링크도 일치하지 않습니다.',
	...
	'Overlay_ErrorNotLoadingDetails' => '오른쪽에 로드된 페이지는 Intranet Statistics의 추적 코드가 누락되었을 수 있습니다. 이 경우, 페이지 보고서에서 다른 페이지에서 오버레이를 실행해보세요.',
	'Overlay_ErrorNotLoadingDetailsSSL' => 'Intranet Statistics에서 HTTPS를 사용하도록 설정되었지만, 당신의 웹사이트는 SSL을 지원하지 않습니다. Intranet Statistics에 HTTP를 사용해 보세요.',
