...
$translations = array(
	...
	'General_Error' => '错误',
	'General_Warning' => '警告',
	'General_BackToHomepage' => '返回 Intranet Statistics 首页',
	'General_Yes' => '是',
	'General_No' => '否',
	'General_Delete' => '删除',
	'General_Report' => '报告',
	...
	'General_AllowPiwikArchivingToTriggerBrowser' => '当报告在浏览器里显示时，允许 Intranet Statistics 触发整理',
	'General_ArchivingInlineHelp' => '对于中或高流量的网站，建议停用 Intranet Statistics 整理触发浏览器。反之，我们建议您设定一个工作排程(Cron job)，每小时处理 Intranet Statistics 报告。',
	'General_ArchivingTriggerDescription' => '推荐大型的 Intranet Statistics 安裝，您需要%s设定一个工作排程(Cron job)%s来自动处理报告。',
	...
	'General_RequiresFlash' => '在 Intranet Statistics 显示图表必須有 Flash',
	'General_GraphHelp' => '更多关于 Intranet Statistics 显示图标的资讯',
	...
	'General_YouAreViewingDemoShortMessage' => '您正在浏览 Intranet Statistics 范例',
	'General_DownloadFullVersion' => '%1$s下載%2$s完整版本！來吧 %3$s',
	'General_NewUpdatePiwikX' => '新的更新：Intranet Statistics %s',
	'General_AboutPiwikX' => '关于 Intranet Statistics %s',
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Intranet Statistics %1$s 已经可用。 %2$s 请立即更新！%3$s （查看 %4$s 与%5$s 的差异）。',
	'General_PiwikXIsAvailablePleaseNotifyPiwikAdmin' => '%s 已经可用。请通知网站管理员。',
	'General_NewReportsWillBeProcessedByCron' => '当 Intranet Statistics 存档无法由浏览器触发时，新的报表將以 crontab 处理。',
	...
	'General_BackToPiwik' => '返回 Intranet Statistics',
	...
	'General_ConfigFileIsNotWritable' => 'Intranet Statistics 配置文件 %s 无法写入，您的变更将无法保存。%s 请变更配置文件的权限让它可被写入。',
	'General_ExceptionDatabaseVersion' => '您的 %1$s 版本为 %2$s ，但 Intranet Statistics 需求至少要 %3$s。',
	...
	'General_FileIntegrityWarningExplanation' => '文件完整性检查错误且报告了一些问题。这大多是因为上传了部分或错误的 Intranet Statistics 文件所致。您应该使用 BINARY 模式重新上传所有的 Intranet Statistics 文件然后重新整理此页面直到它沒有显示任何错误。',
	...
	'General_Language' => '语系',
	'General_PleaseUpdatePiwik' => '请更新您的 Intranet Statistics',
	...
	'Actions_DownloadsReportDocumentation' => '在这份报告中，您可以看到用户下载了那些文件。%s Intranet Statistics计算的是下载链接的点击数量。至于文件是否下载完成Intranet Statistics无法知道。',
	...
	'API_PluginDescription' => '所有在 Intranet Statistics 的资料都能使用简单的 APIs 取得。这个插件是网页服务的切入点，让您可以以 xml, json, php, csv 及其他格式取得网站分析资料。',
	'API_QuickDocumentationTitle' => 'API 快速说明文件',
	'API_GenerateVisits' => '如果您今天还沒有任何资料，您可以先使用 %s 插件来产生一些数据。您可以启用 %s 外挂，然后点击在 Intranet Statistics 管理员区域里的\'产生访客\'选单。',
	'API_MoreInformation' => '取得更多关于 Intranet Statistics APIs 的资讯，请前往 %sIntranet Statistics API 指引%s 与 %s Intranet Statistics API 參考资料%s。',
	...
	'CoreAdminHome_PluginDescription' => 'Intranet Statistics 插件管理',
	...
	'CoreAdminHome_LogoNotWriteable' => 'Intranet Statistics需要主题文件夹内%s的写权限去自定义您的logo',
	'CoreAdminHome_TrustedHostSettings' => '被信任的Intranet Statistics主机名',
	'CoreAdminHome_TrustedHostConfirm' => '你确信要修改Intranet Statistics主机名？',
	'CoreAdminHome_PiwikIsInstalledAt' => 'Intranet Statistics安装在',
	'CoreAdminHome_ValidPiwikHostname' => '有效的Intranet Statistics主机名',
	'CoreHome_CheckForUpdates' => '检查更新',
	'CoreHome_YouAreUsingTheLatestVersion_js' => '你在使用最新版的Intranet Statistics！',
	'CoreHome_MakeADifference' => '行动起来%1$s捐款%2$s给Intranet Statistics 2.0基金!',
	'CoreHome_SupportPiwik' => '支持Intranet Statistics！',
	'CoreHome_OnlyForAdmin' => '这些只显示给您-超级管理员。',
	'CoreHome_CheckPiwikOut' => '访问Intranet Statistics',
	'CoreHome_ShareThis' => '分享这个',
	'CoreHome_ViewAllPiwikVideoTutorials' => '查看所有的Intranet Statistics视频教程',
	'CoreHome_SharePiwikShort' => 'Intranet Statistics！自由和开源的网络分析程序。掌控您的统计数据。',
	'CoreHome_SharePiwikLong' => '您好！我刚刚发现了一个很棒的开源网络统计程序：Intranet Statistics！ Intranet Statistics可以让您统计您的网站访客记录。您一定要看一看！',
	...
	'CoreHome_JavascriptDisabled' => '使用 Intranet Statistics 的标准视图时必须启用 JavaScript。<br />然而，看来您的浏览器已停用或不支持 JavaScript。<br />若要使用标准视图，请变更您的浏览器选项并启用 JavaScript, 然后%1$s重试一次%2$s。<br />',
	...
	'CorePluginsAdmin_MainDescription' => '插件延伸并扩展了 Intranet Statistics 的功能。 当一个插件安装了以后，您可以在这里启用或停用它。',
	...
	'CoreUpdater_PluginDescription' => 'Intranet Statistics 更新机制',
	'CoreUpdater_UpdateTitle' => '升级',
	'CoreUpdater_DatabaseUpgradeRequired' => '数据库需要升级',
	'CoreUpdater_YourDatabaseIsOutOfDate' => '您的 Intranet Statistics 数据库已经太旧了，所以您必须先升级才可以继续！',
	'CoreUpdater_TheFollowingPluginsWillBeUpgradedX' => '以下插件将被升级： %s！',
	'CoreUpdater_NoteForLargePiwikInstances' => '大型 Intranet Statistics 网站重要注意事项',
	'CoreUpdater_TheUpgradeProcessMayFailExecuteCommand' => '如果您有一个大型的 Intranet Statistics 数据库，在浏览器内更新可能需要花费很长时间。在此情況下，您可以通过以下指令来执行更新：%s',
	'CoreUpdater_YouCouldManuallyExecuteSqlQueries' => '如果您无法使用指令来更新且 Intranet Statistics 升级失败（数据库超时、浏览器超时或任何问题），您可以手动执行 SQL 语句来更新 Intranet Statistics.',
	...
	'CoreUpdater_UpgradePiwik' => '升级 Intranet Statistics',
	...
	'CoreUpdater_ErrorDIYHelp_3' => '手动更新您的 Intranet Statistics 数据库內的 \'option\' 数据表，version_core 的设定值更新失败',
	'CoreUpdater_ErrorDIYHelp_4' => '重新执行更新程序（通过浏览器或指令列）来继续剩余的更新',
	'CoreUpdater_ErrorDIYHelp_5' => '报告问题（或解決办法）以改善 Intranet Statistics',
	'CoreUpdater_HelpMessageContent' => '请检查 %s Intranet Statistics FAQ %s ，在其中已试图解释最常见的升级过程中的错误。 %s 请询问您的系统管理员 - 他们可以协助您解决几乎所有有关您的服务器或 MySQL 设定的问题！',
	...
	'CoreUpdater_PiwikHasBeenSuccessfullyUpgraded' => 'Intranet Statistics 已成功升级！',
	'CoreUpdater_ContinueToPiwik' => '继续 Intranet Statistics',
	'CoreUpdater_UpdateAutomatically' => '自动升级',
	'CoreUpdater_ThereIsNewVersionAvailableForUpdate' => '已经有新的Intranet Statistics版本可以升级',
	'CoreUpdater_YouCanUpgradeAutomaticallyOrDownloadPackage' => '你可以自动升级到%s版本，或者下载package之后手动安装：',
	'CoreUpdater_YouMustDownloadPackageOrFixPermissions' => 'Intranet Statistics 无法覆盖您之前的安裝。您可以直接修改目录/文件权限，或是下载压缩包然后手动安裝 %s 版本：',
	'CoreUpdater_DownloadX' => '下载 %s',
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'Intranet Statistics 一键升级已被取消。如果您无法修正以上的错误信息，建议您手动升级 Intranet Statistics。%1$s 请查看 %2$s升级文件%3$s 来开始吧！',
	...
	'CoreUpdater_PiwikUpdatedSuccessfully' => 'Intranet Statistics 已成功升级！',
	'CoreUpdater_EmptyDatabaseError' => '数据库 %s 是空的。您可能要编辑或移除您的 Intranet Statistics 配置文件。',
	'CoreUpdater_ExceptionAlreadyLatestVersion' => '您的 Intranet Statistics 版本 %s 是最新的。',
	...
	'DBStats_PluginDescription' => '这个插件能报告 Intranet Statistics 的数据表使用情况。',
	'DBStats_DatabaseUsage' => '数据库使用状况',
	'DBStats_MainDescription' => 'Intranet Statistics 在MySQL中保存您的所有网站分析数据。 目前， Intranet Statistics 数据表已经使用了 %s！',
	'DBStats_LearnMore' => '了解更多关于 Intranet Statistics 如何处理数据以及使 Intranet Statistics 在中高流量的网站上运作事宜，请查阅说明文件 %s。',
	'DBStats_Table' => '数据表',
	...
	'ExampleUI_PluginDescription' => '范例插件：这个插件让您了解如何使 Intranet Statistics UI 运作：建立数据表、图表等等。',
	'Feedback_PluginDescription' => '传送您的意见反馈給 Intranet Statistics 小組。与我们分享您的点子及建议！',
	...
	'Feedback_WhyWrongCountry' => '为什么 Intranet Statistics 显示了错误的来源国家？',
	...
	'Feedback_SpecialRequest' => '您对于 Intranet Statistics 小组有特殊的请求？',
	'Feedback_ContactThePiwikTeam' => '联系 Intranet Statistics 小组！',
	'Feedback_IWantTo' => '我想要：',
	'Feedback_CategoryShareStory' => '分享一个 Intranet Statistics 成功故事',
	'Feedback_CategorySponsor' => '赞助 Intranet Statistics',
	'Feedback_CategoryHire' => '雇佣一位 Intranet Statistics 顾问',
	...
	'Feedback_MessageSent' => '您的信息已寄给 Intranet Statistics 小組。',
	'Feedback_ThankYou' => '谢谢您协助我们使 Intranet Statistics 变得更好！',
	'Feedback_ThePiwikTeam' => 'Intranet Statistics 小组',
	...
	'Goals_NoGoalsNeedAccess' => '只有管理员或超级使用者能为网站新增目标。请询问您的 Intranet Statistics 管理员來协助设定您的网站目标。<br />追踪目标是一个绝佳的方式，帮忙了解及最大化您的网站效益！',
	...
	'Goals_DefaultRevenueHelp' => '举例来说，访客送出一个联系表单可能平均价值为 $10。Intranet Statistics 将帮助您了解您的访客。',
	...
	'Goals_LearnMoreAboutGoalTrackingDocumentation' => '在使用者文件里找到更多关于 %s Intranet Statistics 里的追踪目标 %s。',
	...
	'Installation_PluginDescription' => 'Intranet Statistics 的安裝程序。通常只需要安裝一次。如果配置文件 config/config.inc.php 被刪除，那么将会重新安裝。',
	'Installation_Installation' => '安装',
	'Installation_InstallationStatus' => '安装状态',
	'Installation_PercentDone' => '%s %% 已完成',
	'Installation_NoConfigFound' => '无法找到 Intranet Statistics 配置文件，而您正尝试存取一个 Intranet Statistics 的页面！<br /><b>  » 您可以 <a href=\'index.php\'>立刻安装 Intranet Statistics</a></b><br /><small>假如您在之前已安装过 Intranet Statistics，并且已有些数据表在您的数据库中，不用担心，您可以重复使用此相同的数据表并保留您现存的数据！</small>',
	...
	'Installation_LargePiwikInstances' => 'Intranet Statistics 给予大型网站的协助',
	'Installation_JsTag' => 'Javascript 标签',
	'Installation_Congratulations' => '恭喜您',
	'Installation_CongratulationsHelp' => '<p>恭喜您！ 您的 Intranet Statistics 安装已经完成！</p><p>请确认您的 Javascript 统计代码已插入至您的网页之中，并等候您的首位访客！</p>',
	'Installation_ContinueToPiwik' => '继续',
	'Installation_SiteSetup' => '请设置用Intranet Statistics追踪和分析的第一个站点：',
	...
	'Installation_SiteSetupFootnote' => '注意：一旦Intranet Statistics安装完成，你可以添加更多的站点去追踪！',
	...
	'Installation_SecurityNewsletter' => '寄给我重要的 Intranet Statistics 更新与安全性警告电子邮件通知',
	'Installation_CommunityNewsletter' => '寄给我社区更新的电子邮件通知（如：新插件、新功能等等。）',
	'Installation_PasswordDoNotMatch' => '密码不相符',
	'Installation_Requirements' => 'Intranet Statistics 需求',
	...
	'Installation_SystemCheckDatabaseHelp' => 'Intranet Statistics 需要 mysqli 扩展组件或包含 PDO 及 pdo_mysql 扩展组件。',
	...
	'Installation_SystemCheckParseIniFileHelp' => '內建的函式在您的空间內已被停用。Intranet Statistics 将会尝试模拟这些功能，但可能会造成更多安全性问题。追踪的表现也会受到影响。',
	'Installation_SystemCheckGlobHelp' => '这个內建的函数已被您的主机商停用。Intranet Statistics 將尝试模拟这个功能，但可能会遇到更多安全限制。功能可能受到影响。',
	'Installation_SystemCheckDebugBacktraceHelp' => '检查::无法建立模組检查。',
	'Installation_SystemCheckCreateFunctionHelp' => 'Intranet Statistics 在callbacks上使用匿名函式。',
	...
	'Installation_SystemCheckPackHelp' => 'Intranet Statistics需要使用pack()函数追踪访客',
	...
	'Installation_SystemCheckAutoUpdateHelp' => '注意：Intranet Statistics 的一键更新功能必须要有 Intranet Statistics 目录及內容的写入权限。',
	'Installation_SystemCheckError' => '发生错误 - 必须先修正，才能再继续',
	'Installation_SystemCheckWarning' => 'Intranet Statistics 将正常工作，但某些功能可能无效',
	...
	'Installation_TablesDeletedSuccess' => '已存在的 Intranet Statistics 数据表已成功删除',
	'Installation_TablesCreatedSuccess' => '数据表已成功建立！',
	'Installation_DatabaseCreatedSuccess' => '数据库 %s 已成功建立！',
	'Installation_GoBackAndDefinePrefix' => '返回并为 Intranet Statistics 数据表定义一个数据表前綴',
	'Installation_ConfirmDeleteExistingTables' => '您确定要从您的数据库中删除表：%s吗？警告：删除的表中的数据无法恢复！',
	'Installation_Welcome' => '欢迎使用！',
	'Installation_WelcomeHelp' => '<p>Intranet Statistics 是一个让您能够轻易取得您所想要的访客信息的开放原始码网页分析软件！</p><p>此安装过程分为 %s 个简易的步骤，并且将仅花大约 5 分钟的时间！</p>',
	'Installation_ConfigurationHelp' => '您的 Intranet Statistics 配置文件看起來似乎损坏了。您可以移除 config/config.ini.php 然后重新安裝，或是修复数据库的连接配置。',
	'Installation_ErrorInvalidState' => '错误：看来您正在尝试停止安裝程序的某个步驟，或是您的 cookies 功能未启用，或者 Intranet Statistics 配置文件已经建立。%1$s请确定您的 cookies 功能已启用%2$s然后返回%3$s至安裝程序的初始画面 %4$s。',
	...
	'LanguagesManager_PluginDescription' => '这个插件会显示 Intranet Statistics 页面可以使用的语系列表。选择的语言将会被保存在每个使用者的偏好里。',
	'LanguagesManager_AboutPiwikTranslations' => '关于 Intranet Statistics 翻译',
	...
	'Login_InvalidNonceOrHeadersOrReferer' => '表单安全检查失败，请重新打开表单，检查是否启用cookie。如果配置了代理服务器，需要 %s 设置Intranet Statistics接收代理头信息 %s ，同时检查Referer头是否正确',
	'Login_InvalidOrExpiredToken' => '凭证无效或已经过期。',
	'Login_MailTopicPasswordChange' => '密码修改确认',
	'Login_PasswordChanged' => '你的密码已经被修改。',
	'Login_ContactAdmin' => '可能的原因：您的主机可能已经停用了 mail() 函数！ <br />请联络您的 Intranet Statistics 管理员！',
	...
	'Mobile_AddPiwikDemo' => '增加Intranet Statistics演示',
	...
	'Mobile_AccessUrlLabel' => 'Intranet Statistics 存取网址',
	...
	'Mobile_NoPiwikAccount' => '没有Intranet Statistics账号？',
	...
	'MultiSites_PluginDescription' => '显示多个网站的摘要 / 统计。目前为 Intranet Statistics 的核心插件。',
	...
	'SitesManager_PluginDescription' => 'Intranet Statistics 网站管理：新知一个新网站、编辑一个已存在的网站、显示插入您网页的 JavaScript 源代码。所有动作都可以通过 API 使用。',
	...
	'SitesManager_AliasUrlHelp' => '这是建议，但不是必须，定义一些您的访客进入此网站时可能的网址，一行一个。网站的网址別名将不会显示在推荐链接 > 网站报表里。注意 Intranet Statistics 能兼容包含及不包含 \'www\' 的网址。',
	...
	'SitesManager_PiwikWillAutomaticallyExcludeCommonSessionParameters' => 'Intranet Statistics 将会自动排除常见的会话參數 (%s)。',
	'SitesManager_HelpExcludedIps' => '输入 IP 列表，一行一个，使 Intranet Statistics 不追踪特定 IP 位址。您也可以使用通配符, 例如 %1$s 或 %2$s',
	...
	'TranslationsAdmin_PluginDescription' => '协助将 Intranet Statistics 翻译为您所用的语言。',
	...
	'UsersManager_PluginDescription' => 'Intranet Statistics 使用者管理：新增一个新使用者、编辑已存在的使用者或更新权限。所有动作也可以通过 API 进行。',
	...
	'UsersManager_MainDescription' => '设置在您网站上的哪个用户具有哪些 Intranet Statistics 权限。 您也可以一次设定所有网站的权限。',
	...
	'UsersManager_YourVisitsAreIgnoredOnDomain' => '%s您的访问记录已在 %s %s 被 Intranet Statistics 忽略（在您的浏览器找到 Intranet Statistics 拒绝 cookie）',
	'UsersManager_YourVisitsAreNotIgnored' => '%s您的访问记录沒有被 Intranet Statistics 忽略%s（在您的浏览器找不到 Intranet Statistics 拒绝 cookie）',
	'UsersManager_ClickHereToDeleteTheCookie' => '点击这里刪除 cookie 并让 Intranet Statistics 追踪您的访问记录',
	'UsersManager_ClickHereToSetTheCookieOnDomain' => '点击这里设定一个 cookie 让 %s 的 Intranet Statistics 排除您的访问记录',
	...
	'UsersManager_WhenUsersAreNotLoggedInAndVisitPiwikTheyShouldAccess' => '当使用者未登录且访问 Intranet Statistics 时，他们应该前往',
	...
	'UsersManager_ExceptionEditAnonymous' => 'anonymous 用户不能被修改或删除，因为他是被 Intranet Statistics 使用来定义一个还未登入的用户！例如，您可以授予 \'查看\' 访问权限给 \'anonymous\' 用户以公开您的统计资料！',
	'UsersManager_ExceptionSuperUser' => '請求的使用者為超級使用者且無法被查詢，請透過應用程式介面 API 編輯或刪除。 您可以在您的 Intranet Statistics 設定檔手動編輯超級使用者。',
	...
	'VisitorGenerator_PluginDescription' => '这个插件用于建立假的访客。这可以让 Intranet Statistics 使用者或开发人员轻松产生假的资料来填充 Intranet Statistics 报表。',
	'VisitorGenerator_VisitorGenerator' => '访客产生器',
	'VisitorGenerator_Warning' => '您将产生的假访客将会记录在您的 Intranet Statistics 数据库里。',
	...
	'Widgetize_PluginDescription' => '这个插件让您轻松输出任何 Intranet Statistics 模组至您的博客、网站或 iGoogle 及 Netvibes!',
	...
	'PDFReports_PiwikReports' => 'Intranet Statistics 報表',
	...
	'ImageGraph_PluginDescription' => '为任何Intranet Statistics统计报告生成美丽的png图片。',
