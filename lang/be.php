...
$translations = array(
	...
	'General_BackToHomepage' => 'Вярнуцца на хатнюю старонку Intranet Statistics',
	'General_Yes' => 'Так',
	'General_No' => 'Не',
	...
	'General_AllowPiwikArchivingToTriggerBrowser' => 'Дазволіць Intranet Statistics запускаць архіваванне, калі справаздачы праглядваюцца браўзэрам.',
	'General_ArchivingInlineHelp' => 'Для сайтаў з сярэднім і высокім трафікам, рэкамендуецца адключыць функцыю архівавання Intranet Statistics для запуску з браўзэра.',
	'General_ArchivingTriggerDescription' => 'Рэкамендуецца для Intranet Statistics на сайтах з высокім трафікам, патрэбна %sўсталяваць заданне для крону%s для аўтаматычнай апрацоўкі справаздач.',
	...
	'General_RequiresFlash' => 'Адлюстраванне графікаў у Intranet Statistics патрабуе Флэш',
	'General_GraphHelp' => 'Больш інфармаціі аб адлюстраванні графікаў у Intranet Statistics.',
	...
	'General_YouAreViewingDemoShortMessage' => 'Вы праглядаеце дэма версію Intranet Statistics',
	'General_DownloadFullVersion' => '%1$sСпампуйце%2$s поўную версію! праверце %3$s',
	'General_NewUpdatePiwikX' => 'Новае абнаўленне: Intranet Statistics %s',
	'General_AboutPiwikX' => 'Аб Intranet Statistics %s',
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Intranet Statistics %1$s даступны для спампоўкі. %2$s Калі ласка, абновіцеся!%3$s (глядзі %4$sзмены%5$s).',
	'General_PiwikXIsAvailablePleaseNotifyPiwikAdmin' => '%s даступны. Калі ласка паведаміце аб гэтым адміністратара веб-сайта.',
	'General_NewReportsWillBeProcessedByCron' => 'Калі архіваванне Intranet Statistics не запускаецца ў браўзэры, новыя справаздачы будуць апрацаваныя кронтабам.',
	...
	'General_BackToPiwik' => 'Вярнуцца да Intranet Statistics',
	...
	'General_ConfigFileIsNotWritable' => 'Файл канфігурацыі Intranet Statistics %s недаступны для запісу, некаторыя з Вашых змяненняў могуць быць не захованы. %s Калі ласка, змяніце дазвол канфігурацыйнага файла, каб зрабіць яго даступным для запісу.',
	'General_ExceptionDatabaseVersion' => 'Ваша %1$s версія %2$s, але Intranet Statistics патрабуе па меншай меры версію %3$s.',
	...
	'General_PleaseUpdatePiwik' => 'Ваш Intranet Statistics патрабуе абнаўлення',
	...
	'Actions_DownloadsReportDocumentation' => 'На гэтай справаздачы, можна ўбачыць, якія файлы былі спампаваны вашымя наведвальнікамі. %s Intranet Statistics лічыць за спампаўку націск на адпаведную спасылку. Была запампоўка завершана ці не, гэта не вядома Intranet Statistics.',
	...
	'API_PluginDescription' => 'Усе дадзеныя ў Intranet Statistics даступныя праз простый API. Гэта убудаваныя вэб-службы, праз якія вы можаце атрымаць дадзеныя вэб-аналітыкі ў xml, json, php, csv і г.д. фармаце.',
	'API_QuickDocumentationTitle' => 'Хуткая дакументацыя па API-функцыях',
	'API_GenerateVisits' => 'Калі ў вас няма дадзеных на сённяшні дзень, вы можаце стварыць некаторыя дадзеныя, выкарыстоўваючы даданы модуль %s. Уключыце даданы модуль %s, затым націсніце на "Генератар наведванняў" у адміністрацыйнай частцы Intranet Statistics.',
	'API_MoreInformation' => 'Дадатковыя звесткі аб Intranet Statistics API, калі ласка, звярніце ўвагу на %s Уводзіны ў Intranet Statistics API %s і %s Intranet Statistics API спасылкі %s.',
	...
	'CoreAdminHome_PluginDescription' => 'Адміністрацыная частка Intranet Statistics.',
	...
	'CoreAdminHome_OptOutForYourVisitors' => 'Адмова ад Intranet Statistics для вашых наведвальнікаў',
	'CoreAdminHome_OptOutExplanation' => 'Intranet Statistics прысвечаны забеспячэнню канфідэнцыяльнасці ў Інтэрнэце. Каб прапанаваць сваім наведвальнікам адмовіцца ад Intranet Statistics Вэб-Аналітыкі, вы можаце дадаць наступны код на адной з старонак вашага сайта, напрыклад, на старонцы Палітыка прыватнасці.',
	'CoreAdminHome_OptOutExplanationBis' => 'Гэты код будзе адлюстроўвацца як Айфрэйм, які будзе змяшчаць спасылку для вашых наведвальнікаў, каб адмовіцца ад Intranet Statistics з дапамогай усталявання спецыяльных cookie у браўзэрах. %s Націсніце тут %s, каб прагледзець змесціва, якое будзе адлюстроўвацца ў Айфрэйме.',
	...
	'CoreAdminHome_LogoNotWriteable' => 'Каб выкарыстоўваць уласны лагатып, Intranet Statistics патрабуецца доступ на запіс да файлаў лагатыпа ў дырэкторыі тэмы: %s',
	'PrivacyManager_TeaserHeadline' => 'Наладкі прыватнасці',
	'PrivacyManager_MenuPrivacySettings' => 'Прыватнасць',
	'PrivacyManager_PluginDescription' => 'Наладзіць Intranet Statistics, каб зрабіць яго наладкі прыватнасці сумяшчальнымі з існуючым заканадаўствам.',
	'PrivacyManager_UseAnonymizeIp' => 'Ананімазаваць IP-адрасы наведвальнікаў',
	'PrivacyManager_AnonymizeIpDescription' => 'Абярыце "Так", калі вы хочаце, каб Intranet Statistics не адсочваў поўны IP-адрас.',
	...
	'CoreHome_NoPrivilegesAskPiwikAdmin' => 'Вы ўвайшлі як \'%s\', але здаецца, што у вас няма патрэбнага дазволу у Intranet Statistics. %s Спытайце свайго Intranet Statistics адміністратара (націснуць, каб паслаць паведамленне)%s, каб падаць вам дазвол для прагляду вэб-сайту.',
	'CoreHome_JavascriptDisabled' => 'Java-скрыпт павінен быць уключаны, каб выкарыстоўваць Intranet Statistics ў звычайны рэжыме прагляду.<br />Аднак, здаецца, што Java-скрыпт адключаны або не падтрымліваецца браўзэрам.<br />Каб выкарыстоўваць стандартны выгляд, уключыце JavaScript, змяніўшы наладкі браўзэра , затым %1$sпаспрабуйце зноў%2$s.<br />',
	...
	'CorePluginsAdmin_MainDescription' => 'Плагіны пашыраюць функцыянальнасць Intranet Statistics. Пасля ўсталёўкі плагіна Вы можаце актываваць ці дэактываваць яго тут.',
	...
	'CoreUpdater_PluginDescription' => 'Механізм абнаўлення Intranet Statistics',
	'CoreUpdater_UpdateTitle' => 'Абнаўленне',
	'CoreUpdater_DatabaseUpgradeRequired' => 'Патрабуецца абнаўленне базы дадзеных',
	'CoreUpdater_YourDatabaseIsOutOfDate' => 'Тэрмін дзеяння Вашай Intranet Statistics базы мінуў, Вам трэба яе абнавіць для працягу.',
	'CoreUpdater_PiwikWillBeUpgradedFromVersionXToVersionY' => 'Intranet Statistics база будзе абноўлена з версіі %1$s да версіі %2$s.',
	'CoreUpdater_TheFollowingPluginsWillBeUpgradedX' => 'Наступныя плагіны будуць абноўлены: %s.',
	'CoreUpdater_NoteForLargePiwikInstances' => 'Важныя заўвагі для буйных усталёвак Intranet Statistics',
	'CoreUpdater_TheUpgradeProcessMayFailExecuteCommand' => 'Калі ў вас вялікая база дадзеных Intranet Statistics, абнаўленне можа заняць шмат часу для працы ў браўзэры. У гэтай сітуацыі, вы можаце выконваць абнаўлення з каманднага радка: %s',
	'CoreUpdater_YouCouldManuallyExecuteSqlQueries' => 'Калі вы не можаце выкарыстоўваць камандны радок для абнаўлення, і калі Intranet Statistics не ўдаецца абнавіць (з-за тайм-аўта у базе дадзеных, тайм-аўта ў браўзэр, або па любой іншай падставе), вы можаце ўручную запусціць SQL запыты для абнаўлення Intranet Statistics.',
	...
	'CoreUpdater_UpgradePiwik' => 'Абнавіць Intranet Statistics',
	...
	'CoreUpdater_ErrorDIYHelp_3' => 'ўручную абнавіце `option` табліцу ў базе дадзеных Intranet Statistics, усталёўваючы значэнне version_core на версію няўдалага абнаўлення',
	...
	'CoreUpdater_ErrorDIYHelp_5' => 'паведаміце аб гэтай праблеме (і рашэнні), каб палепшыць Intranet Statistics',
	'CoreUpdater_HelpMessageContent' => 'Праверце %1$s Intranet Statistics FAQ %2$s, у якім тлумачыцца большасць вядомых памылак, якія могуць здарыцца падчас абнаўлення. %3$s Звернецеся да сістэмнага адміністратара - ён можа дапамагчы Вам з рашэннем праблемы на серверы ці з наладамі MySQL.',
	...
	'CoreUpdater_PiwikHasBeenSuccessfullyUpgraded' => 'Intranet Statistics паспяхова абноўлены!',
	'CoreUpdater_ContinueToPiwik' => 'Перайсці да Intranet Statistics',
	'CoreUpdater_UpdateAutomatically' => 'Абнавіць аўтаматычна',
	'CoreUpdater_ThereIsNewVersionAvailableForUpdate' => 'Даступная новая версія Intranet Statistics',
	...
	'CoreUpdater_YouMustDownloadPackageOrFixPermissions' => 'Intranet Statistics не можа перазапісаць бягучыя ўсталёўкі. Вы можаце выправіць правы доступу да файлаў/каталогаў або загрузіць і ўсталяваць пакет %s ўручную:',
	'CoreUpdater_DownloadX' => 'Запампаваць %s',
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'Intranet Statistics One Click Update адменены. Калі Вы не можаце выправіць вышэйапісаныя памылкі, рэкамендуецца абнавіць Intranet Statistics уручную. %1$s Калі ласка, праверце %2$sдокументацію абнаўленні%3$s для тона, каб пачаць!',
	...
	'CoreUpdater_PiwikUpdatedSuccessfully' => 'Intranet Statistics абноўлены паспяхова!',
	'CoreUpdater_EmptyDatabaseError' => 'База дадзеных %s пустая. Вам неабходна кіраваць уручную ці выдаліць файл канфігурацыі Intranet Statistics.',
	'CoreUpdater_ExceptionAlreadyLatestVersion' => 'Ваш версія Intranet Statistics %s ў актуальным стане.',
	...
	'DBStats_PluginDescription' => 'Гэты плагін паведамляе аб выкарыстанні базы дадзеных таблицам Intranet Statistics',
	'DBStats_DatabaseUsage' => 'Выкарыстанне БД',
	'DBStats_MainDescription' => 'Intranet Statistics захоўвае ўсю Вашу web статыстыку ў базе MySQL. Выкарыстанне Intranet Statistics табліц на дадзены момант %s.',
	'DBStats_LearnMore' => 'Каб даведацца больш аб тым, як Intranet Statistics апрацоўвае дадзеныя і як налдзцца больш аб тым, як Intranet Statistics апрацоўвае дадзеныя і як налдзиціць Intranet Statistics для добрага працавання на сайтах з сярэднімі і высокім трафікам, праверце дакументацыю %s.',
	...
	'ExampleUI_PluginDescription' => 'Прыклад плагіна: Гэты плагін паказвае, як працаваць з інтэрфейсам Intranet Statistics: ствараць табліцы, графікі і г.д.',
	'Feedback_PluginDescription' => 'Водгук для каманды Intranet Statistics. Падзяліцеся сваімі ідэямі і прапановамі з намі!',
	...
	'Feedback_WhyWrongCountry' => 'Чаму Intranet Statistics паказвае мае наведванннаведванніе з няправільнай краінай?',
	...
	'Feedback_SpecialRequest' => 'У вас ёсць спецыяльны запыт для каманды Intranet Statistics?',
	'Feedback_ContactThePiwikTeam' => 'Звяжыцеся з камандай Intranet Statistics!',
	'Feedback_IWantTo' => 'Я хачу, каб:',
	'Feedback_CategoryShareStory' => 'Падзяліцеся паспяховай гісторыяй з Intranet Statistics',
	'Feedback_CategorySponsor' => 'Спонсар Intranet Statistics',
	'Feedback_CategoryHire' => 'Найміце кансультанта Intranet Statistics',
	...
	'Feedback_MessageSent' => 'Ваша паведамленне было адпраўлена камандзе Intranet Statistics.',
	'Feedback_ThankYou' => 'Дзякуй за дапамогу нам зрабіць Intranet Statistics лепш!',
	'Feedback_ThePiwikTeam' => 'Каманда Intranet Statistics',
	...
	'Goals_NoGoalsNeedAccess' => 'Толькі Адміністратар або Супер Карыстальнік можа дадаць Мэты да дадзенага вэб-сайта. Калі ласка, папытаеце вашага Intranet Statistics адміністратара, каб наладзіць Мэты для вашага сайта. <br>Адсочванне Мэт гэта выдатны спосаб, каб дапамагчы зразумець і максімізаваць прадукцыйнасць вашага вэб-сайта!',
	...
	'Goals_DefaultRevenueHelp' => 'Напрыклад, Кантактная фарма запоўненая наведвальнікам можа каштаваць у сярэднім $10. Intranet Statistics дапаможа вам зразумець, наколькі добра выконваюцца вашы сегменты наведвальнікаў.',
	...
	'Goals_LearnMoreAboutGoalTrackingDocumentation' => 'Даведайцеся больш пра %s Адсочванне Мэт у Intranet Statistics%s у карыстацкай дакументацыі.',
	...
	'Installation_PluginDescription' => 'Працэс усталёўкі Intranet Statistics. Усталёўка звычайна адбывацца толькі адзін раз. Калі канфігурацыйны файл config/config.inc.php выдалены, ўстаноўка пачнецца зноў.',
	'Installation_Installation' => 'Усталёўка',
	'Installation_InstallationStatus' => 'Статут усталёўкі',
	'Installation_PercentDone' => '%s %% Завершана',
	'Installation_NoConfigFound' => 'Канфігурацыйны файл Intranet Statistics не можа быць знойдзены, аднак вы спрабуеце зайсці ў сістэму.<br /><b>  » Вы можаце <a href=\'index.php\'>усталяваць Intranet Statistics цяпер</a></b><br /><small>. Калі Intranet Statistics ужо быў усталяваны і вы маеце дадзеныя ў БД, вы можаце выкарыстоўваць іх.</small>',
	...
	'Installation_LargePiwikInstances' => 'Дапамога для буйных усталёвак Intranet Statistics',
	'Installation_JsTag' => 'JavaScript тэг',
	'Installation_Congratulations' => 'Віншуем',
	'Installation_CongratulationsHelp' => '<p>Віншуем! Усталёўка Intranet Statistics скончана.</p><p>Пераканаецеся, што JavaScript-код змесцаваны на ўсіх старонках, і, чакайце першых наведвальнікаў!',
	'Installation_ContinueToPiwik' => 'Перайсці да Intranet Statistics',
	...
	'Installation_SecurityNewsletter' => 'паведамляць мяне пра значныя абнаўленні Intranet Statistics і памылках бяспекі па email',
	...
	'Installation_Requirements' => 'Патрабаванні Intranet Statistics',
	...
	'Installation_SystemCheckDatabaseHelp' => 'Intranet Statistics патрабуе пашырэнне mysqli альбо абодва пашырэння PDO і pdo_mysql.',
	...
	'Installation_SystemCheckMailHelp' => 'Функцыі водгукаў о Intranet Statistics і аднаўленне пароляў не будуць працаваць без mail().',
	'Installation_SystemCheckParseIniFileHelp' => 'Гэтая убудаваная функцыя адключана на вашым хосце. Intranet Statistics паспрабуе эмуляваць гэтую функцыю, але могуць паўстаць дадатковыя абмежаванні бяспекі. Трэкер прадукцыйнасці таксама будзе закрануты.',
	'Installation_SystemCheckGlobHelp' => 'Гэтая убудаваная функцыя адключана на вашым хосце. Intranet Statistics паспрабуе эмуляваць гэтую функцыю, але могуць паўстаць дадатковыя абмежаванні бяспекі. Функцыянальныя магчымасці могуць быць закрануты.',
	'Installation_SystemCheckDebugBacktraceHelp' => 'Прагляд::сістэма не ў стане стварыць прадстаўленне для выкліку модуля.',
	'Installation_SystemCheckCreateFunctionHelp' => 'Intranet Statistics выкарыстоўвае ананімныя функцыі зваротнага выкліку.',
	...
	'Installation_SystemCheckPackHelp' => 'Функцыя pack() патрабуецца для адсочвання наведвальнікаў у Intranet Statistics.',
	...
	'Installation_SystemCheckAutoUpdateHelp' => 'Заўважце: абнаўленне Intranet Statistics у рэжыме "аднаго націска" п атрабуе дазвол запісу да тэчцы Intranet Statistics і яё змесціва.',
	'Installation_SystemCheckError' => 'Паўстала памылка - павінна быць выпраўлена перад працягам',
	'Installation_SystemCheckWarning' => 'Intranet Statistics будзе працаваць звычайна, але некаторыя функцыі не будуць даступныя',
	...
	'Installation_TablesWithSameNamesFound' => 'Некаторыя %1$s табліцы ў Вашай базе дадзеных %2$s маюць супадальныя назвы з табліцамі, якія Intranet Statistics спрабуе стварыць.',
	...
	'Installation_TablesDeletedSuccess' => 'Існыя табліцы Intranet Statistics паспяхова выдалены',
	...
	'Installation_GoBackAndDefinePrefix' => 'Вярніцеся назад і ўвядзіце прэфікс для табліц Intranet Statistics',
	...
	'Installation_WelcomeHelp' => '<p>Intranet Statistics - гэта адкрытае праграмнае забеспячэнне, якое дазваляе вам весткі статыстычны ўлік наведванняў вашага сайта і праводзіць аналітычныя разлікі для атрымання інфармацыі неабходным вам інфармацыі пра наведвальнікаў. Гэты працэс складаецца з %s простых крокаў і займае каля 5 мінуць чакай.</p>',
	'Installation_ConfigurationHelp' => 'Ваш Intranet Statistics канфігурацыйны файл, няправільна зканфігураваны. Вы можаце альбо выдаліць config/config.ini.php і працягнуць усталёўку або правільна наладзіць злучэнне з базай дадзеных.',
	'Installation_ErrorInvalidState' => 'Памылка: Падобна, Вы спрабуеце прапусціць крок усталявальнай праграмы, ці cookie забаронены ў брауезере, ці файл канфігурацыі Intranet Statistics ужо існуе. %1$sУбедітесь, што cookies дазволены%2$s і вярніцеся назад %3$s да першага кроку ўсталёўкі %4$s.',
	'LanguagesManager_PluginDescription' => 'Гэты плагін будзе адлюстроўваць спіс даступных моў інтэрфейсу Intranet Statistics. Абраная мова, будзе захавана ў наладках для кожнага карыстальніка.',
	'LanguagesManager_AboutPiwikTranslations' => 'Аб перакладах Intranet Statistics',
	...
	'Login_InvalidNonceOrHeadersOrReferer' => 'Бяспека формы не атрымалася. Калі ласка, перазагрузіце форму і пераканаецеся, што вашы cookies ўключаны. Калі вы выкарыстоўваеце проксі-сервер, то неабходна %s наладзіць Intranet Statistics да прыняцця проксі загалоўкаў%s, якія перанакіроўваюць да загалоўкаў вузлоў. Акрамя таго, праверце, што ваш Referer загаловак перадаецца правільна.',
	...
	'MultiSites_PluginDescription' => 'Адлюстравае мульті-сайтавую выканаўчую рэзюмэ/статыстыку. У цяперашні час падтрымліваецца як плагін ядра Intranet Statistics.',
	...
	'Provider_ProviderReportDocumentation' => 'Гэтая справаздача паказвае, якія інтэрнэт-правайдэры наведвальнікаў выкарыстоўваюцца для доступу да вэб-сайту. Вы можаце націснуць на імя правайдэра для больш падрабязнай інфармацыі. %s Калі Intranet Statistics не можа вызначыць, правайдэра наведвальніка, ён паказваецца ў якасці IP-адраса.',
	...
	'SitesManager_PluginDescription' => 'Кіраванне Сайтамі ў Intranet Statistics: Дадаць новы сайт, Рэдагаваць існуючы, паказаць код JavaScript, каб дадаць яго на старонкі свайго сайта. Усе дзеянні, таксама даступныя праз API.',
	...
	'SitesManager_PiwikWillAutomaticallyExcludeCommonSessionParameters' => 'Intranet Statistics аўтаматычна выключае агульныя параметры сесіі (%s).',
	'SitesManager_HelpExcludedIps' => 'Калі ласка, увядзіце спіс IP-адрасоў, па адным у радку, якія патрэбна сключыць з адсочвання Intranet Statistics. Вы можаце выкарыстоўваць групавыя сімвалы, напр. %1$s або %2$s',
	...
	'SitesManager_PiwikOffersEcommerceAnalytics' => 'Intranet Statistics прапаноўвае пашыранае адсочванне і рэпартаванне для камерцыйных вэб-сайтаў. Даведайцеся больш пра %s Аналітыку Электронна-камерцыйных сайтаў%s.',
	'TranslationsAdmin_PluginDescription' => 'Дапамажыце перакласць Intranet Statistics на ваш мову.',
	...
	'UsersManager_PluginDescription' => 'Кіраванне карыстальнікамі ў Intranet Statistics: даданне новых карыстальнікаў, рэдагаванне ужо існуючых, абнаўленне правоў дазволу. Усе дзеянні, таксама даступныя праз API.',
	...
	'UsersManager_MainDescription' => 'Пакажыце, якія карыстачы маюць доступ да Intranet Statistics на Вашым сайце. Таксама Вы можаце задаць правы доступу на ўсе сайты.',
	...
	'UsersManager_YourVisitsAreIgnoredOnDomain' => '%sВашы наведванні ігнаруюцца Intranet Statistics на %s %s (Intranet Statistics знайшоў ў вашым браўзэры ігнаруючыя cookie).',
	'UsersManager_YourVisitsAreNotIgnored' => '%sВашы наведванні не ігнаруюцца Intranet Statistics%s (Intranet Statistics не знайшоў ў вашым браўзэры ігнаруючыя cookie).',
	'UsersManager_ClickHereToDeleteTheCookie' => 'Націсніце тут, каб выдаліць cookie і пачаць адсочванне вашых наведванняў Intranet Statistics',
	'UsersManager_ClickHereToSetTheCookieOnDomain' => 'Націсніце тут, каб усталяваць cookie, які выключыць адсочванне вашых наведванняў на вэб-сайтах з Intranet Statistics на %s',
	...
	'UsersManager_WhenUsersAreNotLoggedInAndVisitPiwikTheyShouldAccess' => 'Калі карыстальнікі не аўтарызаваны і наведваюць Intranet Statistics, яны павінны атрымліваць доступ да',
	...
	'UsersManager_ExceptionEditAnonymous' => 'Ананімны карыстач не можа быць выдалены. Ён неабходзен Intranet Statistics для ідэнтыфікацыі карыстачоў, якія не ўвайшлі ў сістэму. Дапушчальна, вы можаце зрабіць статыстыку публічнай, падаючы права \'Прагляд\' ананімнаму карыстачу.',
	'UsersManager_ExceptionSuperUser' => 'Запытаны карыстальнік Super User, яго нельга рэдагаваць або выдаляць з дапамогай API. Вы можаце ўручную адрэдагаваць Super User карыстальніка ў файле канфігурацыі Intranet Statistics.',
	...
	'VisitorGenerator_PluginDescription' => 'Плагін для стварэння неіснуючых наведванняў. Гэта можа быць зроблена карыстальнікам ці распрацоўшчыкам Intranet Statistics, як просты спосаб стварэння падробленых дадзеных для запаўнення справаздач Intranet Statistics.',
	'VisitorGenerator_VisitorGenerator' => 'Генератар наведванняў',
	'VisitorGenerator_Warning' => 'Вы збіраецеся генераваць падробленыя наведванні, якія будуць запісаны ў базу дадзеных Intranet Statistics.',
	'VisitorGenerator_NotReversible' => 'Будзе %s не%s лёгка выдаліць гэтыя візіты з запісаў Intranet Statistics.',
	...
	'VisitTime_NHour' => '%s ч.',
	'Widgetize_PluginDescription' => 'Плагін дазваляе лёгка экспартаваць любы віджэт Intranet Statistics у блог, вэб-сайт або на iGoogle і Netvibes!',
	...
	'PDFReports_PiwikReports' => 'Intranet Statistics справаздачы',
