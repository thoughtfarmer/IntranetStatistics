...
$translations = array(
	...
	'General_AllowPiwikArchivingToTriggerBrowser' => 'Leisti Intranet Statistics archyvavimo trigerį, kai naršyklėje peržiūrimos ataskaitos',
	'General_ArchivingInlineHelp' => 'Vidutinio ir didelio srauto svetainėms rekomenduojama išjungti Intranet Statistics archyvavimo trigerį. Vietoj to, rekomenduojame nustatyti cron job Intranet Statistics ataskaitų generavimui kas valandą.',
	'General_ArchivingTriggerDescription' => 'Rekomenduojama didesniems Intranet Statistics diegimams. Jums reikia %snustatyti cron job%s automatiniam ataskaitų generavimui.',
	...
	'General_YouAreViewingDemoShortMessage' => 'Šiuo metu Jūs stebite Intranet Statistics demonstraciją',
	'General_DownloadFullVersion' => '%1$sAtsisiųskite%2$s pilną versiją! Išsamiau %3$s',
	'General_NewUpdatePiwikX' => 'Atnaujinimai: Intranet Statistics %s',
	'General_AboutPiwikX' => 'Apie Intranet Statistics %s',
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Išleista Intranet Statistics %1$s versija. %2$s Atnaujinkite dabar!%3$s (peržiūrėti %4$s pasikeitimus%5$s).',
	'General_PiwikXIsAvailablePleaseNotifyPiwikAdmin' => 'Pasirodė %s. Prašome pranešti svetainės administratoriui.',
	'General_NewReportsWillBeProcessedByCron' => 'Kai Intranet Statistics archyvavimas neaktyvuotas per naršyklę, naujos ataskaitos bus sugeneruotos per crontab',
	...
	'General_BackToPiwik' => 'Atgal į Intranet Statistics',
	...
	'General_ConfigFileIsNotWritable' => 'Intranet Statistics konfigūracijos failas %s negali būti keičiamas, todėl dalis Jūsų nustatymų gali būti neišsaugoti. %s Prašome pakeisti šio failo teises, kad galėtumėte įrašyti pakeitimus.',
	'General_ExceptionDatabaseVersion' => 'Jūsų %1$s versija yra %2$s, tačiau Intranet Statistics reikalinga bent jau %3$s.',
	...
	'General_FileIntegrityWarningExplanation' => 'Failo vientisumo patikra nutraukta ir pateikiama klaidų ataskaita. Tikėtina, jog tai įtakoja nepilnas arba nutrauktas Intranet Statistics failų įkėlimas į serverį. Prašome pabandyti pakartotinai perkelti Intranet Statistics failus ir atnaujinti šį puslapį kol nebebus rodomi klaidų pranešimai.',
	...
	'General_PleaseUpdatePiwik' => 'Prašome atnaujinti Intranet Statistics',
	...
	'API_PluginDescription' => 'Visi duomenys Intranet Statistics pasiekiami per paprastas API sąsajas. Šis papildinys - tai žiniatinklio tarnybos įėjimo taškas, kuriuo galite naudotis norėdami gauti savo žiniatinklio analizatoriaus duomenis xml, json, php, csv ir kitais formatais.',
	'API_QuickDocumentationTitle' => 'API trumpa dokumentacija',
	'API_GenerateVisits' => 'Jei neturite duomenų šiandienai , galite sugeneruoti jų pasinaudoję %s papildiniu. Įjunkite šį %s papildinį, tada spauskite ant \'Apsilankymų generatorius\' meniu Intranet Statistics administratoriaus srityje.',
	'API_MoreInformation' => 'Norinčius gauti daugiau informacijos apie Intranet Statistics API sąsajas, prašome žvilgtelėti į %s Įvadas į Intranet Statistics API %s ir %s Intranet Statistics API informacija %s.',
	...
	'CoreAdminHome_PluginDescription' => 'Intranet Statistics administravimo sritis',
	...
	'CoreHome_JavascriptDisabled' => 'JavaScript turi būti įjungta, kad būtų galima naudoti standartinę Intranet Statistics išvaizdą.<br />Tačiau panašu, kad JavaScript yra arba išjungta, arba nepalaikoma Jūsų naršyklės.<br />Norėdami matyti standartinę išvaizdą, įjunkite JavaScript keisdami savo naršyklės nustatymus, tada %1$sbandykite dar kartą%2$s.<br />',
	...
	'CorePluginsAdmin_MainDescription' => 'Papildiniai suteikia Intranet Statistics papildomų galimybių. Įdiegę papildinį, čia galite jį aktyvinti arba pasyvinti',
	...
	'CoreUpdater_PluginDescription' => 'Intranet Statistics naujinimo įranga',
	'CoreUpdater_UpdateTitle' => 'Naujinimas',
	'CoreUpdater_DatabaseUpgradeRequired' => 'Reikalingas duombazės atnaujinimas',
	'CoreUpdater_YourDatabaseIsOutOfDate' => 'Norint tęsti, reikia atnaujinti Intranet Statistics duombazę',
	'CoreUpdater_PiwikWillBeUpgradedFromVersionXToVersionY' => 'Intranet Statistics duombazė bus atnaujinta iš %1$s į %2$s versiją.',
	'CoreUpdater_TheFollowingPluginsWillBeUpgradedX' => 'Bus atnaujinti šie papildiniai: %s.',
	'CoreUpdater_NoteForLargePiwikInstances' => 'Svarbi pastaba apie didelius Intranet Statistics diegimus',
	'CoreUpdater_TheUpgradeProcessMayFailExecuteCommand' => 'Jei Jūsų Intranet Statistics duombazė yra didelė, atnaujinimas naršyklėje gali užtrukti per ilgai. Tokiu atveju, galite paleisti atnaujinimus per komandinę eilutę: %s',
	'CoreUpdater_YouCouldManuallyExecuteSqlQueries' => 'Jei negalite pasinaudoti komandine eilute Intranet Statistics atnaujinti ar Intranet Statistics tiesiog neatsinaujina (dėl nutrūkusios sesijos, prarasto ryšio su duombaze ar kurios nors kitos priežasties), galite rankiniu būdu įvykdyti SQL užklausas Intranet Statistics atnaujinimui.',
	...
	'CoreUpdater_UpgradePiwik' => 'Naujinti Intranet Statistics',
	...
	'CoreUpdater_ErrorDIYHelp_3' => 'rankiniu būdu papildykite `option` lentelę Intranet Statistics duombazėje, nustatydami version_core reikšmę į nepavykusio naujinimo versijos numerį',
	...
	'CoreUpdater_ErrorDIYHelp_5' => 'praneškite apie problemą (ir sprendimą), kad Intranet Statistics būtų patobulintas',
	'CoreUpdater_HelpMessageContent' => 'Peržiūrėkite %1$s Intranet Statistics DUK, %2$s kur paaiškinamos dažniausiai pasitaikančios naujinimo problemos. %3$s Jūsų sistemos administratorius gali padėti išspręsti daugumą jų, kadangi jos dažniausiai susijusios su serverio arba MySQL nustatymais.',
	...
	'CoreUpdater_HelpMessageIntroductionWhenWarning' => 'Intranet Statistics atnaujinta, tačiau su išlygomis. Prašome perskaityti aukščiau pateikiamą aprašymą. Jei reikia daugiau pagalbos:',
	...
	'CoreUpdater_PiwikHasBeenSuccessfullyUpgraded' => 'Intranet Statistics sėkmingai atnaujinta!',
	'CoreUpdater_ContinueToPiwik' => 'Grįžti į Intranet Statistics',
	'CoreUpdater_UpdateAutomatically' => 'Naujinti automatiškai',
	'CoreUpdater_ThereIsNewVersionAvailableForUpdate' => 'Pasirodė nauja Intranet Statistics versija',
	'CoreUpdater_YouCanUpgradeAutomaticallyOrDownloadPackage' => 'Galite atnaujinti iki %s versijos automatiškai arba atsisiųsti paketą ir atnaujinti Intranet Statistics rankiniu būdu:',
	'CoreUpdater_YouMustDownloadPackageOrFixPermissions' => 'Intranet Statistics negali perrašyti Jūsų dabartinio diegimo. Galite arba pataisyti katalogo/failo teises, arba atsisiųsti paketą ir įdiegti šią versiją %s rankiniu būdu:',
	'CoreUpdater_DownloadX' => 'Atsisiųsti %s',
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'Intranet Statistics automatinis atnaujinimas atšauktas. Jei negalite ištaisyti nurodytos klaidos, rekomenduojame atnaujinti Intranet Statistics rankiniu būdu. %1$s Peržiūrėkite %2$sNaujinimo dokumentaciją%3$s prieš pradedant!',
	...
	'CoreUpdater_PiwikUpdatedSuccessfully' => 'Intranet Statistics sėkmingai atnaujinta!',
	'CoreUpdater_EmptyDatabaseError' => 'Duombazė %s yra tuščia. Privalote paredaguoti arba pašalinti savo Intranet Statistics konfigūracijos failą.',
	'CoreUpdater_ExceptionAlreadyLatestVersion' => 'Jūsų Intranet Statistics versija %s yra naujausia.',
	...
	'DBStats_MainDescription' => 'Intranet Statistics saugo visus Jūsų duomenis MySQL duombazėje. Šiuo metu Intranet Statistics lentelės naudoja %s.',
	'DBStats_LearnMore' => 'Norint geriau susipažinti su Intranet Statistics duomenų apdorojimu bei kaip priversti Intranet Statistics veikti geriau vidutinės ir didelės apkrovos svetainėse, siūlome pastudijuoti dokumentaciją %s.',
	...
	'ExampleUI_PluginDescription' => 'Pavyzdinis papildinys: Šis papildinys parodys kaip dirbti su Intranet Statistics UI: kurti lenteles, grafikus ir pan.',
	'Feedback_PluginDescription' => 'Siųskite savo atsiliepimus Intranet Statistics komandai. Dalinkitės savo idėjomis ir pasiūlymais su mumis!',
	...
	'Feedback_WhyWrongCountry' => 'Kodėl Intranet Statistics rodo mano apsilankymus ne iš tos šalies?',
	...
	'Feedback_SpecialRequest' => 'Gal turite specialių pageidavimų Intranet Statistics komandai?',
	'Feedback_ContactThePiwikTeam' => 'Susisiekite su Intranet Statistics komanda!',
	'Feedback_IWantTo' => 'Aš noriu:',
	'Feedback_CategoryShareStory' => 'Pasidalinkite Intranet Statistics sėkmės istorija',
	'Feedback_CategorySponsor' => 'Paremkite Intranet Statistics',
	'Feedback_CategoryHire' => 'Nusisamdykite Intranet Statistics konsultantą',
	...
	'Feedback_MessageSent' => 'Jūsų žinutė buvo nusiųsta Intranet Statistics komandai.',
	'Feedback_ThankYou' => 'Dėkojame už pagalbą kuriant tobulesnį Intranet Statistics!',
	'Feedback_ThePiwikTeam' => 'Intranet Statistics komanda',
	...
	'Goals_NoGoalsNeedAccess' => 'Tik administratorius ir super naudotojas gali pridėti uždavinius nurodytoms svetainėms. Paprašykite savo Intranet Statistics administratoriaus pridėti uždavinį Jūsų svetainei. <br> Uždavinių stebėjimas yra puikus būdas suprasti ir maksimizuoti Jūsų svetainės įdirbį!',
	...
	'Goals_DefaultRevenueHelp' => 'Pavyzdžiui, lankytojo užpildyta ir išsiųsta kontaktinė forma gali būti verta vidutiniškai 10 Lt. Intranet Statistics padės Jums suprasti Jūsų lankytojų segmentų efektyvumą.',
	...
	'Goals_LearnMoreAboutGoalTrackingDocumentation' => 'Sužinokite daugiau apie %s uždavinių stebėjimą Intranet Statistics%s naudotojo dokumentacijoje.',
	'Installation_PluginDescription' => 'Intranet Statistics diegimo procesas. Diegimas paprastai atliekamas vieną kartą. Jei konfigūracijos failas config/config.inc.php ištrinamas, bus paleistas papildomas diegimas.',
	'Installation_Installation' => 'Įdiegimas',
	'Installation_InstallationStatus' => 'Įdiegimo būklė',
	'Installation_PercentDone' => '%s %% Atlikta',
	'Installation_NoConfigFound' => 'Jūs bandote pasiekti Intranet Statistics puslapį, tačiau negalima rasti Intranet Statistics konfigūracinio failo.<br /><b>  » Galite <a href=\'index.php\'>įdiegti Intranet Statistics dabar</a></b><br /><small>Jei Intranet Statistics duombazėje liko lentelių iš ankstesnių diegimų, nesijaudinkite, nes galite naudoti tas pačias lenteles ir išsaugoti turimus duomenis!</small>',
	...
	'Installation_LargePiwikInstances' => 'Pagalba dideliems Intranet Statistics pavyzdžiams',
	'Installation_JsTag' => 'JavaScript gairė (tag)',
	'Installation_Congratulations' => 'Sveikiname',
	'Installation_CongratulationsHelp' => '<p>Sveikiname! Intranet Statistics diegimas baigtas.</p><p>Įsitikinkite, kad JavaScript žymė (tag) yra įrašyta visuose puslapiuose ir laukite pirmųjų lankytojų!</p>',
	'Installation_ContinueToPiwik' => 'Grįžti į Intranet Statistics',
	...
	'Installation_SecurityNewsletter' => 'pranešti man apie svarbesnius Intranet Statistics atnaujinimus bei saugos įspėjimus',
	...
	'Installation_Requirements' => 'Intranet Statistics reikalavimai sistemai',
	...
	'Installation_SystemCheckDatabaseHelp' => 'Intranet Statistics reikalingas mysqli plėtinys arba abu PDO ir pdo_mysql plėtiniai',
	...
	'Installation_SystemCheckParseIniFileHelp' => 'Ši integruota funkcija yra išjungta Jūsų serveryje. Intranet Statistics pabandys emuliuoti šią funkciją, tačiau galimi saugumo suvaržymai ateityje. Stebėjimo sparta taip pat gali būti paveikta.',
	...
	'Installation_SystemCheckAutoUpdateHelp' => 'Pastaba: Intranet Statistics atnaujinimas "vienu paspaudimu" reikalauja rašymo teisių Intranet Statistics katalogui ir jo turiniui.',
	'Installation_SystemCheckError' => 'Rasta klaida turi būti ištaisyta prieš tęsiant',
	'Installation_SystemCheckWarning' => 'Intranet Statistics funkcionuos normaliai, tačiau kai kurios savybės gali būti prarastos',
	'Installation_SystemCheckSecureProtocol' => 'Saugus protokolas',
	'Installation_Tables' => 'Kuriamos lentelės',
	'Installation_TablesWithSameNamesFound' => 'Kai kurios %1$s lentelės Jūsų duombazėje %2$s pavadintos taip pat, kaip lentelės, kurias Intranet Statistics bando sukurti',
	'Installation_TablesFound' => 'Šios lentelės buvo rastos duombazėje',
	'Installation_TablesWarningHelp' => 'Pasirinkite ar naudoti jau esančias duombazėje lenteles, ar atlikti švarų įdiegimą ištrinant visus duomenis Intranet Statistics duombazėje.',
	'Installation_TablesReuse' => 'Naudoti esamas lenteles',
	'Installation_TablesDelete' => 'Ištrinti visas aptiktas lenteles',
	'Installation_TablesDeletedSuccess' => 'Esamos Intranet Statistics lentelės ištrintos sėkmingai',
	...
	'Installation_GoBackAndDefinePrefix' => 'Grįžkite atgal ir nurodykite Intranet Statistics lentelių priešdėlį',
	...
	'Installation_WelcomeHelp' => '<p>Intranet Statistics yra atvirojo kodo programa, kuri leidžia lengvai rinkti informaciją apie Jūsų lankytojus.</p><p>Šis procesas padalintas į %s lengvus žingsnius, kurie užims apie 5 minutes.</p>',
	'Installation_ConfigurationHelp' => 'Jūsų Intranet Statistics konfigūracijos failas sukonfigūruotas netinkamai. Jūs galite ištrinti config/config.ini.php failą arba pakartoti diegimą, arba pakoreguoti susijungimo su duomenų baze nustatymus.',
	'Installation_ErrorInvalidState' => 'Klaida: Panašu, kad bandote praleisti įdiegimo procesą, arba Jūsų naršyklėje išjungti slapukai, arba Intranet Statistics konfigūracinis failas jau yra sukurtas. %1$sĮsitikinkite, kad slapukai įjungti%2$s ir grįžkite %3$s į pradinį įdiegimo puslapį %4$s.',
	'LanguagesManager_PluginDescription' => 'Šis papildinys pateikia visų prieinamų kalbų Intranet Statistics vartotojo sąsajai sąrašą. Kiekvienas naudotojas gali pasirinkti savo kalbą.',
	'LanguagesManager_AboutPiwikTranslations' => 'Apie Intranet Statistics vertimus',
	...
	'Login_ContactAdmin' => 'Galima priežastis: Jūsų pagr. kompiuteryje (serveryje) gali būti išjungta mail() funkcija.<br />Prašome susisiekti su savo Intranet Statistics administratoriumi.',
	...
	'SitesManager_AliasUrlHelp' => 'Rekomenduojama, nors ir nebūtina, nurodyti įvarius URLs, kuriais lankytojai pasiekia šią svetainę. Alternatyvių vardų URLs svetainei nebus atvaizduojama Šaltiniai > Svetainių ataskaitos. Nebūtina nurodyti URL su ar be \'www\', kadangi Intranet Statistics automatiškai palaiko abu.',
	...
	'SitesManager_PiwikWillAutomaticallyExcludeCommonSessionParameters' => 'Intranet Statistics automatiškai neįtrauks paplitusių sesijos parametrų (%s).',
	...
	'TranslationsAdmin_PluginDescription' => 'Padėkite versti Intranet Statistics į Jūsų kalbą.',
	...
	'UsersManager_PluginDescription' => 'Intranet Statistics naudotojų administravimas: pridėkite naudotoją, redaguokite esamą, atnaujinkite leidimus. Visi veiksmai taip pat pasiekiami per API sąsają.',
	...
	'UsersManager_MainDescription' => 'Nuspręskite kuris naudotojas kokias Intranet Statistics teises turės Jūsų svetainei. Taip pat galite sukurti leidimus visoms svetainėms iš karto.',
	...
	'UsersManager_YourVisitsAreIgnoredOnDomain' => '%sJūsų apsilankymai yra ignoruojami Intranet Statistics %s %s (Intranet Statistics ignoravimo slapukas buvo aptiktas Jūsų naršyklėje).',
	'UsersManager_ClickHereToDeleteTheCookie' => 'Spauskite čia, kad ištrintumėte slapuką ir Intranet Statistics stebėtų Jūsų apsilankymus',
	'UsersManager_ClickHereToSetTheCookieOnDomain' => 'Spauskite čia, kad sukurtumėte slapuką, kuris neleis Intranet Statistics sekti Jūsų apsilankymų %s',
	...
	'UsersManager_WhenUsersAreNotLoggedInAndVisitPiwikTheyShouldAccess' => 'Kai naudotojai neprisijungę apsilanko Intranet Statistics, jie turi pasiekti',
	...
	'UsersManager_ExceptionSuperUser' => 'Pageidaujamas naudotojas yra Super Naudotojas, todėl negali būti klausiamas, keičiamas ar šalinamas per API sąsają. Super Naudotojo duomenis galite keisti rankiniu būdu Intranet Statistics konfigūraciniame faile.',
	...
	'VisitTime_NHour' => '%sh',
	'Widgetize_PluginDescription' => 'Šis papildinys leidžia itin paprastai eksportuoti bet kurį Intranet Statistics valdiklį į Jūsų interneto dienoraštį, svetainę ar į Igoogle bei Netvibes!',
	...
	'PDFReports_PiwikReports' => 'Intranet Statistics ataskaitos',
