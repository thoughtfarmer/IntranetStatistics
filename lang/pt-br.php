...
$translations = array(
	...
	'General_BackToHomepage' => 'Voltar a página do Intranet Statistics',
	'General_Yes' => 'Sim',
	'General_No' => 'Não',
	...
	'General_AllowPiwikArchivingToTriggerBrowser' => 'Permitir que o Intranet Statistics salve numa trigger quando relatórios são vistos do navegador',
	'General_ArchivingInlineHelp' => 'Para sites com tráfego de médio a alto, é recomendado desabilitar a trigger que salva do navegador. Em vez disso, nós recomendamos que instale um cron job para processar os relatorios Intranet Statistics a cada hora.',
	'General_ArchivingTriggerDescription' => 'Recomendado para instalações maiores do Intranet Statistics, precisa de %s configurar um cron job%s para processar os relatórios automaticamente.',
	...
	'General_RequiresFlash' => 'Mostrar gráficos no Intranet Statistics requer Flash',
	'General_GraphHelp' => 'Mais informações sobre mostrar gráficos em Intranet Statistics.',
	...
	'General_YouAreViewingDemoShortMessage' => 'Está atualmente a ver a demonstração do Intranet Statistics',
	'General_DownloadFullVersion' => '%1$sBaixar%2$s a versão completa! Ver %3$s',
	'General_NewUpdatePiwikX' => 'Nova atualização: Intranet Statistics %s',
	'General_AboutPiwikX' => 'Sobre o Intranet Statistics %s',
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Intranet Statisticsi %1$s está disponível. %2$s Por favor atualize agora!%3$s (veja %4$sas mudanças%5$s).',
	'General_PiwikXIsAvailablePleaseNotifyPiwikAdmin' => '%s está disponível. Por favor notifique o administrador do site.',
	'General_NewReportsWillBeProcessedByCron' => 'Quando o arquivamento do Intranet Statistics não for iniciado pelo navegador, novos relatórios irão ser processados pelo crontab.',
	...
	'General_BackToPiwik' => 'Volta ao Intranet Statistics',
	...
	'General_ConfigFileIsNotWritable' => 'O arquivo %s de configuração Intranet Statistics não é editável, suas mudanças não serão salvas. %s por favor mude as permissões da configuração do arquivo para fazê-lo editável.',
	'General_ExceptionDatabaseVersion' => 'Sua %1$s versão é %2$s mas o Intranet Statistics requer no mínimo %3$s.',
	...
	'General_PleaseUpdatePiwik' => 'Por favor atualize o seu Intranet Statistics',
	...
	'Actions_DownloadsReportDocumentation' => 'Neste relatório, você pode ver quais arquivos seus visitantes baixaram. %s Intranet Statistics registra como download como um click em um link de download. Se o download foi completado ou não o Intranet Statistics não consegue determinar.',
	...
	'API_PluginDescription' => 'Todos os dados no Intranet Statistics estão disponíveis através de APIs simples. Esse plugin é o ponto de entrada para o web service, que você pode chamar para ter seus dados Web Analytics em xml, json, php, csv, etc.',
	'API_QuickDocumentationTitle' => 'API documentação rápida',
	'API_GenerateVisits' => 'Se você não tem nenhum dado hoje, você pode gerar alguns dados usando o plugin %s. Você pode habilitar o plugin %s, então clique no menu "Gerador de Visitantes" na área Intranet Statistics Admin.',
	'API_MoreInformation' => 'Para mais informações sobre as APIs Intranet Statistics, por favor, dê uma olhada no %s Introdução para  Intranet Statistics API %s e a %s API Intranet Statistics de Referência %s .',
	...
	'CoreAdminHome_PluginDescription' => 'Área Administrativa do Intranet Statistics.',
	...
	'CoreAdminHome_TrustedHostConfirm' => 'Tem certeza de que deseja alterar o hostname confiável Intranet Statistics?',
	'CoreAdminHome_PiwikIsInstalledAt' => 'Intranet Statistics esta instalado no',
	'CoreHome_InjectedHostEmailSubject' => 'Intranet Statistics foi acessado por um hostname desconhecido : %s',
	'CoreHome_PluginDescription' => 'Estrutura de Relatórios Web Analytics',
	'CoreHome_WebAnalyticsReports' => 'Relatórios Web Analytics',
	'CoreHome_JavascriptDisabled' => 'JavaScript deve ser habilitado para que você possa usar o Intranet Statistics como visualização padrão. <br/>Contudo, parece que JavaScript ou está desabilidado ou não é suportado pelo seu navegador. <br/>Para usar a visualização padrão, habilite o JavaScript mudando as opções do seu navegador, então %1$stente novamente%2$s.<br/>',
	...
	'CorePluginsAdmin_MainDescription' => 'Plugins estendem e expandem a funcionalidade do Intranet Statistics. Uma vez que um plugin for instalado, você pode ativá-lo ou desativá-lo aqui.',
	...
	'CoreUpdater_PluginDescription' => 'Mecanismo de update Intranet Statistics',
	'CoreUpdater_UpdateTitle' => 'Atualiza',
	'CoreUpdater_DatabaseUpgradeRequired' => 'Atualização do banco de dados requerida',
	'CoreUpdater_YourDatabaseIsOutOfDate' => 'Seu banco de dados do Intranet Statistics está desatualizado e deve ser atualizado antes de continuar.',
	'CoreUpdater_PiwikWillBeUpgradedFromVersionXToVersionY' => 'O banco de dados do Intranet Statistics será atualizado da versão %1$s para a nova versão %2$s.',
	...
	'CoreUpdater_TheUpgradeProcessMayFailExecuteCommand' => 'Se você tem um grande banco de dados Intranet Statistics, atualizações podem levar muito tempo para rodar no navegador. Nesse caso, você pode executar as atualizações da sua linha de comando: %s',
	'CoreUpdater_YouCouldManuallyExecuteSqlQueries' => 'Se você não tem permissão para atualizar pela linha de comando e se o Intranet Statistics falhou em atualizar (devido a um timeout do banco de dados, timeout do navegador, ou outro problema), você poderá manualmente executar as queries SQL para atualizar o Intranet Statistics.',
	...
	'CoreUpdater_UpgradePiwik' => 'Atualiza o Intranet Statistics',
	...
	'CoreUpdater_ErrorDIYHelp_3' => 'Atualiza manualmente a tabela `option` no banco de dados Intranet Statistics, ajustando o valor de version_core para a versão da atualização que falhou',
	...
	'CoreUpdater_ErrorDIYHelp_5' => 'relate o problema (e solução) para que o Intranet Statistics possa ser melhorado',
	'CoreUpdater_HelpMessageContent' => 'Verifique o %1$s Intranet Statistics FAQ %2$s que explica os erros mais comuns durante a atualização. %3$s Pergunte ao seu administrador do sistema - Ele pode ser capaz de lhe ajudar com o erro que muito provavelmente é relacionado com o seu servidor ou o setup do MySQL.',
	...
	'CoreUpdater_PiwikHasBeenSuccessfullyUpgraded' => 'Intranet Statistics foi atualizado com sucesso!',
	'CoreUpdater_ContinueToPiwik' => 'Continua no Intranet Statistics',
	'CoreUpdater_UpdateAutomatically' => 'Atualiza automaticamente',
	'CoreUpdater_ThereIsNewVersionAvailableForUpdate' => 'Há uma nova versão do Intranet Statistics disponível para atualização',
	...
	'CoreUpdater_YouMustDownloadPackageOrFixPermissions' => 'Intranet Statistics é incapaz de sobrescrever uma instalação atual. Você pode arrumar as permissões de diretório/arquivos ou download o pacote e instalar a versão %s manualmente:',
	'CoreUpdater_DownloadX' => 'Dowload %s',
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'O Intranet Statistics One Click Update foi cancelado. Se você não pode consertar a mensagem de erro acima, é recomendado que você atualize manualmente o Intranet Statistics. %1$s Por favor cheque a %2$sDocumentaçao de atualização%3$s para começar!',
	...
	'CoreUpdater_PiwikUpdatedSuccessfully' => 'Intranet Statistics atualizado com sucesso!',
	'CoreUpdater_EmptyDatabaseError' => 'O banco de dados %s está vazio. Você deve editar ou remover o seu arquivo de configuração do Intranet Statistics.',
	'CoreUpdater_ExceptionAlreadyLatestVersion' => 'Sua versão %s do Intranet Statistics está atualizada.',
	...
	'DBStats_PluginDescription' => 'Esse plugin relata o banco de dados MySQL usado pelas tabelas Intranet Statistics.',
	'DBStats_DatabaseUsage' => 'Uso do banco de dados',
	'DBStats_MainDescription' => 'O Intranet Statistics está armazenando todos os dados de análise de tráfego no banco de dados MySQL. Atualmente, as tabelas do Intranet Statistics estão usando %s.',
	'DBStats_LearnMore' => 'Apara aprender mais sobre como o Intranet Statistics processa os dados e como fazer o Intranet Statistics trabalhar bem para sites de médio e alto tráfego, confira a documentação %s.',
	...
	'ExampleUI_PluginDescription' => 'Plugin Exemplo: Esse plugin mostra como trabalhar com o Intranet Statistics UI: criar tabelas, gráficos, etc.',
	'Feedback_PluginDescription' => 'Envie seu FeedBack para a Equipe Intranet Statistics. Compartilhe suas ideias e sugestões conosco!',
	...
	'Feedback_WhyWrongCountry' => 'Porque o Intranet Statistics mostra minha visita de um país errado?',
	...
	'Feedback_SpecialRequest' => 'Você tem algum pedido especial para a equipe do Intranet Statistics?',
	'Feedback_ContactThePiwikTeam' => 'Entre em contato com a equipe Intranet Statistics!',
	'Feedback_IWantTo' => 'Eu quero:',
	'Feedback_CategoryShareStory' => 'Compartilhe uma história Intranet Statistics de sucesso',
	'Feedback_CategorySponsor' => 'Patrocinador Intranet Statistics',
	'Feedback_CategoryHire' => 'Contrate um consultor Intranet Statistics',
	...
	'Feedback_MessageSent' => 'Sua mensagem foi enviada para a equipe Intranet Statistics',
	'Feedback_ThankYou' => 'Obrigado por nos ajudar a fazer o Intranet Statistics melhor!',
	'Feedback_ThePiwikTeam' => 'A Equipe Intranet Statistics',
	...
	'Goals_NoGoalsNeedAccess' => 'Apenas um Administrador ou um Super Usuário podem adicionar metas para um dado website. Por favor peça a um administrador Intranet Statistics  topara setar uma meta para seu website. <br>Rastrear metas é uma grande maneira de ajudar a entender e maximizar a performance de seu website!',
	...
	'Goals_DefaultRevenueHelp' => 'Por exemplo, um Form Contato submetido por um visitante pode valer $10 em média. Intranet Statistics ajudará a entender quão bem o segmento de seus visitantes está funcionando.',
	...
	'Goals_LearnMoreAboutGoalTrackingDocumentation' => 'Aprenda mais sobre %s Rastreando Metas no Intranet Statistics %s na documentação do usuário.',
	'Goals_Products' => 'Produto SKU',
	'Installation_PluginDescription' => 'Processo de instalação do Intranet Statistics. A instalação normalmente é feita apenas uma vez. Se o arquivo de configuração config/config.inc.php é deletado, a instalação começará novamente.',
	...
	'Installation_NoConfigFound' => 'O arquivo de configuração de relatórios não pode ser encontrado e você está tentando acessar uma página do Intranet Statistics.<br /><b>  » Você poderá <a href=\'index.php\'>instalar o Intranet Statistics agora</a></b><br /><small>Se você instalou o Intranet Statistics antes e possui algumas tabelas em seu banco de dados, não se preocupe, você poderá reutilizar as mesmas tabelas e manter os dados existentes!</small>',
	...
	'Installation_LargePiwikInstances' => 'Ajuda para instancias Intranet Statistics grandes',
	'Installation_JsTag' => 'Tag JavaScript',
	'Installation_Congratulations' => 'Parabéns',
	'Installation_CongratulationsHelp' => '<p>Parabéns! A sua instalação do Intranet Statistics está completa.</p><p>Certifique-se de ter colocado o código JavaScript em todas as suas páginas, e aguarde os seus primeiros visitantes!</p>',
	'Installation_ContinueToPiwik' => 'Continuar no Intranet Statistics',
	...
	'Installation_Requirements' => 'Requerimentos do Intranet Statistics',
	...
	'Installation_SystemCheckDatabaseHelp' => 'O Intranet Statistics requer ou a extensão mysqli ou ambas as extensões PDO e pdo_mysql.',
	...
	'Installation_SystemCheckParseIniFileHelp' => 'Essa função built-in foi desabilitada em seu host. Intranet Statistics tentará simular essa função mas poderá encontrar algumas restrições de segurança. Rastreador de performance também será impactado.',
	'Installation_SystemCheckGlobHelp' => 'Essa função embutida foi desabilitada em seu host. Intranet Statistics tentará simular essa função mas poderá encontrar mais adiante restrições de segurança. Funcionalidades podem ser impactadas.',
	'Installation_SystemCheckDebugBacktraceHelp' => 'View Factory não será permitida para criar views pelo módulo chamado.',
	'Installation_SystemCheckCreateFunctionHelp' => 'Intranet Statistics usa funções anônimas para callbacks',
	...
	'Installation_SystemCheckAutoUpdateHelp' => 'Nota: atualização do Intranet Statistics One Click requer permissões de escrita para as pastas Intranet Statistics e seu conteúdo.',
	'Installation_SystemCheckError' => 'Ocorreu um erro - precisa ser reparado antes de você poder prosseguir',
	'Installation_SystemCheckWarning' => 'Intranet Statistics vai funcionar corretamente mas alguns recursos podem não estar disponíveis',
	...
	'Installation_TablesWithSameNamesFound' => 'Algumas tabelas %1$s no seu banco de dados %2$s tem o mesmo nome das tabelas que o Intranet Statistics está tentando criar',
	...
	'Installation_TablesDeletedSuccess' => 'Tabelas Intranet Statistics excluídas com sucesso',
	...
	'Installation_GoBackAndDefinePrefix' => 'Volte e defina um prefixo para as tabelas Intranet Statistics',
	...
	'Installation_WelcomeHelp' => '<p>Intranet Statistics é um analisador de tráfego open source que torna fácil obter informações sobre os seus visitantes.</p><p>Este processo é dividido em %s passos fáceis e irá demorar por volta de 5 minutos.</p>',
	'Installation_ConfigurationHelp' => 'Seu arquivo de configuração Intranet Statistics parece estar desconfigurado. Você pode ou remover config/config.ini.php e fechar a instalação, ou corrigir as configurações de conexão com banco de dados.',
	'Installation_ErrorInvalidState' => 'Erro: parece que você está tentando pular um passo do processo de instalação, ou seus cookies estão desligados, ou o arquivo de configuração do Intranet Statistics já foi criado. %1$sTenha certeza de que seus cookies estão ativados%2$s e volte %3$spara a página inicial da instalação%4$s.',
	'LanguagesManager_PluginDescription' => 'Esse plugin mostrará uma lista de idiomas disponíveis para a interface do Intranet Statistics. O idioma selecionado salvará as preferencias para cada usuário.',
	'LanguagesManager_AboutPiwikTranslations' => 'Sobre traduções Intranet Statistics.',
	...
	'Login_ContactAdmin' => 'Possível razão: o seu host desabilitou a função mail(). <br />Por favor contacte o administrador do Intranet Statistics.',
	...
	'Mobile_HelpUsToImprovePiwikMobile' => 'Gostaria de ativar o acompanhamento de uso anônimo em Intranet Statistics Mobile?',
	'Mobile_LastUpdated' => 'Última Atualização: %s',
	'Mobile_PullDownToRefresh' => 'Puxar e atualizar...',
	'Mobile_RatingPleaseRateUs' => 'Intranet Statistics Mobile App é um Software Livre, nós realmente apreciamos se você tirar um minuto para avaliar a aplicação do %s. Se você tiver sugestões de novas funcionalidades ou relatórios de bugs, por favor, entre em contato %s \'',
	'Mobile_AnonymousAccess' => 'Acesso anônimo',
	'Mobile_AccessUrlLabel' => 'Url de Acesso Intranet Statistics',
	...
	'MultiSites_PluginDescription' => 'Mostra sumários/estatísticas executivas multi-site. No momento, mantida como plugin núcleo do Intranet Statistics.',
	...
	'SitesManager_PluginDescription' => 'Gerenciamento de websites no Intranet Statistics: adiciona um novo website, edita um existente, mostra código JavaScript para incluir em suas páginas. Todas as ações também estão disponíveis através da API.',
	...
	'SitesManager_PiwikWillAutomaticallyExcludeCommonSessionParameters' => 'Intranet Statistics excluirá automaticamente a sessão comum de parâmetros (%s).',
	'SitesManager_HelpExcludedIps' => 'Entre com a lista de IPs, um por linha, que você deseja excluir por ter sido rastreado pelo Intranet Statistics. Você pode usar wildcards, ex: %1$s ou %2$s',
	...
	'TranslationsAdmin_PluginDescription' => 'Ajude a traduzir o Intranet Statistics para seu idioma.',
	...
	'UsersManager_PluginDescription' => 'Gerenciamento de Usuários no Intranet Statistics: adicionar novo usuário, editar um existente, atualizar permissões. Todas as ações também estão disponíveis na API.',
	...
	'UsersManager_MainDescription' => 'Decida quais usuários terão acesso ao Intranet Statistics nos seus websites. Você pode também ajustar as permissões em todos os websites de uma só vez.',
	...
	'UsersManager_YourVisitsAreIgnoredOnDomain' => '%s Suas visitas são ignoradas pelo Intranet Statistics em %s %s (o Intranet Statistics ignora o cookie encontrado em seu navegador).',
	'UsersManager_YourVisitsAreNotIgnored' => '%sSuas visitas não são ignoradas pelo Intranet Statistics%s (o Intranet Statistics ignora o cookie não encotrado em seu navegador)',
	'UsersManager_ClickHereToDeleteTheCookie' => 'Clique aqui para deletar o cookie e deixar o Intranet Statistics rastrear suas visitas',
	'UsersManager_ClickHereToSetTheCookieOnDomain' => 'Clique aqui para setar um cookie que excluirá suas visitas em websites rastrados pelo Intranet Statistics em %s',
	...
	'UsersManager_WhenUsersAreNotLoggedInAndVisitPiwikTheyShouldAccess' => 'Quando usuários não estão logados e visitam o Intranet Statistics, eles deveriam acessar',
	...
	'UsersManager_ExceptionSuperUser' => 'O usuário requisitado é o Super Usuário e não pode ser alterado, editado ou apagado através da API. Você pode editar manualmente os detalhes do Super Usuário no seu arquivo de configurações do Intranet Statistics.',
	...
	'Widgetize_PluginDescription' => 'O plugin faz ficar muito fácil exportar qualquer widget Intranet Statistics para seu blog, website ou em Igoogle e Netvibes!',
