...
$translations = array(
	...
	'General_BackToHomepage' => 'Povratak na Intranet Statistics stranicu',
	'General_Yes' => 'Da',
	'General_No' => 'Ne',
	...
	'General_AllowPiwikArchivingToTriggerBrowser' => 'Dozvoli pokretanje Intranet Statistics arhiviranja kada se izvještaji pregledavaju iz preglednika',
	'General_ArchivingInlineHelp' => 'Preporučljivo je isključiti pokretanje arhiviranja pri posjeti za stranice sa srednjom i visokom posjećenošću.Umjesto toga savjetujemo da postavite cron job koja će obraditi Intranet Statistics izvještaje svakih sat vremena.',
	'General_ArchivingTriggerDescription' => 'Za veće Intranet Statistics instalacije preporučamo %spostavljanje cron joba %s za automatsku obradu izvještaja.',
	...
	'General_RequiresFlash' => 'Intranet Statistics zahtjeva Flash za prikaz grafova',
	'General_GraphHelp' => 'Više informacija o prikazu grafova u Intranet Statisticsu.',
	...
	'General_YouAreViewingDemoShortMessage' => 'Trenutno gledate demonstraciju Intranet Statisticsa',
	'General_DownloadFullVersion' => '%1$sPreuzmite%2$s punu verziju! Pogledajte %3$s',
	'General_NewUpdatePiwikX' => 'Nova verzija: Intranet Statistics %s',
	'General_AboutPiwikX' => 'O Intranet Statisticsu %s',
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Dostupan je Intranet Statistics %1$s. %2$sInstalirajte novu verziju!%3$s (pogledajte %4$snovosti%5$s).',
	'General_PiwikXIsAvailablePleaseNotifyPiwikAdmin' => 'Dostupan je %s. Molimo vas da obavijestite administratora stranice.',
	'General_NewReportsWillBeProcessedByCron' => 'U slučaju da Intranet Statistics arhiviranje ne pokreće preglednik, nove izvještaje obrađivat će crontab.',
	...
	'General_BackToPiwik' => 'Natrag na Intranet Statistics',
	...
	'General_ConfigFileIsNotWritable' => 'Nije moguće upisati promjene u Intranet Statistics konfiguracijsku datoteku %s. %s Izmjenite dozvole na datoteci kako bi se moglo u nju upisivati.',
	'General_ExceptionDatabaseVersion' => 'Vaša %1$s verzija je %2$s ali Intranet Statistics zahtjeva barem %3$s.',
	...
	'General_FileIntegrityWarningExplanation' => 'Provjera integriteta datoteke nije uspjela i prijavila je određene greške. Najvjerojatniji razlog je nepotpuno ili neuspjelo slanje nekih Intranet Statistics datoteka. Pošaljite nanovo sve Intranet Statistics datoteke na poslužitelj koristeći BINARY način slanja i osvježite ovu stranicu dok se greške ne otklone.',
	...
	'General_PleaseUpdatePiwik' => 'Unaprijedite vašu Intranet Statistics instalaciju',
	...
	'Actions_DownloadsReportDocumentation' => 'U ovom izvješću možete vidjeti popis datoteka koje su vaši posjetitelji preuzeli. %s Intranet Statistics kao download broji klik na poveznicu za download i ne može znati je li pri tom datoteka zaista u potpunosti preuzeta.',
