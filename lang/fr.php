...
$translations = array(
	...
	'General_BackToHomepage' => 'Retour à la page d\'accueil Intranet Statistics',
	'General_Yes' => 'Oui',
	'General_No' => 'Non',
	...
	'General_AllowPiwikArchivingToTriggerBrowser' => 'Autoriser l\'archivage de Intranet Statistics à se déclencher lorsque les rapports sont visionnés depuis le navigateur',
	'General_ArchivingInlineHelp' => 'Pour les sites à trafic moyen et fort, il est recommandé de désactiver l\'archivage de Intranet Statistics depuis le navigateur. Nous vous recommandons de mettre en place une tâche planifiée (cron job) qui génère les rapports toutes les heures.',
	'General_ArchivingTriggerDescription' => 'Recommandé pour les installations importantes de Intranet Statistics, vous devriez %s mettre en place une tâche planifiée (cron) %s pour générer les rapports automatiquement.',
	...
	'General_RequiresFlash' => 'L\'affichage des graphiques dans Intranet Statistics requiert Flash',
	'General_GraphHelp' => 'Plus d\'informations à propos de l\'affichage des graphiques dans Intranet Statistics.',
	...
	'General_PiwikIsACollaborativeProjectYouCanContributeAndDonate' => '%1$s Intranet Statistics %2$s est un projet collaboratif. %3$s Si vous êtes fan, vous pouvez nous aider: Les démarches%4$s Comment participer à Intranet Statistics%5$s, ou%6$s %7$sfaire un don maintenant%8$s pour contribuer à Intranet Statistics 2.0!',
	'General_YouAreViewingDemoShortMessage' => 'Vous êtes en train de visionner la démonstration de Intranet Statistics',
	'General_YouAreCurrentlyUsing' => 'Vous utilisez actuellement Intranet Statistics %s',
	'General_DownloadFullVersion' => '%1$sTéléchargez%2$s la version complète! Rendez vous sur %3$s',
	'General_NewUpdatePiwikX' => 'Nouvelle mise à jour : Intranet Statistics %s',
	'General_AboutPiwikX' => 'À propos de Intranet Statistics %s',
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Intranet Statistics %1$s est maintenant disponible. %2$s Merci de mettre à jour!%3$s (voir %4$s les modifications%5$s).',
	'General_PiwikXIsAvailablePleaseNotifyPiwikAdmin' => '%s est disponible. Merci de prévenir l\'administrateur du site.',
	'General_NewReportsWillBeProcessedByCron' => 'Quand l\'archivage de Intranet Statistics n\'est pas déclenché par le navigateur, les nouveaux rapports seront générés par la crontab.',
	...
	'General_BackToPiwik' => 'Retourner à Intranet Statistics',
	...
	'General_ConfigFileIsNotWritable' => 'Le fichier de configuration de Intranet Statistics %s n\'a pas la permission d\'écriture, vos modifications ne seront pas sauvegardées. %s Merci de modifier les permissions du fichier de configuration de manière à le rendre accessible en écriture.',
	'General_StatisticsAreNotRecorded' => 'Le suivit des visiteurs par Intranet Statistics est actuellement désactivé! Réactivez le suivit des visiteurs en paramétrant record_statistics = 1 dans votre fichier config/config.ini.php.',
	'General_ExceptionDatabaseVersion' => 'Votre version de %1$s est %2$s mais Intranet Statistics a besoin au minimum de la version %3$s.',
	...
	'General_FileIntegrityWarningExplanation' => 'Le contrôle d\'intégrité a échoué et a rapporté des erreurs. Cela est probablement dû à un envoi de fichier partiel ou en échec des fichiers de Intranet Statistics. Vous devriez envoyer de nouveau les fichiers de Intranet Statistics et rafraîchir cette page jusqu\'à ce qu\'elle n\'affiche plus aucune erreur.',
	...
	'General_PleaseUpdatePiwik' => 'Merci de mettre à jour Intranet Statistics',
	...
	'Actions_DownloadsReportDocumentation' => 'Dans ce rapport vous pouvez voir quels fichiers les utilisateurs ont téléchargés. %s Ce que Intranet Statistics compte comme un téléchargement est le click sur le lien de téléchargement. Le fait que le téléchargement ait été terminé ou non n\'est pas connu de Intranet Statistics.',
	...
	'API_PluginDescription' => 'Toutes les données de Intranet Statistics sont disponibles au travers de simples APIs. Ce plugin est le point d\'entrée du web service, ainsi vous pouvez obtenir vos données Statistiques Web en xml, json, php, csv, etc.',
	'API_QuickDocumentationTitle' => 'Documentation rapide de l\'API.',
	'API_GenerateVisits' => 'Si vous n\'avez pas de données pour aujourd\'hui vous pouvez en générer en utilisant le plugin %s. Vous pouvez activer le plugin %s, ensuite cliquez sur le menu \'Générateur de visites\' dans la zone d\'administration de Intranet Statistics.',
	'API_MoreInformation' => 'Pour plus d\'informations à propos de l\'API de Intranet Statistics, merci de visiter %s l\'introduction à Intranet Statistics %s et %s la référence de l\'API Intranet Statistics %s.',
	...
	'CoreAdminHome_PluginDescription' => 'Zone d\'administration de Intranet Statistics.',
	...
	'CoreAdminHome_OptOutForYourVisitors' => 'Exclusion de Intranet Statistics pour vos visiteurs',
	'CoreAdminHome_OptOutExplanation' => 'Intranet Statistics met un point d\'honneur à respecter la vie privée sur Internet. Pour fournir à vos visiteurs le choix de ne pas apparaître dans les analyses de Intranet Statistics, vous pouvez ajouter le code HTML suivant sur une des pages de votre site web, par exemple dans la page "Politique de confidentialité".',
	'CoreAdminHome_OptOutExplanationBis' => 'Ce code va afficher un Iframe contenant un lien pour vos visiteurs pour ne pas être suivi dans Intranet Statistics en installant un cookie de neutralisation dans leur navigateur. %s Cliquez ici %s pour visualiser le contenu qui sera affiché par l\'iFrame.',
	...
	'CoreAdminHome_CustomLogoHelpText' => 'Vous pouvez personnaliser le logo Intranet Statistics qui sera affichée dans l\'interface utilisateur et les rapports par courriel.',
	...
	'CoreAdminHome_LogoNotWriteable' => 'Pour utiliser un logo personnalisé Intranet Statistics a besoin d\'un accès en écriture aux fichiers de logo dans les répertoires des thèmes: %s',
	...
	'CoreAdminHome_PiwikIsInstalledAt' => 'Intranet Statistics est installé à l\'adresse',
	'CoreAdminHome_ValidPiwikHostname' => 'Nom d\'höte Intranet Statistics valide',
	...
	'CoreHome_InjectedHostWarningIntro' => 'Vous accédez maintenant à Intranet Statistics depuis %1$s, mais Intranet Statistics a été configuré pour s\'exécuter à cette adresse : %2$s.',
	'CoreHome_InjectedHostSuperUserWarning' => 'Intranet Statistics est probablement mal configuré (par exemple, si Intranet Statistics a récemment été déplacé vers un nouveau serveur ou une nouvelle URL). Vous pouvez ou %1$scliquer ici et l\'ajouter %2$s en tant que nom d\'hôte Intranet Statistics valide (si vous lui faites confiance)%3$s, ou %4$s cliquer ici et accéder %5$s à Intranet Statistics de manière sécurisée%6$s.',
	'CoreHome_InjectedHostNonSuperUserWarning' => '%1$sCliquez ici pour accéder à Intranet Statistics de manière sécurisé%2$s et supprimer cette alerte. Vous pouvez aussi contacter votre administrateur Intranet Statistics and l\'avertir de ce problème (%3$sCliquez ici pour envoyer un message%4$s).',
	'CoreHome_InjectedHostEmailSubject' => 'On a accédé à Intranet Statistics avec un nom d\'hôte inconnu : %s',
	'CoreHome_InjectedHostEmailBody' => 'Bonjour, j\'ai essayé d\'accéder à Intranet Statistics aujourd\'hui et j\'ai rencontré l\'avertissement de nom d\'hôte inconnu.',
	'CoreHome_CheckForUpdates' => 'Vérifier les mises à jour',
	'CoreHome_YouAreUsingTheLatestVersion_js' => 'Vous utilisez la dernière version de Intranet Statistics!',
	'CoreHome_MakeADifference' => 'Faites une différence : %1$sDonnez Maintenant%2$s pour financer Intranet Statistics 2.0!',
	'CoreHome_DonateCall1' => 'Intranet Statistics ne vous coûtera jamais rien à utiliser, mais cela ne veut pas dire que ça ne nous coûte rien pour le réaliser.',
	'CoreHome_DonateCall2' => 'Intranet Statistics a besoin de votre support continu pour croître et prospérer.',
	'CoreHome_DonateCall3' => 'Si vous pensez que Intranet Statistics a ajouté une valeur significative à votre entreprise ou à votre projet, %1$s pensez à faire un don s\'il vous plait! %2$s',
	'CoreHome_HowMuchIsPiwikWorth' => 'Combien vaut Intranet Statistics pour vous?',
	'CoreHome_SupportPiwik' => 'Supporter Intranet Statistics!',
	...
	'CoreHome_SubscribeAndBecomePiwikSupporter' => 'Procéder à un paiement par carte de crédit sécurisé (Paypal) pour devenir un bienfaiteur de Intranet Statistics!',
	'CoreHome_CheckPiwikOut' => 'Vérifiez sur Intranet Statistics!',
	...
	'CoreHome_ViewAllPiwikVideoTutorials' => 'Visualiser tous les tutoriaux vidéo de Intranet Statistics',
	'CoreHome_SharePiwikShort' => 'Intranet Statistics! Analyse web gratuite et libre. Maitrisez vos données.',
	'CoreHome_SharePiwikLong' => 'Salut! Je viens juste de trouver un bon logiciel libre: Intranet Statistics!  Intranet Statistics va te permettre de suivre els visiteurs de ton site web gratuitement. Tu devrais vraiment aller voir!',
	'PrivacyManager_TeaserHeadline' => 'Paramètres de vie privée',
	'PrivacyManager_Teaser' => 'Sur cette page, vous pouvez personnaliser Intranet Statistics pour que sa gestion de la vie privée respecte la législation en vigueur, en : %s rendant anonyme l\'adresse IP du visiteur%s, %s supprime automatiquement les anciens logs de visiteurs de la base de données%s, et %s fournit un mécanisme d\'exclusion pour votre site web%s.',
	'PrivacyManager_MenuPrivacySettings' => 'Vie privée',
	'PrivacyManager_PluginDescription' => 'Personnalisez Intranet Statistics pour que son rapport à la vie privée soit respectueux des législations existantes.',
	'PrivacyManager_UseAnonymizeIp' => 'Rendre anonymes les adresses IP des visiteurs',
	'PrivacyManager_AnonymizeIpDescription' => 'Sélectionnez "Oui" si vous voulez que Intranet Statistics ne trace pas les adresses IP complètes.',
	...
	'PrivacyManager_DeleteDataDescription' => 'Vous pouvez configurer Intranet Statistics pour supprimer régulièrement les journaux des anciens visiteurs et/ou générer les rapports pour maintenir votre base de données à une taille minimale.',
	...
	'PrivacyManager_DoNotTrack_EnabledMoreInfo' => 'Quand les utilisateurs ont définit au sein de leurs navigateurs "Je ne veux plus être suivit" (DoNoTrack est activé) Intranet Statistics ne suit plus leurs visites.',
	'PrivacyManager_DoNotTrack_Disabled' => 'Intranet Statistics suit actuellement tous les visiteurs, même si ils ont précisé "Je ne veux pas être suivit" dans leurs navigateurs.',
	...
	'CoreHome_NoPrivilegesAskPiwikAdmin' => 'Vous êtes connecté en tant que \'%s\' mais il semble que nous n\'ayez aucune permission définie dans Intranet Statistics. %s Demandez à votre administrateur (cliquez pour envoyer un e-mail)%s de vous donner l\'accès \'Consultation\' à un site web.',
	'CoreHome_JavascriptDisabled' => 'JavaScript doit être activé pour que vous puissiez utiliser Intranet Statistics de manière basique.<br />Cependant, il semble que JasvaScript ne soit pas supporté ou soit désactivé sur votre navigateur.<br />Pour utiliser l\'interface basique, activez JavaScript en modifiant les options de votre navigateur, ensuite %1$sessayez encore%2$s.<br />',
	...
	'CorePluginsAdmin_MainDescription' => 'Les plugins étendent et ajoutent des fonctionnalités à Intranet Statistics. Une fois un plugin installé, vous pouvez l\'activer ou le désactiver ici.',
	...
	'CoreUpdater_PluginDescription' => 'Mécanisme de mise à jour Intranet Statistics',
	...
	'CoreUpdater_PiwikWillBeUpgradedFromVersionXToVersionY' => 'La base de données de Intranet Statistics sera mise à jour depuis la version %1$s vers la version %2$s.',
	'CoreUpdater_TheFollowingPluginsWillBeUpgradedX' => 'Les plugins suivants seront mis à jour : %s.',
	'CoreUpdater_NoteForLargePiwikInstances' => 'Note importante pour les installations Intranet Statistics de taille importante',
	'CoreUpdater_TheUpgradeProcessMayFailExecuteCommand' => 'Si votre base de données Intranet Statistics est trop volumineuse, la mise à jour pourra être trop longue pour l\'effectuer depuis le navigateur. dans ce cas exécutez depuis la ligne de commande : %s',
	'CoreUpdater_YouCouldManuallyExecuteSqlQueries' => 'Si vous n\'aviez pas la possibilité d\'utiliser la console (CLI) et si Intranet Statistics échouait à se mettre à jour (à cause du délais d\'expiration de la base de données, du navigateur ou n\'importe quel autre problème), vous pourriez exécuter manuellement les requêtes SQL pour mettre à jour Intranet Statistics.',
	...
	'CoreUpdater_UpgradePiwik' => 'Mettez Intranet Statistics à jour',
	...
	'CoreUpdater_ErrorDIYHelp_3' => 'mettez à jour manuellement la table `option` de votre base de données Intranet Statistics, en spécifiant la valeur de version_core à la version de celle de l\'échec de la mise à jour',
	...
	'CoreUpdater_ErrorDIYHelp_5' => 'rapportez le problème et la solution à Intranet Statistics, de cette manière il pourra être vérifié et distribué',
	'CoreUpdater_HelpMessageContent' => 'Allez voir la %1$s FAQ Intranet Statistics %2$s qui explique les erreurs courantes lors de la mise à jour. %3$s Demandez à votre administrateur système - il pourra être à même avec cette erreur qui est très probablement liée à la configuration de votre serveur MySQL.',
	...
	'CoreUpdater_PiwikHasBeenSuccessfullyUpgraded' => 'Intranet Statistics a été mis à jour avec succès !',
	'CoreUpdater_ContinueToPiwik' => 'Continuer vers Intranet Statistics',
	'CoreUpdater_UpdateAutomatically' => 'Mettre à jour automatiquement',
	'CoreUpdater_ThereIsNewVersionAvailableForUpdate' => 'Il y a une nouvelle mise à jour de Intranet Statistics disponible',
	...
	'CoreUpdater_YouMustDownloadPackageOrFixPermissions' => 'Intranet Statistics ne peut pas écraser votre installation courante. Vous pouvez soit corriger les permissions du répertoire/fichier, soit télécharger le package et installer la version %s manuellement:',
	'CoreUpdater_DownloadX' => 'Télécharger %s',
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'La mise à jour de Intranet Statistics en un clic a été désactivée. Si vous ne pouvez pas corriger la cause du message d\'erreur ci-dessous, il est recommandé que vous fassiez manuellement la mise à jour de Intranet Statistics. %1$sConsultez la documentation%2$s de la mise à jour%3$s  pour commencer!',
	...
	'CoreUpdater_PiwikUpdatedSuccessfully' => 'Intranet Statistics a été mis à jour avec succès!',
	'CoreUpdater_EmptyDatabaseError' => 'La base de données %s est vide. Vous devez éditer ou supprimer votre fichier de configuration Intranet Statistics.',
	'CoreUpdater_ExceptionAlreadyLatestVersion' => 'Votre version de Intranet Statistics %s est à jour.',
	...
	'CustomVariables_PluginDescription' => 'Les variables personnalisées sont des paires de nom/valeur que vous pouvez définir pour une visite en utilisant la fonction de l\'API Javascript setVisitCustomVariables(). Intranet Statistics vous rapportera alors combien de visites, pages, conversions il y a pour chacun de ces noms et valeurs personnalisés',
	...
	'CustomVariables_TrackingHelp' => 'Aide: %1$sSuivez les variables personnalisées dans Intranet Statistics%2$s',
	...
	'DBStats_PluginDescription' => 'Ce plugin effectue des rapports sur l\'utilisation de la base de données MySQL par les tables de Intranet Statistics.',
	'DBStats_DatabaseUsage' => 'Utilisation de la base de données',
	'DBStats_MainDescription' => 'Intranet Statistics stocke toutes vos donnés de statistiques web dans la base de données MySQL. En ce moment les tables de Intranet Statistics utilisent %s.',
	'DBStats_LearnMore' => 'Pour en apprendre plus à propos de la manière dont Intranet Statistics traite les données et sur comment faire fonctionner Intranet Statistics correctement pour les sites à moyen et fort trafic, consultez la documentation %s.',
	'DBStats_Table' => 'Table',
	...
	'ExampleUI_PluginDescription' => 'Plugin d\'exemple: Ce plugin montre comment fonctionne l\'interface utilisateur de Intranet Statistics: création de tables, graphiques, etc.',
	'Feedback_PluginDescription' => 'Envoie vos retours à l’Équipe Intranet Statistics. Partagez vos idées et suggestions avec nous!',
	...
	'Feedback_WhyWrongCountry' => 'Pourquoi Intranet Statistics affiche un mauvais pays pour ma visite?',
	...
	'Feedback_SpecialRequest' => 'Avez-vous une demande spéciale pour l’Équipe Intranet Statistics?',
	'Feedback_ContactThePiwikTeam' => 'Contactez l’Équipe Intranet Statistics!',
	'Feedback_IWantTo' => 'Je veux:',
	'Feedback_CategoryShareStory' => 'Partager une réussite avec Intranet Statistics',
	'Feedback_CategorySponsor' => 'Sponsoriser Intranet Statistics',
	'Feedback_CategoryHire' => 'Employer un consultant Intranet Statistics',
	...
	'Feedback_MessageSent' => 'Votre message a été envoyé à l’Équipe Intranet Statistics.',
	'Feedback_ThankYou' => 'Merci d\'avoir aidé à améliorer Intranet Statistics!',
	'Feedback_ThePiwikTeam' => 'L’Équipe Intranet Statistics',
	...
	'Feedback_WantToThankConsiderDonating' => 'Vous pensez que Intranet Statistics est génial et vous voulez nous remercier? Pensez à faire un don',
	...
	'Goals_DefaultRevenueHelp' => 'Par exemple, un formulaire de contact soumis par un visiteur peut avoir une valeur de 10 € en moyenne. Intranet Statistics vous aidera à comprendre comment se comportent vos visiteurs.',
	...
	'Goals_LearnMoreAboutGoalTrackingDocumentation' => 'Apprenez en plus à propos de %s Comment traquer les Objectifs dans Intranet Statistics %s dans la documentation utilisateur',
	...
	'Installation_PluginDescription' => 'Procédé d\'installation de Intranet Statistics. L\'installation est effectuée une unique fois. Si le fichier de configuration config/config.inc.php est supprimé, l\'installation recommencera.',
	...
	'Installation_NoConfigFound' => 'Le fichier de configuration de Intranet Statistics ne peut être trouvé et vous essayez d\'accéder à une page de Intranet Statistics.<br> <b>  » Vous pouvez <a href=\'index.php\'>installer Intranet Statistics maintenant</a></b><br><small>Si vous avez déjà installé Intranet Statistics ne vous inquiétez pas Intranet Statistics réutilisera ces tables et leurs données.</small>',
	...
	'Installation_LargePiwikInstances' => 'Aide pour les instances de Intranet Statistics volumineuses',
	'Installation_JsTag' => 'Tag JavaScript',
	'Installation_Congratulations' => 'Félicitations',
	'Installation_CongratulationsHelp' => '<p>Félicitations! Votre installation de Intranet Statistics est terminée.</p><p>Assurez-vous que le code JavaScript est présent sur toutes vos pages et attendez vos premiers visiteurs!</p>',
	'Installation_ContinueToPiwik' => 'Continuer vers Intranet Statistics',
	'Installation_SiteSetup' => 'Veuillez configurer le premier site web que vous voulez suivre et analyser avc Intranet Statistics :',
	...
	'Installation_SiteSetupFootnote' => 'Note : une fois que l\'installation de Intranet Statistics est terminée, vous pourrez ajouter d\'autres sites web à suivre!',
	...
	'Installation_Requirements' => 'Pré requis Intranet Statistics',
	...
	'Installation_SystemCheckDatabaseHelp' => 'Intranet Statistics requiert ou l\'extension mysqli ou les extensions pdo et pdo_mysql.',
	...
	'Installation_SystemCheckParseIniFileHelp' => 'Cette fonction incluse a été désactivée sur votre serveur. Intranet Statistics va essayer d\'émuler cette fonction mais il est possible que vous rencontriez des restrictions de sécurité par la suite. Les performances seront aussi impactées.',
	'Installation_SystemCheckGlobHelp' => 'Cette fonction native a été désactivée sur votre hôte. Intranet Statistics va tenter de l\'émuler mais il pourra rencontrer des restrictions de sécurité. Les fonctionnalités pourront en être impactées.',
	'Installation_SystemCheckDebugBacktraceHelp' => 'View::factory ne pourra pas créer des vues pour le module appelé.',
	'Installation_SystemCheckCreateFunctionHelp' => 'Intranet Statistics utilise des fonctions anonymes pour les callbacks.',
	...
	'Installation_SystemCheckPackHelp' => 'La fonction pack() est requise pour suivre les visiteurs dans Intranet Statistics.',
	...
	'Installation_SystemCheckAutoUpdateHelp' => 'Note: La mise à jour de Intranet Statistics en un clic requiert une permission en écriture sur le dossier de Intranet Statistics et son contenu.',
	'Installation_SystemCheckError' => 'Une erreur s\'est produite — elle doit être corrigée avant de pouvoir continuer',
	'Installation_SystemCheckWarning' => 'Intranet Statistics fonctionnera normalement mais certaines fonctionnalités seront manquantes',
	...
	'Installation_TablesWithSameNamesFound' => 'Environ %1$s tables dans votre base de données %2$s ont le même nom que celles que Intranet Statistics essaie de créer.',
	...
	'Installation_TablesDeletedSuccess' => 'Tables Intranet Statistics existantes supprimées avec succès',
	...
	'Installation_GoBackAndDefinePrefix' => 'Retournez à la page précédente et définissez le préfixe pour les tables Intranet Statistics',
	...
	'Installation_WelcomeHelp' => '<p>Intranet Statistics est une application d\'analyse du web Open Source qui vous permet d\'obtenir facilement les informations que vous désirez sur vos visiteurs.</p>	<p>Ce procédé est divisé en %s étapes faciles et vous prendra 5 minutes environ.</p>',
	'Installation_ConfigurationHelp' => 'Votre configuration de Intranet Statistics semble être erronée. Vous pouvez ou bien supprimer config/config.inc.php et reprendre l\'installation ou corriger les paramètres de connexion.',
	'Installation_ErrorInvalidState' => 'Erreur: il semble que vous essayez de sauter une étape du processus d\'installation, ou vous avez désactivé les cookies, ou le fichier de configuration de Intranet Statistics est déjà créé. %1$sAssurez vous que les cookies sont bien activés%2$s et retournez %3$s à la première page d\'installation %4$s.',
	...
	'Installation_SystemCheckSummaryThereWereErrors' => 'Oh-oh! Intranet Statistics a détecté des %1$sproblèmes critiques%2$s avec votre installation de Intranet Statistics. %3$sCes problèmes critiques doivent être fixés immédiatement.%4$s',
	'Installation_SystemCheckSummaryThereWereWarnings' => 'Il y a des problèmes avec votre système. Intranet Statistics va fonctionner, mais vous pourriez rencontrer des problèmes mineurs.',
	'Installation_SystemCheckSummaryNoProblems' => 'Génial! Il n\'y a aucun problème avec votre installation de Intranet Statistics. Donnez vous une tape dans le dos.',
	...
	'Installation_LoadDataInfileUnavailableHelp' => 'L\'utilisation de %1$s va grandement accélérer la vitesse du processus d\'archivage de Intranet Statistics. Pour le rendre disponible à Intranet Statistics, essayez de mettre à jour PHP & MySQL et assurez vous que votre utilisateur MySQL a les privilèges de %2$s.',
	'Installation_LoadDataInfileRecommended' => 'Si votre serveur Intranet Statistics traque des sites à grand trafic, (ex > 100 000 pages par mois), nous recommandons d\'essayer de résoudre ce problème.',
	...
	'Installation_NfsFilesystemWarningSuffixAdmin' => 'Cela signifie que Intranet Statistics va être très lent lors de l\'utilisation des sessions en fichier.',
	'Installation_NfsFilesystemWarningSuffixInstall' => 'Utiliser les sessions en fichier avec NFS est très lent, donc Intranet Statistics va utiliser des sessions en base de données. Si vous avez plusieurs utilisateurs de tableaux de bords en parallèle, vous pourriez avoir besoin d\'augmenter le nombre maximal de connexions au serveur de base de données.',
	'LanguagesManager_PluginDescription' => 'Ce plugin affichera la liste des langues disponibles pour l\'interface de Intranet Statistics. Le langage sélectionné sera sauvegardé dans les préférences de chaque utilisateur.',
	'LanguagesManager_AboutPiwikTranslations' => 'À propos des traductions de Intranet Statistics',
	...
	'Login_InvalidNonceOrHeadersOrReferer' => 'La sécurité du formulaire a échoué. Veuillez recharger le formulaire et vérifier que vos cookies sont activés. Si vous utilisez un serveur proxy, vous devez %s configurer Intranet Statistics pour accepter les en-têtes du proxy %s qui relaient les en-têtes de l\'hôte. Vérifiez aussi que l\'en-tête de votre référant est correctement transmis.',
...
Merci d\'utiliser Intranet Statistics!',
	...
	'Login_ContactAdmin' => 'Raison possible : Votre hébergeur peut avoir désactivé la fonction mail(). <br /> Veuillez contacter votre administrateur Intranet Statistics.',
	...
	'Mobile_AddPiwikDemo' => 'Ajouter une démo Intranet Statistics',
	'Mobile_AnonymousTracking' => 'Traçage anonyme',
	'Mobile_AskForAnonymousTrackingPermission' => 'Quand activé, Intranet Statistics Mobile enverra les données d\'utilisation anonyme vers piwik.org. Le but est d\'utiliser ces données pour aider les développeurs de Intranet Statistics Mobile à mieux comprendre comment l\'application est utilisée. Les informations envoyées sont : clics sur les menus et paramètres, nom et version de l\'OS, toute erreur affichée dans Intranet Statistics Mobile. Nous ne traquerons PAS vos données. Ces données anonymes ne seront jamais publiées. Vous pouvez désactiver/activer le traçage anonyme dans les Paramètres à tout moment.',
	...
	'Mobile_HelpUsToImprovePiwikMobile' => 'Voulez-vous activer le traçage d\'utilisation anonyme dans Intranet Statistics Mobile ?',
	'Mobile_HttpIsNotSecureWarning' => 'Votre token d\'authentification Intranet Statistics (token_auth) est envoyée en texte clair si vous utilisez "HTTP". Pour cette raison, nous recommandons d\'utiliser HTTPS pour sécuriser le transport des données sur Internet. Voulez-vous le faire ?',
	...
	'Mobile_RatingPleaseRateUs' => 'L\'application Intranet Statistics Mobile est un logiciel gratuit, nous vous serions très reconnaissant si vous preniez 1 minute pour noter l\'application sur le %s. Si vous avez des suggestions de nouvelles fonctionnalités ou si vous souhaitez signaler un bug, veuillez contacter %s',
	...
	'Mobile_AccessUrlLabel' => 'URL d\'accès à Intranet Statistics',
	...
	'Mobile_NoPiwikAccount' => 'Pas de compte Intranet Statistics ?',
	...
	'MobileMessaging_VerificationText' => 'Le code est %s. Pour valider votre numéro de téléphone et recevoir les rapports SMS de Intranet Statistics veuillez copier ce code dans le formulaire accessible via Intranet Statistics > %s > %s.',
	...
	'MobileMessaging_Settings_PhoneNumbers_HelpAdd' => 'Quand vous cliquez sur "Ajouter", un SMS contenant un code sera envoyé au téléphone. L\'utilisateur qui recevra le code devra ensuite se connecter à Intranet Statistics, Cliquer sur Paramètres, puis sur Messagerie Mobile. Après avoir entré le code, l\'utilisateur sera capable de recevoir des rapports sur son téléphone.',
	...
	'MobileMessaging_Settings_CredentialNotProvidedByAdmin' => 'Avant de pouvoir créer et gérer vos numéros de téléphone, veuille demander à votre administrateur de connecter Intranet Statistics à un compte SMS.',
	'MobileMessaging_Settings_CredentialNotProvided' => 'Avant de pouvoir créer et gérer les numéros de téléphone veuillez connecter Intranet Statistics à votre compte SMS ci-dessus.',
	...
	'MobileMessaging_MultiSites_Must_Be_Activated' => 'Pour générer des textes SMS de vos statistiques web, veuillez activer le module multisites dans Intranet Statistics.',
	'MultiSites_PluginDescription' => 'Affiche le sommaire/les statistiques multi-site. Actuellement maintenu comme un plugin Intranet Statistics cœur.',
	...
	'Provider_ProviderReportDocumentation' => 'Ce rapport affiche quel Fournisseur d\'Accès à Internet vos visiteurs ont utilisé pour accéder à votre site web. Vous pouvez cliquer sur le nom d\'un FAI pour plus de détails. %s Si Intranet Statistics ne peut déterminer le FAI d\'un visiteur, il est listé en tant qu\'IP.',
	...
	'SitesManager_PluginDescription' => 'Gestion des sites web dans Intranet Statistics: Ajoute un nouveau site web, modifie un existant, affiche le code JavaScript à inclure dans vos pages. Toutes les actions sont disponibles au travers de l\'API.',
	'SitesManager_Sites' => 'Sites',
	'SitesManager_TrackingTags' => 'Tags de suivi pour %s',
	'SitesManager_WebsitesManagement' => 'Gestion des sites',
	'SitesManager_MainDescription' => 'Intranet Statistics a besoin de sites pour générer des rapports ! Ajoutez, éditez et supprimez des sites, et voyez le code JavaScript à inclure dans vos pages.',
	...
	'SitesManager_AliasUrlHelp' => 'Il est recommandé, mais pas requis, de spécifier les URL différentes que vos utilisateurs utilisent pour accéder au site web. Les URL d\'alias pour un site n’apparaîtront pas dans Référents > Sites Internet. Il n\'est pas nécessaire d\'entrer les URL avec et sans les www, Intranet Statistics les traite automatiquement.',
	...
	'SitesManager_ExceptionDeleteSite' => 'Impossible de supprimer le site car c\'est le seul site enregistré dans Intranet Statistics. Vous pouvez d\'abord en ajouter un nouveau, puis supprimez celui-ci.',
	...
	'SitesManager_GlobalListExcludedUserAgents_Desc' => 'Si le user agent du visiteur contient n\'importe laquelle des chaines de caractères que vous avez spécifiées, le visiteur sera exclu de Intranet Statistics.',
	'SitesManager_GlobalExcludedUserAgentHelp1' => 'Entrez la liste des navigateurs (par user agent) à exclure du suivit par Intranet Statistics.',
	'SitesManager_GlobalExcludedUserAgentHelp2' => 'Vous pouvez utiliser ceci pour exclure certains robot du suivit par Intranet Statistics.',
	...
	'SitesManager_PiwikWillAutomaticallyExcludeCommonSessionParameters' => 'Intranet Statistics exclura automatiquement les paramètres de session communs (%s).',
	'SitesManager_HelpExcludedIps' => 'Entrez une liste d\'adresses IP, une par ligne, que vous souhaitez exclure des statistiques Intranet Statistics. Vous pouvez utiliser des caractères jokers ex %1$s ou %2$s',
	...
	'SitesManager_PiwikOffersEcommerceAnalytics' => 'Intranet Statistics permet un suivi et un rapport avancé des statistiques E-commerce. Apprenez-en plus à propos %s des statistiques E-commerce%s.',
	'SitesManager_TrackingSiteSearch' => 'Suivit de la recherche interne du site',
	'SitesManager_SiteSearchUse' => 'Vous pouvez utiliser Intranet Statistics pour suivre et effectuer un rapport sur ce que vos visiteurs cherchent sur le moteur de recherche interne de votre site web.',
	...
	'SitesManager_SearchCategoryDesc' => 'Intranet Statistics peut aussi effectuer le suivit de la catégorie de recherche pour chaque mot clef de recherche interne.',
	...
	'TranslationsAdmin_PluginDescription' => 'Aidez à traduire Intranet Statistics dans votre langue.',
	...
	'UserCountryMap_LoginToViewRealTime' => 'Identifiez-vous pour visualiser la carte des visiteurs en temps réel de Intranet Statistics!',
	...
	'UserCountry_PiwikNotManagingGeoIPDBs' => 'Intranet Statistics ne gère actuellement aucune base de données GeoIP.',
	...
	'UserCountry_GeolocationPageDesc' => 'Sur cette page vous pouvez changer la manière dont Intranet Statistics détermine la localisation des visiteurs.',
	...
	'UserCountry_TestIPLocatorFailed' => 'Intranet Statistics a essayé de vérifier la localisation d\'une adresse IP connue (%1$s), mais le serveur a renvoyé %2$s. Si ce fournisseur était configuré correctement il aurait renvoyé %3$s.',
	...
	'UserCountry_HowToSetupGeoIP_Step2' => 'Extrayez ce fichier et copiez le résultat %1$s dans le %2$ssous-répertoire misc%3$s de Intranet Statistics (vous pouvez effectuer cela par FTP ou SSH).',
	...
	'UserCountry_HowToSetupGeoIP_Step4' => 'Vous avez terminé! Vous venez juste de configurer Intranet Statistics pour utiliser GeoIP ce qui veut dire que vous allez être capable de voir de quelles régions et villes sont vos visiteurs avec une information sur le pays très précise.',
	...
	'UserCountry_FoundApacheModules' => 'Intranet Statistics a trouvé les modules Apache suivants',
	'UserCountry_GeoIPNoServerVars' => 'Intranet Statistics ne parvient à trouver aucune variable GeoIP %s.',
	...
	'UserCountry_GeoIPUpdaterIntro' => 'Intranet Statistics gère actuellement les mises à jour pour les bases de données GeoIP suivantes',
	...
	'UserCountry_CannotSetupGeoIPAutoUpdating' => 'Il apparait que vous stockez vos bases de données GeoIP en dehors de Intranet Statistics (nous nous basons sur le fait qu\'il n\'y a pas de bases de données dans le sous-répertoire misc, mais votre GeoIP fonctionne). Intranet Statistics ne peut pas mettre à jour automatiquement vos bases de donnés GeoIP si elles se trouvent en dehors du répertoire misc.',
	...
	'UserCountry_FatalErrorDuringDownload_js' => 'Une erreur fatale est arrivée lors du téléchargement de ce fichier. Il y a peut être un problème avec votre connexion Internet, avec la base de données GeoIP que vous téléchargez ou avec Intranet Statistics. Essayez de la télécharger et de l\'installer manuellement.',
	...
	'UsersManager_PluginDescription' => 'Gestion des utilisateurs dans Intranet Statistics: ajouter un nouvel utilisateur, en éditer, mettre à jour les permissions. Toutes les actions sont aussi disponibles au travers de l\'API.',
	...
	'UsersManager_YourVisitsAreIgnoredOnDomain' => '%sVos visites sont ignorées par Intranet Statistics sur %s %s(Le cookie d\'exclusion de Intranet Statistics est présent sur votre navigateur)',
	'UsersManager_YourVisitsAreNotIgnored' => '%sVos visites sont prises en compte par Intranet Statistics%s (le cookie d\'exclusion de Intranet Statistics n\'a  pas été trouvé sur votre navigateur).',
	'UsersManager_ClickHereToDeleteTheCookie' => 'Cliquez ici pour supprimer le cookie et pour que Intranet Statistics prenne en compte vos visites',
	'UsersManager_ClickHereToSetTheCookieOnDomain' => 'Cliquez ici pour mettre en place un cookie qui exclura vos visites sur ceux de vos sites web qui sont analysés par Intranet Statistics sur %s',
	...
	'UsersManager_WhenUsersAreNotLoggedInAndVisitPiwikTheyShouldAccess' => 'Quand les utilisateurs ne sont pas connectés et accèdent à Intranet Statistics, ils verront',
	...
	'VisitorGenerator_PluginDescription' => 'Plugin visant à créer de fausses visites. Il peut être utilisé par les utilisateurs Intranet Statistics ou par les développeurs comme un moyen aisé de générer de fausses données de manière à peupler les rapports Intranet Statistics.',
	'VisitorGenerator_VisitorGenerator' => 'Générateur de visites',
	'VisitorGenerator_Warning' => 'Vous êtes sur le point de générer de fausses visites qui seront enregistrées dans votre base de donnés Intranet Statistics',
	'VisitorGenerator_NotReversible' => 'Il sera %s impossible%s de supprimer facilement ces données des logs Intranet Statistics.',
	...
	'Widgetize_PluginDescription' => 'Le plugin rend simple l\'export de n\'importe quel Widget Intranet Statistics dans votre blog, site web ou sur Igoogle et Netvibes!',
	'Widgetize_TopLinkTooltip' => 'Exporter les rapports Intranet Statistics en tant que gadget et incorporer le tableau de bord dans votre application en tant qu\'iframe.',
	...
	'PDFReports_PiwikReports' => 'Rapports Intranet Statistics',
	...
	'PDFReports_TopLinkTooltip' => 'Créer un rapport par courriel afin que les statistiques Intranet Statistics soient envoyées automatiquement à votre adresse courriel ou celles de vos clients automatiquement!',
	'ImageGraph_PluginDescription' => 'Génère de magnifiques graphiques en image PNG statique pour tous vos rapports Intranet Statistics.',
	...
	'Overlay_Link' => 'Lien',
	'Overlay_RedirectUrlError' => 'Vous tentez à présent d\'ouvrir une page superposée pour l\'URL "%s". %s Aucun des domaines des paramètres de Intranet Statistics ne correspond au lien.',
	...
	'Overlay_ErrorNotLoadingDetails' => 'Peut être que la page chargée sur la droite n\'a pas de code de suivit Intranet Statistics. Dans ce cas, essayez de lancer la navigation superposée depuis une autre page que le rapport de pages.',
	'Overlay_ErrorNotLoadingDetailsSSL' => 'Etant donné que vous utilisez Intranet Statistics en https, la cause la plus probable est que votre site web ne supporte pas le SSL. Essayez d\'utiliser Intranet Statistics en http.',
