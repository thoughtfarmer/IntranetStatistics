...
$translations = array(
	...
	'General_BackToHomepage' => 'Nazaj na Intranet Statistics-ovo glavno stran',
	'General_Yes' => 'Da',
	'General_No' => 'Ne',
	...
	'General_AllowPiwikArchivingToTriggerBrowser' => 'Dovoli, da se akitivira Intranet Statistics arhiviranje, ko se poročila ogledujejo v brskalniku.',
	...
	'General_RequiresFlash' => 'Za prikazovanje Grafov v Intranet Statistics-u potrebujete Flash',
	'General_GraphHelp' => 'Več informacij o prikazovanju Grafov v Intranet Statistics-u.',
	...
	'General_YouAreViewingDemoShortMessage' => 'Trenutno si ogledujete Intranet Statistics v demo načinu',
	'General_YouAreCurrentlyUsing' => 'Trenutno uporabljate Intranet Statistics %s.',
	'General_DownloadFullVersion' => '%1$sPrenesite%2$s celotno verzijo! Oglejte si %3$s',
	'General_NewUpdatePiwikX' => 'Nova Posodobitev: Intranet Statistics %s',
	'General_AboutPiwikX' => 'O Intranet Statistics %s',
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Intranet Statistics %1$s je na voljo. %2$sProsimo posodobite ga zdaj!ow!%3$s (oglejte si %4$sspremembe%5$s).',
	...
	'General_BackToPiwik' => 'Nazaj na Intranet Statistics',
	...
	'General_ConfigFileIsNotWritable' => 'Intranet Statistics-ova konfiguracijska datoteka %s ni zapisljiva, zato nekaterih vaših sprememb ni bilo mogoče shraniti. %s Prosimo, da spremenite dovoljenja konfiguracijske datoteke tako, da bo zapisljiva.',
	'General_ExceptionDatabaseVersion' => 'Vaša %1$s verzija je %2$s, vendar Intranet Statistics potrebuje vsaj %3$s.',
	...
	'General_PleaseUpdatePiwik' => 'Prosimo, da posodobite Intranet Statistics',
	...
	'Actions_DownloadsReportDocumentation' => 'V tem poročilu lahko visite, katere datoteke so prenesli vaši uporabniki. %s Intranet Statistics šteje vse klike na povezavo za prenos. Intranet Statistics ne ve ali je bila datoteka uspešno prenesena.',
	...
	'API_PluginDescription' => 'Vsi podatki v Intranet Statisticsu so na voljo preko prepreostega API vmesnika. Ta vtičnik je vstopna točka spletne storitve, ki jo lahko pokličete, če želite svoje podatke preko xml, json, php, csv, itd.',
	'API_QuickDocumentationTitle' => 'API hitra dokumentacija',
	'API_GenerateVisits' => 'Če nimate današnjih podatkov, potem lahko najprej ustvarite nekaj podatkov s %s vtičnikom. Vtičnik %s lahko omogočite in nato kliknete na \'Visitor Generator\' meni v Intranet Statistics administraciji.',
	'API_MoreInformation' => 'Za več informacij o Intranet Statistics API-ju, si oglejte %sNavodila za uporabo Intranet Statistics API-ja %s in %s Intranet Statistics API Reference %s.',
	...
	'CoreAdminHome_PluginDescription' => 'Administrativno okolje Intranet Statistics.',
	...
	'CoreAdminHome_OptOutExplanation' => 'Intranet Statistics želi zagotoviti zasebnost na internetu. Če želite svojim obiskovalcem omogočiti \'opt-out\' iz Intranet Statistics spletne analitike, potem lahko dodate naslednjo HTML kodo na vašo spletno stran, npr. na stran \'Varovanje zasebnosti\'.',
	...
	'CoreAdminHome_CustomLogoHelpText' => 'Intranet Statistics-ov logo lahko prilagodite po vaših željah. Spremembe bodo vidne tako v uporabniškem vmesniku, kot v email poročilih.',
	...
	'CoreHome_NoPrivilegesAskPiwikAdmin' => 'Vpisani ste kot \'%s\', vendar v Intranet Statistics-u nimate nastavljenih nobenih pooblastil. %s Poprosite vašega Intranet Statistics administratorja (klik za email)%s naj vam da pooblastila za ogled določene(ih) strani.',
	...
	'CorePluginsAdmin_MainDescription' => 'Vtičniki razširjajo Intranet Statistics-ovo funkcionalnost. Ko je vtičnik enkrat nameščen, ga lahko tukaj aktivirate oziroma deaktivirate.',
	...
	'CoreUpdater_PluginDescription' => 'Intranet Statistics-ov mehanizem za posodabljanje',
	...
	'CoreUpdater_PiwikWillBeUpgradedFromVersionXToVersionY' => 'Intranet Statistics-ova podatkovna baza bo nadgrajena iz različice %1$s, na novo različico %2$s.',
	'CoreUpdater_TheFollowingPluginsWillBeUpgradedX' => 'Sledeči vtičniki bodo posodobljeni: %s',
	'CoreUpdater_NoteForLargePiwikInstances' => 'Pomembna opomba za velike Intranet Statistics namestitve',
	'CoreUpdater_TheUpgradeProcessMayFailExecuteCommand' => 'V primeru, da ima vaša Intranet Statistics namestitev veliko bazo podatkov je mogoče, da posodabljanje v brskalniku traja zelo dolgo. V tem primeru lahko posodobitve uveljavite preko komandne vrstice: %s',
	...
	'CoreUpdater_UpgradePiwik' => 'Nadgradi Intranet Statistics',
	...
	'CoreUpdater_PiwikHasBeenSuccessfullyUpgraded' => 'Intranet Statistics je bil uspešno posodobljen!',
	'CoreUpdater_ContinueToPiwik' => 'Nadaljuj na Intranet Statistics',
	'CoreUpdater_UpdateAutomatically' => 'Samodejno posodpobi',
	'CoreUpdater_ThereIsNewVersionAvailableForUpdate' => 'Za posodobitev je na voljo nova različica Intranet Statistics-a',
	...
	'CoreUpdater_PiwikUpdatedSuccessfully' => 'Intranet Statistics je bil uspešno posodobljen!',
	'CoreUpdater_EmptyDatabaseError' => 'Baza podatkov %s je prazna. Urediti ali pa odstraniti morate vašo Intranet Statistics-ovo konfiguracijsko datoteko.',
	'CoreUpdater_ExceptionAlreadyLatestVersion' => 'Imate najnovejšo verzijo Intranet Statistics-a (%s)',
	...
	'DBStats_PluginDescription' => 'Ta vtičnik poroča o Intranet Statistics-ovi uporabi MySQL podatkovne baze.',
	'DBStats_DatabaseUsage' => 'Uporaba podatkovne baze',
	'DBStats_MainDescription' => 'Intranet Statistics shranjuje vse vaše podatke v MySQL bazo podatkov. Trenutna poraba podatkovne baze je %s.',
	...
	'Feedback_PluginDescription' => 'Podajte vašo povratno informacijo ekipi Intranet Statistics. Zaupajte nam vaše ideje in predloge!',
	...
	'Feedback_WhyWrongCountry' => 'Zakaj Intranet Statistics prikazuje moje obiske iz napačne države?',
	'Feedback_VisitTheForums' => 'Obiščite %sForume%s',
	'Feedback_LearnWaysToParticipate' => 'Oglejte si vse načine kako lahko %ssodelujete%s',
	'Feedback_ContactThePiwikTeam' => 'Kontaktiraje Intranet Statistics-ovo ekipo!',
	'Feedback_IWantTo' => 'Želim:',
	'Feedback_CategoryShareStory' => 'Delite Intranet Statistics zgodbo o uspehu',
	'Feedback_CategorySponsor' => 'Sponzorirajte Intranet Statistics',
	'Feedback_CategoryHire' => 'Najemite Intranet Statisticsi-svetovalca',
	...
	'Feedback_MessageSent' => 'Vaše sporočilo je bilo poslano Intranet Statistics-ovi ekipi.',
	'Feedback_ThankYou' => 'Hvala, ker nam pomagate izboljšati Intranet Statistics!',
	'Feedback_ThePiwikTeam' => 'Intranet Statistics-ova ekipa',
	...
	'Installation_CongratulationsHelp' => '<p>Čestitamo! Namestitev Intranet Statistics-a je končana.</p><p>Poskrbite, da bo JavaScript sledilna koda integrirana v željene strani</p>',
	'Installation_ContinueToPiwik' => 'Nadaljuj na Intranet Statistics',
	...
	'Installation_SecurityNewsletter' => 'obveščajte me o najpomembnejših varnostnih opozorilh Intranet Statistics-a',
	'Installation_PasswordDoNotMatch' => 'gesli se ne ujemata',
	'Installation_Requirements' => 'Intranet Statistics-ovi minimalni pogoji',
	...
	'LanguagesManager_PluginDescription' => 'Ta vtičnik bo prikazoval seznam vseh jezikov, ki so na voljo za Intranet Statistics-ov vmesnik. Izbrani jezik bo shranjen v nastavitvah vsakega uporabnika.',
	'LanguagesManager_AboutPiwikTranslations' => 'O prevodih Intranet Statistics-a',
	...
	'Mobile_AccessUrlLabel' => 'Intranet Statistics dostopni URL',
	...
	'TranslationsAdmin_PluginDescription' => 'Pomagajte nam prevesti Intranet Statistics v vaš jezik.',
	...
	'VisitorGenerator_PluginDescription' => 'Vtičnik za ustvarjanje navideznih obiskov. Tega lahko uporabljajo uporabniki ali pa razvijalci, ter tako generirajo lažne podatke in z njimi napolnijo Intranet Statistics-ova poročila.',
	'VisitorGenerator_VisitorGenerator' => 'Generator Obiskovalcev',
	'VisitorGenerator_Warning' => 'Ravnokar boste generirali navidezne obiske, ki bodo shranjeni v podatkovno bazo vašega sistema Intranet Statistics.',
	...
	'PDFReports_PiwikReports' => 'Intranet Statistics Poročila',
	...
	'ImageGraph_PluginDescription' => 'Ustvarite prelepe, statične, PNG grafe za vsa Intranet Statistics poročila.',
