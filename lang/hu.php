...
$translations = array(
	...
	'General_BackToHomepage' => 'Vissza a Intranet Statistics kezdőlapra',
	'General_Yes' => 'Igen',
	'General_No' => 'Nem',
	...
	'General_AllowPiwikArchivingToTriggerBrowser' => 'Engedélyezi a Intranet Statistics-nek az archiválást, amikor a jelentéseket megtekintik a böngészőben.',
	'General_ArchivingInlineHelp' => 'Közepes és nagy forgalmú weboldalak esetén ajánlott letiltani a böngészővel való megnyitás által előidézett archiválást. Ehelyett ajánlott egy cron job beállítása, mely óránként feldolgozza a Intranet Statistics jelentéseket.',
	'General_ArchivingTriggerDescription' => 'Nagyobb, Intranet Statistics-et használó weboldalak esetén ajánlott. A jelentések automatikus feldolgozásához %segy cron job belállítása%s is szükséges.',
	...
	'General_RequiresFlash' => 'A Intranet Statistics grafikonok megjelenítéséhez Flash kiegészítő szükséges.',
	'General_GraphHelp' => 'További információ a Intranet Statistics grafikonok megjelenítéséről.',
	...
	'General_YouAreViewingDemoShortMessage' => 'Jelenleg a Intranet Statistics demóváltozatát láthatod.',
	'General_DownloadFullVersion' => '%1$sTöltsd le%2$s a teljes verziót! Nézd meg ezt: %3$s',
	'General_NewUpdatePiwikX' => 'Új verzió: Intranet Statistics %s',
	'General_AboutPiwikX' => 'Intranet Statistics %s verzióinformáció',
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Megjelent a Intranet Statistics %1$s verziója.  %2$s Kérlek, frissíts most!%3$s (tekintse meg %4$s a változások listáját%5$s).',
	'General_PiwikXIsAvailablePleaseNotifyPiwikAdmin' => 'Már kiadásra került a %s. Kérlek, értesítsd az oldal adminisztrátorát.',
	'General_NewReportsWillBeProcessedByCron' => 'Ha a Intranet Statistics archiváló funkcióját nem a jelentések böngésző segítségével történő lehívása aktiválja, akkor a crontab segítségével kerülnek feldolgozásra.',
	...
	'General_BackToPiwik' => 'Vissza a Intranet Statistics-hez',
	...
	'General_ConfigFileIsNotWritable' => 'A Intranet Statistics konfigurációs fájl %s nem írható, így egyes változtatásokat nem lehet elmenteni. %s Kérjük, engedélyezze a konfigurációs fájlra az írási jogot.',
	'General_ExceptionDatabaseVersion' => 'A %1$s verziód %2$s, de a Intranet Statistics-nek legalább a következőre van szüksége: %3$s.',
	...
	'General_FileIntegrityWarningExplanation' => 'A fájlintegritás-ellenőrzés sikertelen volt; néhány hibát jelentve. Ezt nagy valószínűséggel valamelyik Intranet Statistics fájl  részleges vagy sikertelen feltöltése okozhatta. Kérjük, töltsd fel újra az összes Intranet Statistics fájlt BINARY módban és frissítsd ezt a weblapot addig, mindaddig, amíg itt hibaüzenetek jelennek meg.',
	...
	'General_PleaseUpdatePiwik' => 'Kérjük frissítse Intranet Statistics-jét',
	...
	'Actions_DownloadsReportDocumentation' => 'Ez a jelentés azt mutatja, hogy a látogatók melyik fájlokat töltötték le. %s A Intranet Statistics a letöltési linkekre való kattintást számolja letöltésnek. Arról, hogy a letöltés valóban befejeződött-e, a Intranet Statistics nem tud.',
	...
	'API_PluginDescription' => 'A Intranet Statistics által tárolt összes adat elérhető egyszerű API-k segítségével. Ez a kiegészítő egy belépési pontként funkcionáló web alkalmazás, melyet meghívhatsz, hogy hozzáférhess a webanalitika adatokhoz xml, json, php, csv, stb. formátumokban.',
	'API_QuickDocumentationTitle' => 'API dokumentáció összefoglalója',
	'API_GenerateVisits' => 'Ha nem volt még ma látogató, automatikusan generálhatsz mintaadatokat a %s kiegészítő segítségével. A %s kiegészítőt a Intranet Statistics adminisztrációs felületén megjelenő Látogatógenerálás menüpontra kattintva engedélyezheted.',
	'API_MoreInformation' => 'További információkért a Intranet Statistics API-kkal kapcsolatban kérjük, tekintse meg a %s Introduction to Intranet Statistics API %s és a %s Intranet Statistics API Reference %s című leírásokat.',
	...
	'CoreAdminHome_PluginDescription' => 'Intranet Statistics adminisztrációs felület',
	...
	'CoreAdminHome_CustomLogoHelpText' => 'A felhasználói felületen és az e-mail jelentésekben megjelenő Intranet Statistics logó testreszabható.',
	'CoreAdminHome_CustomLogoFeedbackInfo' => 'A Intranet Statistics logó konfigurálása esetén érdekes lehet a felső menüben található %s link eltávolítása is. Ehhez a %sBővítmények%s oldalon ki kell kapcsolni a Feedback bővítményt.',
	...
	'CoreAdminHome_LogoNotWriteable' => 'Egyéni logó használatához a Intranet Statisticsnek írási jogra van szüksége a \'themes\' mappában a logó fájlokhoz: %s',
	'CoreHome_PluginDescription' => 'Webanalitikai jelentések struktúrája',
	'CoreHome_WebAnalyticsReports' => 'Webanalitikai jelentések',
	'CoreHome_NoPrivilegesAskPiwikAdmin' => '\'%s\' felhasználóként léptél be, de úgy tűnik, hogy nem rendelkezel semmilyen jogosultsággal. %s Kérd meg a Intranet Statistics adminisztrátorod (kattints ide egy email írásához)%s, hogy adjon számodra \'megtekintési\' jogosultságot a webhelyhez.',
	...
	'CorePluginsAdmin_MainDescription' => 'A bővítmények kiterjesztik a Intranet Statistics alapfunkcióit. A már telepített bővítményeket itt kapcsolhatod ki vagy be.',
	...
	'CoreUpdater_PluginDescription' => 'Intranet Statistics frissítésére szolgáló alkalmazás',
	'CoreUpdater_UpdateTitle' => 'Frissítés',
	'CoreUpdater_DatabaseUpgradeRequired' => 'Adatbázis-frissítés szükséges',
	'CoreUpdater_YourDatabaseIsOutOfDate' => 'A Intranet Statistics adatbázisod elavult. Frissítened kell, mielőtt folytathatnád!',
	'CoreUpdater_PiwikWillBeUpgradedFromVersionXToVersionY' => 'Intranet Statistics adatbázisa frissülni fog %1$s verzióról az új %2$s verzióra.',
	'CoreUpdater_TheFollowingPluginsWillBeUpgradedX' => 'A következő bővítmények kerülnek frissítésre: %s.',
	'CoreUpdater_NoteForLargePiwikInstances' => 'Fontos megjegyzés nagyobb weboldalakra telepített Intranet Statistics rendszerekhez.',
	'CoreUpdater_TheUpgradeProcessMayFailExecuteCommand' => 'Ha nagy Intranet Statistics adatbázissal rendelkezel, a frissítések lehet, túl sok időt vesznek igénybe a böngészőben futtatáshoz. Ebben az esetben a frissítéseket a parancssorból így lehet végrehajtani: %s',
	'CoreUpdater_YouCouldManuallyExecuteSqlQueries' => 'Ha nem lehetséges a parancssori frissítés és ha a Intranet Statistics nem tud frissíteni az újabb verzióra (adatbázis-műveletek időtúllépése, a böngésző időtúllépése vagy egyéb problémák miatt), kézzel is lehet frissíteni a Intranet Statistics-et a megfelelő SQL parancsok segítségével.',
	...
	'CoreUpdater_UpgradePiwik' => 'Intranet Statistics frissítése',
	...
	'CoreUpdater_ErrorDIYHelp_3' => 'kézzel aktualizáld az "option" táblát a Intranet Statistics adatbázisban, beállítva a version_core paraméter értékét a sikertelenül frissíteni próbált verziónak megfelelő értékre.',
	...
	'CoreUpdater_ErrorDIYHelp_5' => 'jelentsd a problémát (és a megoldást) a Intranet Statistics fejlesztőinek, segítve így a rendszer tökéletesítését.',
	'CoreUpdater_HelpMessageContent' => 'Nézd meg a %1$s Intranet Statistics GYIK-et %2$s, melyből megismerheted a frissítés folyamán leggyakrabban fellépő problémákat. %3$s Kérdezd a rendszergazdád - Talán ő tud segíteni, hisz a rendszergazda áll közvetlen kapcsolatban a szervereddel, és segíthet megérteni a MySQL beállításokkal kapcsolatos problémákat!',
	...
	'CoreUpdater_PiwikHasBeenSuccessfullyUpgraded' => 'A Intranet Statistics sikeresen frissült!',
	'CoreUpdater_ContinueToPiwik' => 'Tovább a Intranet Statistics-hez',
	'CoreUpdater_UpdateAutomatically' => 'Automatikus frissítés',
	'CoreUpdater_ThereIsNewVersionAvailableForUpdate' => 'Új Intranet Statistics verzió áll rendelkezésre a frissítéshez',
	...
	'CoreUpdater_YouMustDownloadPackageOrFixPermissions' => 'A Intranet Statistics nem tudta felülírni a jelenlegi rendszert. Kérjük, állítsd be megfelelően a könyvtár- és fájlhozzáférési jogosultságokat, vagy töltsd le a csomagot és telepítsd a %s verziót kézzel:',
	'CoreUpdater_DownloadX' => '%s letöltése',
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'Az Egyklikkes Intranet Statistics Frissítés modult törölték. Ha nem tudod kijavítani a fenti hibaüzenetben kapott hibát, akkor a Intranet Statistics kézzel történő frissítését ajánljuk. %1$s Kérjük, kezdd a %2$s frissítésről szóló dokumentáció %3$s elolvasásával!',
	...
	'CoreUpdater_PiwikUpdatedSuccessfully' => 'A Intranet Statistics frissítése sikeresen megtörtént!',
	'CoreUpdater_EmptyDatabaseError' => 'A(z) %s adatbázis üres. Kérjük szerkessze, vagy törölje a Intranet Statistics konfigurációs fájlt.',
	'CoreUpdater_ExceptionAlreadyLatestVersion' => 'Intranet Statistics verziód (%s) a lehető legújabb.',
	...
	'DBStats_PluginDescription' => 'A kiegészítő statisztikákat jelenít meg a Intranet Statistics adatbázis-használatáról.',
	'DBStats_DatabaseUsage' => 'Adatbázis-használat',
	'DBStats_MainDescription' => 'A Intranet Statistics egy MySQL adatbázisban tárolja a webanalitikai adatokat. Jelenleg a Intranet Statistics táblák a következőket használják: %s.',
	'DBStats_LearnMore' => 'Ha többet szeretnél megtudni arról, hogyan dolgozza fel a Intranet Statistics az adatokat, és hogyan lehet mindezt hatékonyan megoldani közepes és nagyobb forgalommal rendelkező weboldalak esetén is, olvasd el a vonatkozó dokumentációt: %s',
	'DBStats_Table' => 'Tábla',
	...
	'ExampleUI_PluginDescription' => 'Példakiegészítő: Ez a kiegészítő bemutatja, hogyan lehet a Intranet Statistics felhasználói felületével dolgozni: táblázatokat, grafikonokat létrehozni, stb.',
	'Feedback_PluginDescription' => 'Küldd el véleményedet a Intranet Statistics fejlesztőinek. Oszd meg ötleteid, javaslataid velük!',
	...
	'Feedback_SpecialRequest' => 'Valamilyen speciális kérdésed lenne a Intranet Statistics fejlesztőkhőz?',
	'Feedback_ContactThePiwikTeam' => 'Vedd fel a kapcsolatot a Intranet Statistics fejlesztőkkel!',
	'Feedback_IWantTo' => 'A következőt szeretném:',
	'Feedback_CategoryShareStory' => 'Egy Intranet Statistics sikertörténetet megosztani',
	'Feedback_CategorySponsor' => 'A Intranet Statistics-et támogatni, szponzorálni',
	'Feedback_CategoryHire' => 'Egy Intranet Statistics szakértőt megbízni',
	...
	'Feedback_MessageSent' => 'Üzeneted elküldtük a Intranet Statistics fejlesztőknek.',
	'Feedback_ThankYou' => 'Köszönjük, hogy segítesz jobbá tenni a Intranet Statistics-et!',
	'Feedback_ThePiwikTeam' => 'A Intranet Statistics csapat',
	...
	'Goals_NoGoalsNeedAccess' => 'Csak adminisztrátor és superuser jogosultságokkal rendelkező felhasználó tud célokat létrehozni egy adott weboldallal kapcsolatban. Kérjük, keresd meg a Intranet Statistics adminisztrátorod, ha szeretnél célokat létrehozni ehhez az oldalhoz.<br>A célok követése nagyszerű lehetőséget ad megérteni, hogy mi zajlik a weboldalon, és ennek megfelelően maximalizálni az oldal teljesítményét!',
	...
	'Goals_DefaultRevenueHelp' => 'Például egy látogató által elküldött kapcsolatfelvételi űrlap 1000 forintnak megfelelő értéket jelenthet átlagosan. A Intranet Statistics segít annak megértésében, hogy az egyes látogatói szegmensek hogyan teljesítenek ennek fényében.',
	...
	'Goals_LearnMoreAboutGoalTrackingDocumentation' => '%sA célok Intranet Statistics segítségével történő nyomon követésének részleteiről%s a  felhasználói dokumentációban olvashatsz.',
	'Installation_PluginDescription' => 'Intranet Statistics telepítése. Általában csak egyszer fut le, ha azonban a config/config.inc.php konfigurációs fájl hiányzik, akkor a telepítés újból fog kezdődni.',
	'Installation_Installation' => 'Telepítés',
	'Installation_InstallationStatus' => 'Telepítés állása',
	'Installation_PercentDone' => '%s %% kész',
	'Installation_NoConfigFound' => 'Megpróbáltál belépni a Intranet Statistics oldalra, de a konfigurációs fájl nem található.<br /><b>  »  <a href=\'index.php\'>(Újra)telepítheted a Intranet Statistics-et most.</a></b><br /><small>Ha már telepítetted a Intranet Statistics-et korábban és voltak már táblák az adatbázisodban, ne aggódj, tudod használni azokat a táblákat és így megmaradnak a meglévő adataid !</small>',
	...
	'Installation_CongratulationsHelp' => '<p>Gratulálunk! A Intranet Statistics telepítése kész!</p><p>Bizonyosodj meg róla, hogy a JavaScript követőkód beillesztésre került minden weblapba. Ebben az esetben nincs más hátra, mint várnod az első látogatókat!</p>',
	'Installation_ContinueToPiwik' => 'Tovább a Intranet Statistics-hez',
	...
	'Installation_SecurityNewsletter' => 'e-mail küldése főbb Intranet Statistics verziók megjelenése és biztonsági riasztások esetén',
	...
	'Installation_Requirements' => 'Intranet Statistics Rendszerkövetelmények',
	...
	'Installation_SystemCheckDatabaseHelp' => 'A Intranet Statistics-nek szüksége van vagy a mysqli kiterjesztésre vagy a PDO és a pdo_mysql kiterjesztésekre.',
	...
	'Installation_SystemCheckMailHelp' => 'A Intranet Statistics fejlesztőknek szóló visszajelzés és az elveszett jelszó pótlása céljából generált e-mail üzenetek nem lesznek elküldve a mail() nélkül.',
	'Installation_SystemCheckParseIniFileHelp' => 'Ez a beépített funkció le van tiltva a szervereden. Intranet Statistics megpróbálja emulálni ezt a funkciót, de további biztonsági korlátozások akadályozhatják ezt. A nyomon követés teljesítményére szintén kihatással lehet mindez.',
	'Installation_SystemCheckGlobHelp' => 'Ez a beépített funkció le van tiltva a szervereden. Intranet Statistics megpróbálja emulálni ezt a funkciót, de további biztonsági korlátozások akadályozhatják ezt. A Intranet Statistics működésére kihatással lehet mindez.',
	...
	'Installation_SystemCheckCreateFunctionHelp' => 'A Intranet Statistics anonim funkciókat használ a callback-okhoz.',
	...
	'Installation_SystemCheckPackHelp' => 'A pack() funkció szükséges a látogatók Intranet Statistics-ben történő nyomon követéséhez.',
	...
	'Installation_SystemCheckAutoUpdateHelp' => 'Megjegyzés: Az egyklikkes Intranet Statistics frissítés működéséhez  írási jogosultság szükséges a Intranet Statistics mappára és annak tartalmára egyaránt.',
	'Installation_SystemCheckError' => 'Hiba lépet fel - ki kell javítanod, mielőtt folytatnád',
	'Installation_SystemCheckWarning' => 'A Intranet Statistics működni fog normálisan, de néhány funkció hiányozhat',
	...
	'Installation_TablesWithSameNamesFound' => 'Néhány táblának (%1$s) az adatbázisodban (%2$s) ugyanaz a neve, mint amilyet a Intranet Statistics próbál létrehozni.',
	...
	'Installation_TablesDeletedSuccess' => 'Korábbi Intranet Statistics táblák sikeresen törölve!',
	...
	'Installation_GoBackAndDefinePrefix' => 'Lépj vissza, és add meg a Intranet Statistics táblák nevének előtagját!',
	...
	'Installation_WelcomeHelp' => '<p>A Intranet Statistics egy nyílt forráskódú webanalitikai szoftver, mellyel könnyedén juthatsz információkhoz weboldalad látogatottságáról.</p><p>A telepítési folyamat %s egyszerű lépésből áll és kb. 5 percet vesz igénybe.</p>',
	'Installation_ConfigurationHelp' => 'Úgy tűnik, a Intranet Statistics konfigurációs fájl hibás. Törölheted a config/config.ini.php fájlt — újrakezdve a telepítést, vagy kijavíthatod az adatbázis-kapcsolathoz szükséges beállításokat.',
	'Installation_ErrorInvalidState' => 'Hiba: úgy tűnik, hogy megpróbáltad kihagyni a telepítési eljárás egy lépését, esetleg a sütik le vannak tiltva böngésződben, vagy a Intranet Statistics konfigurációs fájlját korábban már létrehoztad. %1$s Engedélyezd a sütiket %2$s és lépj vissza %3$s a telepítés első lépéséhez %4$s.',
	'LanguagesManager_PluginDescription' => 'Ez a kiegészítő a Intranet Statistics felhasználói felület megtekintéséhez elérhető nyelvek listáját jeleníti meg. A kiválasztott nyelv a felhasználóhoz kötötten rögzítésre kerül.',
	'LanguagesManager_AboutPiwikTranslations' => 'A Intranet Statistics fordításokról',
	...
	'Login_ContactAdmin' => 'Lehetséges ok: talán a szolgáltatód tiltja a mail() funkciót. <br /> Kérjük, lépj kapcsolatba a Intranet Statistics adminisztrátoroddal.',
	...
	'MultiSites_PluginDescription' => 'Összefoglaló statisztikákat jelenít meg több weboldal látogatottságáról. A kiegészítő jelenleg a Intranet Statistics magjához tartozik.',
	...
	'SitesManager_PluginDescription' => 'Weboldalak kezelése a Intranet Statistics rendszerében: Új weboldal hozzáadása, meglévő weboldal szerkesztése, a weblapokba beillesztendő JavaScript követőkódok megjelenítése. Az összes funkció elérhető az API-n keresztül is.',
	...
	'SitesManager_AliasUrlHelp' => 'Javasolt, de nem kötelező megadni azokat a különböző URL-eket, melyek segítségével a látogatók elérhetik a weboldalt. Ezek az alternatív URL-ek nem fognak megjelenni a "Forgalmi források » Weboldalak" jelentésben. Nem szükséges azonban külön megadni www-vel és www nélkül is a domainneveket, mivel a Intranet Statistics mindkettőt automatikusan figyelembe veszi.',
	...
	'SitesManager_PiwikWillAutomaticallyExcludeCommonSessionParameters' => 'A Intranet Statistics automatikusan kiszűri az általánosan használt session paramétereket (%s).',
	'SitesManager_HelpExcludedIps' => 'Add meg azon IP címek listáját, amelyekről érkező látogatókat szeretnéd kiszűrni a Intranet Statistics statisztikákból. Használhatsz helyettesítő karaktereket mint pl. %1$s vagy %2$s',
	...
	'TranslationsAdmin_PluginDescription' => 'Segíts lefordítani a Intranet Statistics-et saját nyelvedre.',
	...
	'UsersManager_PluginDescription' => 'A Intranet Statistics felhasználóinak kezelése: új felhasználó felvétele, meglévő felhasználók adatainak szerkesztése, jogosultságok megváltoztatása. Az összes funkció elérhető az API-n keresztül is.',
	...
	'UsersManager_MainDescription' => 'Döntsd el, melyik felhasználónak milyen Intranet Statistics jogosultságokat biztosítasz a weboldaladon. Beállíthatod a jogosultságokat akár az összes weboldalhoz is egyszerre.',
	...
	'UsersManager_YourVisitsAreIgnoredOnDomain' => '%sLátogatásaidat nem veszi figyelembe a Intranet Statistics itt: %s %s (a Intranet Statistics megfelelő sütijét megtaláltuk a böngésződben lementve).',
	'UsersManager_YourVisitsAreNotIgnored' => '%sLátogatásaid nem kerültek ignorálásra a Intranet Statistics által%s (Az ehhez szükséges süti nem volt megtalálható a böngésződben.)',
	'UsersManager_ClickHereToDeleteTheCookie' => 'Kattints ide a szűrés érdekében lementett süti törléséhez, hogy a továbbiakban a Intranet Statistics regisztrálja látogatásaid.',
	...
	'UsersManager_WhenUsersAreNotLoggedInAndVisitPiwikTheyShouldAccess' => 'Amikor a felhasználók nincsenek belépve a Intranet Statistics-be és így keresik fel a Intranet Statistics-et, akkor a következőhöz férjenek hozzá:',
	...
	'UsersManager_ExceptionEditAnonymous' => '\'Névtelen\' felhasználó nem szerkeszthető vagy törölhető. Ezt a Intranet Statistics használja a be nem lépett felhasználók azonosítására. Nyilvánossá teheted például statisztikáidat, ha \'megtekintési\' jogosultságot adsz a \'névtelen\' felhasználók számára.',
	'UsersManager_ExceptionSuperUser' => 'A kért felhasználó egy superuser és így nem lehet lekérdezni, szerkeszteni vagy törölni az API-n keresztül. A superuser adatait csak kézzel tudod szerkeszteni a Intranet Statistics konfigurációs fájlban.',
	...
	'VisitorGenerator_PluginDescription' => 'Műlátogatásokat generáló kiegészítő. Hasznos eszköz Intranet Statistics felhasználók és fejlesztők számára ahhoz, hogy egyszerűen feltöltsék fals adatokkal a különböző Intranet Statistics jelentéseket.',
	'VisitorGenerator_VisitorGenerator' => 'Látogatógenerátor',
	'VisitorGenerator_Warning' => 'Fals látogatások generálására készülsz, melyeket rögzíteni fogunk a Intranet Statistics adatbázisban.',
	'VisitorGenerator_NotReversible' => 'A műlátogatásokat %snem%s lehet egyszerűen kitörölni a Intranet Statistics naplófájlokból',
	...
	'VisitTime_NHour' => '%s ó',
	'Widgetize_PluginDescription' => 'A kiegészítő egyszerűvé teszi bármelyik Intranet Statistics modul megjelenítését más blogon, weboldalon vagy akár az iGoogle és a Netvibes nyitólapokon!',
	...
	'PDFReports_PiwikReports' => 'Intranet Statistics jelentések',
