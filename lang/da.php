...
$translations = array(
	...
	'General_BackToHomepage' => 'Tilbage til Intranet Statistics startside',
	'General_Yes' => 'Ja',
	'General_No' => 'Nej',
	'General_Delete' => 'Slet',
	...
	'General_AllowPiwikArchivingToTriggerBrowser' => 'Tillad at Intranet Statistics-arkivering udføres når rapporter vises i browseren',
	'General_ArchivingInlineHelp' => 'For hjemmesider med medium til høj trafik anbefales det at deaktivere Intranet Statistics-arkivering udløst fra browseren. I stedet anbefales det at køre et cron job hver time til at behandle Intranet Statistics rapporter.',
	'General_ArchivingTriggerDescription' => 'Til større Intranet Statistics installationer anbefales det, at %soprette et cron job%s til at behandle rapporterne automatisk.',
	...
	'General_RequiresFlash' => 'Visning af diagrammer i Intranet Statistics kræver Flash',
	'General_GraphHelp' => 'Flere oplysninger om visning af diagrammer i Intranet Statistics.',
	...
	'General_PiwikIsACollaborativeProjectYouCanContributeAndDonate' => '%1$s Intranet Statistics %2$s er et samarbejdsprojekt. %3$s Hvis du vil hjælpe, så se: %4$s Hvordan bidrager man til Intranet Statistics? %5$s, eller %6$s %7$s donere nu %8$s for at hjælpe med at finansiere Intranet Statistics 2.0!',
	'General_YouAreViewingDemoShortMessage' => 'Du bruger en demo version af Intranet Statistics',
	'General_YouAreCurrentlyUsing' => 'Du bruger i øjeblikket Intranet Statistics %s.',
	'General_DownloadFullVersion' => '%1$sHent%2$s fuld version! Tjek %3$s',
	'General_NewUpdatePiwikX' => 'Ny opdatering: Intranet Statistics %s',
	'General_AboutPiwikX' => 'Om Intranet Statistics %s',
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Intranet Statistics %1$s er tilgængelig. %2$sOpdater nu!%3$s (se %4$sændringer%5$s).',
	'General_PiwikXIsAvailablePleaseNotifyPiwikAdmin' => '%s er tilgængelig. Underet administratoren.',
	'General_NewReportsWillBeProcessedByCron' => 'Når Intranet Statistics arkivering ikke udløses af browseren, vil nye rapporter blive behandlet af crontab.',
	...
	'General_BackToPiwik' => 'Tilbage til Intranet Statistics',
	...
	'General_ConfigFileIsNotWritable' => 'Intranet Statistics konfigurationsfilen %s er skrivebeskyttet, nogle af ændringerne vil ikke blive gemt. %s Skift tilladelser til konfigurationsfilen for at gøre den skrivebar.',
	'General_StatisticsAreNotRecorded' => 'Intranet Statistics besøgssporing er i øjeblikket deaktiveret! Genaktiver sporing ved at sætte record_statistics = 1 i config/config.ini.php filen.',
	'General_ExceptionDatabaseVersion' => '%1$s version er %2$s, men Intranet Statistics behøver mindst version %3$s.',
	...
	'General_FileIntegrityWarningExplanation' => 'Fil integritetstjek mislykkedes og rapporterede nogle fejl. Det skyldes mest sandsynligt en delvis eller mislykket overførelse af nogle Intranet Statistics filer. Du bør overføre alle Intranet Statistics filer igen og opdatere denne side, indtil den ingen fejl viser.',
	...
	'General_PleaseUpdatePiwik' => 'Opdater Intranet Statistics',
	...
	'Actions_DownloadsReportDocumentation' => 'Rapporten viser, hvilke filer dine besøgende har hentet. %s Hvad Intranet Statistics tæller som en filhentning, er klikket på et link. Hvorvidt overførelsen er afsluttet eller ej ved Intranet Statistics ikke.',
	...
	'API_PluginDescription' => 'Alle data i Intranet Statistics er tilgængelig via enkle API\'er. Programudvidelsen er webservice indgangen, som kan kaldes for at få Web analyse-data i xml, json, php, csv, osv.',
	...
	'API_MoreInformation' => 'Mere information om Intranet Statistics API\'er, findes på %sIntroduktion til Intranet Statistics API%s og %sIntranet Statistics API Reference%s.',
	...
	'CoreAdminHome_PluginDescription' => 'Intranet Statistics administration.',
	...
	'CoreAdminHome_OptOutForYourVisitors' => 'Intranet Statistics opt-out for dine besøgende',
	'CoreAdminHome_OptOutExplanation' => 'Intranet Statistics er dedikeret til at værne om personlige oplysninger på internettet. For at give dine besøgende valgmulighed for at framelde Intranet Statistics Web Analyse, kan du tilføje den følgende HTML-kode på en af dine hjemmesider, f. eks. på en fortrolighedspolitik side.',
	'CoreAdminHome_OptOutExplanationBis' => 'Koden vil vise en Iframe, der indeholder et link til dine besøgende til at framelde Intranet Statistics ved at sætte en opt out-cookie i browseren. %sKlik her%s for at få vist indholdet af iFramen.',
	...
	'CoreAdminHome_CustomLogoHelpText' => 'Du kan tilpasse Intranet Statistics logo, der bliver vist i brugergrænsefladen og e-mail rapporter.',
	'CoreAdminHome_CustomLogoFeedbackInfo' => 'Hvis du tilpasser Intranet Statistics logoet, kan du også være interesseret i at skjule %s linket i topmenuen. For at gøre dette, kan du deaktivere tilbagemeldingsmodulet på %sUdvidelsesmodul administration%s siden.',
	...
	'CoreAdminHome_LogoNotWriteable' => 'For at anvende et brugerdefineret logo, kræver Intranet Statistics skrive adgang til logofilerne i skabelonmappen: %s',
	'CoreAdminHome_TrustedHostSettings' => 'Betroet Intranet Statistics værtsnavn',
	'CoreAdminHome_TrustedHostConfirm' => 'Er du sikker på, at du vil ændre det betroede Intranet Statistics værtsnavn?',
	'CoreAdminHome_PiwikIsInstalledAt' => 'Intranet Statistics er installeret på',
	'CoreAdminHome_ValidPiwikHostname' => 'Gyldigt Intranet Statistics værtsnavn',
	...
	'CoreAdminHome_JSTrackingIntro2' => 'Når du har JavaScript sporingskoden til hjemmesiden, kopier og indsæt den på alle de sider, der skal spores med Intranet Statistics.',
	'CoreAdminHome_JSTrackingIntro3' => 'De fleste hjemmesider, blogs, CMS, mv. kan bruge et foruddefineret modul til at gøre det tekniske arbejde for dig. (Se %1$slisten med moduler, der kan bruges til at integrere Intranet Statistics%2$s). Hvis der ikke findes et modul, kan du redigere hjemmeside skabelonen og tilføje denne kode i "sidefoden".',
	...
	'CoreAdminHome_JSTrackingIntro5' => 'Hvis du vil gøre mere end at spore sidevisninger, kan du checke %1$sIntranet Statistics Javascript sporingsdokumentation%2$s for listen over tilgængelige funktioner. Ved hjælp af disse funktioner kan du spore mål, brugerdefinerede variabler, e-handels ordrer, forladte indkøbskurve og meget mere.',
	...
	'CoreAdminHome_JSTracking_CustomCampaignQueryParamDesc' => 'Note: %1$sIntranet Statistics registrerer automatisk Google Analytics parametre.%2$s',
	...
	'CoreHome_InjectedHostWarningIntro' => 'Du tilgår Intranet Statistics fra %1$s, men Intranet Statistics er konfigureret til at køre på denne adresse: %2$s.',
	'CoreHome_InjectedHostNonSuperUserWarning' => '%1$sKlik her for at få adgang Intranet Statistics på en sikker måde%2$s og fjerne denne advarsel. Du kan også vælge at kontakte din Intranet Statistics administrator og underrette om problemet (%3$sKlik her for e-mail%4$s).',
	'CoreHome_InjectedHostEmailSubject' => 'Intranet Statistics blev åbnet fra et ukendt værtsnavn: %s',
	'CoreHome_InjectedHostEmailBody' => 'Hej, jeg forsøgte at få adgang Intranet Statistics i dag og stødte på den ukendte værtsnavn advarsel.',
	'CoreHome_CheckForUpdates' => 'Søg efter opdateringer',
	'CoreHome_YouAreUsingTheLatestVersion_js' => 'Du bruger den seneste version af Intranet Statistics!',
	'CoreHome_MakeADifference' => 'Gør en forskel: %1$sGiv et bidrag nu%2$s og støt Intranet Statistics 2.0!',
	'CoreHome_DonateCall1' => 'Intranet Statistics vil altid ikke koste noget at bruge, men det betyder ikke, at det ikke koster os noget at lave.',
	'CoreHome_DonateCall2' => 'Intranet Statistics har brug for din fortsatte støtte til at vokse og trives.',
	'CoreHome_DonateCall3' => 'Synes du, at Intranet Statistics har tilføjet væsentlig merværdi til dig eller din virksomhed, %1$s overvej at donere!%2$s',
	'CoreHome_HowMuchIsPiwikWorth' => 'Hvor meget er Intranet Statistics værd for dig?',
	'CoreHome_SupportPiwik' => 'Støt Intranet Statistics!',
	...
	'CoreHome_SubscribeAndBecomePiwikSupporter' => 'Fortsæt til sikker kreditkort betalingsside (Paypal) for at blive en Intranet Statistics supporter!',
	'CoreHome_CheckPiwikOut' => 'Tjek Intranet Statistics!',
	'CoreHome_CloseWidgetDirections' => 'Luk modulet ved at klikke på \'X\' ikonet øverst.',
	'CoreHome_ShareThis' => 'Del dette',
	'CoreHome_ViewAllPiwikVideoTutorials' => 'Vis alle Intranet Statistics videoselvstudier',
	'CoreHome_SharePiwikShort' => 'Intranet Statistics! Gratis og open source internet analyse. Ej dine egne data.',
	'CoreHome_SharePiwikLong' => 'Hej! Jeg har lige fundet et fantastisk open source program: Intranet Statistics!    Intranet Statistics kan gratis spore besøgende på din hjemmeside. Du bør helt klart undersøge det!',
	'PrivacyManager_TeaserHeadline' => 'Privatlivsindstillinger',
	'PrivacyManager_MenuPrivacySettings' => 'Privatliv',
	'PrivacyManager_PluginDescription' => 'Tilpas Intranet Statistics til beskyttelse af personlige oplysninger i overensstemmelse med gældende lovgivning.',
	'PrivacyManager_UseAnonymizeIp' => 'Anonymisere besøgendes IP-adresser',
	'PrivacyManager_AnonymizeIpDescription' => 'Vælg "Ja", hvis Intranet Statistics ikke skal spore fuldt kvalificerede IP-adresser.',
	...
	'PrivacyManager_DoNotTrack_EnabledMoreInfo' => 'Når brugere har sat deres web-browser til "Jeg ønsker ikke at blive sporet" (spor ikke er aktiveret), vil Intranet Statistics ikke spore disse besøg.',
	'PrivacyManager_DoNotTrack_Disabled' => 'Intranet Statistics sporer i øjeblikket alle besøgende, selv når de har angivet "Jeg ønsker ikke at blive sporet" i deres webbrowser.',
	...
	'CoreHome_NoPrivilegesAskPiwikAdmin' => 'Du er logget på som \'%s\' men det ser ikke ud som du har adgang til Intranet Statistics. %s Spørg Intranet Statistics administratoren (klik for at sende e-mail)%s for at give dig \'se\' adgang til et websted.',
	'CoreHome_JavascriptDisabled' => 'JavaSript skal være aktiveret for at Intranet Statistics kan bruges i standardvisning. JavaScript er enten deaktiveret eller ikke understøttet i netlæseren.<br />For at bruge standardvisning, aktiver JavaScript i indstillingerne for netlæseren, og %1$s prøv igen %2$s.<br />',
	...
	'CorePluginsAdmin_MainDescription' => 'Udvidelsesmoduler udvider funktionaliteten i Intranet Statistics. Når et udvidelsesmodul er installeret, kan det aktiveres eller deaktiveres her.',
	...
	'CoreUpdater_PluginDescription' => 'Intranet Statistics ajourføringsmekanisme',
	'CoreUpdater_UpdateTitle' => 'Opdatering',
	'CoreUpdater_DatabaseUpgradeRequired' => 'Database opdatering er nødvendig',
	'CoreUpdater_YourDatabaseIsOutOfDate' => 'Intranet Statistics databasen er ikke opdateret, og skal opgraderes før du kan fortsættes.',
	'CoreUpdater_PiwikWillBeUpgradedFromVersionXToVersionY' => 'Intranet Statistics vil blive opgraderet fra version %1$s til den nye version %2$s.',
	'CoreUpdater_TheFollowingPluginsWillBeUpgradedX' => 'Følgende udvidelsesmoduler vil blive opgraderet: %s.',
	'CoreUpdater_NoteForLargePiwikInstances' => 'Vigtig bemærkning til store Intranet Statistics installationer',
	'CoreUpdater_TheUpgradeProcessMayFailExecuteCommand' => 'Hvis du har en stor Intranet Statistics database, kan opdateringer tage for lang tid at køre i browseren. I denne situation, kan du udføre opdateringen fra kommandolinjen: %s',
	'CoreUpdater_YouCouldManuallyExecuteSqlQueries' => 'Hvis du ikke er i stand til at bruge kommandolinje opdatering og hvis Intranet Statistics opgradering fejler (på grund af timeout i databasen, netlæser timeout, eller andet), kan du manuelt udføre SQL-forespørgsler til at opdatere Intranet Statistics.',
	...
	'CoreUpdater_UpgradePiwik' => 'Opgrader Intranet Statistics',
	...
	'CoreUpdater_ErrorDIYHelp_3' => 'opdater manuelt "option" tabellen i Intranet Statistics databasen, skift værdien af "version_core" til versionen på den mislykkede opdatering',
	...
	'CoreUpdater_ErrorDIYHelp_5' => 'indberet problemet (og løsning), så Intranet Statistics kan forbedres',
	'CoreUpdater_HelpMessageContent' => 'se %1$s Intranet Statistics FAQ %2$s som forklarer de mest almindelige fejl om opdateringer. %3$s Spørg systemadministratoren - vedkommende kan måske hjælpe med fejlen som sandsynligvis skyldes server eller MySQL-opsætning.',
	...
	'CoreUpdater_PiwikHasBeenSuccessfullyUpgraded' => 'Intranet Statistics blev opdateret!',
	'CoreUpdater_ContinueToPiwik' => 'Fortsæt til Intranet Statistics',
	'CoreUpdater_UpdateAutomatically' => 'Opdater automatisk',
	'CoreUpdater_ThereIsNewVersionAvailableForUpdate' => 'Ny version af Intranet Statistics er tilgængelig',
	...
	'CoreUpdater_YouMustDownloadPackageOrFixPermissions' => 'Intranet Statistics er i stand til at overskrive din nuværende installation. Du kan enten rette mappe/fil tilladelserne eller hente pakken og installere version %s manuelt:',
	'CoreUpdater_DownloadX' => 'Hent %s',
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'Intranet Statistics ét klik-opdatering er blevet annulleret. Kan ovenstående fejlmeddelelse ikke løses, anbefales det at opdatere Intranet Statistics manuelt. %1$s Læs %2$sOpdaterings dokumentationen%3$s for at komme i gang!',
	...
	'CoreUpdater_PiwikUpdatedSuccessfully' => 'Intranet Statistics er opdateret!',
	'CoreUpdater_EmptyDatabaseError' => 'Databasen %s er tom. Redigere eller fjern Intranet Statisticss konfigurationsfil.',
	'CoreUpdater_ExceptionAlreadyLatestVersion' => 'Intranet Statistics version %s er fuld opdateret.',
	...
	'CustomVariables_PluginDescription' => 'Brugerdefinerede variabler er navne, værdipar, du kan tildele en besøgende ved hjælp af funktionen Javascript API setVisitCustomVariables(). Intranet Statistics vil derefter rapportere hvor mange besøg, sider, konverteringer for hver af disse brugerdefinerede navne og værdier.',
	...
	'CustomVariables_TrackingHelp' => 'Hjælp: %1$sSporing af egne variabler i Intranet Statistics%2$s',
	...
	'DBStats_PluginDescription' => 'Programudvidelsen viser MySQL-database brugen af Intranet Statistics tabeller.',
	'DBStats_DatabaseUsage' => 'Database brug',
	'DBStats_MainDescription' => 'Intranet Statistics gemmer al statistik i MySQL-databasen. Lige nu bruger Intranet Statistics-tabellerne %s.',
	'DBStats_LearnMore' => 'Hvis du vil vide mere om, hvordan Intranet Statistics behandler data, og hvordan man kan få Intranet Statistics til arbejde godt på mellem til stærkt trafikerede hjemmesider, se dokumentationen på %s.',
	'DBStats_Table' => 'Tabel',
	...
	'ExampleUI_PluginDescription' => 'Programudvidelse eksempel: programudvidelsen viser, hvordan man arbejder med Intranet Statistics UI: opretter tabeller, diagrammer osv.',
	'Feedback_PluginDescription' => 'Send tilbagemelding til Intranet Statistics Team med et enkelt klik. Del ideer og forslag med os!',
	...
	'Feedback_WhyWrongCountry' => 'Hvorfor viser Intranet Statistics mit besøg fra et forkert land?',
	...
	'Feedback_SpecialRequest' => 'Har du en speciel anmodning til Intranet Statistics holdet?',
	'Feedback_ContactThePiwikTeam' => 'Kontakt Intranet Statistics holdet',
	'Feedback_IWantTo' => 'Jeg ønsker at:',
	'Feedback_CategoryShareStory' => 'Dele en Intranet Statistics succeshistorie',
	'Feedback_CategorySponsor' => 'Sponsere Intranet Statistics',
	'Feedback_CategoryHire' => 'Ansætte en Intranet Statistics konsulent',
	...
	'Feedback_MessageSent' => 'Din besked blev sendt til Intranet Statistics holdet.',
	'Feedback_ThankYou' => 'Tak, fordi du hjælper med at gøre Intranet Statistics bedre!',
	'Feedback_ThePiwikTeam' => 'Intranet Statistics holdet',
	...
	'Feedback_WantToThankConsiderDonating' => 'Synes du at Intranet Statistics er fantastisk og ønsker at takke os? Overvej at donere',
	'Goals_Goals' => 'Mål',
	...
	'Goals_NoGoalsNeedAccess' => 'Kun en administrator eller superbruger kan tilføje mål for en given hjemmeside. Bed din Intranet Statistics administrator om at oprette et mål for din hjemmeside. <br /> Sporingsmål er en fantastisk måde til at forstå og optimere din hjemmesides ydelse!',
	...
	'Goals_DefaultRevenueHelp' => 'F.eks. en kontaktformular sendt af en besøgende kan være 10 kr. værd i gennemsnit. Intranet Statistics vil hjælpe dig med at forstå, hvor godt dine besøgendes segmenter klarer sig.',
	...
	'Goals_LearnMoreAboutGoalTrackingDocumentation' => 'Lær mere om %s Spor mål i Intranet Statistics%s i brugerdokumentationen, eller opret et mål nu.',
	...
	'Installation_PluginDescription' => 'Installation af Intranet Statistics. Installationen sker som regel kun én gang. Hvis konfigurationsfilen config/config.inc.php slettes starter installationen igen.',
	...
	'Installation_NoConfigFound' => 'Intranet Statistics-konfigurationsfil blev ikke fundet og du prøver at få adgang til Intranet Statistics. <ul><li>Du kan <a href=\'index.php\'>installere Intranet Statistics nu</a></b><small> Hvis du har installeret Intranet Statistics tidligere og har nogle tabeller i databasen, kan du genbruge tabellerne og holde dine eksisterende data!</small>',
	...
	'Installation_LargePiwikInstances' => 'Hjælp til store Intranet Statistics installationer',
	'Installation_JsTag' => 'JavaScript kode',
	'Installation_JsTagArchivingHelp1' => 'For mellemstore og højt trafikere hjemmesider, er der  visse optimeringer, der bør gøres for at hjælpe Intranet Statistics til køre hurtigere (såsom %1$soprettelse af auto-arkivering%2$s).',
	'Installation_Congratulations' => 'Tillykke',
	'Installation_CongratulationsHelp' => '<p>Tillykke! Intranet Statistics installationen er færdig.</p><p>Sørg for at JavaScript-koden er tilføjet på dine sider, og vent på de første besøgende!</p>',
	'Installation_ContinueToPiwik' => 'Fortsæt til Intranet Statistics',
	'Installation_SiteSetup' => 'Opsæt den første hjemmeside, som du vil spore og analysere med Intranet Statistics:',
	...
	'Installation_SiteSetupFootnote' => 'Bemærk: når Intranet Statistics installationen er færdig, vil du have mulighed for at tilføje flere hjemmesider som du vil spore!',
	...
	'Installation_SecurityNewsletter' => 'send e-mail med vigtige Intranet Statistics opgraderinger og sikkerheds advarsler',
	...
	'Installation_Requirements' => 'Intranet Statistics krav',
	...
	'Installation_SystemCheckDatabaseHelp' => 'Intranet Statistics behøver enten mysqli udvidelsen eller både PDO og pdo_mysql udvidelserne.',
	...
	'Installation_SystemCheckGDHelp' => 'Mindre grafiske elementer (i Intranet Statistics Mobile app og e-mail-rapporter) vil ikke fungere som ønsket.',
	...
	'Installation_SystemCheckParseIniFileHelp' => 'Den indbyggede funktion er blevet deaktiveret hos udbyderen. Intranet Statistics vil forsøge at efterligne funktionen, men kan støde på yderligere sikkerhed restriktioner. Sporingsydelsen vil også blive påvirket.',
	'Installation_SystemCheckGlobHelp' => 'Den indbyggede funktion er blevet deaktiveret på din vært. Intranet Statistics vil forsøge at efterligne funktionen, men kan støde yderligere sikkerhedsrestriktioner. Funktionaliteten kan blive påvirket.',
	'Installation_SystemCheckDebugBacktraceHelp' => 'View:: factory kan ikke oprette visninger for det modul.',
	'Installation_SystemCheckCreateFunctionHelp' => 'Intranet Statistics bruger anonyme funktioner til tilbagekald.',
	...
	'Installation_SystemCheckPackHelp' => 'Funktionen pack() er nødvendig for at spore besøgende i Intranet Statistics.',
	...
	'Installation_SystemCheckAutoUpdateHelp' => 'Note: Intranet Statistics\'s ét klik opdatering kræver skrive-tilladelser til Intranet Statistics mappen og dens indhold.',
	'Installation_SystemCheckError' => 'En fejl opstod - skal rettes før der fortsættes',
	'Installation_SystemCheckWarning' => 'Intranet Statistics vil virke normalt, men nogle funktioner vil måske mangle',
	...
	'Installation_TablesWithSameNamesFound' => 'Nogle %1$s tabeller i databasen %2$s har samme navn, som dem Intranet Statistics prøver at oprette',
	...
	'Installation_TablesDeletedSuccess' => 'Eksisterende Intranet Statistics-tabeller blev slettet',
	'Installation_TablesCreatedSuccess' => 'Tabellerne blev oprettet!',
	'Installation_DatabaseCreatedSuccess' => 'Databasen %s blev oprettet!',
	'Installation_GoBackAndDefinePrefix' => 'Gå tilbage og opret præfiks for Intranet Statistics tabeller',
	...
	'Installation_WelcomeHelp' => '<p>Intranet Statistics er et Open Source statistik-program som gør det nemt at finde information om besøgende.</p><p> Processen er delt op i %s lette trin og vil tage ca. 5 minutter.</p>',
	'Installation_ConfigurationHelp' => 'Intranet Statistics konfigurationsfil synes at være konfigureret forkert. Fjern enten config/config.ini.php og genoptage installation eller ret database forbindelsesindstillinger.',
	'Installation_ErrorInvalidState' => 'Fejl: Det lader til at du forsøger at springe et skridt af installationen over, eller cookies er slået fra, eller Intranet Statistics konfigurationsfil allerede er oprettet. %1$sSørg for, at cookies er aktiveret%2$s og gå tilbage %3$s til den første side i installationen %4$s.',
	...
	'Installation_SystemCheckSummaryThereWereErrors' => 'Ups! Intranet Statistics har opdaget nogle %1$skritiske problemer%2$s med din Intranet Statistics opsætning. %3$sDisse problemer skal løses øjeblikkeligt.%4$s',
	'Installation_SystemCheckSummaryThereWereWarnings' => 'Der er nogle problemer med dit system. Intranet Statistics vil virke, men du kan opleve nogle mindre problemer.',
	'Installation_SystemCheckSummaryNoProblems' => 'Sådan! Der er ingen problemer med din Intranet Statistics opsætning. Giv dig selv et klap på skulderen.',
	'Installation_SeeBelowForMoreInfo' => 'Se nedenfor for mere information.',
	'Installation_DatabaseAbilities' => 'Database egenskaber',
	'Installation_LoadDataInfileUnavailableHelp' => 'Brug af %1$s vil i høj grad sætte Intranet Statisticss arkiveringhastighed op. For at gøre det tilgængeligt for Intranet Statistics, opdater PHP & MySQL-softwaren og sørg for at databasebruger har %2$s privilegium.',
	'Installation_LoadDataInfileRecommended' => 'Hvis Intranet Statistics serveren sporer trafikbelastede hjemmesider(fx. > 100.000 sider pr. måned), anbefales det for at forsøge at løse problemet.',
	'Installation_Filesystem' => 'Filsystem',
	'Installation_NfsFilesystemWarning' => 'Din server benytter et NFS filsystem.',
	'Installation_NfsFilesystemWarningSuffixAdmin' => 'Det betyder at Intranet Statistics vil være ekstremt langsom når der benyttes filbaserede sessioner.',
	'Installation_NfsFilesystemWarningSuffixInstall' => 'Brug af filbaserede sessioner på et NFS filsystem er ekstrem langsomt, så Intranet Statistics vil benytte database sessioner. Hvis du har mange samtidige kontrolpanelsbrugere, vil du muligvis være nødt til at hæve det maksimale antal af klient forbindelser til database serveren.',
	'Installation_JSTracking_Intro' => 'For at spore hjemmeside trafik med Intranet Statistics skal du sørge for nogle ekstra kode til hver af hjemmesiderne.',
	...
	'LanguagesManager_PluginDescription' => ' Programudvidelsen viser en liste over de tilgængelige sprog for Intranet Statistics brugerflade. Det valgte sprog vil blive gemt i præferencer for hver bruger.',
	'LanguagesManager_AboutPiwikTranslations' => 'Om Intranet Statistics oversættelser',
	...
	'Login_ContactAdmin' => 'Mulig årsag: udbyderen har måske deaktiveret mail()-funktionen. <br />Kontakt Intranet Statistics administrator.',
	...
	'Mobile_AddPiwikDemo' => 'Tilføj Intranet Statistics demo',
	'Mobile_AnonymousTracking' => 'Anonym sporing',
	'Mobile_AskForAnonymousTrackingPermission' => 'Når aktiveret, vil Intranet Statistics Mobile sende anonyme data om brugen til Intranet Statistics.org. Formålet er at bruge disse data til at hjælpe Intranet Statistics Mobile udviklerne, med at få et indblik i hvordan applikationen bruges. Information som sendes: klik i menuen og på indstillinger, styresystemets navn og version, enhver fejl som vises i Intranet Statistics Mobile. Vi sender INGEN af dine analyse data. Disse anonyme data vil aldrig blive offentliggjort. Du kan deaktivere/aktivere anonym sporing i Indstillinger til enhver tid.',
	...
	'Mobile_HelpUsToImprovePiwikMobile' => 'Aktiver anonyme forbrugsdata i Intranet Statistics Mobile ?',
	'Mobile_HttpIsNotSecureWarning' => 'Intranet Statistics tilladelse token (token_auth) sendes i klar tekst, hvis der bruges "HTTP". Af denne grund anbefales HTTPS til sikker transport af data over internettet. Vil du fortsætte?',
	...
	'Mobile_RatingPleaseRateUs' => 'Intranet Statistics Mobile app er gratis software. Vi vil sætte stor pris på, at du bruger 1 minut på at bedømme app\'en i %s. Hvis du har forslag til nye features eller fejlrapporter, så kontakt %s',
	...
	'Mobile_AccessUrlLabel' => 'Intranet Statistics adgangs netadresse',
	...
	'Mobile_NoPiwikAccount' => 'Ingen Intranet Statistics konto?',
	'Mobile_NoVisitorFound' => 'Ingen besøgende fundet',
	'Mobile_NoWebsiteFound' => 'Ingen hjemmesider fundet',
	'Mobile_SaveSuccessError' => 'Intranet Statistics URL eller brugernavn og adgangskode er forkert.',
	...
	'MobileMessaging_VerificationText' => 'Koden er %s. For at validere dit telefonnummer og modtage Intranet Statistics SMS rapporter, kopierer koden til formularen tilgængelig på Intranet Statistics > %s > %s.',
	...
	'MobileMessaging_Settings_PhoneNumbers_HelpAdd' => 'Når du klikker på "Tilføj", vil en sms med en kode sendes til telefonen. Den bruger, der modtager koden skal derefter logge ind på Intranet Statistics, klikke på Indstillinger, og klik derefter på mobilbeskeder. Når du har indtastet koden, vil brugeren være i stand til at modtage SMS rapporter på telefonen.',
	...
	'MobileMessaging_Settings_CredentialNotProvidedByAdmin' => 'Før du kan oprette og administrere telefonnumre, skal du bede din administrator om at forbinde Intranet Statistics til en SMS-konto.',
	'MobileMessaging_Settings_CredentialNotProvided' => 'Før du kan oprette og administrere telefonnumre, skal du tilslutte Intranet Statistics til din SMS-konto ovenfor.',
	...
	'MobileMessaging_MultiSites_Must_Be_Activated' => 'For at generere SMS beskeder med dine website statistik, skal du aktivere MultiSites udvidelsesmodulet i Intranet Statistics.',
	'MultiSites_PluginDescription' => 'Viser multi-websted resumé/statistik. Vedligeholdes som et Intranet Statistics-kerne udvidelsesmodul.',
	...
	'Provider_ProviderReportDocumentation' => 'Rapporten viser hvilken Internet udbyder de besøgende bruger. Klik på en udbyders navn for flere oplysninger. %s Hvis Intranet Statistics ikke kan bestemme  besøgendes udbyder, er den opført som IP.',
	...
	'Referers_CampaignFooterHelp' => 'Hjælp til: %sSporingskampagner i Intranet Statistics %s URL bygge værktøj',
	...
	'SitesManager_PluginDescription' => 'Hjemmeside styring i Intranet Statistics: Tilføj en ny hjemmeside, rediger et eksisterende, vis JavaScript-koden til at inkludere på dine sider. Alle handlinger er også tilgængelige via API.',
	...
	'SitesManager_GlobalListExcludedUserAgents_Desc' => 'Hvis besøgende brugeragent streng indeholder nogen af de ​​strenge, du angiver, vil besøgende blive udelukket fra Intranet Statistics.',
	'SitesManager_GlobalExcludedUserAgentHelp1' => 'Angiv listen over brugeragenter der ikke skal spores af Intranet Statistics.',
	...
	'SitesManager_PiwikWillAutomaticallyExcludeCommonSessionParameters' => ' Intranet Statistics vil automatisk udelukke den fælles session parametre (%s).',
	...
	'SitesManager_PiwikOffersEcommerceAnalytics' => 'Intranet Statistics giver mulighed for avancerede e-handel analysesporing og rapportering. Lær mere om %s E-handel analyse%s.',
	'SitesManager_TrackingSiteSearch' => 'Sporing af intern webstedssøgning',
	'SitesManager_SiteSearchUse' => 'Du kan bruge Intranet Statistics til at spore og rapportere hvad besøgende søger efter i hjemmesidens interne søgemaskine.',
	...
	'SitesManager_SearchCategoryDesc' => 'Intranet Statistics kan også spore søgekategori for hver interne hjemmeside søgeord.',
	...
	'TranslationsAdmin_PluginDescription' => ' Hjælpe med at oversætte Intranet Statistics.',
	...
	'UserCountryMap_LoginToViewRealTime' => 'Log ind for at få vist tidstro Intranet Statistics besøgskort!',
	...
	'UserCountry_PiwikNotManagingGeoIPDBs' => 'Intranet Statistics styrer pt. ikke nogle GeoIP databaser.',
	...
	'UserCountry_GeolocationPageDesc' => 'På denne side kan du ændre hvordan Intranet Statistics bestemmer de besøgendes lokation.',
	...
	'UserCountry_TestIPLocatorFailed' => 'Intranet Statistics forsøgte kontrollere placeringen af en kendt IP-adresse (%1$s), men serveren returnerede %2$s. Hvis denne udbyder blev konfigureret korrekt, vil den tilbage %3$s.',
	...
	'UserCountry_HowToSetupGeoIP_Step2' => 'Udpak filen og kopiere resultatet, %1$s til %2$smisc%3$s Intranet Statistics undermappen (du kan gøre dette enten ved FTP eller SSH).',
	...
	'UserCountry_HowToSetupGeoIP_Step4' => 'Og du er færdig! Du har lige sat Intranet Statistics op til at bruge GeoIP, hvilket betyder, at du vil være i stand til at se de regioner og byer de besøgende kom fra, sammen med meget nøjagtig lande information.',
	...
	'UserCountry_OldGeoIPWarning' => 'Vi har opdaget det gamle GeoIP udvidelsesmodul. GeoIP integration er nu i Intranet Statistics kernen og udvidelsesmodulet anses for forældet. Nye region og by rapporter vil ikke blive vist, mens dette udvidelsesmodul er indlæst. %1$sdeaktivere udvidelsesmodulet%2$s og %3$skonfigurere GeoIP%4$s. Hvis du vil have lokaliseringsdata fra gamle besøg brug scriptet beskrevet %5$sher%6$s og %7$sombearbejd rapporterne%8$s.',
	...
	'UserCountry_GeoIPServerVarsFound' => 'Intranet Statistics registrerer følgende GeoIP %s variabler',
	'UserCountry_AssumingNonApache' => 'Kan ikke finde apache_get_modules funktion, antager ikke-Apache webserver.',
	'UserCountry_FoundApacheModules' => 'Intranet Statistics fandt følgende Apache moduler',
	'UserCountry_GeoIPNoServerVars' => 'Intranet Statistics kan ikke finde nogen GeoIP %s variable.',
	...
	'UserCountry_GeoIPUpdaterIntro' => 'Intranet Statistics styrer opdateringen af følgende GeoIP databaser',
	...
	'UserCountry_CannotSetupGeoIPAutoUpdating' => 'Det lader til, at GeoIP databaserne gemmes udenfor Intranet Statistics (der ikke er nogen databaser i \'misc\' undermappe, men din GeoIP virker). Intranet Statistics kan ikke automatisk opdatere GeoIP databaser, hvis de er placeret uden for \'misc\' mappen.',
	...
	'UserCountry_FatalErrorDuringDownload_js' => 'Fatal fejl opstod under overførsel af filen. Der kan være noget galt med din internetforbindelse, med GeoIP databasen du har hentet eller Intranet Statistics. Prøv at hente og installere filen manuelt.',
	...
	'UsersManager_PluginDescription' => 'Brugere styring i Intranet Statistics: tilføje en ny bruger, redigere en eksisterende, opdatere tilladelserne. Alle handlinger er også tilgængelige via API.',
	...
	'UsersManager_MainDescription' => 'Bestem hvilke brugere der har hvilken Intranet Statistics adgang til hjemmesiderne. Adgang kan også sættes på alle hjemmesider på en gang.',
	...
	'UsersManager_YourVisitsAreIgnoredOnDomain' => '%sDine besøg ignoreres af Intranet Statistics på %s %s (Intranet Statistics ignorer cookie blev fundet i netlæseren).',
	'UsersManager_YourVisitsAreNotIgnored' => '%sDine besøg bliver ikke ignoreret af Intranet Statistics%s (Intranet Statistics ignorer cookie blev ikke fundet i netlæseren).',
	'UsersManager_ClickHereToDeleteTheCookie' => 'Klik her for at slette cookie og få Intranet Statistics til at spore dine besøg',
	'UsersManager_ClickHereToSetTheCookieOnDomain' => 'Klik her for at sætte en cookie og udeluk egne besøg på hjemmesider der spores af Intranet Statistics på %s',
	...
	'UsersManager_WhenUsersAreNotLoggedInAndVisitPiwikTheyShouldAccess' => 'Når ingen brugere er logget på Intranet Statistics bør de tilgå',
	...
	'UsersManager_ExceptionEditAnonymous' => 'Anonyme brugere kan ikke redigeres eller slettet. Anvendes af Intranet Statistics til at definere en bruger, som ikke er blevet logget på endnu. F. eks. kan du gøre statistikken offentlig ved at give \'se\' adgang til \'anonym\' bruger',
	'UsersManager_ExceptionSuperUser' => 'Anmodet bruger er Superbrugeren og kan ikke forespørges, rettes eller slettes gennem API. Kan rettes manuelt under Superbruger detaljerne i Intranet Statistics konfigurationsfilen.',
	...
	'VisitorGenerator_PluginDescription' => 'Programudvidelse til at generer kunstige besøg. Kan bruges af Intranet Statistics brugere eller udviklere som en let måde at generere kunstige data til at udfylde Intranet Statistics rapporter.',
	'VisitorGenerator_VisitorGenerator' => 'Besøgsgenerator',
	'VisitorGenerator_Warning' => ' Du er ved at generere kunstige besøg, som vil blive gemt i Intranet Statistics databasen.',
	'VisitorGenerator_NotReversible' => 'Det er %s ikke%s muligt nemt at slette disse besøg fra Intranet Statisticss log.',
	...
	'Widgetize_PluginDescription' => 'Programudvidelsen gør det nemt at eksportere Intranet Statistics moduler til din blog, hjemmeside eller på iGoogle og Netvibes!',
	'Widgetize_TopLinkTooltip' => 'Eksporter Intranet Statistics rapporter som moduler og indlejre dit kontrolpanel i din applikation som en iframe.',
	...
	'PDFReports_PiwikReports' => 'Intranet Statistics rapporter',
	...
	'PDFReports_TopLinkTooltip' => 'Opret e-mail-rapporter for at få Intranet Statistics statistik leveret til din e-mail eller dine kunders adresse automatisk!',
	'ImageGraph_PluginDescription' => 'Generere flotte statiske PNG diagrammer til Intranet Statistics rapporter.',
	...
	'Overlay_Link' => 'Link',
	'Overlay_RedirectUrlError' => 'Du forsøger at åbne sideoverlejring for URL "%s". %s Ingen af ​​domæner fra Intranet Statisticss indstillinger matcher linket.',
	...
	'Overlay_ErrorNotLoadingDetails' => 'Måske den indlæste side til højre ikke har Intranet Statistics sporingskode. I så tilfælde, kan du prøve at starte overlejring for en anden side fra siderapporter.',
	'Overlay_ErrorNotLoadingDetailsSSL' => 'Da du bruger Intranet Statistics over HTTPS, er den mest sandsynlige årsag, at hjemmesiden ikke understøtter SSL. Prøv at bruge Intranet Statistics over HTTP.',
